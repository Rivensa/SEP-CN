...
> | (TW) | 如果一个主体 S 在相信 p 方面是有保证的，并且在相信 p 蕴含 q 的方面也是有保证的（并且 S 进一步认识到 q 是从这些信念中演绎出来的），那么 S 有可能第一次获得相信 q 的保证。（参见 Wright 2000a，第 140-141 页。） |
> | ------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> | (CW) | 如果 S 在相信 p 方面是有保证的，并且在相信 p 蕴含 q 的方面也是有保证的，那么 S 在相信 q 方面是有保证的（或者有可能获得这样的保证）。 |
> | ------ | -------------------------------------------------------------------------------------------------------------------------------------- |
...
> | (TC) | S 对 p 的信念的理由是这样的，如果某个相关的替代情况是真的，S 仍然会相信 p。 |
> | ------ | ----------------------------------------------------------------------------- |
...
> | W(†) | 水是我现在唯一喝的东西；然而，多年前，我喝过加了杜松子酒的水。 |
> | ------- | ---------------------------------------------------------------- |
...
> | (PKI) | 如果一个主体 S 认识到她的断言/信念有多种相关解释，并且 S 没有任何决定的依据，那么 S 就缺乏对她的断言/信念内容的知识。 |
> | ------- | ----------------------------------------------------------------------------------------------------------------------- |
