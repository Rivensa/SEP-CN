# 威廉·惠威尔 Whewell, William (Laura J. Snyder)
...
惠威尔首次明确而详细地讨论归纳法的文章出现在他的《归纳科学哲学》中，该书最初于 1840 年出版（第二版于 1847 年出版，第三版则分为三个独立的作品于 1858 年至 1860 年间出版）。他将自己的归纳法称为“发现者的归纳法”，并解释说它用于发现现象和因果定律。惠威尔认为自己是培根的追随者，并声称在“更新”培根的归纳法；因此，第三版《哲学》的其中一卷名为《新修归纳法》。惠威尔在拒绝了标准的、过于狭隘的归纳法观念上与培根保持一致，后者认为归纳法仅仅是简单的实例列举。相反，惠威尔解释说，在归纳法中，“在思维的行为中，通过将实例组合在一起，为这个组合添加了一个新的要素”（1847 年，II，48）。这个“思维的行为”是惠威尔称之为“联结”的过程。根据惠威尔的说法，联结是通过“超越”经验事实，将它们联系在一起的心理操作，从而使它们能够通过一个普遍定律来表达。这个概念因此提供了“真正的统一纽带，将现象联系在一起”（1847 年，II，46），通过提供一个被已知类别成员共享的属性（在因果定律的情况下，联结属性是共享相同原因）。

因此，开普勒利用椭圆曲线的概念将火星轨道的已知点联系起来。惠威尔指出，新的发现通常不是在发现新事实时进行的，而是在将适当的概念应用于事实时进行的。在开普勒的发现中，轨道的观测点是由第谷·布拉赫所知的，但只有当开普勒应用椭圆概念时，轨道的真实路径才被发现。开普勒是第一个将这个概念应用于轨道路径的人，部分原因是因为他对椭圆概念有一个非常清晰的概念。这很重要，因为基本的思想和概念是由我们的思维提供的，但它们不能以其固有的形式使用。惠威尔解释说，“这些思想的构想，至少是它们的种子，在[经验]之前就存在于人类的思维中；但通过科学思维的进展，它们被展开成清晰和明确的形式”（1860a，373）。惠威尔将这种思想和概念的“展开”称为“概念的阐释”。阐释是发现的必要前提，它包含部分经验性和部分理性的过程。科学家首先尝试在他们的思维中澄清和明确一个概念，然后试图将其应用于他们精确检查过的事实，以确定该概念是否能将事实联系成一个定律。如果不能，科学家将利用这种经验来进一步完善概念。惠威尔声称，科学史的很大一部分是“科学思想的历史”，即它们的阐释和随后作为联系概念的使用的历史。因此，在开普勒使用椭圆概念的情况下，惠威尔指出，“提供这个概念需要特殊的准备和发现者思维中的特殊活动。 …要发现这样的联系，思维必须熟悉空间的某些关系和某些类型的图形”（1849 年，28-9）。

一旦概念被阐明，就可以选择适当的概念来联系现象。但是如何选择适当的概念呢？根据惠威尔的说法，这不是一个猜测的问题。重要的是，这也不仅仅是观察的问题。惠威尔解释说，“除了纯粹观察事实之外，思维中还有一个特殊的过程是必要的”（1849 年，40）。这个“思维中的特殊过程”是一种推理过程。“我们推断的不仅仅是我们所看到的”，惠威尔声称（1858a，I，46）。通常，找到适当的概念来联系一类现象需要一系列的推理，因此惠威尔指出，发现者的归纳是一个涉及“一系列研究”的过程（1857/1873，I，297）。他允许在联系中使用任何类型的推理，包括枚举、排除和类比。因此，可以看出开普勒在他的《新天文学》（1609 年）中使用了各种形式的推理来得出椭圆概念（参见斯奈德 1997a）。当奥古斯都·德摩根在他的 1847 年逻辑教材中抱怨某些作家将“归纳”一词包括“使用整个[逻辑]工具箱”时，他无疑是在指他的老师和朋友惠威尔（参见斯奈德 2008）。

在使用一个概念将一个类的已知成员联系起来之后，惠威尔的发现者归纳的第二步发生了：即将共同属性概括到整个类中，包括其中的未知成员。通常情况下，正如惠威尔所承认的，这是一个非常简单的过程。当开普勒将椭圆的概念应用于火星位置的观察成员时，他将其概括到整个类的所有成员，包括未知的（未观察到的），从而得出结论：“火星轨道上的所有点都位于一个以太阳为焦点的椭圆上。”然后，他进一步概括以得出他的第一行星运动定律：“所有行星的轨道都位于以太阳为焦点的椭圆上。”

我已经提到过，惠威尔认为自己在改进培根的归纳哲学。他的归纳主义与培根解释自然的方法有许多共同之处：例如，归纳必须涉及不仅仅是简单的实例列举，科学必须通过逐步概括的步骤进行，归纳科学可以研究不可观察的事物（对于培根来说是“形式”，对于惠威尔来说是不可观察的实体，如光波或椭圆轨道或引力）。 （有关惠威尔和培根之间关系的更多信息，请参见 Snyder 2006; McCaskey 2014）。然而，令人惊讶的是，20 世纪对惠威尔方法论的普遍看法倾向于将惠威尔描述为波普尔式的反归纳主义者（例如，Ruse 1975; Niiniluoto 1977; Laudan 1980; Butts 1987; Buchdahl 1991）。也就是说，有人声称惠威尔支持“猜测和反驳”科学发现观点。然而，从上面的讨论可以清楚地看出，他对发现者的归纳观点并不像那种声称假设通常是通过纯粹的猜测得出的观点。事实上，惠威尔明确反对了非理性猜测得出的假设可以通过后果测试来确认的假设演绎主义观点。例如，在他对朋友赫歇尔的《自然哲学研究初论》的评论中，惠威尔反对赫歇尔的观点，认为当假设是非归纳性形成时，验证是不可能的（1831 年，400-1 页）。近 30 年后，在哲学的最后一版中，惠威尔提到了“发现现象的法则和原因是一种松散的猜测”，并声称这种观点“在我看来是对科学整体性质的误解”（1860a，274 页）。 在他的其他成熟作品中，他指出发现并非“任意的猜测或武断的选择”（1858a，I，29），并解释说新的假设应该“从事实中收集”（1849，17）。事实上，惠威尔因为不同意发现（包括牛顿发现普遍引力定律）通常是偶然发生的观点而受到当时的大卫·布鲁斯特的批评。

为什么惠威尔被许多现代评论家误解了呢？其中一个原因是他在 19 世纪使用的某些术语被现代人误读为与 20 世纪和 21 世纪的意义相同。因此，由于惠威尔使用了“猜测”和“猜想”这些术语，一些作家认为他与波普尔的方法论相同。例如，惠威尔提到科学家们做出的“幸运的猜测”（1858b，64），并声称“知识的进步”常常是“先前进行一些大胆和放肆的猜测”的结果（1847，II，55）。但是，惠威尔通常使用这些术语来表示一个（尚未）得到确凿证实的结论。《牛津英语词典》告诉我们，在 20 世纪之前，“猜测”一词的意思并不是通过非理性手段得出的假设，而是指“未经验证”的假设，或者是“对可能或可能性的结论”（与证明的结果相对）。培根、开普勒、牛顿和达格尔德·斯图尔特等作家都是惠威尔熟悉的人，他们都是以这种方式使用这个术语的。在惠威尔使用“猜测”一词的其他地方，他暗示了看似是猜测结果的实际上是我们可以称之为“有根据的猜测”的结论，即通过（弱）推理得出的结论。惠威尔描述了开普勒的发现，它看起来是如此“反复无常和幻想”，实际上是由他的“明确的科学观念”所“调节”（1857/1873，I，291-2）。最后，惠威尔对猜测术语的使用有时出现在他区分多种可能概念的生成和在事实上引入其中一种的选择之间的背景下。在找到适当的概念之前，科学家必须能够在脑海中召唤出许多可能性（见 1858b，79）。惠威尔指出，这种召唤出许多可能性的过程“在某种程度上是一个猜测的过程”。“然而，选择与数据相关联的适当概念并非推测性的（1858b，78）。因此，惠威尔声称选择概念通常是“以猜测为前提”（1858b，xix）；也就是说，他并不声称选择是凭猜测进行的。当推理不用于选择适当的概念时，得出的理论不是“归纳”，而是“草率和不完善的假设”。他在哥白尼的日心说和公元前三世纪亚里士多德提出的日心系统之间做出了这样的区分，他称哥白尼的理论为归纳，而将亚里士多德的理论称为草率和不完善的假设（1857/1873，I，258）。

因此，惠威尔的科学哲学不能被描述为假设演绎观。它是一种归纳方法；然而，它与密尔的更狭隘的归纳主义明显不同。惠威尔对归纳的看法比密尔的优势在于允许推断不可观察的属性和实体，因此更准确地反映了科学的工作方式。（有关反对将惠威尔解读为假设演绎主义的更详细论证，请参见 Snyder 2006；Snyder 2008；McCaskey 2014）。

## 3. 科学哲学：确认

根据惠威尔的观点，一旦理论由发现者归纳出来，它必须经过多种测试才能被视为经验真理的确认。这些测试包括预测、协调和连贯性（见 1858b，83-96）。惠威尔将这些特征描述为首先，“我们的假设应该预测到尚未被观察到的现象”（1858b，86）；其次，它们应该“解释和确定与形成假设时所考虑的不同类型的情况”（1858b，88）；第三，假设必须“随着时间的推移变得更加连贯”（1858b，91）。

我首先讨论预测的标准。惠威尔解释说，假设应该预测现象，“至少是同类现象的所有情况”，因为“我们对假设的同意意味着它被认为适用于所有特定情况。这些情况是过去还是未来，已经发生还是尚未发生，对于规则的适用性没有影响。因为规则适用于所有情况”（1858b，86）。惠威尔在这里的观点很简单，由于我们的假设是普遍形式的，一个真实的假设将涵盖规则的所有特定情况，包括过去、现在和未来的情况。但他还提出了更强的主张，即对未知事实的成功预测比对已知事实的解释具有更大的证实价值。因此，他认为“后来发现为真的未知事实的预测是……对理论的证实，在印象和价值上超越了对已知事实的任何解释”（1857/1873，II，557）。惠威尔声称，预测与发生的事实一致（即预测被证明是正确的），“如果理论是真实的，这并不奇怪，但如果理论不是真实的，这是完全无法解释的”（1860a，273-4）。例如，他认为，如果牛顿的理论不是真实的，那么从该理论中我们能够正确预测到一个新行星——海王星的存在、位置和质量（正如在 1846 年发生的那样），将是令人困惑的，甚至是奇迹般的。

根据惠威尔的说法，更有价值的确认标准是“一致性”。惠威尔解释说，“当我们的归纳能够解释和确定（即预测）与我们假设形成时所考虑的不同类型的情况时，支持我们归纳的证据具有更高和更有力的特征。确实发生了这种情况的实例使我们确信我们的假设是正确的”（1858b，87-8）。惠威尔将这种类型的证据称为归纳的“跳跃”或“一致性”。一个归纳，它是通过将一类事实联系在一起而得出的，也被发现能够成功地联系另一类事实。因此，惠威尔对一致性的概念与他对自然类别的对象或事件的观点相关。
...
* Cowles, H. M., 2016, “William Whewell, Charles Peirce, and Scientific Kinds,” *Isis*, 107: 722–38.
...
* –––, 1869 [1984], “Whewell,” in Max H. Fisch (ed.), *Writings of Charles S. Peirce: A Chronological Edition* (Volume 2), Bloomington, IN: Indiana University Press, pp. 337–45.
