...
需要假设“中间体”的原因在于不能对这些“理念数字”进行算术运算，正如库克·威尔逊所称的那样，而需要介于感性事物和理念数字之间的实体来解释像“二加二等于四”这样基本的算术真理。然而，库克·威尔逊反对承诺“中间体”（OPD，§4），他的观点是算术运算总是针对个别事物进行的，如果算术的“单元数字”是单位的多元体，那么理念数字就是这些数字的属性。至于柏拉图在写《理想国》或之后是否达到了这种理念数字作为ἀσύμβλητοι ἀριθμοί的观点，那又是另一个问题。
