...
*首次发表于 2007 年 1 月 26 日；实质修订于 2014 年 7 月 30 日*

鉴于维特根斯坦非常重视生活的审美维度，他在这个主题上写得如此少实际上令人惊讶。确实，我们有他在 1938 年夏天在剑桥的私人房间里给一小群学生讲授美学的讲义笔记（维特根斯坦，1966 年），以及 G.E.摩尔记录的维特根斯坦在 1930-1933 年期间的一些讲座（摩尔，1972 年）。在维特根斯坦自己的著作中，我们可以在他关于语言、心灵、数学和哲学方法的著作中找到关于文学、诗歌、建筑、视觉艺术以及特别是音乐和更广泛的文化哲学的评论，这些评论散布在他的个人笔记和《文化与价值》（维特根斯坦，1980 年）中。从另一个角度来看，这一点并不令人惊讶，正是因为他给予审美以核心地位：在他一生中从最早的《论理论之前》（维特根斯坦，1961 年，1971 年）的著作到《论确定性》（维特根斯坦，1969 年）中他生命最后几周的评论，他一直在写关于意义问题的文章；在他的《哲学研究》第二部分（维特根斯坦，1958 年）、《心理哲学哲学评论》第一卷和第二卷（维特根斯坦，1980a 年，1980b 年）以及《心理哲学哲学评论最后著作》第一卷（维特根斯坦，1982 年）中，他写了关于感知的文章；在他关于心灵和语言的哲学中写了关于情境前提对意义出现的影响的文章（在《哲学研究》（维特根斯坦，1958 年）以及他关于数学哲学的著作中），他在写关于审美的文章，虽然有一定的距离。 对于意义、感知和意义的问题，它们都明显是审美体验的核心，他在这些主题上所进行的写作对于艺术意义和解释的问题仍然具有重要意义，这些问题仍在被探索和阐明（Lewis 2004，Dauber 和 Jost 2003，Gibson 和 Huemer 2004）。维特根斯坦将审美放置在哲学主题的边缘，而不是在这些兴趣的集中点上，因为那样的话它仍然是一个独立的主题领域。相反，维特根斯坦以一种方式将主题的各种各样的线索交织在他的写作中，在某些情况下明确显示，并在更多情况下隐含地暗示着审美考虑与他所写的哲学的每个其他领域之间的分层相互关系。在本文中，我将研究他关于这个主题的讲座的记录（可预见的是，这些讲座在途中涉及了许多与审美问题无关的联系），但在整个过程中，我将试图对它们进行解读，将它们置于他哲学工作的更大背景之中。

---

## 1. 传统美学的批判

维特根斯坦的开场白是双管齐下的：他说美学领域既非常广阔，又被完全误解。通过“非常广阔”，我相信他指的是美学维度以上述方式贯穿了整个哲学，并且美学在人类事务中的影响远远大于艺术的受限影响；世界上充满了美感或美学兴趣的表现，而艺术作品的数量要少得多。在他接下来的讨论中，有充分的理由相信他意图让任何全面的美学解释都承认前者，而不仅仅是像许多哲学解释那样局限于后者。通过“完全误解”，可以看出他的意思是（1）美学问题是一种与经验问题非常不同的概念类型，我们想要的答案或概念满足与我们从经验心理学实验中得到的答案非常不同，以及（2）在哲学上传统的本质定义方法——确定“艺术作品”类的所有成员所展示的本质，并由此对其进行分类——将掩盖我们的视野，而不是揭示更多。

### 1.1 属性和本质

从这些讲座的开始就清楚地看出，维特根斯坦敦促人们对语言的各种方式保持高度警惕，因为这些方式在语法表面上可能会误导人。如果我们在调查的开始就看到我们把“美丽”这个词用作形容词，我们很快就会问这个特定例子展示的美的属性的本质是什么。他设想了一本哲学书籍，研究词类（比普通语法书中的词类更多），我们会非常详细和细致地关注“看到”、“感觉”以及其他与个人经验相关的动词，以及对“所有”、“任何”、“一些”、数词、第一人称代词等的长篇研究，他认为，如果对每个用法的语法背景进行足够的关注，这样一本书将揭示语言可能导致我们陷入的混乱。后来，在他的《哲学研究》（维特根斯坦 1958 年）中，他将工具和语言之间的类比发展成为一种打破概念图像束缚的方式，这种方式认为词语以某种方式工作（通过命名事物，包括命名属性，就像我们过快地思考美的问题一样），展示了工具箱中各种物品（如锤子、胶水、凿子、火柴）之间的种类和用途的多样性。如果我们将注意力从关于由词语“美丽”或“漂亮”命名的共同属性的难题的固定观念上转移开来，而是关注我们审美批判词汇的实际用途，我们会发现，这并不是语言符号内部所携带的某种内在意义（维特根斯坦 1958a）使得这个词能够作为审美或批判的插入语或赞同的表达方式。 相反，我们将能够将我们的注意力重新集中在实际上使所讨论的词在美学上发挥作用的事物上，即“在美学表达有所位置的极其复杂的情境上”，他补充说，通过这样一个扩大的视野，我们可以看到“表达本身几乎没有什么重要性”（第 2 页）。他在这里提到（将美学问题视为与哲学的其他部分交织在一起），如果他必须确定他这一代哲学工作中的主要错误，那就是在看待语言时，专注于词的形式，而不是词的使用。他将继续暗示，如果不是直接断言，这种类比也适用于艺术作品：将其置于更大的参照框架中，将其与所讨论的艺术家的其他作品进行比较，并将其与其文化背景中的其他作品并列，就是看到它在当时和当地的对话式展开的艺术“语言游戏”[1]中所扮演的角色。在讲座中，他接着说，在使用语言时，在相互理解中 - 并且在最初掌握一种语言时 - 我们并不是从一小组词或一个单词开始，而是从具体的场合和活动开始。我们的美学参与就是这种场合和活动；因此，作为一个概念探究领域的美学，应该从不假设中心任务是分析由美学谓词命名的决定性属性，而是从对美学生活活动的充分考虑开始。

### 1.2 谓词和规则

但是许多（并非全部）批判性谓词的形容词形式很快就加强了“带有名称的属性”模型，而维特根斯坦则以音乐和诗歌批评的例子来对抗这一模型，我们只是简单地关注过渡的正确性或图像的精确性或适切性。而正是在这里，维特根斯坦提醒我们，诸如“庄严的”、“浮夸的”或“忧郁的”（后者是指舒伯特的作品）这样的描述就像给作品一个面孔（Shiner 1978），或者我们可以使用手势（或进一步具体化这些描述）来代替。在重新构思作品的情况下（例如诗歌的韵律），我们通过手势、面部表情和非描述性谓词的言论来理解其节奏和结构，美学形容词在其中起到了较小的或根本没有作用。我们通过穿着来展示对裁缝工作的赞赏，而不是通过描述西装。场合和活动是基础，描述性语言是次要的。

维特根斯坦在这里转向规则和遵循规则在审美决策中的主题。这源于他对审美话语中“正确”一词的思考，并提到了在和声和对位法中进行训练的情况。他声称，这种规则学习允许他所称之为特定情况下规则的解释，其中越来越精细的判断来自于对所讨论规则的越来越精细的掌握。特别有趣的是，在这里加入了一个限定条件，即在艺术创造和审美判断的背景下，这些规则“可能非常明确并且可以教授，或者根本没有明确规定”（维特根斯坦 1966 年）。这本身就强烈暗示着，在这种情况下，行动首先出现，这些行动可能（引用康德著名的区别）要么明确地遵循规则，要么与规则相符但（对于维特根斯坦来说）以一种不明确的方式。实践的掌握可以被描述为遵循规则的认知问题，但不一定如此。因此，在维特根斯坦在美学和语言哲学方面的研究中，我们发现了一个交叉点：遵循规则的考虑（霍尔兹曼和莱奇 1981 年以及麦克道尔 1998 年）和关于非认知主义的辩论（麦克道尔 2000 年）与这个讨论直接相关。

遗憾的是，维特根斯坦过早地结束了这个问题（声称这个问题不应该在这个时候提出）；语言和美学中遵循规则之间的联系至今仍然研究得太少。然而，从某种意义上说，维特根斯坦在讨论中进行了延伸，即使只是隐含地。在研究美学“欣赏”所指的事物类型时，他确实说“一个欣赏者不是通过他使用的感叹词来展示”，而是通过他的选择、挑选，他在特定场合的行动。他声称，要描述欣赏的内容将是不可能的，因为“要描述它的内容，我们将不得不描述整个环境”（维特根斯坦 1966 年，7），他回到了裁缝的案例，隐含地回到了遵循规则。这些规则，正如我们在行动中觉察到的那样，从认知明确和语言封装到非认知隐含和仅行为表现的连续范围内，具有生命-在那些更大的参与背景中，那些“整个环境”。而那些环境，那些背景，那些语言游戏，不能简化为一个我们可以分析其基本属性的统一类型：“正确性”在某些美学欣赏和理解的情况下起着核心作用，在其他情况下则无关紧要，例如在裁剪服装与贝多芬交响乐之间，或者在家庭建筑与哥特式大教堂之间。他明确地提出了这里出现的伦理学和美学之间的类比：他指出了一个人行为良好与说一个人给人留下了巨大或深刻印象之间的区别。确实，“整个游戏是不同的”（维特根斯坦 1966 年，8）。
