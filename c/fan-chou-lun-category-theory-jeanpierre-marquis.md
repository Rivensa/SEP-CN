...
这是大多数范畴论教科书中所找到的定义。因此，它明确依赖于集合论背景和语言。一种替代方案是由 Lawvere 在六十年代初提出的，即为范畴的范畴开发一个适当的语言和背景框架。我们不会在这里介绍正式的框架，因为这会让我们偏离我们的主要关注点，但基本思想是定义所谓的弱 n-范畴（和弱 ω-范畴），之前称为范畴的东西将被称为弱 1-范畴（而集合将被称为弱 0-范畴）。 （例如，参见 Baez 1997，Makkai 1998，Leinster 2004，Baez＆May 2010，Simpson 2011。）
...
8. 一个_范畴的等价_是伴随性的一个特例。实际上，如果在上述三角恒等式中，箭头 η:IC→GF 和 ξ:FG→ID 是自然_同构_，那么函子 F 和 G 构成一个_范畴的等价_。在实践中，重要的是范畴的等价概念，而不是范畴的同构概念。
