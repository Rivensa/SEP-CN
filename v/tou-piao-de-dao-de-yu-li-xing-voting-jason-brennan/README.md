...
另一个简单而合理的论点是，投票可以是理性的，因为它可以履行被视为投票义务（Mackie 2010）。调查显示，事实上大多数公民确实认为有投票的义务或“尽自己的一份力量”（Mackie 2010: 8-9）。如果存在这样的义务，并且这些义务足够重要，那么对大多数选民来说投票是理性的。
...
Maskivker（2019）在某种程度上回应了这个反对意见，她说：“为什么不两者兼顾呢？” J. Brennan（2011a）和 Freiman（2020）认为，任何投票义务的潜在基础可以通过其他行动来履行（并且履行得更好）。Maskivker 认为，这并不意味着投票是可选的，而是如果一个人已经足够了解情况并具有公共精神，那么他应该投票，并且还要执行这些其他行动。Maskivker 的论证基于一种易助义务的义务论：如果一个人可以以对自己的成本非常低的方式为他人提供帮助，那么他应该这样做。对于已经了解情况的公民来说，投票是一种易助的例子。
...
有人可能会争辩说，选民对被统治者也有类似的关怀责任。也许选民应该 1）投票支持他们认为是最好结果的（符合战略性投票），并且 2）以足够了解和理性的方式做出这样的决定。选民的投票方式对政治结果有重大影响，并且可以帮助决定和平与战争、生与死、繁荣与贫困的问题。多数选民不仅仅为自己做选择，还为每个人做选择，包括持不同意见的少数派、儿童、非选民、居住在其他受其决策影响的国家的人。因此，投票似乎是一项具有道德意义的活动（克里斯蒂亚诺，2006 年；J.布伦南，2011 年；比尔博姆，2012 年）。
...
对购买和出售选票的某些反对意见似乎证明了太多的东西；这些反对意见导致了反对者不愿意支持的结论。例如，反对购买选票的一个常见论点是支付一个人投票对第三方造成了外部性。然而，说服他人投票或以某种方式投票也会造成同样的外部性（Freiman 2014: 762）。如果因为支付你投票给 X 是错误的，因为它对第三方造成了成本，那么为了保持一致，我也应该得出这样的结论，即说服你根据一个好的论点投票给 X 同样存在问题。
...
早期的民主捍卫者关心的是要证明民主优于贵族制、君主制或寡头制。然而，近年来，认知民主已经成为民主的主要竞争者（Estlund 2003, 2007; Landemore 2012）。一个系统被称为认知民主，是指该系统根据知识或政治能力在正式上分配政治权力的程度。例如，认知民主可能会给受过大学教育的公民额外的选票（Mill 1861），除非公民能通过选民资格考试，否则不允许他们投票，根据每个选民的政治知识程度对选票进行权衡，同时纠正人口统计因素的影响，或者创建专家小组，他们有权否决民主立法（Caplan 2007; J. Brennan 2011b; López-Guerra 2014; Mulligan 2015）。

对于知识统治的论点通常集中在对民主无能的担忧上。知识统治者认为民主赋予公民投票的权利过于放纵。大量实证研究表明，公民的基本政治知识水平（更不用说社会科学知识）的平均、中位数和众数都非常低（Somin 2013；Caplan 2007；Delli Carpini 和 Keeter 1996）。此外，政治知识在公民投票和支持何种政策上起着重要作用（Althaus 1998, 2003；Caplan 2007；Gilens 2012）。知识统治者认为限制或加权投票可以防止民主无能的一些弊端。

一种支持认知统治的论点是政治决策的合法性取决于其是否能够以胜任和善意的方式进行。可以将其类比为：在刑事审判中，陪审团的决定具有重大影响；他们的决定可能剥夺一个人的权利，或者严重损害其生命、自由、福利或财产。如果陪审团的决定是出于无知、恶意、任性或基于非理性和偏见的思维过程，我们可以说陪审团的决定不具有权威性或合法性。相反，我们认为被告有权利接受由胜任人员善意进行的审判。在许多方面，选举决策与陪审团决策类似：它们也具有重大影响，可能导致无辜的人失去生命、自由、福利或财产。如果陪审团决定的合法性和权威性取决于陪审团做出胜任和善意的决定，那么大多数其他政府决策，包括选民及其代表所做的决策，也应该如此。现在，假设鉴于普遍存在的选民无知和非理性，民主选民往往做出不胜任的决策。如果是这样，那么这似乎至少提供了支持认知统治优于民主的初步理由（J. Brennan 2011b）。

一些人争议是否认为认知统治比民主在原则上表现更好。认知统治通常试图通过某种方式提高政治决策者的平均可靠性来产生更好的政治结果。政治科学家陆宏和斯科特·佩奇（2004 年）提出了一个数学定理，表明在适当的条件下，集体决策中参与者之间的认知多样性比提高个体参与者的可靠性更有助于集体做出明智的决策。根据陆宏-佩奇定理，大量多样但不可靠的决策者在集体决策中可能表现得比少量不太多样但更可靠的决策者更好。关于陆宏-佩奇定理是否具有任何数学实质性（汤普森 2014 年认为没有），现实世界的政治决策是否符合该定理的条件，以及如果符合该定理，那在多大程度上证明了普选的合理性，或者仅仅表明广泛但受限制的选举权比高度受限制的选举权更优越（兰德莫尔 2012 年；索明 2013 年：113-5）存在一些争议。

相关地，孔多塞的陪审团定理认为，在适当的条件下，只要平均选民是可靠的，随着越来越多的选民加入到集体决策中，民主作出正确选择的概率将趋近于 1（利斯特和古丁 2001 年）。然而，假设该定理适用于现实生活中的民主决策，定理支持还是谴责民主取决于选民的可靠性。如果选民的表现比随机选择还差（例如，阿尔特豪斯 2003 年；卡普兰 2007 年），那么该定理反而意味着大型民主国家几乎总是做出错误的选择。

对于某些形式的知识统治，例如通过考试获得投票权的制度，人们担心这样的系统可能偏向某些人口群体做出决策。毕竟，政治知识在所有人口群体中并不均匀分布。（至少，政治科学家一直在研究的知识类型并不均匀分布。其他类型的知识是否更均匀分布是一个未解之谜。）平均而言，在美国，基本政治知识方面，白人比黑人更多，东北地区的人比南方地区的人更多，男性比女性更多，中年人比年轻人或老年人更多，高收入人群比贫困人口更多（Delli Carpini 和 Keeter 1996: 137-177）。如果实施这样的选民考试制度，选民将会更多是白人、男性、富人、中年人和就业状况更好的人，而不是整个人口。民主党人可能有理由担心，正因为这个原因，知识统治不会充分考虑非白人、女性、贫困人口或失业人口的利益。

然而，至少有一种形式的知识统治可能能够避免这个反对意见。例如，考虑“选民抽签”：

> 投票抽签包括两个设备。首先，将进行一次抽签，剥夺大多数人的选举权。在每次选举之前，除了随机抽取的一小部分公众之外，其他人都将被排除在外。我称这个设备为排斥性抽签，因为它仅告诉我们在特定竞选中谁没有权利投票。实际上，幸存下来的抽签者（预选民）不会自动获得选举权。与他们所属的较大群体中的每个人一样，预选民被认为投票能力不足。这就是第二个设备的作用。为了最终获得选举权并投票，预选民将聚集在相对较小的群体中，参与一个精心设计的能力培养过程，以优化他们对选票上的备选方案的了解。（López-Guerra 2014: 4; cf. Ackerman and Fishkin 2005）

在这个方案下，没有人有投票的假定权利。相反，每个人都默认具有平等的被选为选民的资格。在进行投票抽签之前，候选人将像在民主制度中一样进行竞选。然而，他们在竞选过程中并不知道哪些具体公民最终将获得投票权。在选举前立即，通过抽签随机选择一部分具有代表性的公民。这些公民并不会自动获得投票权。相反，被选中的公民仅获得获得投票权的许可。为了获得这个权利，他们必须参与某种能力培养的活动，比如研究党派纲领或在一个协商论坛中与其他人会面。实际上，这个系统可能会受到腐败或滥用的影响，但是，认同认知精英主义的人回应说，民主制度在实践中也存在这些问题。对于认知精英主义者来说，问题是哪个系统更好，即，从所有方面来看，哪个系统能产生最好或最具实质正义的结果。

对于知识统治的一个重要的道义上的反对意见是，它可能与公共理性自由主义不相容（Estlund 2007）。公共理性自由主义者认为，只有当所有受到该权力约束的合理人都有足够充分的理由来支持对该权力的正当化时，强制性政治权力的分配才是合法和有权威的（Vallier and D’Agostino 2013）。根据定义，知识统治赋予一些公民比其他人更大的权力，理由是这些公民拥有更多的社会科学知识。然而，反对意见认为，合理的人们可能对什么算作专业知识以及谁是专家存在分歧。如果合理的人们对什么算作专业知识以及谁是专家存在分歧，那么知识统治就会在不是所有合理人都有确凿理由支持的条件下分配政治权力。因此，知识统治在不是所有合理人都有确凿理由支持的条件下分配政治权力（然而，参见 Mulligan 2015）。


## Bibliography

* Achen, C. and Bartels, L., 2016, *Democracy for Realists*, Princeton: Princeton University Press.
* Ackerman, B. and Fishkin, J.S., 2005, *Deliberation Day*, New Haven: Yale University Press.
* Althaus, S., 1998, “Information Effects in Collective Preferences”, *American Political Science Review*, 92: 545–58.
* –––, 2003, *Collective Preferences in Democratic Politics*, New York: Cambridge University Press.
...
* Brennan, J., 2009, “Polluting the Polls: When Citizens Should Not Vote”, *Australasian Journal of Philosophy*, 87: 535–549.
...
* –––, 2013, “Epistocracy within Public Reason”, in *Democracy in the Twenty First Century: Problems and Prospects*, A. Cudd and S. Scholz (ed.), Berlin: Springer.
* Brennan, J. and L. Hill, 2014, *Compulsory Voting: For and Against*, New York: Cambridge University Press.
...
* List, C., 2013, “Social Choice Theory”, in *The Stanford Encyclopedia of Philosophy* (Winter 2013 Edition), Edward N. Zalta (ed.), URL = <[https://plato.stanford.edu/archives/win2013/entries/social-choice/](https://plato.stanford.edu/archives/win2013/entries/democracy/)>.
