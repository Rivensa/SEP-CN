# 中世纪的“普遍性 ”问题 the medieval problem of (Gyula Klima)
...
根据他们认为哪些项目（单个事物的普遍特征、它们的普遍概念或它们的普遍名称）是主要的、真实存在的普遍性，通常将中世纪的作者分为现实主义者、概念主义者或唯名论者。现实主义者被认为是那些声称在特定事物中和/或之前存在真实普遍性的人，概念主义者是那些只允许普遍性，或主要是心灵概念的人，而唯名论者则是那些只承认普遍词或主要是普遍词的人。但这种相当粗糙的分类并不能充分反映中世纪思想家之间真正的、更微妙的意见差异。（难怪在二次文献中经常可以找到对这些粗略定义立场的“温和”和“极端”版本的区分。）首先，几乎所有中世纪思想家都同意在事物之前存在普遍性，以神圣思想的形式存在于神圣的心灵中，但他们都否认了普拉托最初提出的独立于心灵、真实、永恒实体的存在形式。此外，中世纪思想家还一致认为，特定事物具有某些特征，人类的思维能够以普遍的方式理解并通过普遍术语表示。正如我们将看到的，他们的分歧更多地涉及特定事物、它们的个体但普遍可理解的特征、心灵的普遍概念和我们语言中的普遍术语之间的关系类型，以及事物的个体化特征和心灵的普遍概念之间的本体论地位和区别。 然而，“现实主义”和“名义主义”之间的区别，尤其是当它被用来指代中世纪后期哲学和神学中截然不同的方式时，是完全合理的，只要我们澄清这些方式真正的分歧，我希望在本文的后面部分做到这一点。
...
当然，从我们的角度来看，这个证明的重要之处不在于其结论的真实性，而在于它证明这个结论的方式。因为这个结论是一个普遍性定理，它必须涉及到所有可能的三角形，不仅仅是上图中的那个半圆内切的三角形。然而，显然，在上面的证明中，我们只谈到了那个三角形。那么，我们如何声称我们所证明的关于那个特定三角形的内容将适用于所有可能的三角形呢？
...
因此，这个论证证明了没有任何一件事物可以在其存在中成为普遍性，也就是说，没有任何东西可以既是一个存在，又以这样的方式共同存在于许多存在中，以至于它与这些许多存在共享其存在行为，构成它们的实质。
...
除了博伊修斯，将新柏拉图哲学传统与中世纪拉丁西方的基督教联系起来，并指出其神学含义的最重要的中介者是圣奥古斯丁。在一段经常被中世纪作者引用的关于神圣理念的讨论中，他写道：
...
但是这种对事物真理的认知，虽然是智力的、普遍性的认知，但远非我们所追求的不可错误的知识。正如亨利进一步辩论的那样：
...
尽管马修强烈反对这一立场，认为这违背了奥古斯丁的原意（“这是不可接受的，因为他是一位杰出的教师，天主教教师和尤其是神学家应该遵循他的” - 正如马修所说），但这种观点在 13 世纪末以来的更加精细的版本中越来越受到认同，不仅被阿奎那和他的追随者采纳，而且还被他的主要对手苏格拉底和他的追随者采纳。[25]

然而，中世纪的思想家从未将启蒙主义和抽象主义视为互相排斥的选择。它们更像是在判断自然和直接神圣干预在人类智力认知中的相应作用时的一种平衡行为的两个极点。[26]

尽管柏拉图主义在中世纪（以及以后）确实存活下来，以神圣理念、参与和启蒙的相互关联的教义的形式存在，但在阿贝拉尔德之后，普遍存在着相当普遍的亚里士多德共识 [27]，即物质存在的物种和属类的世俗普遍存在于人的心灵中，是心灵从其个体化条件中抽象出来的结果。但是，对于这些抽象出来的普遍存在，对于它们在心灵中存在的方式，它们与其个体的关系如何，它们在这些个体中的真实基础是什么，它们在构成我们的普遍知识中的作用是什么，以及它们如何在各种人类语言中对这种知识的编码和传播中起到贡献，尚未达成一致意见。因为尽管普遍存在的一般亚里士多德立场成功地处理了由天真的柏拉图主义本体论明显产生的不一致性，但它却引发了自身的进一步问题。

## 6. 普遍性根据亚伯拉德的亚里士多德观念

首先，亚伯拉德是第一个明确以这种形式处理普遍性问题的人。在他的《逻辑学》中，他相对容易地解决了被认为是真实实体的普遍形式，这些形式与博伊修斯的定义相对应，他得出结论：根据亚里士多德在《解释学》中对普遍性的定义，普遍词语才能被视为真正存在的普遍性。然而，由于根据亚里士多德在同一作品中的论述，词语之所以有意义，是因为它们在意义上表示了思维中的概念，亚伯拉德很快提出了以下问题：

1. 根据哪种共同原因，施加了一个共同的名称？
2. 对于事物的相似性，理解的普遍概念是什么？
3. “普遍”这个词是因为事物所共同具有的共同原因，还是因为共同概念，或者两者都有？[《五篇文献》，Spade 1994，第 41 页（88）]

这些问题在普遍性问题的历史上开启了一个新的篇章。因为这些问题为最初主要构成该问题的本体论、认识论和神学问题增加了一个语义方面。根据亚里士多德关于普遍性的概念，作为普遍谓词，显然存在普遍性，即我们的普遍词。但是我们的词的普遍性显然不依赖于我们发音的物理特性，或者表示它们的各种书写标记的物理特性，而是依赖于它们的代表功能。因此，为了解释我们的普遍词的普遍性，我们必须能够说明它们具有这种普遍代表功能的原因，也就是说，我们必须能够通过在一个共同概念中识别共同原因，给属于同一类别的无限个体赋予一个共同的名称。

但是这个共同的原因肯定不能像博伊修斯描述普遍事物那样是一个共同的东西，因为正如我们所见，假设存在这样一个共同的东西会导致矛盾。当然，阿贝拉尔还提供了一些进一步的论证，涉及到他同时代的一些人对普遍性的细化描述，比如威廉·尚波、伯纳德·沙特尔、克拉伦巴尔德·阿拉斯、苏瓦松的乔斯林和莫尔塔涅的沃尔特 - 但我不能在这里详细讨论这些细节。[28] 关键是他反驳并拒绝了所有这些建议，要么是将真正的普遍性保存为共同的事物，具有自己的真正统一性，要么是将它们作为几个事物的集合，具有仅仅集合的统一性。他反对前一种观点的论证要点是，根据那种观点，普遍事物必须具有自己的数值统一性，因此，由于它构成了所有特定事物的实质，所有这些特定事物必须实质上是同一个东西，同时必须同时具有它们所有的相反属性，这是不可能的。他反对集合理论的主要观点是，集合是由构成它们的个体的任意整体组成的，因此它们根本不符合波菲里奥的本质谓词的特征，比如种类和属。[29]

因此，普遍性词汇的施加的普遍原因不能是任何一个事物，也不能是多个事物；然而，作为一个普遍原因，它也不能是不存在的。因此，这个普遍原因，亚伯拉罕称之为那些共同的事物的状态 [30]，是一个原因，但它是一个非物质的原因。不管听起来多么奇怪，亚伯拉罕观察到有时我们确实会指定一些非物质的原因。例如，当我们说“船只失事是因为船长不在”，我们所指定的原因，即船长不在，不是某个具体的事物，而是事物的状态，也就是事物的状况，在这种情况下，我们用整个命题“船长不在”来表示。从理解亚伯拉罕的状态的角度来看，他将状态作为施加的共同原因与由整个命题表示的原因相类比。这些由整个命题表示的意义，在英语中我们可以通过使用相应的“that 从句”来指称（就像我上面所做的，用短语“that the pilot was absent”来指称船只失事的原因），在拉丁语中则通过一个带有不定式的宾格结构来表示，这就是亚伯拉罕所称之为命题的陈述。这些陈述既不可归属于任何单一事物，又不是不存在的，构成了一个本体论领域，与普通事物的领域完全不同。但也正是在这个领域中，亚伯拉罕的施加的共同原因可以找到它们的位置。

阿贝拉尔德说，普遍名称的强加共同原因必须是一些事物在该名称下达成一致的东西。例如，“人”这个名称（指的是“人类”，而不是“男性人类”）被强加给所有人类，是因为所有人类在某种程度上达成了一致。但是，所有人类在某种程度上达成一致的是他们每个人都是一个人，也就是说，每个人在他们都是人这一点上与其他人一致。因此，阿贝拉尔德寻找的共同原因就是他们的人性（esse hominem），这就是他所说的人的地位。人的地位不是一件事物；它不是任何一个特定的人，因为显然没有一个特定的人是所有人的共同点，也不是一个普遍的人，因为没有这样的东西。但是作为一个人在所需的方式上是共同的（即，它是所有人类一致的东西），但显然它不是一件事物。因为让我们考虑特定的命题“苏格拉底是一个人”[Socrates est homo]，“柏拉图是一个人”[Plato est homo]，等等。这些表示它们的陈述，即苏格拉底是一个人 [Socratem esse hominem]，柏拉图是一个人 [Platonem esse hominem]，等等。但是，如果我们从特定的主语中抽象出来，保留它们所有共同的东西，我们可以准确地得到所有这些主语一致的地位，即成为一个人 [esse hominem]。因此，地位，就像可以从中获得它们的陈述一样，构成了一个完全不同于普通事物的本体论领域。

尽管很明显与抽象有关，是心智的一种活动，阿贝拉尔坚持认为状态不是我们心智的概念。他坚持的原因是，状态作为共同名称施加的共同原因，必须是真实的，其存在不依赖于我们心智的活动。状态存在于事物的本质中，无论我们是否形成一种心智行为来认识它。实际上，对于阿贝拉尔来说，状态是神圣心智的对象，上帝从永恒中预先构思了他的创造状态。然而，我们心智的概念或心智形象只存在于我们心智的对象中，只要我们心智进行形成这个对象的心智行为。但是，这个对象本身并不是一件事物，确实不比我们心智的其他虚构对象更多。然而，普遍概念与我们心智的仅仅虚构对象的区别在于前者对应于真实存在的个别事物的状态，而后者没有任何对应物。

确实，阿贝拉尔在关于这里所区分事物之间关系的讨论中还有一些不明确的问题。例如，阿贝拉尔说我们无法构想出这种状态。然而，似乎我们只能通过我们的言辞来表示我们能够构想的东西。然而，阿贝拉尔坚持说，除了我们的概念，我们的言辞必须表示状态本身。对于这个问题的解决方案只在阿贝拉尔的话中略有暗示，他说名称可以表示状态，因为“名称的发明者意图根据事物的某些本质或特征来使用它们，即使他不知道如何思考事物的本质或特征”（《五篇文献》，斯佩德，1994 年，第 46 页（116））。因此，我们可以假设，尽管名称的发明者不知道状态，但他模糊的、受感官束缚的构想，从中他取得了词语的意义，是指向状态的，即他打算表示的东西。然而，阿贝拉尔没有进一步详细阐述这个建议。此外，状态与在状态中一致的事物的个体化本质之间的关系也不清楚。如果状态是神圣的心灵从个体中抽象出来的，为什么本质本身不能以同样的方式被构想出来呢？毕竟，抽象的本质不必是一个实物，就像状态一样，因为它的存在不是真实的存在，而只是被构想出来的存在。此外，阿贝拉尔的状态似乎可以通过从具有相同谓词的个别断言中抽象出来，正如上面所提到的。但是，断言是我们命题的普通意义，阿贝拉尔从未将其视为认识论上的问题，那么为什么我们可以明显从它们中抽象出状态，而这种状态只能被神圣的心灵所理解呢？

I’m not suggesting that Abelard could not provide acceptable and coherent answers to these and similar questions and problems.[[35](https://plato.stanford.edu/entries/universals-medieval/notes.html#note-35)] But perhaps these problems also contributed to the fact that by the 13th century his doctrine of *status* was no longer in currency. Another historical factor that may have contributed to the waning of Abelard’s theory was probably the influence of the newly translated Aristotelian writings along with the Arabic commentaries that flooded the Latin West in the second half of the 12th century.
...
![A box labeled 1 'common term' has arrows pointing to boxes labeled 2 'individual natures', 3 'singulars', 4 'absolute nature', 5 'objective concept', and 6 'subjective concept' The arrow from 1 to 2 is labeled 'signification', the arrow from 1 to 3 is dashed and labeled 'supposition', the arrow from 1 to 6 is labeled 'subordination' Boxes 2 and 3 share a side Boxes 4 and 5 share a side and have dashed frames Box 3 has an arrow to box 7 'phantasms' which has an arrow to box 8 'intelligible species' which has an arrow to box 9 'subjective concept' which has an arrow to box 5 Boxes 7,8, and 9 are inside a large box 10 labeled 'MIND'](https://plato.stanford.edu/entries/universals-medieval/image4.gif)

Figure 4. The *via antiqua* conception

显然，这是一幅相当复杂的图画。然而，它的复杂性本身不应被视为问题，甚至不应感到惊讶。毕竟，这个图表仅仅总结并区分了人类思维如何处理从众多个别经验中获得的可理解的普遍信息的主要阶段，以及如何将这些信息应用于进一步分类经验的过程。这个过程可以合理地预期是复杂的，并且不应期望比设置和从计算机数据库中检索信息等过程涉及的阶段更少。

更加令人困惑的是，识别和区分这些阶段和相应的项目所涉及的困难。进一步的复杂性也是由于几位作者之间术语的差异以及他们在引入不同概念的身份和差异的各种标准上应用的差异而产生的。事实上，许多在这个框架内工作的作者的重大争论可以准确地描述为对这里所呈现的项目的身份或差异的争论，或者对识别或区分它们的标准的争论。

例如，亚伯拉德（Abelard）已经提出了一个问题，即我们可以在图表中将其识别为后来作者的客观概念，是否应该与思维行为（我们可以将其识别为主观概念）或者可能是进一步的心智行为（称为 formatio），即潜在智力形成概念的行为，使用可理解的种类作为其行动的原则。这些区别后来受到了约翰·彼得·奥利维（John Peter Olivi）等作者的严厉批评，他们主张消除可理解的种类，以及一般地消除智力行为与其最终对象之间的任何中介物，即以普遍方式构思的个别事物。[42]

再次，从单个实体的侧面图表来看，大多数 13 世纪的作者都同意，解释同一物种的几个个体的特定统一性的原因，即它们的特定性质，应该是与解释它们的数值差异性的原因，即它们的个体化原则不同。然而，在几个共同物种个体中的一个单个实体必须同时包含这些个体的特定统一性原则和自身的个体化原则。因此，这个单个实体，至少由其特定性质和个体化原则组成，必须与其特定性质不同。无论如何，这是物质实体的情况，其个体化原则被认为是它们的物质。然而，基于这种推理，诸如天使之类的非物质实体不能因为其物质而被视为数值上不同，而只能因为其形式而被视为数值上不同。但由于形式是特定统一的原则，形式的差异导致特定的多样性。因此，基于这一点，任何两个天使都必须被视为物种上的不同。这个结论被阿奎那和其他人明确地得出，但被奥古斯丁神学家拒绝，并在 1277 年巴黎被谴责。[43]

因此，难怪亨利·根特和邓斯·斯科特等作者提出了个体化的替代解释，不仅引入了不同的个体化原则，如斯科特派著名（或臭名昭著）的个体性，还引入了不同的差异和同一性标准，如亨利·根特的意向区分，或斯科特的形式区分，甚至后来苏亚雷斯的模态区分。[44][45]

但是，进一步的问题是考虑到同一实体中由几个共同术语所表示的个体化本质的身份或差异。从这个角度来看，关于本质和存在的真正区别的形而上学辩论实际上就是关于事物定义所表示的个体化共同本质是否与同一事物中动词“是”所表示的存在行为相同的问题。事实上，关于实体形式的多样性与统一性的著名问题也可以看作是关于在物质范畴中波尔菲里树上由实质谓词所表示的共同本质在同一实体中是不同还是相同的争议（参见卡卢斯 1967 年）。最后，这似乎是奥克姆创新的主要动机，问题是我们是否必须将亚里士多德十种范畴中由几个谓词在同一实体中所表示的个体化共同本质视为彼此不同。肯定的答案将涉及对实体的几乎无限的增殖的承诺。

实际上，根据奥克姆的观点，via antiqua 的概念将意味着

> 柱子是通过右边性质来到右边的，上帝通过创造来创造，通过善良来成为善良，通过正义来成为正义，通过力量来成为强大，通过附着来附着，通过受制来受制，通过适应性来适应，通过虚无来成为虚无，通过盲目来成为盲目，通过移动性来移动，等等，对于其他无数情况也是如此。[46]

而这只是“根据术语的多样性来增加存在物的数量...然而，这是错误的，并且远离了真理”[47]。

## 9. 普遍性在现代之路中

当然，正如在古代之路框架内关于该框架中各种项目的同一性或非同一性的辩论所表明的那样，奥卡姆的指责并不完全成立 [48]。毕竟，几位古代之路的作者确实允许将属于各种类别的术语的意义进行等同，因此他们的“存在物的增加”不一定与术语的多样性相匹配。此外，由于古代之路的作者还区分了各种存在的模式或意义，允许各种“减少”的存在种类，例如理性存在物，因此他们的本体论承诺在这一段落中肯定不像奥卡姆所说的那样明确。然而，如果我们将上述古代之路框架的图表与奥卡姆引入的以下现代之路框架的示意图进行对比，我们可以立即理解奥卡姆创新的观点。

![shows the simplified version of Figure 4, what we get as a result of the nominalist reductions It consists of three main boxes, labeled 'common term' on the top, 'singulars' on the lower left, and 'mind' on the lower right The 'mind' box contains two subboxes, labeled 'phantasms' and 'common concepts', with an arrow pointing from the former to the latter, indicating the flow of information, as does the arrow pointing from the box 'singulars' to the box 'phantasms' The rest of the arrows indicate semantic relations the full arrow pointing from the box 'common term' to 'singulars' is labeled 'signification', the dashed arrow is labeled 'supposition' The full arrow pointing from 'common term' to 'common concept' is labeled 'subordination' Finally, the unlabeled full arrow pointing from 'common concept' to 'singulars' represents natural signification or signification, as is clear from the text](https://plato.stanford.edu/entries/universals-medieval/image5.gif)

图 5. 现代观念

毫无疑问，正是这幅画的迷人简洁性，尤其是与古代观念的复杂性相比，成为奥卡姆主义方法的主要吸引力。这里的项目较少，同样处于本体论地位，通过相同明确的区别，即个体实体之间的数值区别，彼此区分。

确实，在这个图景中仍然存在普遍性。但是这些普遍性既不是通过某种真实或仅仅形式上有区别的个体化原则而“收缩”到个体身上的共同本质，也不是存在于“减少”方式下的理性存在的心智普遍对象。奥卡姆的普遍性，至少在他成熟的理论中，仅仅是我们的共同术语和共同概念。我们的共同术语，仅仅是特定的言辞或记录，之所以是共同的，是因为它们从属于我们的共同概念。另一方面，我们的共同概念仅仅是我们个体心智的特定行为。它们的普遍性仅仅在于它们的代表功能的普遍性。例如，共同术语“人”是英语的一个口头或书面的普遍术语，因为它从属于我们的概念，我们通过这个概念不加区分地构想每个人。（参见 Klima，2011）正是这种代表功能中的不加区分使得我的心智行为能够以普遍的方式构想每个人，你的心智行为也是如此。因此，我们不需要假设在个体人类中有任何与这些人类本身不同的东西，一种共同但个体化的本质等待被心智抽象出来。我们只需要假设两个人类彼此比任何一个人类与一种野兽更相似，所有动物彼此比任何一个动物与一种植物更相似，等等，并且心智能够识别这种相似性，能够通过共同的特定概念来代表人类，通过共同的通用概念来代表动物，通过更一般的通用概念来代表所有生物等等。[ 50] 这样一来，那么，这些概念所从属的普通术语不需要在心灵中表示某种抽象的普遍性质，因此也不需要在个体中表示其个体化的实例，因为它们直接表示个体本身，就像它们被心灵的普遍代表行为直接构思的那样。所以，这些普通术语所表示的就是个体本身，当它们在命题中使用时，也是这些术语所指的事物。按照中世纪逻辑术语的惯例表达，普通术语最终表示的是它的指示物，而当同一个术语在命题中使用时，所指的事物是它们（个人）的指代物。[ 51]

现在，如果我们比较代表两种途径的两个图表，我们可以看到奥卡姆的创新如何彻底改变了连接术语、概念和事物的语义关系的特性。在两种途径中，普通术语都被从属于普通概念，正是由于这种从属关系，它们最终表示了它们的概念所代表的内容。在现代途径中，概念只是一种以更或多或少冷漠的方式代表个体的心智行为，为术语提供了更或多或少普遍的意义。然而，在古代途径中，心智行为只是一系列中间代表的一部分，这些代表根据它们在处理普遍信息中的不同功能而区分，并通过它们的共同内容相连，最终代表了它们的个体化本质。因此，一个表达这种共同内容的普通术语首先从属于心智的客观概念。当然，这个客观概念只是个体心智的主观概念的共同内容，这些主观概念是通过可理解的种类，由主动智力抽象出来形成的。另一方面，客观概念从所有个体化条件中抽象出来，只表示所有个体共有的内容，即它们的本质的绝对考虑。但是，这个绝对考虑的本质只是每个个体在其实际存在中所知的相同本质的共同内容。因此，术语的最终指示物将是个体化的个体本质。但是，这些最终指示物可能仍然不是个体本身，即当被这些指示物所知的事物不是形而上学上的简单时。 因此，在现代观念中，术语的最终意义仅仅是那些可以在不同命题中作为术语的主体的特定事物，这是语义学的问题。相比之下，在古代观念中，术语的最终意义可能与术语的（个人）主体相同，也可能不同，这取决于这些主体的构成，这是形而上学的问题。当术语被用作命题的主语术语时，这些特定事物将成为术语的主体（对于形而上学上的简单实体，术语的意义和主体是一致的）。[ 53]

然而，尽管名义主义者对此提出了相反的指责，但就其语义考虑而言，古代之路框架与现代之路框架一样，并没有更加坚定地支持普遍术语的意义和指称之间的真实区别。因为如果语义理论本身排除了这些语义值的等同性，那么这些值的可能等同性问题本身就没有意义。此外，在这种情况下，即使在谈论形而上学上的简单实体（如天使和上帝）时，这种等同性也将被排除为无意义的，而这些实体的形而上学简单性恰恰是通过这种等同性来表达的。但是，在九个偶然范畴中，具体和抽象的普遍术语的意义和指称的普遍术语的情况下，一些古代之路的作者主张在范畴内部和跨范畴之间等同这些语义值。首先，亚里士多德的权威声称行动和受动是同一运动 [54]，因此这两个范畴中的术语的意义不能被视为真正不同的实体。但是，一些作者还主张将关系与它们的基础等同起来，也就是说，将相对术语的意义与数量和质量范畴中的术语的意义等同起来。（例如，根据这种观念，如果你和我身高相等，那么我和你身高相等的意义就是我的身高，而不是与我的身高有关的一个独立的“相等物”）[55]。

相比之下，使得现代途径更简单的是它“自动地”根据其语义原则已经实现了这些识别。在这种方法中，具体普通术语的意义仅仅是由相应概念直接表示的个体，术语的意义和（个人）指称从一开始就被认为是相同的个体。因此，这些普通术语无论是绝对的还是相对的，都绝对地指示和指称相同的事物，前提是术语是绝对的，或者相对于其他个体，前提是术语是内涵的。但即使在相对术语的情况下，例如相对术语（实际上，根据奥卡姆的说法，九个偶然范畴中的所有术语，除了某些抽象术语在品质范畴中）我们也不需要假设存在某些神秘的关系实体来告知个体物质的存在。例如，“父亲”这个术语不需要被解释为在我身上指示一种固有的关系，我的父性，以某种方式将我与我的儿子联系起来，并且因此在命题的背景下为我指称；相反，它应该被解释为在与我的儿子的关系中指示我，从而在命题的背景下为我指称，同时内涵着我的儿子。

## 10. 途径的分离，以及晚中世纪哲学中的学院讨论的崩溃

现代途径的简单性吸引力，特别是在约翰·布里丹及其学生的著作中系统地阐述时，对晚中世纪的哲学和神学产生了巨大影响。可以肯定的是，许多熟悉两种方式的晚中世纪学者，会对多明戈·索托（1494-1560，自称“在名义主义者中出生，在实在主义者中成长”）所表达的观点表示共鸣，即虽然古代途径的实在主义教义更难理解，但名义主义途径的教义更难以相信。然而，名义主义途径的整体简单性和内在一致性是不可否认的，在 15 世纪时在欧洲所有主要大学中，无论是古老的还是新建立的，都有了强大的追随者。

由于中世纪途径的分离和随之而来的斗争并未以一方胜利而告终。相反，由于分离主要是语义性质的，使各方陷入越来越复杂的相互对话方式中，从而引发了新的、世俗的、人文主义的知识分子的日益不满，甚至蔑视，这导致了中世纪特有的概念框架在晚中世纪和早期现代时期的消亡。
...
* Aquinas, *Opera Omnia*, R. Busa (ed.), Stuttgart-Bad Canstatt: Frommann-Holzboog, 1980.
* Aristotle, *The Complete Works of Aristotle*, J. Barnes (ed.), Princeton: Princeton University Press, 1984.
* Augustine, *On the Free Choice of the Will*, tr. T. Williams, Indianapolis: Hackett, 1993
* Augustine, *De diversis quaestionibus octoginta tribus*, A. Mutzenbecher (ed.), Corpus Christianorum, Series Latina, vol. 44a, Brepols: Turnholt, 1975
* Avicenna, *Metaphysica* V, 1, S. Van Riet (ed.), 2 vols., E. Peeters: Louvain, and Leiden: E. J. Brill, 1977, 1980.
...
* Biel, G., *Collectorium*: Collectorium circa quattuor libros Sententiarum Gabrielis Biel; W. Werbeck, *et al*. (eds.), Tübingen: J.C.B. Mohr (Paul Siebeck), 1973.
* Cajetan, T., *Commentary on Being and Essence*, tr. L. J. Kendzierski and F. C. Wade, Milwaukee: Marquette University Press, 1964.
* Giles of Rome, *In Primum Librum Sententiarum*, Frankfurt/Main: Minerva, 1968 (Venetiis, 1521).
* Henry of Ghent, *Summae quaestionum ordinariarum theologi recepto praeconio solennis Henrici a Gandavo*, (Parisiis In aedibus Jodoci Badii Ascensii 1520), New York: Franciscan Institute, 1953.
...
* John of Salisbury, *Metalogicon*, Oxford: Clarendon Press, 1929.
* John Wyclif, *Tractatus de Universalibus*, I. J. Mueller (ed.), Oxford: Clarendon Press, 1985.
* Plato, *Collected Dialogues*, E. Hamilton and H. Cairns (eds.), Princeton: Princeton University Press, 1982.
* Seneca, *Ad Lucilium Epistulae Morales*, *Loeb classical library: Latin authors*, Cambridge, MA: Harvard University Press, 1962–1967.
* Soto, D., *In Porphyrii Isagogen, Aristotelis Categorias, librosque de Demonstratione, Commentaria*, Venice, ex officina Dominici Guarraei, et Io. Baptistae, fratrum, 1587, reprint, Frankfurt: Minerva, 1967.
* Spade, P. V., (tr.), *Five Texts on the Mediaeval Problem of Universals: Porphyry, Boethius, Abelard, Duns Scotus, Ockham*, Indianapolis: Hackett, 1994.
* Suarez, F., *Disputaciones Metafisicas*, Madrid: Editorial Gredos, 1960.
* Suarez, F., *On the Various Kinds of Distinctions* (*Disputationes metaphysicae, Disputatio VII, de variis distinctionum generibus*), tr. intro. C. Vollert, Milwaukee: Marquette University Press: 1947.
* Thomas of Sutton, *Quodlibeta*, München: Bayerische Akademie, 1969.
* Vincent Ferrer, *Tractatus de Suppositionibus*, Stuttgart-Bad Cannstatt: Fromman Holzboog, 1977.
* Vives, J. L., *Against the Pseudodialecticians*, tr. R. Guerlac, Dordrecht-Boston-London: D. Reidel Publishing Company, 1979.
* William Ockham, *Summa Logicae*, Ph. Boehner, *et al*. (eds.), *Opera Philosophica*, vol. I., St. Bonaventure, NY: The Franciscan Institute, 1974.
* William Ockham, *Ordinatio*: Guillelmi de Ockham *Scriptum in librum primum sententiarum ordinatio: distinctiones XIX-XLVIII*, G. I. Etzkorn and F. E. Kelley (eds.), *Opera Theologica*, vol. IV, St. Bonaventure, NY: The Franciscan Institute, 1979.

### Secondary Literature

* Adams, M. M., 1987, *William Ockham*, 2 volumes, Notre Dame: University of Notre Dame Press.
* Amerini, F. and Cesalli, L. (eds.), 2017, *Universals in the Fourteenth Century*, Pisa: Scuola Normale Superiore.
* Ashworth, E. J., 1974, *Language and Logic in the Post-Medieval Period* (Synthese Historical Library: Volume 12), Dordrecht: D. Reidel.
* Callus, D. A., 1967, “Unicity and Plurality of Forms”, in *New Catholic Encyclopedia*, New York: McGraw-Hill, 1967–79.
* Cross, R., 2014, “Medieval Theories of Haecceity”, *The Stanford Encyclopedia of Philosophy* (Summer 2014 Edition), Edward N. Zalta (ed.), URL = <https://plato.stanford.edu/archives/sum2014/entries/medieval-haecceity/>.
...
* Gracia, J., 1984, *Introduction to the Problem of Individuation in the Early Middle Ages* (Analytica Series), München and Washington, D.C.: Philosophia Verlag and Catholic University of America Press; 2nd edition, 1988.
* Henninger, M., 1989, *Relations: Medieval Theories 1250–1325*, Oxford: Clarendon Press.
* Hissette, R., 1977, *Enquête sur les 219 articles condamnés à Paris le 7 Mars 1277*, “Philosophes médiévaux,” Volume 22, Louvain: Publications Universitaires.
* Hyman, A., and Walsh, J. J., (eds.), 1973, *Philosophy of the Middle Ages*, Indianapolis: Hackett.
...
* –––, 2000a, “Thomas of Sutton on the Nature of the Intellective Soul and the Thomistic Theory of Being”, in J. Aertsen, *et al.* (eds.), *Nach der Verurteilung von 1277. Philosophie und Theologie an der Universität von Paris im letzten Viertel des 13. Jahrhunderts*, Studien und Texte (Miscellanea Mediaevalia 28), Berlin-New York, 2000, pp. 436-455. [[Author preprint of Klima 2000a available online](https://faculty.fordham.edu/klima/TS.htm)]
* –––, 2000b, “Aquinas on One and Many”, *Documenti e Studi sulla Tradizione Filosofica Medievale (An International Journal on the Philosophical Tradition from Late Antiquity to the Late Middle Ages of the Società Internazionale per lo Studio del Medioevo Latino)*, 11: 195–215. [[Author preprint of Klima 2000b available online](https://faculty.fordham.edu/klima/ONE.HTM)]
* –––, 1999, “Ockham’s Semantics and Metaphysics of the Categories”, in P. V. Spade (ed.), *The Cambridge Companion to Ockham*, Cambridge: Cambridge University Press, pp. 118–142. [[Author preprint of Klima 1999 available online](https://faculty.fordham.edu/klima/OCKHAM.HTM)]
* –––, 1996a, “The Semantic Principles Underlying Saint Thomas Aquinas’s Metaphysics of Being”, *Medieval Philosophy and Theology*, 5: 87–141. [[Author preprint of Klima 1996a available online](https://faculty.fordham.edu/klima/BEAQ.HTM)]
* –––, 1993a, “‘Socrates est species’: Logic, Metaphysics and Psychology in St. Thomas Aquinas’ Treatment of a Paralogism”, in K. Jacobi (ed.), *Argumentationstheorie: Scholastische Forschungen zu den logischen und semantischen Regeln korrekten Folgerns*, Leiden: Brill, pp. 489–504.
* –––, 1993b, “The Changing Role of *Entia Rationis* in Medieval Philosophy: A Comparative Study with a Reconstruction”, *Synthese*, 96: 25–59. [[Author preprint of Klima 1993b available online](https://faculty.fordham.edu/klima/ensrat.htm)]
* –––, and Hall, A.W. (eds.) 2011, *Medieval Metaphysics, or is it “Just Semantics”?*, Newcastle upon Tyne: Cambridge Scholars Publishing.
* Kretzmann, N., and A. Kenny and J. Pinborg (eds.), 1982, *The Cambridge History of Later Medieval Philosophy*, Cambridge: Cambridge University Press.
* Libera, A. de, 1996, *La querelle des universeaux: De Platon à la fin du Moyen Age*, Paris: Éditions du Seuil, 1996.
* Marrone, S., 2001, *The light of Thy countenance: science and knowledge of God in the thirteenth century*, Leiden-Boston: Brill.
* Panaccio, C., 2004, *Ockham on Concepts*, Aldershot: Ashgate.
* Pasnau, R., 2002, *Thomas Aquinas on Human Nature: A Philosophical Study of Summa Theologiae 1a 75–89*, Cambridge: Cambridge University Press.
* –––, 1999a, “[Peter John Olivi](https://plato.stanford.edu/entries/olivi/)”, in *The Stanford Encyclopedia of Philosophy.* (Winter 1999 Edition), Edward N. Zalta (ed.), URL = <[Peter John Olivi (Stanford Encyclopedia of Philosophy/Winter 1999 Edition)](https://plato.stanford.edu/archives/win1999/entries/olivi/)>
* –––, 1999b, “[Divine Illumination](https://plato.stanford.edu/entries/illumination/)”, in *The Stanford Encyclopedia of Philosophy.* (Winter 1999 Edition), Edward N. Zalta (ed.), URL = <https://plato.stanford.edu/archives/win1999/entries/illumination/>
* –––, 1997, *Theories of Cognition in the Later Middle Ages*, Cambridge: Cambridge University Press.
* Read, S. L., 1977, “The Objective Being of Ockham’s Ficta”, *The Philosophical Quarterly*, 27: 14–31.
* –––, 2015, “Medieval Theories: Properties of Terms”, in *The Stanford Encyclopedia of Philosophy.* (Spring 2015 Edition), Edward N. Zalta (ed.), URL = <https://plato.stanford.edu/archives/spr2015/entries/medieval-terms/>
* Schmidt, R. W., 1966, *The Domain of Logic according to Saint Thomas Aquinas*, The Hague: Martinus Nijhoff.
* Spade, P. V., 1982, “The Semantics of Terms”, in [Kretzmann, *et al*., 1982](https://plato.stanford.edu/entries/universals-medieval/#kretz82), pp. 188–196.
* Tweedale, M., 1982, “Abelard and the Culmination of Old Logic”, in [Kretzmann, *et al*., 1982](https://plato.stanford.edu/entries/universals-medieval/#kretz82), pp. 142–157.
* Wood, A., 2011, “Aquinas, Scotus, and Cajetan on ‘Horseness is just Horseness’”, in [Klima, *et al*., 2011](https://plato.stanford.edu/entries/universals-medieval/#kli11), pp. 69–84.

## Academic Tools

> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=universals-medieval). |
> | --- | --- |
> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/universals-medieval/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
> | ![inpho icon](https://plato.stanford.edu/symbols/inpho.png) | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=universals-medieval&redirect=True) at the Internet Philosophy Ontology Project (InPhO). |
> | ![phil papers icon](https://plato.stanford.edu/symbols/pp.gif) | [Enhanced bibliography for this entry](https://philpapers.org/sep/universals-medieval/) at [PhilPapers](https://philpapers.org/), with links to its database. |

## Other Internet Resources

* Klima, G., 1997, [Comments](https://faculty.fordham.edu/klima/King.htm) on Peter King, “[The Failure of Ockham’s Nominalism](https://faculty.fordham.edu/klima/pking.htm)”, (Paper read at the Central Division Meeting of the American Philosophical Association, Pittsburgh, PA, April 26, 1997.)
* Klima, G., 1996b “[*Nulla virtus cognoscitiva circa proprium obiectum decipitur*](https://faculty.fordham.edu/klima/APA.htm)” comments on Robert Pasnau, “[The Identity of Knower and Known](https://faculty.fordham.edu/klima/APAPasnau.htm)”. (Paper read at the Central Division Meetings of the American Philosophical Association, Chicago, April 25, 1996.)
* [Paul Spade’s Medieval Logic and Philosophy site](http://www.pvspade.com/Logic/index.html)
* Spade, P. V., 1996a, [*Thoughts, Words and Things: An Introduction to Late Mediaeval Logic and Semantic Theory,*](http://www.pvspade.com/Logic/docs/thoughts.pdf) Version 1.0, 1996. (PDF file)
* Spade, P. V., 1996b, “[Boethius against Universals: The Arguments in the Second Commentary on Porphyry](http://www.pvspade.com/Logic/docs/boethius.pdf)” (PDF file)
* Spade, P. V., 1985, [*A Survey of Medieval Philosophy*](http://www.pvspade.com/Logic/docs/Survey%202%20Interim.pdf), Version 2.0, 1985. (PDF file)

## Related Entries

[language of thought hypothesis](https://plato.stanford.edu/entries/language-thought/) | [mental representation](https://plato.stanford.edu/entries/mental-representation/) | [mental representation: in medieval philosophy](https://plato.stanford.edu/entries/representation-medieval/) | [properties](https://plato.stanford.edu/entries/properties/) | [relations: medieval theories of](https://plato.stanford.edu/entries/relations-medieval/) | [tropes](https://plato.stanford.edu/entries/tropes/)
