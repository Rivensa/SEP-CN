...
当佛陀说一个人在一生中和另一生中的人既不相同也不不同时，人们的第一反应可能是将“不同”解读为与“不相同”不同的东西。但在英语中，由于“相同”的歧义，这是可能的，但在巴利语的来源中是不可能的，佛陀被描述为明确否认数值上的同一性和数值上的不同性。这导致一些人怀疑佛陀是否使用了一种异常的逻辑。这种怀疑在那些选项不是两个而是四个的情况下得到加强，即所谓的四隅论（_catuṣkoṭi_）。例如，当有人问佛陀关于开悟者或_阿罗汉_（例如，在 M I.483–8 处）死后状态时，可能性被列为：（1）_阿罗汉_死后继续存在，（2）死后不存在，（3）死后既存在又不存在，以及（4）死后既不存在也不不存在。当佛陀拒绝了（1）和（2）时，我们得到了“既不相同也不不同”的重复。但当他继续考虑并拒绝（3）和（4）时，逻辑困难就加剧了。由于（3）和（4）中的每一个似乎在形式上是矛盾的，考虑其中任何一个就是考虑到矛盾可能是真实的可能性。而否认它们似乎等同于肯定排中律，这与同时否认（1）和（2）是_prima facie_不相容的。人们可能会想知道我们是否在这里面对神秘主义。

有一些佛教哲学家是这样理解“既非相同也非不同”的。这些人是**人见** (_Pudgalavādins_)，他们之所以被如此称呼，是因为他们肯定个人的最终存在是依赖于心理生理元素而被命名和概念化的。他们声称个人既不同于心理生理元素，也不与之相异。他们准备接受一个结论，即关于个人与元素之间的关系无法用言语表达。但他们的观点被大多数佛教哲学家所拒绝，部分原因是这很快导致了一个无法言说的悖论：人与元素的关系既无法言说，也不是无法言说。共识观点是，个人既非同于心理生理元素，也非异于元素，这正是将个人视为纯粹概念虚构的理由。关于两世中的人，他们理解“既非相同也非不同”中涉及的否定是无承诺的类型，即，起到类似言语否定的功能。如果我们认同陈述“7 是绿色”在语义上是不合逻辑的，因为数等抽象对象没有颜色，那么我们可能会继续说，“不要说 7 是绿色，也不要说它不是绿色”。这里没有矛盾，因为言语否定运算符“不要说”不会对替代表述产生承诺。

还有证据表明，类型（3）的主张涉及参数化。例如，关于_阿罗汉_的主张可能是，有某种方面可以说他们在死后存在，也有另一方面可以说他们在死后不再存在。考虑这样的命题并不要求相信可能存在真正的矛盾。而类型（4）的主张似乎在逻辑上等同于类型（3）的主张（无论是否涉及参数化），但传统将这种类型视为主张主体超越一切概念化。拒绝关于_阿罗汉_的类型（4）主张是为了排除对前三种主张的拒绝的一种自然回应：即_阿罗汉_在死后的地位超越了理性理解。佛陀拒绝了关于这个问题及相关问题的所有四种可能性，并不意味着他采用了一种异常的逻辑。

佛陀对诸如有关_阿罗汉_之类的问题的回应有时被引用来捍卫关于他对理性态度的不同主张。这个主张是，佛陀基本上是一位实用主义者，他拒绝纯粹为了哲学理论化而进行哲学推理，只有在这样做有助于解决消除痛苦的实际问题时才运用哲学理性。当他为拒绝回答诸如有关_阿罗汉_的问题，或者生命系列是否有开始，或者生命原则(_jīva_)是否与身体相同等问题辩护时，佛陀似乎正在接受类似这种态度。他称所有关于这些问题的可能观点都是干扰，因为回答它们不会导致烦恼的停止，从而导致痛苦的终结。在一个著名的比喻中(《长部》I.429)，他将坚持要求佛陀回答这些问题的人比作被箭伤但不愿意处理伤口直到被告知是谁射出箭，箭是什么木头做的等人。

诸如此类的段落无疑证明了佛陀重视分享自己的见解以帮助他人克服痛苦的重要性。但这与一种信念一致，即哲学理性可以用来回答与紧迫实际关切明显无关的问题。至少有一次，佛陀确实这样做了。在被迫回答有关_阿罗汉_等问题时，佛陀首先拒绝了四隅论的所有可能性，并以这些理论不利于从_轮回_中解脱为由辩护他的拒绝。但当他的提问者显示出对佛陀关于消除痛苦之道的教导价值失去信心的迹象时，佛陀以火燃尽后熄灭的例子作为回应。如果有人问这火去了哪里，佛陀指出，人可以一贯地否认它去了北方、南方或其他任何方向。这是因为问题“它去了北方吗？”，“它去了南方吗？”，等等，都共享一个错误的前提，即火继续存在。同样，有关_阿罗汉_等问题的问题都共享一个错误的前提，即存在这样一个人，他可能在死后继续存在，死后停止存在等等。(Anālayo 2018, 41) 这些问题的困难不在于它们试图将哲学理性扩展到其合法领域之外，作为有益于解脱实践的侍女。而是它们建立在一个错误的前提上——这是通过运用哲学理性揭示出来的。
...
| ![sep man icon](../.gitbook/assets/sepman-icon.png) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=buddha).                                                                      |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sep man icon](../.gitbook/assets/sepman-icon.png) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/buddha/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
| ![inpho icon](../.gitbook/assets/inpho.png)         | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=buddha\&redirect=True) at the Internet Philosophy Ontology Project (InPhO).   |
| ![phil papers icon](../.gitbook/assets/pp.png)      | [Enhanced bibliography for this entry](https://philpapers.org/sep/buddha/) at [PhilPapers](https://philpapers.org/), with links to its database.                          |
