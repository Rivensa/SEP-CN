...
(2) 经常有人反对使用幻觉论的哲学家忽视了_感知恒常_这一事实。布罗德在其后期作品中承认这种抱怨是合理的。然而，“对恒常现象的认识仅仅转移了论点的适用范围”(1947b, p. 112)。存在一类关于物体_X_的感知经验，其中恒常成立；还有一类关于_X_的经验，恒常会瓦解。理论上逻辑上可能认为，_X_的正面表面在属于第一类的感知经验中以感官方式呈现，但在属于第二类的经验中却不是。“但是，考虑到看到的最正常和最异常情况之间的连续性，这样的信条将是完全不可信的，只能通过最绝望的特殊辩护来辩护”(1952a, p. 9)。
...
在《科学思想》（1923）中，布罗德否定了他在《查理·邓巴·布罗德》（1921a）中所捍卫的永恒主义。他现在提出了一个理论，即“承认现在和过去的现实，但认为未来根本就不存在”（1923，第 66 页）。这种_成长块理论_的一个至关重要的推论是_时间流逝_是现实的一个基本特征。这一特征是根据布罗德认为是最基本的变化形式——_变成_来解释的。变成是事件的产生。
...
> 如果_S_在过去愿意采取不同行动，_S_的愿望-情感倾向和对_S_自身本质的了解将被构成得如此，以至于在_S_采取行动时，_S_本可以愿意采取不同行动。
...
批判哲学的第二个任务是审查这些以及其他基本假设；它是“拿起那些我们在科学和日常生活中毫不怀疑地假定的命题，并对它们进行批判”（_同上_）。
...
正如上文所述，根据布罗德的观点，哲学思维具有一种独特的鸟瞰视角。他称之为_综观_。让我们更仔细地看一下这一点。普通人以及专业科学家或学者

> 在他们的生活和思维的各个部分之间划分了相对密封的隔间；对尴尬的、异常的或边缘的事实视而不见；并成功地在现象的表面滑行。但是，大多数聪明人时不时会产生希望看到经验的各个方面如何相互联系的愿望，哲学家是其中特别强烈和持久的人。现在，我所理解的_综观_是尝试满足这种愿望的必要前提，即有意识地将通常分开看待的人类经验方面放在一起观察，并努力看清它们之间的相互关系。(1947a, p. 4)

在反思中，很明显，综合立场对于发现我们对现实的图景中的各种不足是必要的，这些不足是由对现实过于狭隘的视角所导致的。综合立场实际上将导致潜在的哲学问题的发现：“综合，揭示_prima facie_的不连贯，这是哲学活动的主要动机”（1958 年，第 121 页；参见 1947a，第 16 页）。很明显，只有在我们发现并成功解决了这些问题之后，我们才能声称对整体现实有一个令人满意的图景。
...
_概率和归纳_。查理·邓巴·布罗德处理了关于归纳的问题——“科学的荣耀和哲学的丑闻”\[[16](https://plato.stanford.edu/entries/broad/notes.html#note-16)]，在一些论文中涉及了这个问题。他在这个主题上的作品样本是两篇早期论文，题为“归纳与概率的关系”（1918 年，1920 年）。布罗德的焦点是归纳推理的性质和理据。他认为，除非这些推理的结论以概率的术语表达，否则它们都涉及形式谬误。然而，为了得出合理的归纳结论，我们不能简单地对概率理论的任何已知原则（比如我们在处理包含红色和白色球的人造情境时所使用的原则）抱有信心：我们需要一些进一步的前提。不幸的是，这个前提“极其难以陈述\[...]以至于它一下子就显得合理而非重言”（1918 年，第 389 页）。布罗德试图表达所需的至高原则。他长篇论述所需的原则并非简单（和粗糙）地说：“自然中存在着一致性”。它还说，受一致性约束的世界中的特定事物或物质属于各种_natural kinds_。事实上，仔细思考后，很明显“永久物质、真正的自然种类和普遍因果关系的概念是高度复杂且紧密交织在一起的整体的一部分，其中任何一个都在没有其他部分的情况下彻底崩溃”（1920 年，第 44 页）。布罗德在“演绎归纳原则”（1930b）中制定的条件逻辑也很显著。他可能是第一个系统关注这个主题的人。\[[17](https://plato.stanford.edu/entries/broad/notes.html#note-17)]

_因果关系_。查理·邓巴·布罗德在几部作品中讨论了因果关系（早在他的第一本书《感知、物理和现实》（1914 年）开始）。在 1930 年的条件逻辑中，他提出的逻辑条件与某种因果关系的规律理论相吻合。然而，在几部作品中，他对该理论提出了相当深刻的批评（例如，在 1925 年的第 3 章）。在 1933 年，他尝试提出了一种替代方案。因果关系涉及规律性和逻辑蕴涵之间的某种东西；存在某种形式的必然性，但不是逻辑蕴涵中涉及的那种。后者是绝对必然的。考虑命题“任何有形状的东西都会有延伸”。这不仅在实际世界中成立：在所有逻辑可能的世界中也成立；不可能存在这样一个世界，其中有形状但缺乏延伸的事物。现在再看看命题“任何具有惯性质量的东西都会有引力质量”。在_实际_世界中不可能存在具有惯性质量但缺乏引力质量的事物。但可能存在这样一个世界，其中有具有惯性质量但缺乏引力质量的事物。这里涉及的必然性是一种偶然必然性。（参见 1933 年，第 242-3 页。）然而，布罗德对他试图提出的替代方案持怀疑态度。他坦率地表示，偶然性必然性的概念很可能是“彻头彻尾的胡说八道”。

_无意识_。查理·邓巴·布罗德在《心灵及其在自然中的位置》中详细探讨了围绕“无意识”问题。他的目标是捕捉一种（字面上的）经验性心理状态可能被称为无意识的意义。尽管他拒绝认为无意识体验的概念是不连贯的，但他认为没有令人信服的理由认为这种体验实际存在。假设存在一种纯粹的神经状态，具有类似于某种心理状态的因果属性，足以解释事实。

_时间意识_。查理·邓巴·布罗德提出了两种不同的时间体验描述。考虑一段音符的经历：_多_–_雷_–_米_。早期的描述声称，人们意识到的是_时间上延伸_的内容；它包括当前音符以及直接过去的音符：“在任何时刻感知到的东西在那一时刻之前延伸一小段距离”（1923 年，第 348 页）。当_米_出现时，你意识到的内容延伸到过去的音符_雷_和_多_。在后来的描述中，严格来说，我们只意识到当前的音符_米_。但这种意识伴随着对过去音符的表征，以一种独特的时间呈现方式。布罗德引入了_呈现性_的概念。当你意识到当前的音符_米_时，它被理解为具有最大程度的呈现性，而音符_雷_被表征为具有较少的呈现性，_多_则具有更少的程度。

_灵学哲学_。灵学是研究明显超自然事件的学科。布罗德试图捕捉这一主题的性质和重要性。超自然事件是一种似乎与他所称的_基本限制原则_相冲突的事件，即一种“我们毫不犹豫地视为我们所有实际活动和科学理论所限制的框架”（1953 年，第 7 页）的原则。有许多这样的原则。其中一条规定，事件在发生之前不能开始产生任何影响；另一条规定，未来的知识除了通过某些熟悉的方式（例如从现有事实推断）外是不可能的。这些基本限制原则似乎“非常令人满意地涵盖了各种各样的确立事实范围”。因此，我们“自然倾向于认为它们必须是包罗万象的”（第 8 页）。正因为如此，这些原则对我们对宇宙的整体观念和我们在其中的位置具有巨大重要性。但与此重要性成正比的是“任何已确立的例外对它们的哲学重要性”（第 9 页）。

_宗教哲学_。查理·邓巴·布罗德在这一主题上的著作具有他所有作品的特点——彻底、清晰和公正。布罗德拒绝了关于上帝存在的传统论据。他的论文《上帝存在的论据》（1939 年）对宇宙论论证和本体论论证进行了深入批判（关于设计论的论证，布罗德表示他对休谟和康德的批判没有什么可补充的）。他主张，宇宙论论证的结论有一个后果，很少有人能接受，即没有真正的偶然事实，尽管许多事实“相对于我们的无知似乎是偶然的”。至于本体论论证，布罗德声称，最大可能存在的概念是“毫无意义的空话”，除非构成上帝概念的属性允许存在“内在最大值”。他认为这个条件没有得到满足。因此，这个论证“在离港之前就已失败”。在论文的后部分，布罗德转向宗教经验的论证（这可能是对这一论证的首次系统性处理）。他所持的立场简言之是这样的。如果一个人有一种她认为是对_X_的经验，那么合理的结论是她确实经历了_X_，除非有某些积极的理由认为相反。拒绝将这一原则应用于宗教经验是不合理的。因此问题是是否有某些积极的理由认为宗教经验是虚幻的。但经过深思熟虑，结果表明没有这样的理由。因此，我们可以得出结论，宗教经验可能是真实的。

_伦理学_。在包括《五种伦理理论》在内的著作中，布罗德认为伦理句子表达了判断。他倾向于直觉主义或非自然主义分析。然而，在后来的作品中，他没有做出决定：伦理句子可能表达了判断；但是，另一方面，它们也可能表达情感或命令。尽管如此，布罗德有成果地（而且不知疲倦地！）对伦理理论的替代类型进行分类，揭示它们的基本假设，并推导出它们的逻辑结果。至于规范伦理学，布罗德认为不能坚持唯一一个正确行动标准的功利主义观点。他也不接受享乐主义。他认为，除了快乐和痛苦之外，还有其他内在价值和贬值的承担者。
...
| \[1945]  | “Some Reflections on Moral Sense Theories in Ethics,” _Proceedings of the Aristotelian Society_, 45: 131–66.                                                                                                                        |
...
* Gustavsson, K., 2002. _Emergent Consciousness. Themes in C. D. Broad’s Philosophy of Mind_, Göteborg: Acta Philosophica Gothoburgensis.
...
| ![sep man icon](../.gitbook/assets/sepman-icon.png) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=broad).                                                                      |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![sep man icon](../.gitbook/assets/sepman-icon.png) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/broad/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
| ![inpho icon](../.gitbook/assets/inpho.png)         | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=broad\&redirect=True) at the Internet Philosophy Ontology Project (InPhO).   |
| ![phil papers icon](../.gitbook/assets/pp.png)      | [Enhanced bibliography for this entry](https://philpapers.org/sep/broad/) at [PhilPapers](https://philpapers.org/), with links to its database.                          |
