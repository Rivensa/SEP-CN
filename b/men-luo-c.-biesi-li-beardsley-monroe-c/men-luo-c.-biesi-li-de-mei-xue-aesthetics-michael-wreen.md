...
也是(W)的标准证据，并且还有许多其他类似的证据例子。无论一个行为的错误性是否由撒谎和背叛等因素构成，或者它是一种在这些因素上监督的不同属性，这对于我们所关心的问题来说都不重要。重要的是推理关系的逻辑，或者更准确地说，是推理关系的认识论。
...
[Michael Wreen](http://www.marquette.edu/phil/faculty\_wreen.shtml) <[_michael.wreen@marquette.edu_](mailto:michael%2ewreen%40marquette%2eedu)>
