...
吉奇对相对同一关系的行为提出了许多有趣的观点。例如，他声称 a 可以与 b 相同，但不能与 K*相同，其中'K'和'K*'是表示不同种类的分类术语。以债务人悖论为例。在这种情况下，我们有一个较早的物质部分 M1 和一个较晚的物质部分 M2。根据吉奇的观点，M1 不是与 M2 相同的物质部分，但它是同一个人。通过这种方式，他能够允许人在部分变化中持续存在。（有关相对同一的更多详细信息，请参见相对同一条目。）
