...
对于数学实在论的两个最重要的反对论证是形而上学问题 — 我们如何获得关于因果无关的数学实体的知识？（Benacerraf 1983b） — 以及关于将数学归约为集合的不确定性问题 — 如果数是集合，它们是哪些集合？（Benacerraf 1983a）？除了不可或缺性论证之外，数学实在论的另一个主要论证是为了追求一种统一的语义学，适用于所有的话语：无论是数学的还是非数学的（Benacerraf 1983b）。当然，数学实在论很容易应对这一挑战，因为它以与其他领域相同的方式解释数学陈述的真实性。然而，唯名论如何提供统一的语义学则不太清楚。
