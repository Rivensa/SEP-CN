...
让客体实在论成为存在抽象数学对象的观点。客体实在论因此只是存在性和抽象性的结合。[4] 客体实在论与唯名论相对立，在当代哲学中，唯名论通常被定义为不存在抽象对象的观点。（在更传统的哲学用法中，“唯名论”一词实际上是指不存在普遍性的观点。参见 Burgess＆Rosen 1997，第 13-25 页和关于抽象对象的条目。）
