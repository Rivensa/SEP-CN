...
>
> 1. 在实际世界中，樱桃是猫 *，树是垫子*。
> 2. 在每个可能的世界中，“一只猫在垫子上”和“一只猫*在垫子*上”这两个句子具有完全相同的真值。

考虑两个句子“A cat is on a mat”和“A cat*is on a mat *”的代替，现在只考虑一个句子“A cat is on a mat”，允许其解释通过首先采用标准解释，然后采用非标准解释来改变，其中在每个可能的世界中将猫的集合*分配给“cat”，将垫子的集合*分配给“mat”。结果将是“A cat is on a mat”的真值不会改变，并且在每个可能的世界中都与以前完全相同。类似的非标准参考分配可以为语言的所有谓词构建。[参见 Putnam 1985, 1994b.]然而，与 GCT 论证不同，置换论证容易受到刘易斯式回应的影响。
...
* –––, 2003, *Saving the Differences: Essays on Themes from <u>Truth and Objectivity</u>*, Harvard University Press, Cambridge, Massachusetts.
