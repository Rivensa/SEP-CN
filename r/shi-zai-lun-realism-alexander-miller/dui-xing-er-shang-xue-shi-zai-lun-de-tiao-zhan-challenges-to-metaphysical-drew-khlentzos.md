...
不幸的是，对于实在论者来说，这并不是唯一的解释。事实上，普特南在 MTA 的早期阐述中就使用了这个例子。普特南认为，仅仅因为存在满足 ϕ 的不同模型，其中一些模型中 R 是不可数的，而另一些模型（如 μ）中 R 是可数的，就不可能通过一阶公理来确定“集合”的预期解释。此外，在普特南之前，斯科勒姆及其追随者已经从斯科勒姆悖论中得出结论，集合论概念是不确定的\[有关进一步讨论，请参阅斯科勒姆悖论条目]。
