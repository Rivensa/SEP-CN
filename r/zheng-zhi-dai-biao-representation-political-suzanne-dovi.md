...
此外，威廉姆斯解释了代表需要如何调解代表与选民之间的关系，以建立“信任”。对于威廉姆斯来说，信任是民主问责制的基石。威廉姆斯依靠非裔美国人的经验，展示了非裔美国人被特权白人公民背叛的一贯模式，这给他们有充分理由不信任白人代表和机构本身。对于威廉姆斯来说，不信任关系可以“至少部分修复，如果弱势群体由自己的成员代表”（1998 年，14 页）。最后，代表涉及调解群体如何被定义。根据威廉姆斯的说法，群体的边界部分是由过去的经验所确定的——威廉姆斯称之为“记忆”。拥有某些共同的边缘化模式可以证明某些机构机制的存在。

威廉姆斯提供了她对代表作为调解的理解，作为她认为传统自由代表观念的补充。威廉姆斯确定了自由代表中的两个方面。她将第一个方面描述为“公平代表的理想，即通过自由和公开选举，在其中每个公民都有同等权重的选票”（1998 年，57 页）。第二个方面是利益集团多元主义，威廉姆斯将其描述为“共享社会利益组织的理论，旨在确保这些团体在公共政策中的公平代表”（同上）。这两个方面共同构成了实现公平代表的一致方法，但是仅仅将传统自由代表观念简单地看作这两个方面是不足够的。特别是，威廉姆斯批评传统自由代表观念未能考虑到在美国受到边缘化群体所经历的不公正待遇。因此，威廉姆斯将政治代表的解释扩展到了制度设计之外，并因此挑战了那些将代表仅仅看作是授权和问责的形式程序的人。

Nadia Urbinati（2000 年，2002 年）提供了另一种重新构想代表的方式。Urbinati 主张将代表理解为倡导。对于 Urbinati 来说，代表的目的不应该是利益的聚合，而是维护维护自由所必需的分歧。Urbinati 确定了倡导的两个主要特征：1）代表与选民事业的热情联系，2）代表的相对独立判断。Urbinati 强调前者对于激励代表之间及其选民进行研讨的重要性。将代表理解为倡导的好处在于它提高了我们对研讨民主的理解。特别是，它避免了许多当代研讨民主主义者常犯的一个错误：过分关注研讨的正式程序，而忽视了社会内部不平等的根源，例如家庭。Urbinati 对代表的理解的一个好处是它强调了意见和同意形成的重要性。特别是，她对代表的对抗性概念突出了分歧和修辞对民主的程序、实践和精神的重要性。她的解释扩大了对代表制度的理论讨论的范围，将其从授权的正式程序转向代表制度的研讨和表达维度。以这种方式，她对代表的对抗性理解为那些希望解释非国家行为者如何“代表”的人提供了一个理论工具。

其他概念上的进展有助于澄清代表的特定方面的含义。例如，安德鲁·雷菲尔德（2009 年）认为我们需要区分代表和受托人的区别。雷菲尔德强调代表可以以至少三种不同的方式成为代表和受托人。因此，我们应该用三个区别（目标、判断来源和响应性）取代传统的代表/受托人区别。通过合并这三种不同的代表和受托人方式，政治理论家和政治科学家忽视了代表通常是部分代表和部分受托人的方式。

其他政治理论家要求我们重新思考我们对民主代表的理解的核心方面。在《包容与民主》中，艾丽丝·玛丽昂·杨要求我们重新思考描述性代表的重要性。杨强调，试图在政治舞台上包容更多声音可能会压制其他声音。她以一个拉丁裔代表的例子来说明这一点，这个代表可能会无意中代表直男拉丁裔，而忽视同性恋和女同性恋拉丁裔的利益（1986 年，350 页）。对于杨来说，差异的压制是所有代表的问题（1986 年，351 页）。大选区或小社区的代表必须协商一个人代表多个人的困难。因为这种困难是代表的构成要素，所以认为代表应该被表征为“身份关系”是不合理的。代表的合法性主要不是由他或她与被代表者的相似之处决定的。对于杨来说，代表不应被视为被代表者的替代品。因此，杨建议将代表重新概念化为一种差异化的关系（2000 年，125-127 页；1986 年，357 页）。杨对代表的理解有两个主要好处。首先，她对代表的理解鼓励我们认识到被代表者的多样性。其次，她对代表的分析强调了认识到代表机构如何包容和排斥的重要性。民主公民需要警惕为某些群体提供代表权利的方式会排斥其他群体。在杨的观点基础上，苏珊·多维（2009 年）认为，我们不应仅仅将代表概念化为如何将边缘化群体引入民主政治；相反，民主代表可能需要限制过度代表特权群体的影响力。

此外，基于对政治代表的理解方式，杨提供了一种替代性的民主代表解释。具体而言，她将民主代表视为一个动态过程，一个在授权和问责时刻之间移动的过程（2000 年，129 页）。正是在这些时刻之间的转变使得这个过程成为“民主的”。这种流动性使得公民能够授权他们的代表，并且这种授权的痕迹能够在代表的行为和代表如何被问责的方面显现出来。因此，任何给定代表的适当性部分取决于未来的行为以及他或她过去的关系。因此，杨认为对这个过程的评估必须持续“推迟”。我们必须动态地评估代表，即评估授权和问责的整个持续过程。杨对代表动态的讨论强调了对代表评估的不完整性，需要纳入民主公民需要暂停对代表评估的程度以及代表可能面临的意外问题的程度。

关于民主代表的另一个洞察来自于关于描述性代表的文献，即偶然性的重要性。在描述性代表方面，简·曼斯布里奇的工作尤为有影响力。曼斯布里奇建议我们通过背景和特定功能来评估描述性代表。具体而言，曼斯布里奇（1999 年，628 页）关注四个功能及其相关背景，这些功能是“（1）在不信任的背景下进行充分沟通，（2）在未结晶、未完全表达的利益背景下进行创新思维，（3）在历史背景下为一个群体的成员创造‘统治能力’的社会意义，该能力曾受到严重质疑，以及（4）在过去歧视的背景下增加政治体制的实际合法性。”对于曼斯布里奇来说，当边缘化群体不信任相对更有特权的群体的成员，并且边缘化群体拥有尚未完全形成的政治偏好时，需要描述性代表。对于描述性代表的需求取决于特定的功能。

曼斯布里奇关于描述性代表的偶然性的洞察表明，在某些情况下，描述性代表可能不再必要。然而，她没有具体说明我们如何知道利益是否已经结晶，或者信任是否形成到需要描述性代表已经过时的程度。因此，曼斯布里奇对描述性代表的讨论表明，评估代表的标准是流动和灵活的。关于评估拉丁裔代表的统一或固定标准存在问题的有趣讨论，请参阅克里斯蒂娜·贝尔特兰的《团结的困境》。

Mansbridge 对描述性代表的讨论指出了政治代表文献中的另一个趋势，即从代表的职能中推导出代表性的规范解释。Russell Hardin（2004）在他的观点中最清楚地捕捉到了这一趋势，他认为“如果我们希望评估选定官员的道德性，我们必须理解他们作为我们代表的职能，然后推断他们如何履行这一职能。”对于 Hardin 来说，只有对代表角色的经验性解释对于确定代表应该做什么是必要的。在 Hardin 之后，Suzanne Dovi（2007）确定了评估代表表现的三个民主标准：公正、批判性信任建立和良好的门控。在《统治的激情》中，Andrew Sabl（2002）将代表的适当行为与他们的特定职位联系起来。特别是，Sabl 关注三个职位：参议员、组织者和活动家。他认为不应该使用相同的标准来评估这些不同的职位。相反，每个职位都负责促进民主的恒定性，Sabl 将其理解为“利益的有效追求”。Sabl（2002）和 Hardin（2004）是将评估政治代表的标准与这些代表的活动和职位联系起来的趋势的典型例证。

## 4. 研究的未来领域

与政治代表有关的问题有三个持久存在的问题。每个问题都确定了未来的研究领域。第一个问题是民主政体中代表机构的适当制度设计。关于政治代表的理论文献已经对民主制度的制度设计给予了很多关注。更具体地说，政治理论家们推荐了从比例代表制（例如，Guinier，1994 和 Christiano，1996）到公民陪审团（Fishkin，1995）的各种制度。然而，随着民主国家数量的增加，我们很可能会看到不同形式的政治代表之间的更多变化。特别重要的是要意识到非民主和混合政权如何采用代表机构来巩固对其公民的权力。关于采用代表机构的优缺点很可能会有很多争论。

这导致了第二个未来的研究方向——代表性机构如何使民主公民边缘化。这个问题最清楚地由杨的讨论所阐明，即一个人代表多个人所引发的困难。杨认为，代表性机构可以在包容一些公民的意见、观点和利益的同时，边缘化其他人的意见、观点和利益。因此，一个关于增加历史上处于劣势的群体代表性的制度改革的问题是，这样的改革往往会降低代表的反应能力。例如，黑人选区的设立为黑人当选官员创造了安全区域，使他们对选民的问责度降低。考虑到公民对其代表的脆弱性，任何问责度的降低都是令人担忧的。因此，未来的研究方向之一是研究代表性机构如何边缘化民主公民的利益、意见和观点。

特别是，有必要承认代表机构的偏见。虽然 E. E. Schattschneider（1960）长期以来一直指出代表机构的阶级偏见，但很少讨论如何改善不满者的政治代表性——即那些没有意愿、时间或政治资源参与政治的公民的政治代表性。这样的讨论的缺乏在关于描述性代表的文献中尤为明显，这个领域最关注弱势公民。Anne Phillips（1995）提出了关于贫困人口代表性的问题，例如无法定义阶级，然而，她主张将阶级问题融入到一种存在政治中。很少有理论家接受了 Phillip 的挑战，并阐述了如何实现阶级与存在政治的融合。当然，一些人认识到利益集团、协会和个人代表可能背叛最不幸的人（例如 Strolovitch，2004）。一些人（Dovi，2003）认为，描述性代表需要根据他们与被不公正地排除和边缘化的公民的关系来选择。然而，如何抵消国内外代表机构中普遍存在的阶级偏见尚不清楚。有必要明确指定在民主政体内，某些群体需要增强代表性的条件。最近的实证文献表明，拥有描述性代表的好处绝非一帆风顺（Gay，2002）。

第三个也是最后一个研究领域涉及到代表和民主之间的关系。从历史上看，代表被认为与民主相对立 [参见 Dahl（1989）对代表概念的历史概述]。与古代城邦（尤其是雅典）中直接形式的民主相比，代表制度似乎是公民积极统治自己的劣质替代品。巴伯（1984）曾经有名地主张代表制度与强大民主相对立。相比之下，现在几乎每个人都同意民主政治制度是代表性的。
...
[Burke, Edmund](https://plato.stanford.edu/entries/burke/) | [democracy](https://plato.stanford.edu/entries/democracy/)
