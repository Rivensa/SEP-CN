...
其他哲学家可以被理解为追求相反的减少：即将实质性理性减少为结构性理性。例如，有些人认为，有理由去 Φ 的意思是这样的，即如果一个人的心理状态被纠正为结构性非理性，那么他就会被激励去 Φ - 或者渴望 Φ，或者打算 Φ，或者类似的（Smith 1994; Markovits 2014）。这种关于理由的解释通常被称为“理想化态度”解释。如果理由可以归结为关于结构性理性的事实，那么这很有可能提供了将实质性理性（本身以理由响应为基础的理解）归结为关于结构性理性的事实的材料。然而，关于理由的理想化态度解释已经遭到了许多反对意见（参见例如 Enoch 2005）。在当前背景下，一个重要的反对意见是，如何将这种观点推广到信仰的理由（以及因此，实质性非理性）是非常不清楚的（Cuneo 2007: ch. 7）。另一个反对意见是，由于纠正结构性非理性的方法通常不止一种，这样的观点将使我们的理由变得极不确定，或者可能为几乎任何事情产生理由（Sampson 2021）。
...
现在让我们转向涉及非信念状态的结构性非理性形式（至少部分涉及）。我们已经提到的结构性非理性的典型例子是目的手段不一致（也被称为“工具非理性”），尽管这个术语有时被用于其他含义（请参阅有关工具理性的条目），其中一个人打算 Φ，相信为了 Φ，他必须 Ψ，但不打算 Ψ。除此之外，涉及非信念状态的结构性非理性的最常见例子可能是实践性无力行为 - 相信在综合考虑所有事情后，应该 Φ，但不打算 Φ（请参阅 Broome 2001b、2013; Kolodny 2005; 异议请参阅 Arpaly 2000 等）。值得注意的是，这种形式的结构性非理性（以及目的手段不一致）涉及信念和意图（或缺乏意图）之间的不一致，从而连接了信念和意愿状态。另一个将信念状态和意愿状态联系起来的不一致形式的例子可能是打算做一些自己相信自己无法做到的事情。

也有一些合理的例子表明，仅在意愿状态之间存在结构性非理性。通常认为，具有矛盾意图是结构性非理性 - 也就是说，打算 Φ 并打算不 Φ。与信念情况一样，有一些由形式倾向的哲学家（和经济学家）研究的不一致形式自然被视为结构性非理性的实例 - 例如具有循环偏好，其中一个人更喜欢 A 而不是 B，更喜欢 B 而不是 C，但更喜欢 C 而不是 A（Davidson，McKinsey 和 Suppes 1955; Gaus 2008: 36–40）。
