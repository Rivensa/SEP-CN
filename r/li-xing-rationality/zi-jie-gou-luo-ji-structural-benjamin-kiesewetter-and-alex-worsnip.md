# 结构理性 structural (Benjamin Kiesewetter and Alex Worsnip)
...
正如我们已经看到的，对结构性理性的评估涉及一个人心理状态的连贯性。然而，通过确定一些进一步常见的结构性理性或非理性评估特征，我们可以更加清晰地聚焦于结构性理性的概念，这些特征被认为可以将其与实质性理性或非理性评估区分开来。

首先，结构性理性通常涉及态度的组合（以及其缺失），而不是个体态度（以及其缺失）。考虑一个人既相信 p 又相信非 p 的情况。如果这些信念在认知理由上得不到充分支持，它们中的一个或两个都可能不是实质性理性的。但结构性非理性存在于这种组合中，而不是个体信念中。同样，对于打算Φ，相信为了Φ必须Ψ，但不打算Ψ的情况也是如此。这些状态中的一个或多个可能在个体上都不是实质性理性的，但结构性非理性存在于这种组合中。然而，关于结构性理性是否总是涉及态度的组合而不是个体态度存在争议。例如，Broome（2013: 153）认为，对于形式为（p & 非 p）的合取命题的单独信念本身就是结构性非理性。结构性理性也不是仅涉及态度的组合这一特点。可能存在实质性理性的失败，特别是由于态度的组合而产生：例如，即使其中一个意图在个体上是理性允许的，打算明天去参加一次工作面试并打算明天穿泳裤也可能不是实质性理性的。
...
最后，对于结构理性的评估可以称为形式上的，因为我们可以判断出在至少在某种程度上抽象其内容时，态度的组合是否结构上的非理性。例如，无论其内容如何，相信 p 和相信非 p 总是结构上的非理性。同样，目的手段要求说（或蕴含）意图Φ，相信要Φ必须Ψ，但不意图Ψ对于任何行动Φ和Ψ都是非理性的，无论它们是什么。
...
对这种观点的批评者以多种方式进行反驳，但也许最常见的回应是指出一些情况，其中联合不一致的态度在个人的理由下是被允许的（Broome 2013: 85–6; Way 2013）。例如，假设你的证据表明，要去超市，你必须骑自行车（因此允许，甚至可能要求相信这个命题）。假设你的理由允许你去超市，但并不要求你去。在这种情况下，似乎你的理由允许你骑自行车，但并不要求你这样做。在这种情况下，既不去超市的意图，也不相信你必须骑自行车，也不打算骑自行车，都不会在实质上缺乏理性。然而，似乎这三者在组合中仍然是结构上的不合理。如果这是正确的，那么一些态度组合的结构不合理并不能保证至少有一个态度在实质上不合理。同样，也许在信念态度方面存在允许的情况（Ballantyne and Coffman 2011; Schoenfield 2014）。例如，也许你的证据可以允许对 p 的置信度为 0.6，但也可以允许对 p 的置信度为 0.61。相应地，它允许对非 p 的置信度为 0.39 或 0.4。在这种情况下，对 p 的置信度为 0.61 或对非 p 的置信度为 0.4 都不会在实质上缺乏理性。然而，这两者的组合是结构上的不合理（Staffel 2020）。

已经提出了各种应对这一挑战的策略。Kolodny（2011）和 Lord（2018：第 2 章）都认为，采纳一种意图可以改变一个人采取手段的理由，使得在采纳最终意图之前仅仅被允许的手段意图成为实质上必需的（关于置信度的类似故事在 Lord 2020 中也有提出）。借鉴 Bratman（1987）的工作，Kiesewetter（2017：第 10 章）认为，在仅仅被允许的目标情况下，手段-目的不一致的代理人将违反经济原因，因为保持自己不会实施的意图会使人容易浪费资源。关于认知不一致，拒绝与解释结构性非理性的实质性要求相冲突的允许主义也是一个选择（例如，White 2005，Schultheis 2018）。在另一种替代观点中，实质性认识论合理性允许我们拥有不精确的置信度，而不是几个概率上不一致的精确置信度。

其他哲学家可以被理解为追求相反的减少：即将实质性理性减少为结构性理性。例如，有些人认为，有理由去Φ的意思是这样的，即如果一个人的心理状态被纠正为结构性非理性，那么他就会被激励去Φ - 或者渴望Φ，或者打算Φ，或者类似的（Smith 1994; Markovits 2014）。这种关于理由的解释通常被称为“理想化态度”解释。如果理由可以归结为关于结构性理性的事实，那么这很有可能提供了将实质性理性（本身以理由响应为基础的理解）归结为关于结构性理性的事实的材料。然而，关于理由的理想化态度解释已经遭到了许多反对意见（参见例如 Enoch 2005）。在当前背景下，一个重要的反对意见是，如何将这种观点推广到信仰的理由（以及因此，实质性非理性）是非常不清楚的（Cuneo 2007: ch. 7）。另一个反对意见是，由于纠正结构性非理性的方法通常不止一种，这样的观点将使我们的理由变得极不确定，或者可能为几乎任何事情产生理由（Sampson 2021）。

第四，也是最后，一些哲学家认为，实质性和结构性理性都是真正的理性类型，而且两者都不能归约为另一种类型（Worsnip 2021）。这些观点需要解释一下这两种理性如何相互关联，如果有的话：例如，它们是否会相互冲突？如果实质性理性经常推荐一件事情，而结构性理性推荐另一件事情，这可能会令人不满意，特别是如果没有任何关于哪种需求具有理性优先权的说法。实际上，有些人可能认为结构性和实质性理性相冲突的前景表明它们不能同时成为真正的理性要求的来源。

然而，值得注意的是，结构理性与实质理性之间的冲突程度取决于我们采用的结构理性的积极理论。在关于结构理性的“广义范围”观点上（见下文§2.1），其要求仅仅是负面的，禁止不一致的态度组合，并且可以通过修正任何不一致的态度来满足相关要求。如果是这样，就减少了实质理性与结构理性之间的冲突潜力。这是因为，在这种观点下，结构理性只是告诉人们，在不一致时应该以某种方式恢复一致性，这为实质理性留下了空间，以（有时）更具体地确定如何做到这一点。例如，再次考虑阿里，他相信自己是超人，而超人可以飞。如果阿里的证据是正常的，实质理性禁止阿里相信他可以飞。结构理性是否要求他相信他可以飞？不明显：它可能允许他改变他原来的信念之一，只要他相信他可以飞或者改变这些原始信念之一即可。然而，有人认为，在特殊情况下，实质理性与结构理性之间的冲突可能以更微妙的方式出现（Worsnip 2018a）。

### 1.4 结构（非）理性的实例：一份清单

到目前为止，我们主要关注了不一致的信念和目的与手段的不一致作为结构非理性的典型实例。但还有许多其他可能的实例。任何特定的实例都会引起争议，因为人们总是会争论某些心理状态的组合是否真的是结构非理性的。而且，要完全全面地确定所有候选实例是不可行的。但我们将注意一些最有可能的候选状态（模式）的组合。

让我们从一些可能在结构上不合理的信念状态的组合开始。除了严格相互矛盾的信念——即相信 p 和相信非 p 的信念——人们通常认为其他逻辑上不一致的信念集合也是结构上不合理的。例如，正如前面提到的，阿里相信他是超人，相信超人会飞，但同时又相信他自己不能飞，这似乎是结构上不合理的。更进一步，有人认为不相信自己信念的逻辑蕴涵是结构上不合理的——所以如果阿里相信他是超人，相信超人会飞，但仅仅不相信他自己能飞，那么他就是不理性的。要求相信自己信念的逻辑蕴涵通常被称为“演绎闭包”。

然而，关于所有不一致的实例或者不相信自己信念的逻辑蕴涵是否都涉及到非理性的问题存在争议。首先，当相关的不一致或蕴涵非常微妙，需要复杂的逻辑证明才能检测出来时，这一点并不清楚（Broome 2013: 154–5）。其次，我们是否因为不愿意将我们现有信念的无限琐碎后果弄乱我们的思维而变得非理性也不清楚（Harman 1986: 12）。针对第一个问题，有人说结构性非理性只有在人们意识到相关的不一致或蕴涵时才会出现（Sainsbury 2002）。针对第二个问题，有人说，如果 q 是一个人现有信念的某个结果，那么为了不相信 q，一个人需要关心 q（Broome 2013）或者关注 q 才能成为结构性非理性。然而，这些限制并不能解决所有声称的合理不一致的情况。例如，前言悖论（Makinson 1965）是一个合理但不一致的信念的合理案例（尤其是参见 Christensen 2004）。在这种情况下，作者写了一本包含许多主张的书，但在前言中谦虚地肯定，毫无疑问，这本书包含错误——即这本书中至少有一个主张是错误的。这个完整的信念集合——书中的主张加上前言的主张——是不一致的，但可以说，持有这些信念并不是非理性的——即使一个人意识到了不一致，并关注和关心相关的信念。虽然一些人（MacFarlane 2004——参见其他互联网资源）认为这是一个实质性和结构性合理性冲突的案例，但其他人（Worsnip 2016a）则认为这些情况下的不一致信念甚至不是结构性非理性。

也有广泛的观点认为，由于一阶信念与高阶信念的结合方式，代理人可以在结构上是非理性的：也就是说，他们对一阶信念的规范地位或对其证据的信念。例如，人们常常认为，在相信 p 的同时，也相信自己的证据不足以支持 p 是结构上的非理性行为，或者在相信 p 的证据确凿的同时，却不相信 p 也是结构上的非理性行为（参见 Kolodny 2005；Feldman 2005；Titelbaum 2015 等）。这些状态的组合有时被描述为“认识上的无意志”（Horowitz 2014；Greco 2014）。虽然一些人认为，在高阶误导证据的情况下，这些状态可能是理性的，因此不一定是非理性的（Coates 2012；Lasonen-Aarnio 2020），但其他人认为，在这种情况下，认识上的无意志最多只能是实质上的理性，而不是结构上的理性（Worsnip 2018a）。

许多形式认识论者所指出的非理性类型，通常与信念相比更多地涉及到置信度，也可以合理地被视为结构性的。例如，（大多数）未能符合概率公理的置信度，比如前述的将置信度 0.6 分配给 p 和置信度 0.41 分配给非 p 的情况，可以合理地被视为结构性的非理性。更具争议的是，未能通过条件化来更新置信度可能被视为先验置信度和后验置信度之间一种结构性非理性。后一种情况更具争议，因为这种“不一致”通常被理解为历时性的，而有些人认为结构性非理性是一种同步现象（见第 2.3 节）。因此，将其视为一种不一致类型要么需要我们确定在未能正确进行条件化时发生的某种同步性失败，要么允许历时性的结构性非理性实例的存在。

现在让我们转向涉及非信念状态的结构性非理性形式（至少部分涉及）。我们已经提到的结构性非理性的典型例子是目的手段不一致（也被称为“工具非理性”），尽管这个术语有时被用于其他含义（请参阅有关工具理性的条目），其中一个人打算Φ，相信为了Φ，他必须Ψ，但不打算Ψ。除此之外，涉及非信念状态的结构性非理性的最常见例子可能是实践性无力行为 - 相信在综合考虑所有事情后，应该Φ，但不打算Φ（请参阅 Broome 2001b、2013; Kolodny 2005; 异议请参阅 Arpaly 2000 等）。值得注意的是，这种形式的结构性非理性（以及目的手段不一致）涉及信念和意图（或缺乏意图）之间的不一致，从而连接了信念和意愿状态。另一个将信念状态和意愿状态联系起来的不一致形式的例子可能是打算做一些自己相信自己无法做到的事情。

也有一些合理的例子表明，仅在意愿状态之间存在结构性非理性。通常认为，具有矛盾意图是结构性非理性 - 也就是说，打算Φ并打算不Φ。与信念情况一样，有一些由形式倾向的哲学家（和经济学家）研究的不一致形式自然被视为结构性非理性的实例 - 例如具有循环偏好，其中一个人更喜欢 A 而不是 B，更喜欢 B 而不是 C，但更喜欢 C 而不是 A（Davidson，McKinsey 和 Suppes 1955; Gaus 2008: 36–40）。
...
在类似但有些不同的思路中，一些人探索了这样一个观点，即态度在结构上非理性只有在它们不能全部“成功”或实现它们的“目标”时才会出现，其中对于信念来说可能是真实性，对于意图或偏好来说可能是满足或正确性（Fink 即将出版；Fullhart 和 Martinez 即将出版；另见 Gibbard 2003；Brunero 2020：第 7 章；Rosa 2022；Singh 即将出版）。然而，这个提议难以解释其他心理状态的不一致性，比如置信度。而且，显然不明确的是，不一致的态度组合不能共同成功——毕竟，认知无力行动的信念在逻辑上是一致的，即使相应的意图没有得到满足，一个认为自己应该Φ的信念仍然可能是真实的。因此，这种观点的支持者不得不接受某些修正性的含义，引入更具实质性且更具争议性的态度成功条件，或者放弃提供完全统一的结构非理性解释的雄心。

另一个至少部分统一的提议是“认知主义”，它希望将规定意图的某些结构要求（例如目的手段的一致性）减少为规定信念的某些结构要求（例如演绎闭合性）（Harman 1976; Velleman 1989; Wallace 2001; Setiya 2007）。这种观点基于对意图的相应认知主义，大致上认为意图Φ涉及相信自己会Φ。鉴于此，手段目的不一致（例如）可能导致违反闭合性 - 具体而言，违反了一种假言三段论的要求，即相信自己会Φ，相信只有在自己Ψ-s 时才会Φ，但不相信自己会Ψ。正如认知主义者所认识到的（Setiya 2007），他们的解释必须复杂或补充以达到这个结果。这是因为即使意图Φ涉及相信自己会Φ，并不意味着不意图Ψ涉及不相信自己会Ψ（也许一个人相信自己会无意中Ψ）。此外，意图Φ涉及相信自己会Φ的观点已经受到批评（例如，Bratman 2009a）。此外，即使认知主义者认为手段目的不一致必然涉及信念不一致，也有理由认为前者涉及一种独特的实践错误，不能简化为认知态度上的错误（例如，Brunero 2020: Ch. 6）。最后，在我们的背景下，认知主义是否能成为结构理性的完全统一理论是一个悬而未决的问题，因为目前尚不清楚如何将实践性无力行为理解为纯粹信念结构要求的违反，或者认知主义如何在信念结构要求的类别内实现统一。
...
关于理性结构要求的形式最广泛争议的问题，也可以说是最重要的问题，是这些要求是否具有广泛的范围（例如 Broome 1999; Wallace 2001; Bratman 2009b）还是狭窄的范围（例如 Korsgaard 1997; Schroeder 2004; Kolodny 2005）。为了解释这个区别，回想一下，结构性非理性涉及至少两种态度状态之间的紧张关系（其中一种态度状态可能包括态度的存在或缺乏）。例如，无意识行为涉及到一种信念，即一个人应该Φ [BOΦ]，和没有意图Φ [IΦ]之间的紧张关系。根据接受的观点，具有这种态度状态的组合是非理性的，因为违反了结构性理性的要求。根据对这些要求的原始自然解释，这些要求是有条件的，取决于相关态度状态（“前提状态”）中的一个或多个，并且对其他态度状态（“结果状态”）起作用。因此，例如，理解 Broome（2013）所称的“enkratic 要求”-禁止无意识行为的要求的一种自然方式如下：

*Enkratic 要求，狭义范围：*
如果 A 相信她应该Φ，那么理性要求 A 打算Φ [BOΦ→R(IΦ)]。

正如一些作者所强调的那样，然而，结构要求也可以以不同的方式理解（Hill 1973; Greenspan 1975; Dancy 1977; Darwall 1983; 近期的有 Broome 1999, 2007c, 2013; Wallace 2001; Bratman 2009b; Brunero 2010, 2020; Way 2011）。根据这种替代解读，结构要求不是条件性的前提状态；相反，前提状态和结果状态都是要求范围的一部分，这就是为什么这被称为“广泛范围”解读。在行动控制要求的情况下，这种解释说：

*行动控制要求，广泛范围：*
理性要求 A [如果 A 相信她应该Φ，那么 A 打算Φ] [R(BOΦ→IΦ)]。
...
德性要求，狭义范围 + 同步：如果 A 在 t 时刻相信她应该Φ，理性要求 A 在 t 时刻打算Φ。

理性要求，狭义+历时：如果 A 在 t1 时相信她应该Φ，理性要求 A 在 t2 时打算Φ。
...
合理性要求，广义+历时：理性要求 A 在 t1 时不相信她应该Φ，或在 t2 时打算Φ。

如果 A 在 t1 时相信她应该Φ，那么在 t2 时打算Φ是 A 满足这一要求的唯一方式。因此，要求采取这个意图可以合理地被分离出来（Broome 2013）。这违反了广义方法的精神。虽然已经提出了其他解释历时广义要求的方法，但它们是否能保持对称性和不可分离性而不崩溃为它们的同步对应物仍然存在争议（Lord 2014；Reisner 2009；Kiesewetter 2017：58-69；Worsnip 2021：183-7）。
...
尽管关于所有结构性非理性实例是否可以用过程需求来解释存在争议，但可以较少争议的是存在不能归结为状态需求的过程需求。例如，关于一厢情愿思维的非理性之处不一定是信念或愿望，或者这些状态的组合，或者它们在某种时间顺序中的发生，而是形成信念的具体过程。更一般地说，似乎有合理的禁止基于其他态度的基础（Broome 2013）-不要将某些态度建立在其他态度上的合理要求-这些要求不能归结为状态需求。
...
* Dreier, James, 2009, “Practical Conditionals”, in David Sobel and Steven Wall (eds.), *Reasons for Action*, Cambridge: Cambridge University Press, pp. 116–33.
...
* Korsgaard, Christine, 1997, “The Normativity of Instrumental Reason”, in Garrett Cullity and Berys Gaut (eds.), *Ethics and Practical Reason*, Oxford: Clarendon Press, pp. 215–54.
