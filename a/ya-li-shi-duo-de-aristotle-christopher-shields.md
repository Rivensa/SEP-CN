...
> 如果（i）*a* 是 *F*，（ii）*b* 是 *F*，以及（iii）在“*a* 是 *F*”和“*b* 是 *F*”中关于_F_性的解释是相同的，那么_a_和_b_是单义的_F_。
...
亚里士多德关于解释充分性的四因学说中，*物质*（*hulê*）和形式（*eidos_或_morphê*）的概念至关重要。它们共同构成了他最基本的哲学承诺之一，即_形质论_：
