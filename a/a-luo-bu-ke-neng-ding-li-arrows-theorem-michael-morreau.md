...
一个重要的发现是，仅仅拥有基数效用本身是不足以避免不可能性结果的。此外，效用必须是人际可比的。直观地说，为了充分利用有关偏好强度的信息，必须能够比较不同个体偏好的强度。参见 Sen（1970 年：定理 8_2）。人际可比性为聚合效用和偏好打开了许多可能性。其中两个重要的可能性可以从古典功利主义和罗尔斯的差异原则中得出。有关详细信息，请参阅[社会选择理论](https://plato.stanford.edu/entries/social-choice/)的条目。
...
| ![phil papers icon](../.gitbook/assets/pp.png)      | [Enhanced bibliography for this entry](https://philpapers.org/sep/arrows-theorem/) at [PhilPapers](https://philpapers.org/), with links to its database.                          |
