...
### 2.存在主义美学的现象学核心 <a href="#id-2-cun-zai-zhu-yi-mei-xue-de-xian-xiang-xue-he-xin" id="id-2-cun-zai-zhu-yi-mei-xue-de-xian-xiang-xue-he-xin"></a>
...
### 6. 艺术作品的本体论 <a href="#id-6-yi-shu-zuo-pin-de-ben-ti-lun" id="id-6-yi-shu-zuo-pin-de-ben-ti-lun"></a>
...
梅洛-庞蒂在1950年代的著作中提出了一种独特的存在主义表达理论，特别关注后者的维度。可以说，这种表达理论捕捉并明确了其他一些存在主义作家在这些问题上的共享思想。

在《世界的散文》（1964年）中，梅洛-庞蒂探讨了意义和赋予意义的活动的出现和逻辑，符号化和表达的例子是文学作品（尤其是小说）。斯坦达尔为他提供了一个典型的案例研究。从艺术作品中得出深刻的哲学结论的尝试是存在主义实践的典型特征。

首先，文学作品可以通过将作家视为创造新意义、实际上是一种新语言（乔伊斯式的英语，福楼拜式的法语等）的方式，帮助我们理解意义和赋予意义的现象，通过重新组合与整个历史社区共享的语言。这是一个真正模棱两可的方面，可以（一方面）被视为表达之谜的证明，是创造力的证据，使新的从旧的中出现成为可能，而（另一方面）这种新的只有在已经建立的基础上才可能。但这个初步的观察指向了一个更深层次；在这里，绘画提供了最宝贵的线索。在讨论安德烈·马尔罗的关于绘画史的开创性论文（马尔罗 1953）时，梅洛-庞蒂阐述了一种详细的存在主义意义理论，其中艺术作品起着核心作用。胡塞尔的“透视”隐喻被借用并转化为感知能力和人类存在的形而上学条件的一般公式。

可以说，意向性与在一个没有人类存在之前的世界中建立透视重合。为了使现实以其所有不同的品质和结构出现，需要人类意识。艺术家与其他语言使用者的区别在于对世界的特定观点的一致性和连贯性。这种连贯的观点在世界的混乱中引入了一种规律性和结构性。它引入了方向：高低、左右。也就是说，它引入了意义。

这种艺术表达与意义之间的联系导致了对风格概念的重大重新评估。在这个背景下，风格不再是一种表达意义的肤浅方式，而是指一种从世界可以被接近的基本观点；它指的是一种在表达行为之前不存在的观点。它指的是一种“不可替代的偏离”，只有从特定的世界存在方式才可能，随后以象征性语言重新捕捉，无论是文学的语言形式，还是绘画的“间接语言”。风格是一种连贯的观点，一种“连贯的变形”，一种从特定角度来对待世界的方式。根据这个模型，风格不是表达预先存在的意义，而是创造意义。卡缪在《叛逆者》一书中，专门探讨了叛逆的美学维度，发展了一种与之相应的艺术表达观念：

> …艺术中的统一出现在艺术家对现实施加的转化的极限处。艺术家通过他的语言和从现实中提取的元素的重新分配所施加的这种修正被称为风格，它赋予了重新创造的宇宙以统一性和界限（卡缪1951年，270页）。

这反过来给了新旧关系在表达中更具体的意义。真正的表达（无论是学习者的第一次真正自我表达，新的科学意义，还是真正的艺术成就）既是完全独特的，又是对共享元素的重新组合；它改变了旧有的东西。为了发生真正的表达，因此需要两种形式的言语：“说话的言语”和“被说的言语”（梅洛-庞蒂，1945a，197）。这解释了一个令人困惑的事实，即真正的表达必须同时是真正的创造，是前所未闻的东西，但只有在了解所使用的语言（自然语言、科学语言或艺术语言）时才能理解。换句话说，表达始终也是一种“说话者”与说话者群体之间的交流形式。假设梅洛-庞蒂的分析代表了其他存在主义作家的观点（参见萨特，1948a，56，其中使用了相关概念“中介”；“交流”是马塞尔戏剧哲学的核心概念），我们可以注意到，存在主义美学再次与许多现代艺术潮流相左，后者坚持在艺术语言和日常语言的功能和用途之间划清根本区别。例如，像保罗·瓦莱里这样的重要诗人和文学理论家受到马拉美著名的将诗歌描述为“给部落的词语赋予更纯粹的意义”的启发。我们还可以提到超现实主义和表现主义画家和电影导演，他们试图突破日常意象以改变现实。
...
在这一点上，我们可以注意到许多存在主义作家美学中的紧张关系（这种紧张关系在萨特的作品中非常明显），即艺术作品的相对超越历史的意义和它们的绝对“处境性”之间的紧张关系：艺术作品在特定情境中呈现出参与式自由的形象，这些情境实际上只有同时代的人才能真正理解（萨特1948a，50-52）。至于梅洛-庞蒂，他坚持认为绘画历史的基本统一性，使我们能够在现代绘画中找到过去画家的痕迹和回响。绘画历史是历史的微观形象，也是现代人理解过去行动和激情能力的证明（梅洛-庞蒂1964b，72）。梅洛-庞蒂对跨越时代的共情可能性的展望并不否认意义形成的历史相对性。它展示了尽管历史背景之间存在时空距离，人们仍然可以相互理解，历史学家可以理解以前的时代，人类学家可以理解其他民族，我们也可以在某种程度上理解过去艺术实践的一些意义。其他民族的表达成就既是根本上的陌生，又是与我们相称的表达姿态的结果，因为它们是共同的人类能力的产物，即超越自然世界并将其重新创造为有意义和有序的宇宙的能力。

### 8. 艺术家 <a href="#id-8-yi-shu-jia" id="id-8-yi-shu-jia"></a>

存在主义美学的一个核心共同假设是人类存在的本质模糊性，超越了存在主义者之间的宗教和政治差异。我作为意识是完全自由的，但又被我的事实性所决定，即物理、社会和其他环境，这些环境使我的意识来到这个世界。在这一特定观点上，海德格尔的存在分析是一个共同的参考，将原本不同（或者说敌对）的思想家联系在一起。强调人类事实性的一个重要含义是，它在哲学和艺术之间建立了重要的联系，从这个角度来看，艺术也旨在探索人类存在的形而上学模糊性。

这使得艺术家在至少两个方面具有特殊地位：

1. 艺术活动作为一种存在选择，是一种特权模式，可以承担和实现人类存在的矛盾性质。用卡缪的话来说，艺术活动是面对荒谬的关键态度之一。卡缪在《西西弗斯神话》（1942b，127）中对艺术的赞美，将艺术表达视为“快乐”的终极形式，尽管其他存在主义者在荒谬问题上存在明显的差异，但这种观点对其他存在主义者来说也是正确的。事实上，许多其他存在主义作家也发表了类似的观点，反映了他们自己的生活选择，特别是他们决定追求哲学和文学事业。许多存在主义著作中所包含的个人维度，使得这些文本在哲学史上具有特殊地位，因为它模糊了哲学写作类型的定义中一个至关重要的界限，即理论与传记、个人与普遍之间的界限。马塞尔的“形而上学日记”就是一个很好的例子。日记不仅仅是一种独特的哲学分析形式，还展示了马塞尔对真实自我的理解，即通过本体论探究、艺术创作和个人参与的结合实践逐渐觉醒到“存在的吸引力”。萨特也写了一本自传性的作品《文字》，记录了他对文字世界的发现，毫无疑问是他的杰作之一。卡缪的最后一部叙事作品《堕落》也可以说是同样的情况，它将自传与对他哲学的讽刺描述相结合。

除了他们自己的个人实践之外，存在主义者还在伟大艺术家的生活中找到了哲学意义，并对他们选择成为艺术家的时刻以及这一原始选择如何在他们的一生中展开感兴趣。艺术家为“存在”和“表达”的悖论提供了范例性的案例研究（萨特1947b，1971）。事实上，这不仅适用于作家和画家，也适用于演员。对于卡缪来说，实际上演员是那些“从人类存在的形而上学真理中得出最好结论”的人（1942b，107）。

2. 艺术家的活动在表达一个连贯的世界方面也具有深刻的意义。每个人都必须做出存在选择并有表达的需求，但艺术家呈现了人类存在这些方面的特别纯粹和强大的典范。他们的成就值得钦佩，因为它们涉及虚拟世界的创造。每个意识，每个存在于世界中的存在都是有表达性的，但这种表达很少是真正的新颖。大多数时候，人类的表达只是制定的意义的重复，就像口语的准自动使用一样。只有伟大的艺术家展示了表达的力量的纯粹性、新颖性和连贯性。重新创造一个能够恰如其分地展现现实世界复杂性的虚拟世界是一种几乎“奇迹般”的事实，正如梅洛-庞蒂在谈到塞尚时所说的那样。正如我们所看到的，存在主义者在强调天才方面与浪漫主义者并不相距。

由于真正艺术家的表达世界是对世界的新视角，与艺术家整个独特的存在方式相同，因此他或她的作品中将存在着深层次的连续性。艺术作品在时间和空间上建立的交流首先在作品集本身内部进行，其中主题和风格特点在整个作品中相互回响（卡缪斯1942b，102-103；梅洛-庞蒂1964b，67）。但艺术活动中存在着固有的宿命论。表达活动只能是一种尝试表达，并且在结构上注定会失败，因为世界上有太多需要揭示的东西。表达的手段是有限的，并且它们以扭曲的方式运作，既通过直接指称，也通过省略和暗示。这导致卡缪斯得出结论，创造性活动，就像所有自由活动一样，最终只是另一种荒谬的尝试来应对人类生活的荒谬性（1942b，130）。

### 9. 观众 <a href="#id-9-guan-zhong" id="id-9-guan-zhong"></a>
