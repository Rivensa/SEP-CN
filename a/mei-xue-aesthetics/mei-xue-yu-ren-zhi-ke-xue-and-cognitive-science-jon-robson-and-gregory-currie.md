...
本文涉及认知科学在哲学审美研究中的重要性及其可能的作用。我们主要关注分析性、以英语为主的美学写作及其在经验主义传统中的渊源。审美研究在哲学以及其他领域也有所涉及，但在分析传统中，与心理科学的联系得到了最深入的研究，这一传统对经验主义理论和结果最为接受（梅洛-庞蒂在现象学传统中的工作是一个例外；关于他的影响，请参见Solli和Netland 2021）。
...
在这个时期，审美判断在一定程度上受到了对心灵的思考的影响，更多地受到了来自精神分析的思想的推动（Wollheim 1993）。过去三十年来，随着对想象力的兴趣再度兴起，审美判断逐渐回归到经验研究中，现在常常被视为一种具有进化和发展历史的能力（Fuentes 2020；Harris 2000），并且受到选择性损伤的影响（Currie 1996）。

将审美判断完全视为先验的观点从来都不可信。即使是那些认为其主要任务是分析广泛共享的民间概念的人（Dickie 1962），也会同意音乐哲学家应该对某种音乐传统的历史、艺术创作实践和批评传统有相当多的了解。在这方面，审美判断更接近于物理学或经济学的哲学，而不是形而上学。审美判断与感知研究之间也有一个被广泛承认的联系。当鲍姆加滕（1750-58）首次引入“审美学”一词时，他称其为“感知科学”，根据纳奈（2014: 101）的说法。

许多，甚至可能是大多数传统的审美问题实际上是关于感知哲学的问题，并且因此可以借助感知哲学的概念工具来有益地解决。

这是一个比许多人提出的要强的论断（参见Margolis 1960; Sibley 1965; Schellekens 2006; 和Robson 2018），但审美学中的论题有时确实依赖于关于感知本质的主张，包括科学可追踪的主张。一个显著的例子是关于感知是否具有认知渗透性的辩论；如果具有认知渗透性，一幅图片的外观或一段音乐的声音可能取决于观察者对背景因素的了解（对认知渗透性的否定参见Danto 2001；对批评参见Rose & Nanay 2022）。

对于哲学家对实证工作与审美学的相关性的疑虑有各种不同的观点。一些作者仅仅是暗示哲学家往往会根据薄弱的实验证据作出草率的概括，对细节和限制给予不足的关注，并未承认存在着相互冲突的专家意见（Konečni 2013; Stock 2014）。哲学家，其中包括美学家，当然有时会高估自己的专业知识，而在涉及实证问题时可能更容易如此。但这些都并不意味着他们对实证的热情在原则上存在问题。其他怀疑者强调他们所看到的更系统性的危险。罗杰·斯克鲁顿（Roger Scruton）（2014）指出了一种倾向，即试图将审美现象纳入现有的科学框架中，结果发现这些框架并不适用；他引用了试图使用乔姆斯基的语言学来建立音乐生成理论的尝试，他声称这种尝试既无法适应音乐的结构，也无法适应音乐的目的。戈登·格雷厄姆（Gordon Graham）（2014）将休谟的审美理论与里德的审美理论进行对比，称“审美科学”的项目必须忽视或否认理性和判断的作用。同样，我们可以对这两种危险保持警惕，同时对实证工作保持开放的态度。特别是，格雷厄姆的挑战可以通过指出研究理性在审美判断中实际发挥的作用来回应，这表明人们认为自己的理由与决定其偏好的因素之间有时存在明显的脱节（Lopes 2014和Irvin 2014；另见下文，[第3节](https://plato.stanford.edu/entries/aesthetics-cogsci/#PrefJudgReas)）；这对于研究审美判断的合理性来说显然是相关的。此外，美学家们认为是广义上的概念分析的工作往往假设了实际上是实证问题的答案。诺埃尔·卡罗尔（Noel Carroll）说：

> “假设审美属性是客观的，也比投射理论更好地解释了我们对它们的谈论方式。...参与有关审美属性的争论的人们...表现得好像争论的一方是对的，另一方是错的。”（Carroll 1999: 117）
...
> 任何不基于大脑活动的审美理论都不太可能是完整的，更别说是深刻的了

继续说，绘画是对大脑规律的探究，我们所喜欢的就是让我们的大脑感到愉悦的东西（1999: 1–2）。虽然这样的态度可能并不完全否定哲学审美学，但它们对其结果缺乏意识，也不理解神经学研究的局限性。关于大脑过程的事实并不能告诉我们——至少没有一些实质性且有争议的桥接前提——什么是艺术作品，或者哪些作品具有价值（参见Hyman 2010对这种方法的广泛批评）。经验研究与规范美学之间的关系将在本文中反复出现。

### 2. 自下而上和自上而下的审美方法 <a href="#id-2-zi-xia-er-shang-he-zi-shang-er-xia-de-shen-mei-fang-fa" id="id-2-zi-xia-er-shang-he-zi-shang-er-xia-de-shen-mei-fang-fa"></a>

对审美的大量实证研究，虽然并非出于对哲学思想的敌意，但采用了“自下而上”的方法，关注未受训练的受试者对简单刺激的直接反应。相比之下，我们已经看到，哲学审美更关注判断和价值的规范问题，以及这些问题据称依赖于训练、知识和有时被称为“品味”的东西。但这些实证研究并非在哲学上无关紧要；我们不应假设专家的审美反应与天真受试者的反应不连续（尽管关于这里的举证责任的讨论，请参见威廉姆森2011年），也不应假设专家的判断只对专家自己认可的因素敏感。重要的是要问是否存在基线审美反应，可能在不同文化中保持不变，从而产生各种各样的审美传统，并对这些传统及其产品施加限制（关于对审美实验的这种“自下而上”方法的辩护，请参见麦克马纳斯2011年）。现代艺术史的创始人沃尔夫林对以这种方式构建的问题很感兴趣：例如，他声称，在图像中，人们普遍倾向于更喜欢将重要对象放置在右侧（1928年）。随后的研究表明，偏好取决于物理和文化因素：惯用手，以及阅读/书写从左到右还是从右到左（有关参考和讨论，请参见帕尔默、加德纳和威肯斯2008年；查布恩等人2017年发现，放置偏好取决于受试者的阅读/书写方向）。其他研究显示了对某些颜色（帕尔默和施洛斯2010年）、形状、物体在画面中的位置（帕尔默、加德纳和威肯斯2008年）和大小（林森、莱森、萨玛蒂诺和帕尔默2011年）的坚定偏好。这些偏好往往是生态驱动的；例如，人们倾向于喜欢喜欢的物体的颜色，对饱和蓝色有强烈且文化上不变的喜好，对与粪便和呕吐物有关的颜色持有不变的敌意。存在文化差异；例如，日本受试者在对深红色缺乏热情方面似乎是异常的（帕尔默和施洛斯2010年）。某些颜色偏好是非常文化特定的，比如大学生对与他们学校相关的颜色的偏好（施洛斯、波吉西和帕尔默2011年）。

这类研究可能被认为在解释审美艺术制作的持久特征方面具有价值，但不太可能提供超过一般背景的东西，这一背景是审美偏好和判断、关于特定艺术品的辩论和分歧的背景。在某种情况下，饱和蓝色可能是某种背景下的正确颜色，而浑浊的棕色可能是另一种背景下的正确颜���。我们不能说图片中存在饱和蓝色通常是欣赏它或将其与没有该颜色的图片相比更喜欢它的原因，即使是pro tanto的原因。当涉及审美原因和判断而不是不经思考的偏好时，认知科学迄今为止对我们的帮助不大。这在某种程度上可能是由于人类认知本身的性质所致。审美原因，只要我们真正拥有它们，就对一般术语的表述高度抵抗（西布利1959年），一旦我们放弃了审美品质仅仅依赖于狭义描述的对象外观（在视觉艺术的情况下是颜色、形状和大小），就没有明显的方法来限制合法影响这些判断的因素。这表明了一个领域，在这个领域里，大致上一切都与一切相关：这是弗多尔（1983年）对认知科学的怀疑所必不可少的同质性。最近的一项研究试图统一自上而下和自下而上的方法。布洛特和雷伯（2013年）发展了一个“心理历史”过程，从对作品的感知对抗开始，通过观众采取设计立场来达到艺术理解，这涉及重构作品的谱系。这种方法遇到了两个困难。首先是他们假设在各个阶段之间的进展主要是通过从感知信号中提取信息来完成的。实际上，作品的外观常常在其历史上是模糊的或误导性的，就像一个作品被精心构造成看起来杂乱无章一样（莱文森2013年；罗斯2013年）。该模型需要承认从讲座和教科书等来源获得的艺术史知识的重要性，这些知识通常在第一阶段之前并且为之提供信息。第二个反对意见涉及人们对艺术作品的假定本质主义假设的角色。布洛特和雷伯认为，欣赏的历史性是由我们对心理本质主义的承诺来解释的，这使我们超越事物的外观来调查其本质（2013年：132）。但是，超越表象的倾向不一定依赖于本质主义；可能是因为一个事物的兴趣或价值有时存在于其关系和偶然属性中（科斯加德1983年）。由于其制作历史而对一个作品进行评价并不意味着作品与其历史之间存在本质联系，就像因为一个物体是爱人的礼物而对其进行评价并不意味着物体与赠送者之间存在本质联系。

### 3. 偏好，判断和理由 <a href="#id-3-pian-hao-pan-duan-he-li-you" id="id-3-pian-hao-pan-duan-he-li-you"></a>

除了旨在引出偏好的研究外，还有一些以经验为基础的理论来解释偏好。最早的理论之一是温特(1874)的建议，即我们认为一种形式美好的程度是由眼睛容易追随轮廓来决定的。最近的研究将这个想法推广开来：当我们对感知或认知掌握轻松时，刺激物被认为是积极的(Reber, Schwarz, & Winkielman 2004)。这种"处理流程的流畅性"的概念不仅限于审美领域；显然，如果一个命题是用韵脚或易于阅读的字体表达的，我们通常会认为它更可信，这被认为是因为这些因素增加了流畅性(Reber & Schwarz 1999; McGlone & Tofighbakhsh 2000)。因此，审美和流畅的现象并不完全一致，一个现象无法归约为另一个现象。至少可以说的是(这并不无关紧要)，某些类型的流畅性是审美愉悦和不愉悦经验的基础，对称性是一个合理的例子；有关这种研究对潜在机制的重要性的评论，请参见下文的[第4节](https://plato.stanford.edu/entries/aesthetics-cogsci/#ArtEmpaNeur)。

审美判断的一种方法是通过流畅性，但有一个担忧是，流畅性似乎鼓励对刺激物进行较不仔细的审查（Song＆Schwarz 2008），这与对艺术的精细辨别态度的审美理想相矛盾。另一个担忧是，基于流畅性的对刺激物的喜好似乎在美学领域之外的简单形状偏好领域具有非常有限的应用。视觉复杂的图片通常受到广泛赞赏，不仅仅是艺术界的精英（例如弗里斯的繁忙流派绘画）。据说从流畅性中获得的快乐是相对于期望的：对巴赫赋格的快乐取决于它比人们期望的更流畅（Reber 2012: 228，引用Hansen，Dechêne和Wänke 2008）。但是，为什么巴赫的爱好者必须对他的音乐的流畅性抱有不切实际的期望？最后（我们将回到这个主题），引用流畅性不会成为欣赏所讨论的图片或赋格的理由；这种方法似乎专注于快乐，而忽视了理性和判断的概念。（有关审美学中流畅性计划的批评，请参见Cochrane 2021a，第2.3节。）

流畅性的另一个方面被称为纯暴露效应：如果我们经常听到某个陈述，重复听到会导致处理过程越来越流畅，我们倾向于认为这个陈述更可信（Begg，Anas和Farinacci 1992）。Cutting（2003）研究了这个想法的审美变体：反复接触一幅图片会增加对它的喜欢程度。据说这可以解释艺术经典的稳定性：在t时期成为经典的作品更容易被看到，而纯暴露效应提高了它们在t + 1时期成为经典的可能性。Cutting并没有声称暴露是影响审美判断的唯一因素，因此接受这个观点并不意味着对审美价值持错误理论的立场。然而，Meskin，Phelan和同事（2013）比较了纯暴露效应对（广泛被评论家认为是）好艺术和坏艺术的影响，发现对好艺术的喜欢程度增加，对坏艺术的喜欢程度减少，这意味着增加的暴露使观察者更加意识到作品的客观特质（另请参见Delplanque等人2015）。在这种情况下，对作品的重要暴露虽然不是它好或坏的理由，但是是判断它可靠性的理由，因此可以说属于审美理由的范畴。Cutting（2017）在提出一些方法上的保留意见的同时，与Meskin等人的研究表达了广泛的一致意见。

最近，美学效果与知觉和认知的普遍特征之间的联系再次受到预测处理理论的强调：即大脑的基本活动是进行预测并根据来自感官的输入信息进行测试和修订，目标是减少预测错误或降低不确定性（关于该理念的哲学应用的调查，请参见Hohwy）。据说积极情感是这种减少的产物，而当不确定性增加时则产生消极情感。据说艺术作品为大脑提供练习，有时是具有挑战性的练习，以减少错误（van de Cruys＆Wagemans 2011）。但是，为什么我们应该寻求更多的预测错误减少练习，而不是世界不断向我们提供的许多练习呢？有什么理由说最终的错误减少超过了艺术作品所提出的初始增加？

然后，我们可以看到，关于经验工作如何阐明我们的审美偏好及其起因的有许多建议，同时对这项工作能否阐明审美判断的规范结构表示疑虑，据称其关注理性并涉及康德式的客观性特征（尽管请参见Meskin，Phelan等人2013年的140-1页）。第二个常见的异议是维特根斯坦式的思考，即仅仅解释现象的起源并不能给予我们哲学所关心的那种解释（Vrahimis 2020）。然而，审美中的理由概念本身值得进行批判性探究，鉴于人们给出的理由常常似乎是虚构的，并且在判断时专注于理由可能会使你成为一个更糟糕的评判者而不是更好的评判者（参见上述提到的Irvin 2014和Lopes 2014，[第1节](https://plato.stanford.edu/entries/aesthetics-cogsci/#Back)）。这个问题也不仅限于审美领域：Hugo Mercier和Dan Sperber（2017年）认为，理性作为公共辩论的工具很有效，但作为个人判断和决策的指引却表现不佳。

### 4. 艺术、共情和神经美学 <a href="#id-4-yi-shu-gong-qing-he-shen-jing-mei-xue" id="id-4-yi-shu-gong-qing-he-shen-jing-mei-xue"></a>

19世纪末的德国美学特别关注解释人类对绘画、雕塑和建筑形式的吸引力。尽管细节解释并不总是容易，但这项工作的更广泛主题包括我们身体和生态环境决定了我们对对称性等事物的审美偏好（Wölfflin 1886），建筑形式如何被赞赏，以及它在促进空间移动方面的能力（Schmarsow 1894），以及美的感觉是如何从我们将外部对象引发的感觉投射到该对象中而产生的（Lipps 1903，有关讨论请参见Currie 2011）。经过长时间的忽视，这些及相关主题已经重新出现在“具身认知”的旗帜下。Freedberg和Gallese（2007）引起了人们对我们的身体倾向于复制雕塑的姿势，产生隐含或模拟的运动，与似乎产生了刷画或凿痕的运动相呼应，与所代表的人物的痛苦产生共鸣的方式的注意。他们说，这些是审美体验中被强调智力主义方法的理论家忽视的内在因素。他们还声称，基于内省报告的这些效应的证据现在可以通过对镜像和规范神经元的大脑处理的经验证实的理论来补充。批评者声称，这种方法忽视了自上而下因素的审美影响（Kesner＆Horáček 2017），并且在许多与艺术的接触中缺乏运动反应（Casati＆Pignocchi 2007：410）。然而，可以说，Freedberg和Gallese只是试图确定某种重要的审美因素，并不需要为其声称独占性或普遍性。艺术形式主义者甚至可能反对这种受限制的主张，认为Freedberg和Gallese所确定的是对格林伯格（1960）所提倡的“纯粹光学”注意力的阻碍（有关请参见Steinberg 1965；Currie 2007）。但在这里，审美规定也不能忽视经验性工作：没有人能达到的审美注意力标准是不值得认真对待的。
...
审美效果与实现它们的机制之间的区别是重要的。以印象派艺术中的闪烁质感为例。据说这取决于视觉系统涉及两个独立的处理流程，并且某些颜色组合仅由其中一个处理（Livingstone 2002）。如果这是一个事实，那么它是否应被视为审美事实？可以说不是。在审美上重要的是体验到的闪烁质感；如果仅通过其他感知处理机制产生了这种闪烁质感，那么与我们的世界相比，在这方面并没有审美上的不同。同样适用于对刺激本身的科学研究；对古代颜料的化学分析可能表明它是一种难以使用的媒介，这对于理解由其手段产生的艺术作品是相关的。但重要的是媒介的难度；发现其化学配方只是为此提供了证据。

### 5. 真实性 <a href="#id-5-zhen-shi-xing" id="id-5-zhen-shi-xing"></a>

长期以来，受康德启发的观点认为审美不关注事物的本质，而是关注它们的表象（例如，Urmson 1957），这种观点有时被称为“审美经验主义”（Currie 1989）。在这种观点下，审美不考虑真实性，真实性取决于历史而不是外观；一幅假的维米尔画作即使在视觉上与真品无法区分，也不会变得真实。一个物体的历史真的与审美无关吗？对艺术、工艺和物品设计感兴趣的人们非常关注物体的历史，并且有论据支持这样的观点：至少某些审美属性的应用取决于对历史的假设。考虑西布利（Sibley）（1959）广泛列举的两个这样的属性：娇嫩和动态。一条被认为是手绘的线条，当被揭示为机器制作时可能不再显得娇嫩，而沃尔顿（Walton）（1970）认为，两件在视觉上无法区分的作品中，一件可以被描述为动态的，而另一件则不是，这取决于它们所属类别的差异（有关视觉艺术的审美经验主义的辩护请参见Zanwill，有关音乐的请参见Dodd；有关真实性或真实性的审美相关性，请参见Korsmeyer 2019）。至少这些例子中的第一个（娇嫩）的建议是，一件事物的审美属性以及拥有这些属性所带来的审美价值，取决于作品所代表的成就类型。对于一个人在某个时间的一个人来说，可能是一个相当大的成就，而对于另一个人来说，可能是一个更大、更小或至少是一个不同的成就，因为他们使用不同的材料或处于不同的艺术文化中（Dutton 1979；Currie 1989；Huddleston 2012；Levinson 2016）；詹姆斯·格兰特（James Grant）（2020）建议我们更好地从作品展示制作者技能的能力来思考，而不是从作品构成制作者成就的角度来思考（参见Currie 2018）。
...
【A】原作与伪造品之间的区别在于它是一种不同类型表演的终点。原作是一种创造性的作品，而伪造品则不是。（Newman & Bloom 2012: 559）

《格尔尼卡》很可能比餐巾素描更具创造性，因此可能更有价值。一个问题是：如果不仅仅基于外观，人们如何评判一幅画的质量？对于一些高度训练有素的专家来说，答案可能是：通过深入了解作品的文化和艺术背景。而我们其他人，在做出判断时，可能依赖于一些捷径，比如“努力启发法”，将努力的证据视为质量的证据。在一个实验中，人们被要求评判图片A和B的相对优劣，当被告知A花费更长时间绘制时，他们倾向于认为A比B更好，而被告知B花费更长时间的群体则更喜欢B。这种效应在专家和普通人中间同样存在，尽管专家是“自我描述的”（Kruger et al. 2004）。

### 6. 图片、想象和感知 <a href="#id-6-tu-pian-xiang-xiang-he-gan-zhi" id="id-6-tu-pian-xiang-xiang-he-gan-zhi"></a>

沃尔海姆（1980）说，图片表现的独特之处在于它能够产生一种特定的体验：“在图片中看到主题”。对于许多人来说，这似乎捕捉到了关于描绘性表现本质的重要之处，尽管沃尔海姆对此的具体论断存在争议。究竟什么是“在图片中看到”？随后的一个建议是，当我们在图片中看到某个物体 X 时，我们会体验到图片中可见的轮廓形状与 X 从同一视角呈现的轮廓形状之间的相似之处（霍普金斯1998年；有关类似提议，请参见皮科克1987年）。另一个建议是，当我们被图片促使去想象我们看到的图片是 X 的一种看法时，我们在图片中看到了 X（沃尔顿1992年）。认知科学能否帮助我们在这个领域裁决竞争理论之间的争议？看起来，这些明显是哲学理论在经验问题上有所承诺，尽管有些含糊不清。当然，我们不能仅凭坐在舒适的椅子上解决图片感知是否依赖于想象力的问题。科学家们已经在确定与某些功能、情感和感知形式有关的大脑区域方面取得了很大进展，这些都是很好的例子。但我们无法同样地定位想象活动，并且可能存在一个原则性的障碍阻止我们这样做；有一些理由认为，想象活动并没有专门的机制，而是涉及到为其他目的而设计的系统的重复使用。这个问题一直是关于我们如何理解他人思维的辩论的核心争议，这个辩论最初是以理论理论和模拟理论两种对立观点的形式出现的，尽管其他方法也已经出现（加拉格尔和胡托2008年）。理论理论将我们归因于对他人的心理状态、它们与行动的联系等方面的（或许是隐含的）理论，我们从中推导出行为的预测和解释（福多尔1992年；卡鲁瑟斯1996年）。相比之下，模拟主义认为我们有能力使用我们自己的推理和决策的心理系统来模拟他人的思想和决策（戈登1986年）。虽然希尔强调了她认为的“先验”原则，即当我们研究另一个人的思维时，我们必须在我们自己的思维中再现所思考的命题的内容和逻辑关系（1986年），但其他人已经发展出了一个以经验为导向的版本，假设了可以将实践和理论推理“脱离线下”，或者与经验输入和行为输出脱离联系的因果机制（A. I.戈德曼1989年）。有人提出，模拟方法在���大程度上以这种经验为导向的方式，使我们能够解释我们对虚构作品的兴趣和反应（Currie & Ravenscroft 2002年）。关于因果有效的心理结构的问题在其他审美辩论中也起到了一定的作用，比如解释我们如何能够沉浸在叙事中（Schellenberg 2013年），以及对我们感知为道德或其他方面有问题的故事抵制想象参与的相反倾向（Weinberg & Meskin 2006年；Miyazono & Liao 2016年）。

尽管其中一些想法附带有详细的“盒子学”描述了提案的认知实施，但它们通常是在对心灵结构的哲学和推测性研究中产生的，其中的证据最多也只是非常间接的。一个例外是对沃尔海姆（1998年）关于图片感知中的双重性的经验确认的建议，根据这个建议，观众同时意识到图片的表面特征和所描绘的内容。特别地，有人认为：

> 沃尔海姆所谈到的图片的双重体验对应着我们对图片表面的背侧视觉处理和对所描绘场景的腹侧视觉处理之间的二分法。（Nanay 2011: 464）

支持这个观点的证据来自于那些患有腹侧处理损伤的人在解读图片内容时常常遇到困难，而在感知图片表面的普通属性方面却没有相应的困难（Turnbull, Driver, & McCarthy 2004）。这说明了机制研究如何进一步推动审美探究的另一种方式。在这种情况下，一个审美现象——双重性被假设出来，问题是是否有一个合理的解释来说明它是如何实现的。如果没有这样的解释，就会对这个观点产生怀疑。

### 7. 情感 <a href="#id-7-qing-gan" id="id-7-qing-gan"></a>

审美思维中有很多关于其吸引情感能力的限制的争论。其中有两个问题特别值得注意，一个是描述性的，另一个在一定程度上是规范性的。首先，关于我们对虚构作品（显然）情感反应的事实是什么？我们真的钦佩、鄙视或同情我们知道不存在的人吗？这听起来像是一个经验性问题，也许可以通过对受虚构作品吸引的人的大脑进行研究来解决。但是这种方法的前景不佳，不仅因为数据收集方面的实际困难（参见Cova＆Teroni 2016），还因为否认我们同情安娜·卡列尼娜的人并不否认读者可能展示出与该情感相伴随的所有生理迹象。他们声称真正的恐惧在这种情况下缺乏认知成分：对恐惧对象的信念。假设我们能够实证地证明托尔斯泰的读者在不相信安娜·卡列尼娜的存在，而是具有“想象安娜存在”的认知状态的情况下，确实经历了与同情相关的所有生理状态。哲学问题仍然存在：具有这种心理特征的人是否真正处于同情的状态，还是他们的状态仅仅是沃尔顿（1978）所称的“准同情”，它包括了同情的典型生理和心理反应，但由于不具备对其对象的信念或典型的相应行动倾向，因此不足以成为完全成熟的同情？此时，我们可能会想知道关于恐惧和同情的实质性问题是否只是关于标签的问题。然而，有一些间接涉及该问题的经验考虑因素。Gendler和Kovackovick认为，关于情感进化适应功能的合理假设反对了恐惧需要信念的观点。从达尔文的观点来看，我们的情感很可能不仅仅是通过其避免我们遭遇当前危险的能力来塑造的，而且还通过避免可能的危险来塑造的。想象在森林中潜伏着一个危险的生物可能足以让我选择更安全的路线，提高我生存和传递基因的机会。如果想象中的危险是恐惧被选择和保留的原因之一，为什么要坚持认为对虚构作品中想象的生物和事件的反应仅仅是沃尔顿（1978）所称的“准恐惧”？有关审美和进化思维之间的其他联系，请参见下文的第9节。

当我们考虑对音乐的反应时，会出现类似的问题。我们有时会说悲伤的音乐使我们感到悲伤，尽管音乐并没有给我们任何理由认为发生了什么悲伤的事情（悲伤的音乐有时会让我们想起悲伤的事件，但这不是悲伤音乐影响我们的情况的普遍特征）。在这种情况下，想象力似乎不太有帮助；与虚构叙述不同，情感影响的音乐通常不会为我们提供想象某种悲伤事件的材料。Kivy认为，听悲伤音乐的人的悲伤（如果有的话）与音乐欣赏无关，实际上在符合他所偏爱的音乐听取模式的听取过程中不会发生（这种模式要求专注于音乐的结构、现象学和表现特性）（1990年：第8章）。然而，Kivy并不否认音乐听取可以并且确实应该是一种深刻的情感体验；我们可能会被作品所代表的构成和表演品质所淹没。一些人试图通过提供音乐确实能够引发其所表达的情感或情绪的证据来对Kivy进行经验上的挑战（Sizer 2007）。但是，Kivy仅否认了对经典音乐听取情况的可能性，并表示没有理由认为相关实验中的受试者是以Kivy所指的经典方式进行听取的（2007年）。当然，要控制实验条件以排除Kivy所指的非经典听取方式并不容易（另请参见Kivy 2006；Carroll 2003；Carroll＆Moore 2007）。然而，如果实验测试始终提供与音乐所表达的情感一致的情感产生的证据，仅仅说我们尚未测试到正确的听众是不够的。Kivy的支持者必须找到符合他所赞同的听取方式的强有力实例，并且不能仅仅依赖那些支持他理论的人的个人证词。毕竟，我们认为Kivy的理想听取模式是一个可以实现的目标。Zangwill 2004代表了一种不愿容纳情感的形式主义；有关形式主义立场的更有限的辩护，请参见Cochrane 2021b。
...
### 8. 文学与文学语言的审美 <a href="#id-8-wen-xue-yu-wen-xue-yu-yan-de-shen-mei" id="id-8-wen-xue-yu-wen-xue-yu-yan-de-shen-mei"></a>

在二十世纪后半叶，文学的理论和解释研究对认知和审美探究持有一定的敌意，常被认为与严肃的解释工作无关，是对偏爱的政治议程的一种干扰。文学的认知研究在过去二十年中有所发展，但仍然是少数派的事业（Hartner 2017）。长期以来，心理学、文学研究和审美学界一直关注的一个问题是，我们是否能从文学中了解到超越文本的世界，这个想法在受到解构主义或后现代理论影响的人中间受到了一些怀疑，他们认为这样的抱负依赖于未能意识到虚构人物并非真实人物，也不像真实人物（Cixous 1974）。还有人认为，即使存在这样的认知益处，它们在审美上也不相关（Lamarque＆Olsen 1994：第17章；有关批评请参见Gaut 2007：第7章；Currie 2020：§9.6）。然而，人们普遍倾向于认为，例如莎士比亚的戏剧的艺术价值部分取决于我们对其揭示人类状况深刻洞察力的感知。其他艺术形式也有类似的说法；在思考梵高的石版画《悲伤》时，肯德尔·沃尔顿指出，通过想象性地回应这个女人，他“对某种悲伤有了一种理解”（2008：78）。

最近有人努力测试文学是否偶尔提供认知益处的观点。有人声称接触小说——即使只是阅读一次——可以显著提高共情和心智理论能力（Kidd＆Castano 2013）；如果这些效果是真实的，似乎规模很小，并且声称的结果很难复制（Panero等人2016；Kidd＆Castano 2019）。这个不断发展的领域中的其他研究也没有指向一个单一的方向。一些研究表明，小说有能力改善社会认知的某些方面（Calarco等人2017；Mar 2018a，b），而其他研究则发现没有这种效果（例如，Wimmer等人2021a，b；有关一般讨论，请参见Currie 2020；第9-11章）。声称小说具有教育效果的人文学者可能会回应说，这些效果是缓慢而累积的，并且在单次阅读的研究中不太可能看到；测试这些主张将是困难的。但是，他们的主张仍然是经验性的。

在文学的认知研究中，还有其他关于情感反应的调查。虽然审美学家倾向于关注我们对虚构作品的情感反应的明显“矛盾”方面（例如，为什么我们会被不存在的事物所感动，参见上文[第7节](https://plato.stanford.edu/entries/aesthetics-cogsci/#Emot)），但认知科学的研究人员已经开始更广泛地尝试理解各种情感在生成和维持叙事和诗歌中的兴趣中的作用（Menninghaus，Wagner，Wassiliwizky等人2017）；Jenefer Robinson（2005）的工作是审美学领域内从事这一更广泛抱负的例子，同时受到经验性工作的强烈启发。最近，Kukkonen（2020）尝试将读者对情节发展感到惊讶的预期与感知和认知的预测处理方法相结合（参见上文[第3节](https://plato.stanford.edu/entries/aesthetics-cogsci/#PrefJudgReas)）。目前尚不清楚预测处理理论是否能够在审美上对读者的体验提供相关的启示，而不仅仅是提供涉及机制的解释（参见上文[第4节](https://plato.stanford.edu/entries/aesthetics-cogsci/#ArtEmpaNeur)）。

一个引人注目的例子是长期被认为是抵制来自艺术和审美领域以外的理论的领域，即文学语言。对于我们认为是诗歌、戏剧和小说独特语言的洞察力，传统上是从那些专门研究文学而非发展一般沟通理论的人士那里寻求的，这一观点得到了彼得·拉马克的认可，他认为将文学作品视为类似于书信写作或政治演讲等日常言说类型的观点是“完全误解的”（拉马克2007年：34）。但是，倡导“相关性理论”的人，这是格赖斯语用学的自然倾向发展，他们反对文学语言有任何根本上特殊或自主的东西，声称：

> 与比喻性言述传统上相关的文体和诗意效果是在追求相关性的过程中自然产生的，并不需要对普通字面言述的解释提出特殊要求。（D.威尔逊2018年：191）

（寻求关联理论的实证确认的工作，请参见Happe 1993；Sperber＆Wilson 2002；van der Henst，Carles＆Sperber 2002；Noveck＆Posada 2003；以及van der Henst＆Sperber 2004）。

关联理论的一个目标是鼓励我们看到语言的“诗意用法”，其中一个思想通过使用的词语间接地暗示出来，这样的用法不像我们认为的沟通范式那样边缘化，即一个代理人发出的句子恰好意味着发言者希望传达的内容。关联理论家说，这种字面意义的情况很少或不存在，并且不构成任何沟通理想的形式。他们指出了“弱蕴涵”的普遍现象：听众从话语中得出一系列结论，其中一些显然是有意的，但其他一些更难以确定是否有意（Sperber＆Wilson 1995：197-9）。从这个观点来看，即使在平凡的情况下，所指的全部意义也只能模糊地确定，并且如果我们费心去调查，将会遇到与诗歌批评中发现的同样无法解决的争议。并不需要得出结论，即诗意话语完全与围墙外的对话一致；关联理论家的观点是，差异只是程度上的，而不是本质上的。

### 9. 审美判断与进化 <a href="#id-9-shen-mei-pan-duan-yu-jin-hua" id="id-9-shen-mei-pan-duan-yu-jin-hua"></a>

在过去的两百万年里，关于人类进化的理论受到了非常不完整的化石记录和软组织迅速消失的事实的严重限制。尽管这些限制存在，但令人惊讶的是，认知理论已经深入到非常遥远的过去，尽管其主张被普遍认为是高度临时的。研究两百万年前或更久远的石器制品是一项重要的资源，这些制品保存得非常完好，并且数量众多。我们能够重建关于它们制作方法的很多信息，并以相对明确的方式推测所需的认知能力。基于这些推测，石器制造的创新被与语言的发展联系起来（Higuchi等，2009年）。

审美判断和进化方法相交的任何主题都可能被以两个问题为导向来探讨。

1. 艺术创作及相关活动的出现和发展是否完全或很大程度上可以用文化因素来解释，还是存在着重要的生物学成分？ 2. 艺术创作是一种适应性行为还是与可能具有适应性优势的发展相关的非适应性结果（或其他原因）？

可能有人认为第二个问题只有在回答第一个问题时给予生物学重要的解释角色时才会出现。但是，文化决定的“表型”也可以是适应性的、不适应性的或中性的。烹饪，当然是一种文化创新，具有很高的适应性，并且已经导致了肠道大小和可能的大脑大小的显著变化（Godfrey-Smith 2013；对于与大脑大小的关系持怀疑态度，请参见Cornélio等人的研究2016）。人类的生物和文化进化密切相关。

关于在人类审美活动中是否存在生物解释的角色的问题，有一些学者对这个想法持敌对态度；他们认为“艺术”和“审美”是最近和本质上西方的发明，将其应用于其他和更古老的文化是错误的（Gell 1998：97）。这种观点的反对者很容易承认审美活动的巨大文化变异性。他们认为，不同文化在物体的塑造和装饰、音乐、舞蹈和讲故事的方式之间存在足够的共同点，使得生物学为这些活动提供了初始推动力和一组约束（Dutton 2009；Currie 2012）。如果我们曾经认为这些活动的起源不过是欧洲上旧石器时代洞穴壁画，那么审美活动可能太晚出现，没有生物学基础。最近的发现已经提出了一个稍早的起源；印度尼西亚的壁画可以追溯到45,000年前（Brumm等人的研究2021）。然而，如果我们将注意力转向上面提到的石器工具，审美活动的时间深度将大大增加，其中许多工具显示出显著的对称性。大约1.7百万年前出现的Acheulean工业的手斧有时过大、过小或过尖，不适合实际使用，强烈暗示了对熟练制作的展示的兴趣，我们通常在欧洲文艺复兴时期的艺术中认可（参见Currie和Zhu 2021以及Gowlett 2021，两者以不同的方式强调审美实践在社会背景中的重要性）。有人将这些精心制作的工具视为性选择的产物，就像孔雀的尾巴一样：它们可靠地表明制作者作为配偶的品质（Kohn和Mithen 1999）。另一种观点认为它们是可信度的指标，因此也是作为合作者的价值的指标（Spikins 2012）；对于这两种观点的批评，请参见Hiscock 2014。

手斧与孔雀的尾巴不同，它们与身体分离，因此可以从一个人传递给另一个人，这是怀疑它们作为特定个体适合作为配偶的信号可靠性的一个原因。当涉及到身体本身的对称性时，这个反对意见不适用，身体尤其是面部的对称性被提供作为进化调整我们感知的例子，因为它是繁殖伴侣健康的指标。然而，很难找到有力的证据。最近的一项研究“不支持面部对称性作为生理健康可靠线索的观点”（Pound等人，2014年；另见Kalick等人，1998年），另一项研究表明“几乎没有证据表明女性外貌预测健康”（Foo等人，2017年；这项研究确实支持男性面部外貌与生育力之间的联系）。关于伦理论证，以及通过经验发现，我们应该重新思考对人类外貌审美的标准方法，请参见Irvin 2017年。

值得注意的是，即使对审美兴趣的出现进行了非常早期的定位，也不能确定它们具有生物学起源；阿舍尔时期似乎以高水平的计划和组织为特征，表明存在强烈的社会关系（Hiscock 2014年）。从这个意义上说，审美活动可能是一种文化衍生的“技术”，就像写作一样，而不是一种适应性，就像语言可能是的（S. Davies 2012年：第10章）。根据这个假设，我们能解释为什么年幼的孩子如此容易接受绘画和唱歌等形式的审美活动吗？相比之下，学习写作是需要努力和对教育的巨大投入的。最近的研究（Heyes 2021年）试图重塑我们对所学内容的假设，认为人际理解这样一个早期且可靠发展的能力实际上是一种社会获得的“小工具”（Heyes＆Frith 2014年）。除此之外，我们还注意到，一个开始作为小工具或技术的东西，在某些情况下可能完全或部分受到基因控制。这种所谓的“鲍德温效应”，在进化思维中曾经被鄙视，最近引起了兴趣（Weber＆Depew 2003年）。它提出了一种机制，通过这种机制，获得的特征可以在生物遗传中传递，而不是直接传递给下一代的拉马克主义观念。例如，如果学习一项技能带来了优势，可能会有选择性压力来减轻学习的负担和不确定性，通过使技能或其组成部分成为先天的（Papineau 2005年）。鉴于文化和生物进化之间的多重交叉路径，关于审美兴趣的起源，除了我们在50多万年前的人类群体中看到的证据之外，很难有明确的说法。

我们现在转向第二个问题：艺术创作是一种适应还是一种与之相关的非适应性结果，它们本身可能具有适应性优势？或者完全是其他原因？关于这个问题，一些观点相当强烈且相互对立；一些人认为描绘、讲故事和音乐的发展对社会凝聚力至关重要（Dissanayake 1992, 2000, 2017），或者对伴侣选择至关重要（Miller 2000; Dutton 2009；有关批评可以参见C. Wilson 2016），其他人则认为美学艺术品的创作并不具有适应性优势，而是因为它们对于大脑中为其他目的而产生的感知和其他机制提供了奖励（Pinker 1997）。从一个稍微不同的角度来看，有人提出我们最好将人类审美活动看作是植物和动物世界中普遍存在的信号传递和操纵的延续。这个想法的一个有趣之处在于，它取代了传统的艺术品美学与自然美学之间的区别，将艺术品与动物呼叫和花朵着色等自然实体之间进行区分，并将石头、日落和夜空等自然对象归为另一类，这些自然对象“与其感知评估的共同演化没有关系”（Prum 2013: 821；另请参见De Tiège、Verpooten、& Braeckman 2021）。目前尚不清楚我们是否已经了解足够多的信息来决定可行的选择（S. Davies 2012: ch. 12；对于小说的情况，参见Currie 2020；§7.4）。但是，决定艺术创作是否具有适应性能推动审美探究的进程吗？这是值得怀疑的。关于艺术是否是一种适应性的问题涉及到我们现在拥有艺术的原因是否是因为它对我们物种的适应性有所贡献。这可能是真实的，即使同时也可能是真实的，艺术现在没有以通常声称的方式丰富我们的生活-给予愉悦，教育我们的情感，教导我们道德。而且，艺术现在可能具有所有这些优势，同时却是进化上的无关因素。同样，即使艺术最初不具有适应性，但它在某个阶段可能已经变得适应（“旁适性”），并且现在可能是适应性的。不同的答案可能适用于不同的艺术形式。有人说，小说是一种特别适合发展我们的共情和心灵阅读能力的方式（Nussbaum 1990, 1995；Mar and Oatley 2008）；也许这些优势直到18世纪或19世纪才出现。虽然用进化的角度提出关于艺术的问题当然具有科学上的兴趣，但对美学家来说，更重要的是艺术目前和历史上所体现的价值观，以及我们当前和历史上对这些价值观的反应方式。

### 10. 环境的审美学 <a href="#id-10-huan-jing-de-shen-mei-xue" id="id-10-huan-jing-de-shen-mei-xue"></a>

我们对自然和人造环境的审美进行了简要的讨论，并以对这一领域中审美和认知相关工作的简要选择作为结论。这些讨论大部分延续了进化的主题。需要注意的是，其中一些工作依赖于人们对环境图片的反应，而不是对环境本身的反应，这使得人们对环境和对其表现的反应有多少存在不确定性。

对环境偏好的实证研究长期以来一直是规划者们感兴趣的课题，它主要代表了上述自下而上的研究模式（参见[第2节](https://plato.stanford.edu/entries/aesthetics-cogsci/#BottUpTopDownApprAest)），因为其目的是发现人们普遍喜欢什么，而不是根据鉴赏家和哲学家的规范限制来评估他们的喜好。研究的主题包括不同年龄组、种族、教育和收入群体之间的偏好差异（例如，Kaplan＆Talbot 1988）。经常得出的一个结论是，即使在自己历史上稳定的栖息地与之截然不同的社区中，人们普遍、甚至普遍地偏好大草原景观，并且这种偏好体现在公园和花园的设计中（Falk＆Balling 2010）。进一步声称，这是我们在东非环境中进化发展的产物（E. O. Wilson 1975是这个想法的早期来源）；有关详细讨论、参考文献和一些保留意见，请参见S. Davies 2012年第6章。
