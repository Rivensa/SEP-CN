...
长期以来，受康德启发的观点认为美学关注的不是事物的本质，而是它们的表象（例如，Urmson 1957），这种观点有时被称为“美学经验主义”（Currie 1989）。根据这种观点，美学不关注真实性，真实性取决于历史而不是外观；一幅假的维米尔画作即使在视觉上与真品无法区分，也不会变得真实。一个物体的历史真的与美学无关吗？对艺术、工艺和工艺品设计感兴趣的人们非常关注物体的历史，并且有论据支持这样的观点：至少一些美学属性的应用取决于对历史的假设。考虑西布利（Sibley）（1959）广泛列举的两个这样的属性：*娇嫩_和_动态*。当一条线被认为是手绘时，它可能被视为娇嫩，但当它被揭示为机器制作时，它可能不再如此，而沃尔顿（Walton）（1970）认为，两件在视觉上无法区分的作品中，一件可以被描述为动态的，而另一件则不是，这取决于它们所属类别的差异（有关视觉艺术的美学经验主义的辩护请参见 Zanwill，有关音乐的请参见 Dodd；有关真实性或真实性的美学相关性，请参见 Korsmeyer 2019）。至少这些例子中的第一个（*娇嫩*）的建议是，一件事物的美学属性以及拥有这些属性所带来的美学价值，取决于作品所代表的成就类型。对于一个人在某个时间所取得的成就来说，可能对另一个人来说是更大、更小或至少是不同的成就，因为他们使用不同的材料或处于不同的艺术文化中（Dutton 1979；Currie 1989；Huddleston 2012；Levinson 2016）；詹姆斯·格兰特（James Grant）（2020）建议我们更好地从作品展示制作者技能的能力来思考，而不是从作品构成制作者成就的角度来思考（参见 Currie 2018）。
...
支持这个观点的证据来自于那些患有腹侧处理损伤的人在解读图片内容时常常遇到困难，而在感知图片表面的普通属性方面却没有相应的困难（Turnbull, Driver, & McCarthy 2004）。这说明了机制研究如何进一步推动美学探究的另一种方式。在这种情况下，美学现象——这里是双重性——被假设出来，问题就出现了，即是否存在一个合理的解释来说明这是如何实现的。如果没有这样的解释，就会对这个观点产生怀疑。

## 7. 情感

美学思维的很大一部分已经用于讨论其吸引情感的能力的限制。有两个问题特别值得注意，一个是描述性的，另一个在一定程度上是规范性的。首先，关于我们对（显然）虚构作品的情感反应的事实是什么？我们真的钦佩、鄙视或怜悯我们知道不存在的人吗？这听起来像是一个经验性问题，也许可以通过对受虚构作品吸引的人的大脑进行研究来解决。但是这种方法的前景不佳，不仅因为数据收集存在实际困难（参见 Cova＆Teroni 2016）。那些否认我们怜悯安娜·卡列尼娜的人并不否认读者可能表现出与这种情感相伴随的所有生理迹象。他们声称真正的恐惧在这种情况下缺乏认知成分：对恐惧对象的信念。假设我们能够实证地证明托尔斯泰的读者在不相信安娜·卡列尼娜的存在，而是具有“想象安娜存在”的认知状态的同时，确实经历了与怜悯相关的所有生理状态。哲学问题仍然存在：具有这种心理特征的人是否真正处于怜悯的状态，还是他们的状态仅仅是沃尔顿（1978）所称的“准怜悯”，它包括怜悯的典型生理和心理反应，但由于不伴随对其对象的信念或对应的典型行动倾向而不完全是真正的怜悯？此时，我们可能会想知道看似关于恐惧和怜悯的实质性问题是否只是关于标签的问题。然而，有一些间接涉及该问题的经验考虑。根德勒和科瓦科维克认为，关于情感进化适应的合理假设反对了恐惧需要信念的观点。从达尔文的观点来看，我们的情感很可能不仅仅是通过避免当前危险来塑造的，而且还通过避免可能的危险来塑造的。想象一个潜伏在森林中的危险生物可能足以让我选择更安全的路线，提高我生存和传递基因的机会。如果想象中的危险是恐惧被选择和保留的原因之一，为什么要坚持认为对虚构作品中想象的生物和事件的反应仅仅是沃尔顿（1978）所称的准恐惧？有关美学与进化思维之间的其他联系，请参见下文的[第 9 节](https://plato.stanford.edu/entries/aesthetics-cogsci/#AestEvol)。

当我们考虑对音乐的反应时，会出现类似的问题。我们有时会说悲伤的音乐让我们感到悲伤，尽管音乐并没有给我们提供任何理由认为发生了什么悲伤的事情（悲伤的音乐有时会让我们想起悲伤的事件，但这并不是悲伤的音乐影响我们的普遍特征）。在这里，对想象力的诉求似乎不太有帮助；与虚构叙述不同，情感影响的音乐通常不会为我们提供想象某种悲伤事件的材料。Kivy 认为，对于那些听悲伤音乐而感到悲伤的人来说，这种悲伤是与音乐欣赏无关的，而且在符合他所偏爱的音乐听取模式的听取过程中，这种悲伤也不会发生（这种模式要求对音乐的结构、现象学和表现特性进行独占性关注）（1990 年：第 8 章）。然而，Kivy 并不否认音乐听取可以并且应该是一种深刻的情感体验；我们可能会被作品所代表的构图和表演特质所淹没。一些人试图通过提供音乐确实能够引发其所表达的情感或情绪的证据来挑战 Kivy 的观点（Sizer 2007）。但是，Kivy 仅否认了这种可能性适用于经典音乐听取的情况，并表示没有理由认为相关实验中的受试者是以这种经典方式进行听取的（2007 年）。当然，要控制实验条件以排除 Kivy 所说的非经典听取方式并不容易（另请参见 Kivy 2006；Carroll 2003；Carroll＆Moore 2007）。然而，如果实验测试确实始终提供与音乐所表达的情感一致的情感生成证据，仅仅说我们尚未测试到正确的听众是不够的。Kivy 的支持者必须找到符合他所赞同的听取方式的强有力实例，并且不能仅仅依赖那些支持他理论的人的个人证词。毕竟，我们认为 Kivy 的理想听取方式是一个实际可实现的目标。Zangwill 2004 代表了一种不愿容纳情感的形式主义；有关形式主义立场的更有限的辩护，请参见 Cochrane 2021b。
...
一个引人注目的例子是长期被认为抵制来自艺术和美学领域之外的理论的领域，即文学语言。对我们认为是诗歌、戏剧和小说独特语言的洞察力传统上是从那些专门研究文学的人士那里寻求的，而不是从那些发展通用沟通理论的人士那里寻求的，这一观点得到了 Peter Lamarque 的支持，他认为将文学作品视为类似于书信写作或政治演讲等日常流派的观点是“完全错误的”（Lamarque 2007: 34）。但是，倾向于自然主义的 Grice 语用学发展的“关联理论”的支持者们拒绝了文学语言有任何根本特殊性或自主性的观点，声称

> 美学与认知科学中传统上与比喻性言辞相关的文体和诗意效果自然地在追求相关性的过程中产生，并不需要特殊处理，也不需要对普通字面言辞的解释进行特别要求。（D. Wilson 2018: 191）

（有关寻求相关性理论的实证确认的研究，请参见 Happe 1993; Sperber & Wilson 2002; van der Henst, Carles, & Sperber 2002; Noveck & Posada 2003; 和 van der Henst & Sperber 2004）。

一个相关性理论的目标是鼓励我们将语言的“诗意用法”视为不那么边缘化，其中一个观念通过所使用的词语间接地暗示出来，而不是我们认为通信范式是代理人发出一个句子，该句子恰好意味着发言者希望传达的内容。相关性理论者认为，这种字面意义的情况很少或不存在，并且不构成任何形式的沟通理想。他们指出了“弱蕴涵”的普遍现象：听众从话语中得出一系列结论，其中一些显然是有意的，但其他一些更难以确定是否有意（Sperber＆Wilson 1995：197-9）。从这个观点来看，即使在平凡的情况下，所意味的总体也只能模糊地确定，并且如果我们费心去调查，将会面临与我们在诗歌批评中发现的同样无法解决的争议。并不需要得出结论，诗意的话语完全与墙外的对话一致；相关性理论者的观点是，差异只是程度上的差异，而不是本质上的差异。

## 9. 美学与进化

过去两百万年的人类进化理论受到非常不完整的化石记录和软组织迅速消失的事实的严重限制。鉴于这些限制，令人惊讶的是认知理论在非常遥远的过去已经取得了很大的进展，尽管各方对其主张普遍认为是高度临时的。研究两百万年或更久的石器制品一直是一项重要的资源，这些制品保存得非常好，并且数量众多。我们能够重建关于它们制造方法的很多信息，并且可以以相对明确的方式推测它们所需的认知能力。基于这些推测，石器制造的创新与语言的发展有关（Higuchi 等，2009）。

任何美学和进化方法相交的主题都可能以两个问题为导向。

1. 艺术创作及相关活动的出现和发展是否完全或很大程度上可以用文化因素来解释，还是存在着重要的生物因素？
2. 艺术创作是一种适应性行为还是一种非适应性发展的结果（或其他什么）？

可能有人认为第二个问题只有在回答第一个问题时给予生物学重要的解释角色时才会出现。但是，文化决定的“表型”也可以是适应性的、不适应性的或中性的。烹饪，当然是一种文化创新，具有很高的适应性，并且已经导致了肠道大小和可能的大脑大小的显著变化（Godfrey-Smith 2013；对于与大脑大小的关系持怀疑态度，请参见 Cornélio 等人的研究 2016）。人类的生物和文化进化密切相关。

关于在人类审美活动中是否存在生物解释的问题，有一些学者对这个观点持敌对态度；他们认为“艺术”和“审美”是最近和本质上西方的发明，将其应用于其他和更古老的文化是错误的（Gell 1998：97）。这种观点的反对者很容易承认审美活动的巨大文化变异性。他们认为，在非常不同的文化中，人们在物体的塑造和装饰、音乐、舞蹈和讲故事方面的投资方式之间存在足够的共同点，这使得生物学为这些活动提供了初始推动力和一组约束是合理的（Dutton 2009；Currie 2012）。如果我们曾经认为这些活动只能追溯到欧洲上旧石器时代的洞穴描绘，那么审美活动可能太晚出现，没有生物学基础。最近的发现现在已经提出了一个稍早的起源；印度尼西亚的描绘作品被认为可以追溯到 45,000 年前（Brumm 等人的研究 2021）。然而，如果我们将注意力转向上面提到的石器工具，审美活动的时间深度将大大增加，其中许多工具显示出显著的构造对称性。大约 1.7 百万年前出现的 Acheulean 工业的手斧有时过大、过小或过尖，不适合实际使用，强烈暗示了对熟练制作的展示的兴趣，我们通常在欧洲文艺复兴时期的艺术中认可（参见 Currie 和 Zhu 2021 以及 Gowlett 2021，两者以不同的方式强调审美实践在社会背景中的重要性）。有人将这些精心制作的工具视为性选择的产物，就像孔雀的尾巴一样：它们可靠地表明制作者作为配偶的品质（Kohn 和 Mithen 1999）。另一种观点认为它们是可信度的指标，因此也是作为合作者的价值的指标（Spikins 2012）；对于这两种观点的批评，请参见 Hiscock 2014。

手斧与孔雀的尾巴不同，它们与身体分离，因此可以从一个人传递给另一个人，这是怀疑它们作为特定个体适合作为配偶的信号可靠性的一个原因。当涉及到身体本身的对称性时，这个反对意见不适用，身体尤其是面部的对称性被认为是进化调整我们感知的一个例子，因为它是繁殖伴侣健康的指标。然而，很难找到有力的证据。最近的一项研究“不支持面部对称性作为生理健康可靠线索的观点”（Pound 等人，2014 年；另见 Kalick 等人，1998 年），另一项研究表明“几乎没有证据表明女性外貌预测健康”（Foo 等人，2017 年；这项研究确实支持男性面部外貌与生育力之间的联系）。关于伦理论证，以及通过经验发现，我们应该重新思考对人类外貌美学的标准方法，请参见 Irvin 2017 年。

值得注意的是，即使对审美兴趣的出现进行了非常早期的定位，也不能确定它们具有生物学起源；阿舍尔时期似乎以高水平的计划和组织为特征，表明存在强烈的社会关系（Hiscock 2014 年）。从这个意义上说，审美活动可能是一种文化衍生的“技术”，就像写作一样，而不是一种适应性，就像语言可能是的（S. Davies 2012 年：第 10 章）。根据这个假设，我们能解释为什么年幼的孩子如此容易接受绘画和唱歌等形式的审美活动吗？相比之下，学习写作是需要努力和对教育的巨大投入的。最近的研究（Heyes 2021 年）试图重新塑造我们对所学内容的假设，认为人际理解这样一个早期且可靠发展的能力实际上是一种社会获得的“小工具”（Heyes＆Frith 2014 年）。除此之外，我们还注意到，一个开始作为小工具或技术的东西，在某些情况下可能完全或部分受到基因控制。这种所谓的“鲍德温效应”，在进化思维中曾经被鄙视，最近引起了兴趣（Weber＆Depew 2003 年）。它提出了一种机制，通过这种机制，后天获得的特征可以在生物遗传中传递，而不是直接传递给下一代的拉马克主义观念。例如，如果学习一项技能带来了优势，可能会有选择性压力来减轻学习的负担和不确定性，通过使技能或其某些组成部分成为先天的（Papineau 2005 年）。鉴于文化和生物进化之间的多重交叉路径，关于审美兴趣的起源，除了我们在 50 多万年前的人类群体中看到的证据之外，很难有明确的说法。

我们现在转向我们的第二个问题：艺术创作是一种适应还是一种非适应性的发展结果，这些发展本身可能具有适应性优势？还是完全不同的东西？关于这个问题已经表达了强烈而相反的观点；有人认为描绘、讲故事和音乐的发展对社会联系至关重要（Dissanayake 1992, 2000, 2017）或配偶选择（Miller 2000；Dutton 2009；对此的批评见，例如，C. Wilson 2016），还有人说美学艺术品的创作并没有适应性优势，而是因为它们为我们的感官和其他心理机制提供了奖励，这些机制是为了完全不同的目的而产生的（Pinker 1997）。从一个稍微不同的角度来看，有人建议我们最好将人类美学活动视为植物和动物世界中普遍存在的信号和操纵实践的延续。这个想法的一个有趣特点是，它取代了传统的艺术品美学和自然美学之间的区别，而是将艺术品和动物的呼叫和花朵的颜色等自然实体与岩石、日落和夜空等自然物体区分开来，后者“与对它们的感官评价不共同进化”（Prum 2013: 821；参见 De Tiège、Verpooten 和 Braeckman 2021）。目前尚不清楚我们是否已经了解足够多以决定可用的选择之间的区别（S. Davies 2012: ch. 12；对于小说的情况，Currie 2020；§7.4）。但是，确定艺术创作是否具有适应性能否推动美学研究的进展？这是值得怀疑的。关于艺术是否是一种适应性的问题涉及到我们现在拥有艺术的原因是因为它对我们物种的适应性有所贡献。这可能是真实的，而不一定是艺术现在以任何常见方式丰富我们的生活-带来快乐，教育我们的情感，教导我们道德。而且艺术现在可能具有所有这些优势，同时又是一种进化上的无关紧要。同样，即使艺术最初并不具有适应性，它在某个阶段可能已经变得适应性（“外适应”），并且现在可能是适应性的。不同的答案可能适用于不同的艺术形式。据说小说是一种特别适合锻炼我们的共情和心理阅读能力的方式（Nussbaum 1990, 1995；Mar and Oatley 2008）；也许这些优势直到 18 世纪或 19 世纪才出现。虽然以进化的角度提出的关于艺术的问题当然具有科学意义，但对美学家来说，更重要的可能是艺术当前和历史上所体现的价值观以及我们当前和历史上对这些价值观的反应方式。
...
| ![sep man icon](../../.gitbook/assets/sepman-icon.png) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=aesthetics-cogsci).                                                                      |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![sep man icon](../../.gitbook/assets/sepman-icon.png) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/aesthetics-cogsci/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
| ![inpho icon](../../.gitbook/assets/inpho.png)         | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=aesthetics-cogsci\&redirect=True) at the Internet Philosophy Ontology Project (InPhO).   |
| ![phil papers icon](../../.gitbook/assets/pp.png)      | [Enhanced bibliography for this entry](https://philpapers.org/sep/aesthetics-cogsci/) at [PhilPapers](https://philpapers.org/), with links to its database.                          |
