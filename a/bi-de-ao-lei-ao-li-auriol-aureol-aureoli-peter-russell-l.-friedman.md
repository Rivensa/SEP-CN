...
考虑了所有这些观点并发现它们的不足之后，奥雷奥利提出了自己的替代方案：解释基本断言、对超心理对象的知识和必要的科学知识的唯一方法是坚持认为概念是超心理个体，但它们具有与超心理存在不同类型的存在方式（_modus essendi_）。奥雷奥利将这种特殊类型的存在称为“表象存在”（_esse apparens_），但他还使用了许多同义词，包括“有意识的”或“客观的”存在（有关其他同义词，请参见 Tachau 1988 年，第 90 页）。这种存在方式的特点是它是一个特定的超心理对象，例如苏格拉底，但与被动概念（即对苏格拉底的概念形成）不可区分地混合在一起（_indistinguibiliter immiscetur_）。对苏格拉底的概念就是苏格拉底本身的概念。
...
* –––, 2001, ‘Aristotle’s _Metaphysics_ in Peter Auriol’s Commentary on the _Sentences_’, _Documenti e studi sulla tradizione filosofica medievale_, 12: 549–72.
...
* Tachau, K. H., 1988, _Vision and Certitude in the Age of Ockham: Optics, Epistemology and the Foundation of Semantics, 1250–1345_, Leiden: Brill.
