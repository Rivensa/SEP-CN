...
奥林匹奥多罗斯。由 Hunayn ibn Ishaq 翻译并由他的儿子 Ishaq 进行修正的《气象学》的释义（Badawi 1971, 13）已被ʿA. Badawi 发现并编辑（Badawi 1971, 95–190）。然而，这个文本与希腊文本（Schoonheim 2003, 326）保存的文本非常不同。
