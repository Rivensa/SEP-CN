...
此外，并不明显所有的_先验_知识都建立在有根据的概念之上。规范或数学概念可能映射规范和数学领域，但不映射外部世界。我们可以先验地知道虐待儿童只是为了好玩是错误的，以及 2 是唯一的偶素数，而不管外部世界是什么样子。也许我们还可以先验地知道一些一般的规范原则是真实的，比如最佳解释推理原则（IBE）。大致而言，这个原则说如果某个假设是我们观察到的现象的最佳解释，我们就有理由相信它。例如，它说我们有理由相信最近有人沿着海滩走过，因为这最好地解释了我们在沙滩上看到的脚印。但我们不能因为 IBE 有用且最好地解释了它的有用性就有理由接受 IBE，因为那将是一个接受 IBE 的循环论证。最后，即使是 BIV 也有可能知道某些条件命题，例如，知道如果某物是一只狐狸，它就是一只雌性狐狸，以及如果某人是单身汉，他就是一名未婚男性。
...
但是，对于知识的解释存在着竞争性的观点，它们否定了知识在一定程度上可以通过先验论证来分析的观点。其中一种观点被称为知识可靠主义，另一种观点被称为“知识优先”观点。知识可靠主义认为，一个人只有在拥有可靠产生的真实信念时才能知道_P_，而先验知识可靠主义对于先验知识也会有类似的说法。也许仅仅拥有可靠的直觉就足以拥有先验知识，无论它们是否提供了论证。
...
如果这对于可靠主义者来说是一个关于_经验_知识的问题，那么对于_先验_知识来说，这也可能是一个问题。仅仅可靠性似乎不足以构成知识。在 Truenorth 的情况中似乎缺少的是他认为自己关于罗盘方向的信念是可靠的任何理由。也许在关于_先验_知识的可靠主义解释中也存在类似的问题，即主体缺乏任何理由去认为她的_先验_直觉是可靠的，即使它们确实是可靠的。

Brian Weatherson 提供了一个例子，涉及到一个他称之为“Tamati”的年轻数学家。当 Tamati 注意到随着质数变大，它们之间的间隔也变大时，他突然有了一个强烈的信念，即不存在最大的质数（2019: 125-26）。Tamati 基于他的强烈信念相信不存在最大的质数，Weatherson 解释了 Tamati 对数学命题的强烈信念是可靠的。但是，直观上来说，Tamati 没有理由相信，也不知道没有一个证明它是真实的情况下不存在最大的质数。因此，即使在_先验_领域，可靠性也不足以构成合理性或知识。
