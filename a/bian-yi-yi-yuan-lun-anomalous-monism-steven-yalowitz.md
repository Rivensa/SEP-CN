...
_心理现象在物理现象之上的监督性_：如果两个事件共享所有的物理属性，它们将共享所有的心理属性
...
这种对于监督性的_ceteris paribus_概念在广泛的相关文献中并未讨论（其可能性被 Kim 1995, 136 所认可和支持；然而，请参见 Kim 1993, 24-25），而且目前尚不清楚它是否能提供一个足够强的依赖概念以满足唯物主义的直觉。但它似乎是一种吸引人的方式，可以将监督性与心理异常主义调和，从而使得变异一元论保持一致的理论。
...
作为回应，戴维森指出，虽然变异一元论拒绝了心理谓词可以出现的严格定律的可能性，但它允许存在_其他条件相同_的心理和心理物理定律（戴维森 1993 年，9-12 页）。他的观点似乎是，如果有法律的支持足以具有解释相关性，那么心理属性就具有解释相关性。（戴维森和他的批评者经常在因果关系和解释相关性的问题之间滑动，但鉴于戴维森对因果效应和属性的观点，显然后者是问题所在。）其次，戴维森援引心理属性在物理属性上的监督来为心理属性的解释角色提供基础。戴维森说，
