...
从非常广义的意义上讲，能动性几乎无处不在。每当实体之间建立因果关系时，可以说它们相互作用、相互影响，从而引起彼此的变化。从这个非常广义的意义上讲，几乎可以在任何地方找到能动者和能动性，以及受动者和受动性。通常情况下，术语“能动性”在更狭义的意义上被用来表示有意识行动的表现。这种关于能动性的思考方式在哲学中有着悠久的历史，可以追溯到休谟和亚里士多德等历史人物。在当代分析哲学中，它最常与安斯康姆（1957 年）和戴维森（1963 年）的有影响力的著作相关联。安斯康姆和戴维森在许多方面的观点存在显著差异，但他们共同认为行动应该通过有意识行动的意向性来解释。在随后的辩论中，行动哲学主要围绕有意识行动的概念展开。有一段时间，很少使用“能动性”这个术语，如果使用了，通常是指对执行有意识行动的能力的运用。在更近期的辩论中，关于能动性的讨论在哲学的许多领域（以及其他研究领域）变得越来越常见。在某种程度上，对能动性概念的关注是对将能动性归类为有意识行动的抵制。正如我们将在下一节中看到的，这种抵制在某些情况下等同于对标准行动的拒绝，而在其他情况下等同于对标准行动理论的拒绝，还有一些情况下等同于更温和的主张，即存在不同种类的能动性。

Anscombe 和 Davidson 的贡献确立了行动的标准概念，而 Davidson 的工作为行动的标准理论奠定了基础。标准概念的核心有以下两个主张。首先，有意行动的概念比行动的概念更为基础。具体而言，行动应该通过有意行动的意向性来解释。其次，有意行动与出于某种原因而行动之间存在密切联系。

对于第一个主张，有两种阐述方式（对应于行动个体化的两种不同观点；参见[第 3.4 节](https://plato.stanford.edu/entries/agency/#ActEveProOmi)）。根据第一种观点，同一事件可以在不同描述下成为多个行动，只有在某些描述下是有意行动的事件才是行动。也就是说，某个行动在某些描述下是有意行动，在其他描述下则是无意行动（Anscombe 1957; Davidson 1963）。假设你通过打开灯光来警告盗贼，假设这是一个在“打开灯光”描述下是有意行动但在“警告盗贼”描述下不是有意行动的事件。在这种观点下，警告盗贼仍然是你所做的事情，因为该事件在某些描述下是有意行动。根据第二种阐述方式，某个行动要么与有意行动相同，要么是由有意行动“生成”的（Goldman 1970; 参见 Ginet 1990）。在这种观点下，警告盗贼是你的一个行动，要么是因为它是有意行动，要么是因为它是由有意行动（在这种情况下是你打开灯光）“生成”的。如果它仅仅是由有意行动“生成”的，那么它就是你的一个无意行动。在这两种观点中，有意行动比行动本身更为基础：行动源于有意行动并依赖于有意行动。

根据标准概念的第二个主张，有意识地行动和出于理由行动之间存在着密切的联系。根据安斯康姆（Anscombe）和戴维森（Davidson）早期的观点，这种密切联系是一致的。他们都认为，有意识地行动就是出于理由行动，而出于理由行动就是以可以通过一个合理实践三段论的前提来合理化行动的方式行动，这个三段论通常由一个对应于行动者目标的主前提和一个对应于行动者对如何实现目标的看法的次前提组成。此外，戴维森认为，拥有一个意图就意味着拥有与相关三段论的主前提和次前提相对应的欲望和信念（戴维森 1963 年，1970 年；参见戈德曼 1970 年；奥迪 1986 年）。

在标准概念的这种欲望-信念版本中，人们仍然普遍认为意图不能简化为欲望和信念（以及它们的组合）。在这种观点中，意图在实践推理、长期规划以及行动的发起和指导中起着至关重要且不可简化的作用（尤其是参见布拉特曼 1987 年；还有哈曼 1976 年；布兰德 1984 年；毕晓普 1989 年；梅勒 1992 年，2003 年；恩奇 2003 年）。然而，人们仍然普遍认同有意识的行动和出于理由行动之间存在着密切的联系，并且有意识的行动通常是出于理由而进行的（例如，梅勒和莫泽 1994 年；梅勒 2003 年；恩奇 2003 年；克拉克 2010b 年）。

标准的“概念”并不致力于对有意识地行动和出于理由行动的具体解释，也不致力于对理由解释的本质的具体解释。重要的是要区分标准的概念与标准的“理论”，后者提供了关于有意识行动和理由解释的因果解释。这个理论大致上说，只有当某事是由正确的心理状态和事件以正确的方式引起时，它才是有意识的行动和出于理由的行动。正确的心理状态和事件是从行动者的角度对行动进行合理化的状态和事件（如欲望、信念和意图）。正确的因果方式是非偏离的因果关系（参见[第 3.2 节](https://plato.stanford.edu/entries/agency/#DevCauCha)）。从这个观点来看，理由解释是一种以心理状态和事件为基础的解释，这些心理状态和事件引起了行动，并从行动者的角度对其进行了合理化（通常通过提供一种目的手段的理由）。这个理论通常被称为“行动的因果理论”。严格来说，它是一种事件因果理论，包括了关于理由解释的事件因果理论和关于有意识行动的事件因果理论。与标准的概念结合起来，这个因果理论为我们提供了一个行动理论，这在当代心灵和行动哲学中是标准理论（参见也关于“行动”的条目）。

正如所示，标准的概念与非因果的有意识行动和理由解释的理论是相容的。普遍认为，对一个行动的理由解释通常通过揭示行动者的目标或意图使行动变得可理解。根据非因果理论，拥有相关的目标或意图并不意味着拥有因果有效的心理状态或事件（Melden 1961; Ginet 1990; O'Connor 2000; Sehon 2005）。然而，非因果理论被广泛拒绝（最有影响力的批评是由 Davidson 1963 提出的；参见也 Goldman 1970: 76–85; Mele 2003: 38–51; Clarke 2003: 21–24）。此外，标准的概念与双重立场理论是相容的。我们将在[第 3.3 节](https://plato.stanford.edu/entries/agency/#DisAgeNatDuaStaThe)中讨论这个观点。

### 2.1 能动性作为有意识的行动

行动的标准概念为我们提供了对能动性的理解。根据这个观点，只有当一个存在具有有意识行动的能力时，它才具备行动的能动性，而能动性的实现包括有意识行动的执行，以及在许多情况下，无意识行动的执行（这些无意识行动源于有意识行动的执行；参见[第 2 节](https://plato.stanford.edu/entries/agency/#ConTheKinAge)）。将其称为能动性的标准概念。行动的标准理论为我们提供了一种关于能动性的理论，根据这个理论，只有当一个存在具有正确的功能组织时，它才具备有意识行动的能力：只有当某些心理状态和事件（如欲望、信念和意图）的实例化会以正确的方式引起某些事件（如特定的动作）。根据这个能动性的标准理论，能动性的实现在于代理者相关的状态和事件之间正确的因果关系的实例化。（支持者包括 Davidson 1963, 1971; Goldman 1970; Brand 1984; Bratman 1987; Dretske 1988; Bishop 1989; Mele 1992, 2003; Enç 2003.）

这个标准理论面临的最严重问题是异常因果链的问题。此外，有人认为这种观点完全无法捕捉到能动性，因为它将行动简化为纯粹的发生事件。我们将在[第 3 节](https://plato.stanford.edu/entries/agency/#MetAge)中讨论这些问题。最近，有人认为行动的原因不能成为行动的原因，因为原因是事实或情况，而不是心理状态或事件（Dancy 2000; Alvarez 2010）。但是，标准理论并不主张原因与心理实体相同。它特别与这样一种观点相容，即原因是由相关心理状态和事件的内容所代表的事物（参见 Scanlon 1998: 56–64; Mele 2003: 82–84; Setiya 2007: 28–31）。
...
在一篇有影响力的文章中，弗兰克福特（1971）认为人与其他行动者的区别在于他们意志的结构。只有人会反思并关心他们的动机。根据弗兰克福特的观点，对我们动机的反思评估通常会导致形成二阶欲望：这些欲望指向一阶欲望（指向目标和行动）。当一个人希望拥有某种欲望并希望被它驱动时，他或她被称为“认同”该欲望及其动机效力。在这种层次化的代理理论中，高阶态度的作用对于区分人与其他行动者的代理形式至关重要。泰勒（1977）以此为出发点，提出了一个关于独特的“人类”代理的解释，假设人与非人之间的区别本质上是人类与非人类行动者之间的区别。弗兰克福特和泰勒是否意图提供标准代理理论的替代方案或其扩展尚不完全清楚。在一种解读中，他们接受了标准理论提供的有意识代理的解释，并提出了标准理论的层次化扩展，以捕捉人或人类代理的特殊性质（关于此类层次化解释的有影响力批评，请参见沃森 1975 年的文章）。

根据维尔曼（1992）的观点，弗兰克福特观察到一个行动者可能无法认同特定动机，这指出了标准理论的一个根本缺陷。由于一个行动者“否认”导致行动的心理态度似乎总是可能的，这些态度并不能“构成行动者的参与”（1992 年：463）。维尔曼认为，这表明标准理论最多只能解释有缺陷的行动。特别是，它未能解释“典型的人类行动”，因为它未能解释行动者的参与。维尔曼拒绝了对不可简化的行动者因果关系的诉诸（请参见[第 3.1 节](https://plato.stanford.edu/entries/agency/#ThrMetFra)），并主张这只留下了一种解决问题的策略：我们必须找到一个行动者无法否认的心理态度，并且因此适合扮演行动者的角色。也就是说，我们必须找到一个在功能上可以被视为行动者的心理态度。根据维尔曼的观点，根据理由行动的欲望适合扮演这个角色。
...
通常，对于标准理论无法解释能动性的重要方面的主张，往往是基于对于独特的人类能动性的关注。然而，一旦我们将焦点转向非人类的代理者和更简单的生物体，就会出现一个非常不同的挑战。当我们转向这些代理者时，标准理论似乎明显过于苛求。这个观点是通过代理者的欲望、信念和意图来解释能动性。通常，人们认为这是一种基于心理表征的解释：即基于具有表征内容（通常是命题内容）的有意识心理状态和事件的解释。然而，似乎存在一些能够真正具备能动性但不具备表征性心理状态的存在。我们可以在这里区分三个主张（和三个挑战）。第一个主张是，存在着能够具备能动性但不具备表征性心理状态的非人类存在。第二个主张是，有许多人类能动性的实例可以并且应该在不归因于表征性心理状态的情况下加以解释。第三个主张是，所有的能动性实例都可以并且应该在不归因于表征性心理状态的情况下加以解释。我们将依次讨论每个主张。

我们有一种普遍的倾向，以有意识的心理状态来解释和解释行为。我们甚至倾向于以欲望、信念和意图的方式解释动画对象之间的互动（Heider 和 Simmel 1944）。这引出了一个问题，即在解释行为时何时适当归因于心理状态。根据工具主义立场（Dennett 1987：第 2 章），归因心理状态的适当性问题与归因能动性的适当性问题是密不可分的，并且两个问题都应根据预测成功来回答：当归因心理状态在解释能动性时，如果这样做支持行为的成功预测，那么是适当的。然而，大多数标准理论的支持者都假设某种形式的现实主义，即只有在问题中的代理人具有正确的内部状态和正确的表征内容时，才适当归因心理状态。拥有表征性心理状态的问题是心灵哲学和认知科学中最有争议的问题之一，显然超出了本条目的范围（请参见有关[心理表征](https://plato.stanford.edu/entries/mental-representation/)和[认知科学](https://plato.stanford.edu/entries/cognitive-science/)的条目）。不过，请考虑以下几点。戴维森（1982）认为，只有人类代理人具有相关的心理态度，因为他认为具有这种态度需要语言能力。其他人则认为，如果归因表征性心理状态能够提供对非人类代理人行为的最佳解释，那么我们有理由将其归因于非人类代理人（例如，Allen 和 Bekoff 1997）。有时候很难确定是否将代理人行为的最佳解释归因于表征性心理状态。例如，Sterelny（2001：第 11 章，12 章）认为，以欲望为基础的合理解释有时可以被同样好的以驱动为基础的解释所取代。欲望的归因通常被解释为表征性心理状态的归因，而驱动可以用更基本的机制来解释（而不需要归因表征性内容）。在这里需要记住的重要一点是，这个问题不仅涉及相关心理状态和事件的拥有。此外，它还涉及将这些态度的内容组合或处理为合理推理的能力：将相关内容作为实践推理中的前提进行处理（正如 Anscombe 1957 和 Davidson 1970 所强调的）。

假设，为了论证而假设，将表征性心理状态归因于各种非人类存在是合适的。可能仍然存在其他种类的非人类存在，它们具有能动性，但不具备表征性心理状态。这是否表明标准理论要求过高？只有当标准理论被解释为提供关于能动性“本身”的解释时才是如此。根据一种要求较低的观点，标准理论提供了关于一种特别有趣和核心的能动性的解释：有意识的能动性（以及由此产生的无意识能动性；参见[第 2 节](https://plato.stanford.edu/entries/agency/#ConTheKinAge)）。\[[9](https://plato.stanford.edu/entries/agency/notes.html#note-9)]根据这种解释，标准理论与这样一种主张相容：存在更基本的能动性，包括不需要具备表征性心理状态的能动性。例如，它与 Barandiaran 等人（2009）所称的“最小能动性”相容。根据他们的观点，一个能动者是一个与其环境可区分的统一实体，并且根据某个目标（或规范）自主地做某事。这种观点在其对行动（“做某事”）的表征中与标准概念和理论有所不同，它以“与环境的耦合”的“适应性调节”和代谢自维持（受到 Varela 等人 1974 年的启发）来描述行动。他们提出，即使是细菌这样简单的生物也可以说具有这种最小的能动性。关键点在于，这提供了一种关于目标导向行为的解释，而不依赖于目标的心理表征。Barandiaran 等人提出，即使是非常简单的生物也可以说具有固有的目标“存在下去”。

现在我们转向第二个观点，即许多人类能动性的实例可以并且应该在不归因于表征性心理状态的情况下加以解释。这种观点通常基于和激发于心灵哲学和认知科学中的具身和行动主义方法。这种方法的某些版本受到了胡塞尔、海德格尔和梅洛-庞蒂的作品的启发（Dreyfus 1991, 2002），其他版本则基于机器人技术和动力系统理论的最新发展（Brooks 1991；Beer 1995）。这些观点的共同点是关注与世界的熟练和“在线”互动：通过对情境需求的熟练和常常毫不费力的响应，能够与他人和自身的处境进行互动，而无需有意识的思考、推理或计划（通常称为“熟练应对”）。人类能动性的例子包括习惯性行为的实例，例如驾驶汽车时所进行的行为，以及代表性的互动流程，例如爵士即兴演奏或口头交流。机器人学中的例子包括协调肢体运动和在新环境中导航的能力。对标准理论的挑战通常涉及以下三个观点。首先，有人认为，用心理表征来解释这些技能和能力既昂贵又笨拙：它对能动者的信息处理资源提出了非常高的要求，并导致了高度特定的心理表征的不雅观和不可信的过度使用。其次，有人指出，目前关于心理表征的解释是站不住脚的，或者至少是有争议的，并且没有明显的理由认为将来会有一个被普遍接受的心理表征解释。第三，有人认为，解释熟练应对不需要归因于表征性心理状态，因为它可以用行为倾向和对情境相关特征的直接引导来解释。提出的结论是，因此，我们应该在解释熟练应对的实例时不涉及表征性心理状态和事件。

作为回应，标准理论的支持者（以及心智再现理论的支持者）通常会提出以下观点。首先，他们指出标准理论并不要求代理人在有意识的思考或推理中考虑相关的心智内容。这在很大程度上减少了信息处理的需求。其次，他们认为标准理论与以运动模式（或运动意图）解释习惯性行为是相容的。运动模式并不在个人层次心智状态的内容中表示，并且通常会自动地为个人层次的目标和意图服务。利用运动模式进一步减少了所需的处理负荷。第三，他们指出，大多数熟练应对的情况并不是在意图真空中发生的。相反，它们通常受到代理人的长期目标和意图的限制和融合。鉴于此，似乎对熟练应对的全面解释在某个时候或某个层次上必须引用再现心智状态。（有关更多信息，请参见 Clark 和 Toribio 1994 年；Antony 2002 年；Rey 2002 年；Adams 2010 年；Clarke 2010b 年；Schlosser 2018 年。）

根据第三个主张，所有的代理实例，包括所有的人类代理实例，都可以并且应该在不归因于再现心智状态的情况下进行解释。这个立场通常是由对心智的具身和行动主义方法的激进版本所推动的（Chemero 2009 年；Silberstein 和 Chemero 2011 年；Hutto 和 Myin 2014 年）。这里的主要策略通常是概括上述论证：以再现心智状态的方式进行解释是昂贵且笨拙的；对心智再现的解释没有普遍接受的观点；而且有理由认为我们最终将能够在不归因于再现心智状态的情况下解释各种代理形式。这种激进观点引发了一些明显且困难的问题。如何在不假设心智再现的情况下解释我们对未来的思考能力？如何解释对抽象概念、反事实和理论概括的推理？以及如何解释我们的代理行为在很大程度上受到我们的长期计划和承诺的驱动、指导和限制？时间上延伸的计划代理（Bratman 1987 年，2000 年）显然是一个“渴望再现”的现象：很难看出它在不归因于再现心智状态的情况下如何解释（Clark 和 Toribio 1994 年；Schlosser 2018 年；另请参阅[具身认知](https://plato.stanford.edu/entries/embodied-cognition/)条目）。

### 2.5 其他类型的能动性：心理、认识、共享、集体、关系、人工
...
机构的本质是什么？我们应该如何理解代理人和行动之间的关系？机构如何成为事件因果秩序的一部分？在本节中，我们首先转向机构形而上学中的三种主要方法，这三种方法为我们如何思考这些形而上学问题提供了三种不同的框架（事件因果、代理因果和意志主义框架）。在考虑一些问题和反对意见之后，我们转向一种拒绝提供机构形而上学的项目的替代方法（双重立场理论）。最后，我们简要考虑行动的个体化和机构形而上学中的一些进一步问题。

### 3.1 三种形而上学框架

根据一种“事件-因果”方法，能动性是通过代理者参与的状态和事件之间的事件-因果关系来解释的。在这种观点下，行动是事件，只有当它具有正确的事件-因果历史时，事件才是一种行动。我们可以称之为对能动性的一种还原方法，因为它将代理者在能动性行使中的角色还原为代理者参与的状态和事件的因果角色。显然，标准理论属于这种还原的事件-因果框架，因为它通过代理者的心理状态和事件的因果关系来解释能动性。（支持者包括 Davidson 1963, 1971; Goldman 1970; Brand 1984; Bratman 1987; Dretske 1988; Bishop 1989; Mele 1992, 2003; Enç 2003.）

根据一种“代理者-因果”方法，能动性是通过一种物质因果关系来解释的：代理者的因果关系，被解释为一种持续存在的物质。在这种观点下，行动是事件，只有当它具有正确的代理者-因果历史时，事件才是一种行动。这个框架提供了对能动性的非还原解释，因为它认为代理者在能动性行使中的角色应该被解释为行使一种不可还原的代理者-因果能力（Chisholm 1964; Taylor 1966; O’Connor 2000; 另见 Clarke 2003; Lowe 2008）。

根据一种意志主义的观点，能动性可以通过意志行为来解释，通常被称为“意愿”。在这种观点中，意愿是能动性的源泉：只有在符合条件的情况下，明显的动作才是一种行为，因为它是由意愿以正确的方式引起的。意愿本身是完全无因果关系的，它们是独特的行为：它们是因为其内在属性而是行为，而不是因为某些外在或关系属性（例如具有正确的因果历史）。这也是一种非还原的能动性方法，但它与事件因果和主体因果框架有着明显的不同之处，因为它拒绝了所有行为都是具有特定因果历史的事件的建议。

事件因果框架是当代心灵和行动哲学中最广泛接受的观点。其中一个原因是，对事件因果框架的承诺等同于对一种非常基本和广泛认可的自然主义的承诺，即应避免对不可约的物质因果关系或目的论的诉诸。此外，对事件因果框架的承诺是由于对替代的主体因果和意愿主义的能动性理论的普遍不满。对主体因果理论的一些反对意见源于对物质因果关系概念的更一般的反对，另一些则更直接地涉及对能动性的主体因果解释。例如，有人认为对物质的诉诸使得因果关系的时间和方式都变得神秘（Broad 1952）。此外，有人认为物质因果关系在承认物质的因果能力是由其属性决定时，就会崩溃为事件因果关系（Clarke 2003: Ch. 10）。还有人认为将能动性归因于主体作为原因是无意义的，因为它没有解释的价值（Davidson 1971），也无法解释一个能动者对控制的行使包含什么（Schlosser 2010）。对意愿主义理论的常见反对意见是它们会产生心理行为的回归（Ryle 1949）。然而，可以说这个反对意见是在回避问题。这种观点认为明显的行动可以通过意愿来解释。为了解释为什么意愿是行动，没有必要诉诸于进一步的意愿心理行为，因为意愿本身就是独特的行动（参见 Enç 2003 进行讨论）。然而，这也指出了为什么这种观点被广泛拒绝的原因。意愿主义理论将需要解释的事物规定为原始的。特别是，它们没有解释一个能动者对控制的行使包含什么，因为能动者只是意愿的主体或承载者（O'Connor 2000: 25–26; Clarke 2003: 17–24）。此外，如果像大多数当代哲学家所认为的那样，意愿是由大脑中的事件实现的，那么这种观点似乎与大脑中没有完全无因果关系的事件的事实相矛盾。

### 3.2 反常因果链

在 20 世纪 50 年代和 60 年代，几位哲学家认为事件-因果框架是不连贯的。他们的主要论点是所谓的“逻辑连接论证”，大致上说，心理态度和行动之间的关系不能是因果关系，因为它们之间的连接是逻辑的、概念的或在某种意义上是非偶然的（例如，Hampshire 1959；Melden 1961；Kenny 1963）。现在普遍认为这种攻击是不成功的（最有影响力的回应是 Davidson 1963；另见 Goldman 1970：109-116）\[[16](https://plato.stanford.edu/entries/agency/notes.html#note-16)]。在此之后不久，另一个挑战出现了，这被证明是标准理论和事件-因果框架面临的最严重和最持久的问题：反常因果链的问题。

一般来说，问题在于似乎总是可能发生相关的心理状态和事件以异常的方式引起相关事件（例如某种动作），以至于这个事件显然不是有意的行动或根本不是行动。通常区分“基本”异常和“结果性”异常（也称为一级和二级异常）。一个有意杀害叔叔以继承他的财产的凶手开车去叔叔家，在路上意外杀死了一个行人。结果证明，这个行人就是他的叔叔。这是一个结果性异常的案例（Chisholm 1966）。在一个标准的基本异常案例（Davidson 1973）中，一个登山者打算通过放松握住绳子的力量来摆脱承受另一个人的重量和危险。这个意图使他紧张不安，以至于导致他放松对绳子的握持。这两种情况之间的区别最好用“基本”和“非基本”行动的区别来解释。非常粗略地说，基本行动是人们可以在不做其他事情的情况下做的事情（例如举手），而非基本行动的执行需要人们做其他事情（例如通过举手给某人发出信号）。 在结果性案例中，侄子有意进行非基本行动（杀死叔叔）。他成功地进行了几个基本行动，但他实现预期目标纯粹是巧合。相比之下，登山者根本没有进行任何行动。心理先决条件引起了一种本来会是基本行动的动作，如果因果链不是异常的话。

任何关于能动性的事件因果理论都必须要求相关的心理态度以正确的方式引起行动。正确的因果方式是非异常的因果。挑战在于在事件因果框架内详细说明非异常因果的构成；特别是没有诉诸于某种未经分析的能动因果或控制的概念。Davidson（1974）对于找到一个关于非异常因果的事件因果解释的前景持悲观态度，并建议标准理论最好只被理解为提供能动性的必要条件。Goldman（1970）认为，提供非异常因果的解释是一项经验而非哲学的任务。然而，自那时以来，大多数事件因果方法的支持者已经承认异常因果链的问题是一个严重的哲学问题，并提出了各种解决方案（参见 Peacocke 1979；Brand 1984；Bishop 1989；Mele 2003；Schlosser 2007, 2011；Wu 2016）。
...
此外，消失的能动性反对并不总是作为对事件因果框架的一般反对而提出。正如我们所见（[第 2.3 节](https://plato.stanford.edu/entries/agency/#AgeDisHumAct)），Velleman（1992 年）认为标准理论忽略了能动者或能动者的参与，并提出了一个在事件因果框架内解决这个问题的解决方案。在他的回应中，Mele（2003 年：第 10 章）建议更恰当地将其称为“能动者缩小问题”。根据 Velleman 的观点，标准理论只捕捉到能动性的不足实例，其中能动者的参与是“无意识的”或“半心半意的”。能动性不足的实例可以通过各种能力或属性来解释，而这些能力和属性能动者并不具备、行使或实现；这些能力和属性包括意识觉察、反思觉察、理性响应、自我控制、自我管理等等。鉴于此，没有必要将能动性不足的实例概念化为能动者的缺席。此外，这样做会在一种能动者参与的能动性和一种能动者不参与的能动性之间产生一个相当不可信的二分法（Schlosser 2010）。

其他人则提出了消失代理反对论，以激发双重立场理论。根据双重立场理论，无法从任何理论立场或形而上学框架来解释能动性。能动性只能从实践和规范的立场来理解（例如，纳格尔 1986 年；科斯加德 1996 年；比尔格米 2006 年）。可以说，这种观点源于康德对实践理性的描述（参见“康德和休谟关于道德的条目”）。通常，双重立场理论并不排斥形而上学本身，并且它们通常提供自己的形而上学框架。但是，它们拒绝了关于能动性的还原论和非还原论理论，并且一般上拒绝我们可以对能动性的行使有一个形而上学解释的观念。它们自然地与非因果理论的理性解释相一致。这两种观点倾向于强调理性解释的规范性和不可约的目的性，因此也强调了能动性。双重立场理论在行动哲学中受到的关注相对较少。对许多人来说，这些观点似乎深深地令人不满，因为它们拒绝面对能动性形而上学中的一个核心问题：在一个所有运动都可以用事件因果关系来解释的世界中，代理人如何对他们的行动行使控制？这似乎需要解释，而且似乎需要一种能动性的形而上学（参见 Bishop 1989 年；Schlosser 2010 年）。Nelkin（2000 年）基于对双重立场理论的一种论证，质疑了其一致性，认为它们导致了关于自由意志的相互矛盾的信念。

### 3.4 行动、事件、过程和遗漏

我们现在简要地转向代理能动性的一些进一步问题。第一个问题涉及行动的个体化。你按下开关，打开灯，照亮房间，从而也警觉了盗贼。你进行了多少个行动？根据对行动个体化的粗粒度（或最小化）观点，你在不同的描述下进行了一个行动（Anscombe 1957; Davidson 1963）。根据细粒度（或最大化）观点，你进行了多少个行动取决于实例化了多少个行动属性。如果你实例化了四个行动属性，那么你进行了四个不同的行动（Goldman 1970; 另见 Ginet 1990）。根据第三种观点，行动可以有其他行动作为其组成部分（Thalberg 1977; Ginet 1990）。根据这三种观点，行动是事件，行动的个体化源于对事件个体化的不同观点（参见[事件](https://plato.stanford.edu/entries/events/)条目）。最近对此问题的研究工作不多（但参见 Enç 2003: Ch. 3）。这部分是因为现在普遍认为行动的个体化对其他问题几乎没有影响。举例来说，代理能动性是在事件因果或代理因果框架内解释的问题，这直接涉及到自由意志和道德责任辩论中的各种问题（参见[自由意志](https://plato.stanford.edu/entries/freewill/)条目）。但是，事件因果和代理因果理论都与行动个体化的粗粒度和细粒度观点相容。同样，似乎行动个体化观点对于理性解释是否是因果解释的问题没有实质性影响。

一个相关问题是行动是与因果过程的结果还是与过程本身等同。根据大多数事件因果和代理因果理论的版本，行动是以正确方式引起的事件：行动与该过程的结果相同或构成该过程的一部分\[[19](https://plato.stanford.edu/entries/agency/notes.html#note-19)]。根据过程观点，行动要么与该过程相同，要么由该过程构成（Searle 1983; Dretske 1988; Wu 2011; 另见 Thompson 2008）。这个问题也没有得到太多关注。同样，这主要是因为普遍认为这个问题对于代理能动性的更基本问题以及哲学行动之外的辩论几乎没有实质性影响\[[20](https://plato.stanford.edu/entries/agency/notes.html#note-20)]。

在最近的辩论中，代理能动性形而上学中另一个受到更多关注的问题是遗漏的本质（特别是有意的遗漏）。根据 Sartorio（2009）的说法，有意的遗漏是由意图的缺失引起的行动的缺席。她根据这一观点争辩说，有意的遗漏不能轻易地被标准理论所容纳。作为回应，Clarke（2010a）认为，在有意的遗漏的情况下，代理通常确实有一种不行动的意图，这起到了重要的因果作用，并且他还确定了有意的行动和有意的遗漏之间的各种相似之处。在他看来，对有意的遗漏的解释并没有与有意的行动的标准理论相矛盾或不连续的主要障碍。此外，他认为，不能解释有意的遗漏显然不会成为有意的行动理论的不足之处。毕竟，行动和遗漏之间存在着重要的差异，因此我们不应该期望行动理论提供所有需要解释遗漏的资源。（有关更多信息，请参见 Clarke 2014。）

## 4. 经验挑战和意识的作用

### 4.1 原因和起因

根据我们对能动性的常识概念，我们的原因和有意识的意图往往对我们的行为产生真正的影响（例如，D'Andrade 1987; Malle 2004）。这一假设是标准理论和许多关于有意图行为和动机的心理学理论的一部分（例如，Fishbein 和 Ajzen 1975; Locke 和 Latham 1990; Heckhausen 1991; Gollwitzer 1993; Austin 和 Vancouver 1996）。然而，心理学和认知神经科学的各种实证研究结果表明，这种常识假设是没有根据的，并且提出了有关意识在能动性的启动和指导中的作用的有趣而具有挑战性的问题。本节提供了最相关研究的概述。

对于我们的理由与因果关系的怀疑，早期且具有高度影响力的来源是尼斯贝特和威尔逊（1977）的理论回顾。这篇文章报告了许多实验和研究，参与者在其中似乎通过给出不可能是他们行动原因的理由来构建或虚构合理化解释。尽管存在一些相当严重的方法论问题（White 1988），但这项研究已经在心理学和认知科学领域取得并保持了教科书知识的地位。此外，它被认为表明普通的理由解释并不是因果解释，尽管作者们本人拒绝了这个结论。在他们的观点中，证据首先显示，心理状态的口头报告是基于自我解释（理论化或合理化），而不是基于直接或内省的获取。他们指出，这种认识论观点与我们在给出普通的理由解释时能够并经常给出我们行动的实际原因的假设是完全相容的。总之，即使所提出的认识论观点是正确的，证据中没有任何东西表明理由解释不能是因果解释，也没有任何证据表明理由解释通常不是因果解释。

### 4.2 情境主义

似乎支持情境主义的经验证据对我们对能动性的常识观念提出了挑战。根据情境主义，经验研究表明，以品格特质（如诚实、善良或勇气）解释行为的常识解释是系统性错误或不准确的，因为这些研究表明，所讨论的行为更好地用情境特征来解释（Ross 和 Nisbett 1991; Harman 1999; Doris 2002）。但是，没有一个常见的哲学能动性理论说行为应该用代理人的品格特质来解释，因此情境主义似乎对标准理论和其他哲学能动性观点没有提出问题。此外，有关经验证据的解释和情境主义的论证一直存在争议（例如，Sreenivasan 2002）。然而，有人认为这些证据进一步引发了我们是否真正对理性有反应的问题。证据表明，在某些条件下，我们的行为受到情境和与道德无关的因素的驱使，即使存在明显的道德理由要采取其他行动。这表明我们（或我们大多数人）并不像我们想象的那样对理性有反应。但是，关于这些证据是否支持任何更强的主张存在争议（有关更多信息，请参见 Nelkin 2005; Schlosser 2013; Vargas 2013）。

### 4.3 利贝特实验和韦格纳的挑战

关于意识意图的作用的最有影响力的经验性挑战源于利贝特关于运动启动的开创性神经科学研究。在利贝特实验中（利贝特 1985），参与者被指示在出现愿望或冲动时发起一个简单且预定义的动作。在此期间，进行了脑电图测量以记录准备电位，这是已知在有意识运动之前出现的一种脑电位。主要发现是准备电位在有意识的愿望或冲动发生前约 350 毫秒。根据利贝特的观点，这表明运动并非是有意识发起的，我们在常规意义上并没有自由意志（利贝特 1999）。这个实验的方法论已经受到广泛审查，并在一些方面受到批评。其中一些方法论问题已在后续实验中得到解决（Soon 等人 2008; Fried 等人 2011）。

大多数研究利贝特工作的哲学家认为，即使承认实验方法和结果是可靠的，关于意识意图的作用和自由意志的结论也是不成立的。他们认为，有关证据的替代解释可以保留意识意图的因果作用，并且与利贝特对证据的解释一样合理和可信（Flanagan 1992: 136–138; Zhu 2003; Mele 2009a; Schlosser 2012b）。此外，有人认为该实验创造了一个非常不寻常和人为的背景，参与者被“指示”做出“自发”的决定。因此，实验结果是否具有普遍性是值得质疑的（Keller 和 Heckhausen 1990; Roskies 2011; Waller 2012; Schlosser 2014）。Schurger 等人（2012）提出并测试了一个解决这个问题的模型。根据这个模型，利贝特实验中的运动时机是由神经活动的自发波动中的随机阈值穿越决定的。特别是，该模型认为，只有当决策没有受到任何证据或行动原因的限制时，决定何时移动才由随机阈值穿越决定。这个模型已经成功测试，支持了利贝特实验和类似后续研究的结果不具有普遍性的观点，因为我们大多数日常决策显然都受到证据和行动原因的限制。

与意识意图的角色相关的一个挑战源于韦格纳关于明显心理因果模型的观点。根据这个观点，意识意图仅仅提供我们行动的“预览”：它们在我们行动之前出现，但并不引起行动（韦格纳和维特利，1999 年；韦格纳，2002 年）。韦格纳提供了意识代理感和实际代理行动之间的分离的证据，并认为明显心理因果模型提供了最好的解释。这个观点因概念模糊和论证缺陷而受到了强烈的批评（参见[第 4.5 节](https://plato.stanford.edu/entries/agency/#SenAge)）。一个常见的反对意见是，代理感与代理行动的分离事实与意识意图倾向于引起预期行动的假设是完全兼容的。（参见 Bayne，2006 年；Mele，2009 年；关于韦格纳最佳解释的回应，请参见 Schlosser，2012 年。）

然而，利贝特和韦格纳的研究提出了关于意识在代理中的作用的有趣而具有挑战性的问题。标准理论的支持者通常通过声称相关的心理态度不需要被有意识地访问才能在代理行动中发挥正确的作用来限定这个观点。例如，戴维森（1978 年：85-86）考虑了一个代理人在调味时意图改善味道的例子，他声称有意识的代理只需要代理人在当时基于相关态度进行推理，即使他当时并不知道这些态度。然而，很少有人愿意接受我们所有行动都可能是这样的观点：由当时没有有意识访问的态度发起和引导。这引发了一些很少被讨论的问题。行动在多大程度上或在什么样的情况下应该由有意识的意图或有意识的推理先行？需要什么样的意识？在相关态度没有被有意识访问的情况下，它们必须是可访问的吗？等等。\[21]

### 4.4 自动性和双系统理论

与意识在能动性中的作用相关的一种经验研究是关于自动性的工作，特别是关于自动目标追求的研究。例如，已经证明，追求准确完成某项任务的目标可以被激活，以至于代理人在没有意识到的情况下追求这个目标（Bargh 等，2001 年）。关于这个问题已经有大量的研究，并且有人认为这些研究表明我们的大部分行为都是自动执行的，没有意识控制（Bargh 和 Chartrand，1999 年；Custers 和 Aarts，2010 年）\[[22](https://plato.stanford.edu/entries/agency/notes.html#note-22)]。这个观点并不像 Libet（1999 年）和 Wegner（2002 年）提出的观点那样激进，因为它只涉及到意识控制的程度或范围。此外，一旦注意到绝大多数自动行为都是为更高目标和长期意图服务的子程序，这个观点似乎就不那么具有挑战性了。例如，考虑一下在驾驶汽车时执行的所有子程序。这种行为是自动执行的，没有意识控制的观点可以与我们对能动性的常识概念相一致，并且可以被标准理论所接受，前提是意识意图和计划可以自动招募相关的例程，无论是通过生成相关的运动意图，还是通过激活相关的运动模式。 （有关更多信息，请参见 Pacherie，2008 年；Adams，2010 年；Clarke，2010b 年。）

另一个相关的研究领域是关于决策的双过程（或双系统）理论的工作。根据这种模型，决策和能动性的基础是两种不同类型的心理过程（或系统）：一种通常被描述为自动、轻松和基于启发式的，另一种是有意识、谨慎和基于规则的。双过程模型已经广泛而成功地应用于许多研究领域（有关概述，请参见 Sloman 1996；Evans 2008；有关批判性评论，请参见 Osman 2004；Keren 和 Schul 2009）。在哲学中，通常假设明确或隐含地认为存在一个实践理性的机制（或能力），它是实践推理和基于理性的能动性的基础。这似乎与双过程框架不相容。然而，复杂化这个问题的是，对于双过程模型的细节没有共识。例如，关于两个过程（或系统）如何相互作用没有共同接受的观点。有意识和谨慎的过程可能对自动的过程产生自上而下的影响；这两个过程可能相互作用；它们在某些情况下可能相互干扰；可能存在从一个过程切换到另一个过程的情况；等等。并不是所有这些可能性都明显与存在一个实践理性的机制（或能力）的假设不相容。需要进一步研究以调查这两种过程在相关方面是否独立，或者它们是否可以被构想为决策机制的相互作用部分。关于双系统框架是否与行动的哲学标准理论相容的讨论，请参见 Schlosser 2019。

关于我们对自己行为的知识类型存在一些争议。最著名的是安斯康姆（1957）认为我们对自己行为的知识是直接的，即不基于观察或推理（参见[action](https://plato.stanford.edu/entries/action/)条目）。本节提供了关于所谓“能动性感知”的相关辩论的概述。似乎当我们行动时，我们有一种做某事的感觉：一种控制和成为行动的主体或所有者的感觉。关于这一点的辩论主要受到心理学和认知科学的实证研究驱动，并且现在普遍区分以下三个主要立场。

第一个立场主要归功于韦格纳关于“表观心理因果模型”的研究（Wegner and Wheatley 1999; Wegner 2002）。根据这个观点，能动性感知（或韦格纳所称的“有意识的意愿体验”）是当我们将有意识的意图解释为其原因时产生的。具体来说，它说当以下条件满足时，一个主体将意图解释为行动的原因：意图直接紧随行动，行动与意图一致，并且主体没有意识到任何可能提供替代解释的因素。韦格纳对表观心理因果模型的论证基于各种实验、研究和关于控制错觉和能动性归因失败的观察。这项工作开启了对能动性感知的实证研究，但韦格纳的模型现在被广泛拒绝。哲学家们批评这个观点存在各种概念上的模糊和证据解释和使用上的缺陷（例如 Nahmias 2002; Bayne 2006; Dennett 2008; 和 Mele 2009a）。此外，现在有大量实证证据表明能动性感知不仅仅是自我解释的问题（Haggard 2005; Bayne and Pacherie 2007; Gallagher 2007; 和 Synofzik et al. 2008）。

对于主体性的第二种解释基于运动控制的反馈比较模型。根据这个模型，运动控制系统使用运动指令的副本来生成对随后身体运动的预测。这些预测（所谓的“前向模型”）然后用于预测和预期运动轨迹之间的比较，以及预测和实际轨迹之间的比较（基于感觉反馈信息）。该模型认为，一个次人的运动控制系统使用这些预测和比较来调整和微调身体运动的执行（Wolpert 和 Kawato 1998; Frith 等人 2000; Haggard 2005）。有人认为，这个系统在产生主体性感觉方面也可能起到关键作用。根据这个观点，比较器系统中的正向匹配会产生主体性感觉，而不匹配会产生干扰主体性感觉的错误信号。这个模型可以解释关于主体性感觉和控制的各种现象（Frith 等人 2000; Blakemore 等人 2002）。然而，最近有人认为，这个比较器模型最多只能部分解释主体性感觉（Haggard 2005; Bayne 和 Pacherie 2007; Gallagher 2007; Synofzik 等人 2008）。

对于主体性的第三种解释是前两种的混合体。这种方法的支持者通常区分基本的主体性感觉和关于自己主体性的行为后判断。基本的主体性感觉被构建为一种在线的、现象学上相对薄弱的体验，伴随着行动的执行，并不一定需要有意识意图的存在。相反，关于自己主体性的判断是离线的，通常是行为后的判断，因此受到各种可能扭曲对自己主体性解释的偏见的影响。反馈比较模型非常适合解释基本的主体性感觉，而类似 Wegner 的自我解释理论可以解释为什么关于自己主体性的判断在某些条件下往往会被扭曲或产生错觉（Bayne 和 Pacherie 2007; Gallagher 2007; Synofzik 等人 2008）。

Pacherie（2008）将反馈比较器模型发展为一个关于能动性现象学的解释，该模型假设在三个不同层次的意图中存在三个集成的反馈回路：远期（或面向未来）意图、近期（或面向现在）意图和运动意图。这些是行动规范的层次，在后期阶段，根据感知和本体感觉反馈生成越来越详细的行动表征。Pacherie 的主要论点是，行动规范过程中各个阶段的组成表征与能动性现象学的组成部分和内容之间存在强烈的相互关联。例如，在近期意图的层次上，该模型解释了从远期意图继承的概念信息如何与感知输入和情境约束相结合。关于能动性感知，该模型区分了对于“什么”（目标）的意识、对于“如何”（手段）的意识、意图感知、启动感知、情境控制感知和运动控制感知。Shepherd（2017）认为，能动性现象学的组成部分如此丰富地融合在整体体验中，以至于可以被视为融合在一起。
...
| ![sep man icon](../../.gitbook/assets/sepman-icon.png) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=agency).                                                                      |
| ------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![sep man icon](../../.gitbook/assets/sepman-icon.png) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/agency/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
| ![inpho icon](../../.gitbook/assets/inpho.png)         | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=agency\&redirect=True) at the Internet Philosophy Ontology Project (InPhO).   |
| ![phil papers icon](../../.gitbook/assets/pp.png)      | [Enhanced bibliography for this entry](http://philpapers.org/sep/agency/) at [PhilPapers](http://philpapers.org/), with links to its database.                            |
