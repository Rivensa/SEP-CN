...
根据标准观念的第二个主张，有意图地行动和出于理由行动之间存在着密切的联系。根据Anscombe和Davidson早期的观点，这种密切的联系是一致的。他们都认为，有意图地行动就是出于理由行动，而出于理由行动就是以一个合理实践三段论的前提为基础进行行动，该三段论通常由一个对应于行动者目标的主前提和一个对应于行动者对如何实现目标的看法的次前提组成。此外，Davidson认为，拥有一个意图就意味着拥有与相关三段论的主前提和次前提相对应的欲望和信念（Davidson 1963, 1970; 参见Goldman 1970; Audi 1986）。^\[^​^[6](https://plato.stanford.edu/entries/agency/notes.html#note-6)^​^]^
...
根据Velleman（1992）的观察，弗兰克福特指出，一个能动性可能无法认同特定动机，这指向了标准理论中的一个根本缺陷。由于一个能动性似乎总是有可能“否认”导致行动的心理态度，这些态度并不能“构成能动性的参与”（1992: 463）。这表明，根据Velleman的观点，标准理论最多只能捕捉到有缺陷的行动。它未能捕捉到“典型的人类行动”，因为它未能解释能动性的参与。Velleman拒绝了对不可简化的能动性因果关系的诉求（参见[第3.1节](https://plato.stanford.edu/entries/agency/#ThrMetFra)），并且他认为这只留下了一个解决问题的策略：我们必须找到一个能动性无法否认的心理态度，并且因此适合扮演能动性的角色。也就是说，我们必须找到一个在功能上可以被视为能动性的心理态度。根据Velleman的观点，希望根据理由行动的愿望适合扮演这个角色。

Bratman（2000, 2001）同意Velleman的观点，即标准理论无法解释真正的自我管理。然而，在他看来，对于所谓的“完全的能动性”（full-blown agency）的解释并不需要引用一个能动性无法否认的心理态度。在他关于时间延伸计划能动性的研究基础上（Bratman 1987），他认为一个能动性的“自我管理政策”具有“代表能动性发言的权威”，因为它们有助于建立和支持能动性的身份，并且它们规定了哪些愿望应被视为在实践思考中提供正当理由。根据Bratman的观点，这些自我管理政策解释了一个能动性“支持或反对某些动机的立场，这个立场本身可以接受重新审查和修订”（2000: 50–51）。（关于Bratman的解释的批判性讨论，请参见Hornsby 2004和Franklin 2017。）

为了捍卫标准理论，梅勒（2003年：第10章）认为寻找扮演能动性角色的心理态度是错误的，维尔曼对这一观点的批评也是离题的。正如梅勒指出的那样，很明显，欲望不可能是能动者，因为能动者会思考、决策和行动，而欲望却没有这些行为。他建议，将心理态度作为能动者的角色进行讨论，最多只能是隐喻性的。此外，没有明显的理由可以解释为什么能动者不认同动机应该被诊断为参与失败。更有道理的是，能动者在这种情况下确实参与了，只是以一种有缺陷的方式。一旦将有缺陷的参与与不参与区分开来，就很容易避免维尔曼的结论，即标准理论“忽略了能动者”。此外，人们可以将标准理论解释能动者的参与与其是否能够完美地捕捉人类行动分开。根据梅勒的观点，人类能动者只是一个行动的人类。在这种观点下，无论能动者的参与有多么不足，他们在所有能动性的例子中都扮演了一定的角色。标准理论首先提供了一个关于能动者如何进行有意识行动的解释。它并不声称进行有意识行动的能力是区分人类和非人类能动性的能力，并且它也不声称能够解释更精细或更优秀的人类能动性，比如自控、自治、全心全意或自由的能动性。研究标准理论是否能够扩展以解释更精细或更优秀的人类能动性是一个有趣且重要的任务（例如，梅勒1995年；布拉特曼2007年）。但是，因为标准理论未能做到这一点而拒绝接受这一观点是对其目标和范围的误解（另见[第3.3节](https://plato.stanford.edu/entries/agency/#DisAgeNatDuaStaThe)）。

主张标准理论无法解释能动性的重要方面的论点通常是基于对独特的人类能动性的关注。一旦我们将焦点转向非人类的能动者和更简单的生物，就会出现一个非常不同的挑战。当我们转向这些能动者时，标准理论显然要求过高。这种观点是通过代理人的欲望、信念和意图来解释能动性的。通常假设这是一种关于心理表征的解释：关于具有表征内容（通常是命题内容）的有意识心理状态和事件的解释。然而，似乎存在一些能够真正具有能动性但不具备表征性心理状态的存在。我们可以在这里区分三个主张（和三个挑战）。根据第一个主张，有些非人类存在能够具有能动性但不具备表征性心理状态。第二，有许多人类能动性的实例可以并且应该在不归因于表征性心理状态的情况下加以解释。第三，所有能动性的实例都可以并且应该在不归因于表征性心理状态的情况下加以解释。我们依次讨论每个主张。

我们普遍倾向于用有意识的心理状态来解释行为。我们甚至倾向于用欲望、信念和意图来解释有生命的物体之间的互动（Heider和Simmel 1944）。这引发了一个问题，即何时适当地将心理状态归因于行为的解释中。根据工具主义立场（Dennett 1987：第2章），归因心理状态的适当性问题与归因能动性的适当性问题是密不可分的，两个问题都应以预测成功为基础来回答：当归因心理状态在解释能动性时能够支持成功的行为预测时，将心理状态归因于行为是适当的。然而，大多数标准理论的支持者都假设某种形式的现实主义，即只有当涉及的代理人具有正确的内部状态和正确的表征内容时，才适当地归因心理状态。对于拥有表征性心理状态的具体内容是什么的问题是心灵哲学和认知科学中最有争议的问题之一，显然超出了本文的范围（参见[心理表征](https://plato.stanford.edu/entries/mental-representation/)和[认知科学](https://plato.stanford.edu/entries/cognitive-science/)的条目）。不过，考虑以下几点。戴维森（1982）认为，只有人类能动者具有相关的心理态度，因为他认为拥有这种态度需要语言能力。其他人则认为，如果将表征性心理状态归因于非人类能动者能够提供最佳的行为解释，那么我们有理由这样做（例如，Allen和Bekoff 1997）。有时候很难确定是否将表征性心理状态归因于代理人的行为是最佳解释。例如，Sterelny（2001：第11章，12章）认为，用欲望来解释的合理解释有时可以被同样好的用驱力来解释的解释所替代。欲望的归因通常被解释为对表征性心理状态的归因，而驱力可以用更基本的机制来解释（而不需要归因表征性内容）。在这里需要牢记的重要一点是，这个问题不仅涉及到相关心理状态和事件的拥有。它还涉及到将这些态度的内容组合或处理为合理推理的能力：将相关内容作为实践推理的前提进行处理（正如Anscombe 1957和Davidson 1970所强调的）。

假设，为了论证而假设，将表征性心理状态归因于各种非人类存在是合适的。可能仍然存在其他种类的非人类存在，它们具有能动性，但不具备表征性心理状态。这是否表明标准理论要求过高？只有当标准理论被解释为提供关于能动性“本身”的解释时才是如此。根据一种要求较低的观点，标准理论提供了关于一种特别有趣和核心的能动性的解释：有意识的能动性（以及由此产生的无意识能动性；参见[第2节](https://plato.stanford.edu/entries/agency/#ConTheKinAge)）。^\[^​^[9](https://plato.stanford.edu/entries/agency/notes.html#note-9)^​^]^ 根据这种解释，标准理论与存在更基本的能动性的观点是完全兼容的，包括不需要具备表征性心理状态的能动性。例如，它与Barandiaran等人（2009）所称的“最小能动性”是兼容的。根据他们的观点，一个能动者是一个与其环境可区分的统一实体，并且根据某个目标（或规范）自主地做某事。这种观点在行动（“做某事”）的特征化上与标准观念和理论不同，它以与环境的“耦合”的“适应性调节”和代谢自维持为基础（受到Varela等人1974年的启发）。他们提出，即使是细菌这样简单的生物也表现出这种最小能动性。关键点在于，这提供了一种关于目标导向行为的解释，而不依赖于目标的心理表征。Barandiaran等人提出，即使是非常简单的生物也可以说具有固有的目标是“存在”的：为了维持其存在的延续。

现在我们转向第二个观点，即许多人类能动性的实例可以并且应该在不归因于表征性心理状态的情况下加以解释。这种观点通常基于和受到心灵哲学和认知科学中的具身和行动主义方法的启发和推动。这种方法的某些版本受到了胡塞尔、海德格尔和梅洛-庞蒂的作品的启发（Dreyfus 1991, 2002），其他版本则基于机器人技术和动力系统理论的最新发展（Brooks 1991；Beer 1995）。这些观点的共同点是关注与世界的熟练和“在线”互动：通过对情境需求的熟练和常常毫不费力的响应，能够与他人和自身的环境互动，而无需有意识的思考、推理或计划（通常称为“熟练应对”）。人类能动性的例子包括习惯性行为的实例，例如驾驶汽车时所进行的行为，以及代表性的互动流程，例如爵士即兴演奏或口头交流。机器人学中的例子包括协调肢体动作和在新环境中导航的能力。对标准理论的挑战通常涉及以下三个观点。首先，有人认为用心理表征来解释这些技能和能力既昂贵又笨拙：它对能动者的信息处理资源提出了非常高的要求，并导致了高度特定的心理表征的过度存在，这是不优雅和不可信的。其次，有人指出当前的心理表征解释是站不住脚的，或者至少是有争议的，并且没有明显的理由认为将来会有一个被普遍接受的心理表征解释。第三，有人认为解释熟练应对不需要归因于表征性心理状态，因为它可以用行为倾向和对情境相关特征的直接引导来解释。提出的结论是，因此，我们应该在解释熟练应对的实例时不涉及表征性心理状态和事件。

作为回应，标准理论的支持者（以及心智再现理论的支持者）通常会提出以下观点。首先，他们指出标准理论并不要求代理人在有意识的思考或推理中考虑相关的心智内容。这在很大程度上减少了信息处理的需求。其次，他们认为标准理论与以运动模式（或运动意图）解释习惯性行为是相容的。运动模式并不在个人层次心智状态的内容中表示，并且通常会自动地为个人层次的目标和意图服务。利用运动模式进一步减少了所需的处理负荷。第三，他们指出，大多数熟练应对的情况并不是在意图真空中发生的。相反，它们通常受到代理人的长期目标和意图的限制和融合。鉴于此，似乎对熟练应对的全面解释必须在某个时候或某个层次上参考再现性心智状态。（有关更多信息，请参见Clark和Toribio 1994年；Antony 2002年；Rey 2002年；Adams 2010年；Clarke 2010b年；Schlosser 2018年。）

根据第三个主张，所有的能动性实例，包括所有的人类能动性实例，都可以并且应该在不归因于再现性心智状态的情况下加以解释。这个立场通常是由身体化和行动化心智方法的激进版本所推动的（Chemero 2009年；Silberstein和Chemero 2011年；Hutto和Myin 2014年）。这里的主要策略通常是概括上述论证：以再现性心智状态为基础的解释是昂贵且笨拙的；对心智再现的解释没有普遍接受的观点；而且有理由认为我们最终将能够在不归因于再现性心智状态的情况下解释各种能动性。这种激进观点引发了一些明显且困难的问题。如何在不假设心智再现的情况下解释我们对未来的思考能力？如何解释对抽象概念、反事实和理论概括的推理？以及如何解释我们的能动性在很大程度上受到我们的长期计划和承诺的驱动、指导和限制？时间上延伸的计划能动性（Bratman 1987年，2000年）显然是一个“渴望再现”的现象：很难看出它如何在不归因于再现性心智状态的情况下加以解释（Clark和Toribio 1994年；Schlosser 2018年；另请参阅[身体化认知](https://plato.stanford.edu/entries/embodied-cognition/)条目）。

### [2.5 其他种类的能动性：心智的、认识的、共享的、集体的、关系的、人工的](./)
...
能动性的第三种解释是前两种的混合体。这种方法的支持者通常区分基本的能动性感觉和关于自己能动性的行为后判断。基本的能动性感觉被理解为伴随行动表现的在线和现象学上相对薄弱的体验，不一定需要有意识意图的存在。相反，关于自己能动性的判断是离线的，通常是行为后的判断，因此受到各种可能扭曲对自己能动性解释的偏见的影响。反馈比较模型非常适合解释基本的能动性感觉，而类似Wegner的自我解释理论可以解释为什么在特定条件下关于自己能动性的判断往往会被扭曲或产生错觉（Bayne和Pacherie 2007; Gallagher 2007; Synofzik等人2008）。
