...
* [2.2 语言与真理](https://plato.stanford.edu/entries/austin-jl/#LangTrut\_1)
...
相比之下，_指示性_约定将特定的陈述（它们本身是历史事件）与可接触的历史情境、事物、事件等相关联。例如，考虑以下简化情况。有两种可接触的情境，其中一种是猫在垫子上的类型，另一种是狗在油布上的类型。描述性约定并不能确定说话者在特定场合上想要谈论的是这两种可接触情境中的哪一种。为了实现这一点，说话者必须找到一种方式来表明他们的目标是选择，比如说，狗在油布上的情境。他们可以通过在特定场合使用现在时态或指点等方式来实现这一点。（1950a：121-126）\[10]
...
现在，一个坚定的决定论者会声称构成这种失败的事件必须是被决定的，并且在某种意义上由失败之前和之时的环境来解释。但是奥斯汀相信——出于上述原因——这样的解释的存在将使得事实上，高尔夫球手在那些确切的情况下_无法_把推杆打进洞里。

我们在这里可以看到，奥斯丁表达了他的观点，即普通的能力、力量和容量的归属与决定论的论点是不相容的。作为回应，我认为，兼容主义者被迫否认，高尔夫球手能够把推杆推进洞里是真实的，甚至他能够在完全相同的条件下推进推杆也不能说明他在一个_完美的_实际世界的复制中会推进推杆。将这个问题放在一边，奥斯丁提出了一个所谓的“掩盖”案例来说明这个提议的分析，即尽管能力被保留，但成功行使这种能力在某种程度上被阻止，例如由于外部干扰（有关掩盖的讨论，请参见 A. Bird 1998；Clarke 2009；Fara 2008；和 Johnston 1992）。分析的辩护者面临的挑战是要详细说明分析，以应对掩盖。可以说，应对这一挑战取决于提供所有可能的掩盖的非循环规范。我认为，奥斯丁会声称这是不可能的。因为在他看来，有时能力会被_残酷地_掩盖，没有任何可规定的掩盖。即使他在这一点上是错误的，挑战是否能够应对，或者潜在掩盖的无尽异质性是否使得提供一个解释性的规范成为不可能，仍然是一个悬而未决的问题。
...
* –––, 2014, “Austin on the Philosophy of Perception”, in Brian Garvey (ed.), _J.L. Austin on Language_, Basingstoke: Palgrave Macmillan: 161–176. doi:10.1057/9781137329998\_10
