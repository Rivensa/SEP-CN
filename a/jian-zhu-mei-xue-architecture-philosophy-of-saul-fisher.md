...
其次，本质主义可能代表了一个错误的开始。根据一种非本质主义观点，建筑物的本质是我们所经历的，这是一个我们可能会同意的问题，但它在一定程度上取决于主观感知、接受和与作品的互动（Scruton 1979/2013）。这意味着建筑可能具有基本方面，但我们只是不以这种方式体验它们。更坚决的唯名论者认为，建筑物之间的多样性足以扼杀它们共享任何基本方面的可能性。
...
作为抽象主义和具体主义之间的替代方案，一种多元论本体论（根据 Danto 1993）允许“物质基础”和“美学思想”作为不同类型的建筑对象。Goodman 的解释（1968/1976）适合于多元论，或者至少是方面性的阅读。他提出，除非满足某些条件，否则建筑对象可以被确定为完美实现相应计划或其他适当建筑符号的结构（见 §4）。根据他的唯名论观点，这些对象最终是建筑结构，但是一个可行的现实主义解释——可能更好地适应他的故事中的多个对象——将这些对象视为这类结构的类别。
