...
最困难的辩论是关于(iii)的，因为传统解释是基于一些脆弱的假设。亚里士多德从未以“_topoi_”的名义称呼这些特定项目，这一点也很重要，因为在《修辞学》I.5-15 中列出的特定项目通常具有纯粹命题或前提的形式，而不是我们从《论题》中所知的_topoi_的形式（参见上文[§ 7.3](https://plato.stanford.edu/entries/aristotle-rhetoric/#IngrFuncTopo)）。这就是为什么一些作者坚持认为，_topoi_（被认为是常见的）和_idia_之间的区别不是不同类型的_topoi_之间的区别，而是_topoi_和其他东西之间的区别，尤其是前提、普遍接受的前提或由艺术所建立的前提。这个反对意见有几个版本。(a) 一些作者赞同 Solmsen 1929 的观点，即存在两种类型的推理，代表亚里士多德逻辑思维发展的不同阶段，一些推理来自_topoi_（源自亚里士多德早期的非三段论逻辑），而另一些推理则是通过三段论的形式从前提中构建的（因此预设三段论逻辑），而不是来自_topoi_。根据这个观点，第一卷《修辞学》中给出的特定_topoi_是后一种类型的推理的前提，而前一种类型的推理的推理仅来自常见的_topoi_。从这个观点来看，只有常见的_topoi_才是适当意义上的_topoi_，而特定的_topoi_严格来说只是前提。因此，人们预期在《修辞学》的第一卷中会找到“所有_F_都是公正的/高尚的/好的”这样的命题；通过这样的命题，可以构建如“所有_F_都是公正的/高尚的/好的-这个特定的_x_是_F_-这个特定的_x_是公正的/高尚的/好的”的三段论。对于 Solmsen 的观点，有人反对说，实际上在第一卷中得到的东西很难符合 Solmsen 的模型。在某种意义上，亚里士多德在这里给出的不仅仅是孤立的命题，还有某些命题以及理由或证明。此外，《修辞学》的 I.6-7 章提供了一些_topoi_，这些_topoi_也可以在《论题》的第三卷中找到；在《论题》中，它们明确被称为“_topoi_”，因此不太可能认为它们是前提而不是_topoi_。(b) Grimaldi 1958 要求，为了构建一个修辞论证，需要_topoi_提供的逻辑形式以及特定前提或_idia_提供的材料（内容）。Rubinelli 2009 提出了这种“互补性”观点的更精细版本，然而，他也允许有可能有一些推理仅来自_topoi_，而其他推理仅来自_idia_。对于 Grimaldi 的观点，有人反对说，列在第 II.23-24 章中的许多常见_topoi_并不基于语言、语义或逻辑类别，就像《论题》中的与话题无关的_topoi_那样。其中一些只提供战略建议，例如，将对自己的指责转嫁给说出这些指责的人。因此，将《修辞学》中的常见_topoi_解释为提供逻辑推理方案是误导性的。(c) Havrda 2019 攻击了传统观点的假设，但也没有接受 Solmsen、Grimaldi 或 Rubinelli 提出的替代方案。根据他的观点，亚里士多德从未区分常见和特定的_topoi_。相反，他区分了修辞推理的两个不同来源；一个来源是辩证的，使用_topoi_，而另一个来源则基于艺术和科学提供的定义，不使用_topoi_。

## 8. 风格：如何用言辞表达

_Rhet._ III.1–12 介绍了“lexis”的主题，通常被翻译为“风格”。这个主题直到_Rhetoric_ II 的最后一段才被宣布，所以大多数学者认为这一部分是一个相对独立的论文。将这篇论文插入到_Rhetoric_中的原因是，虽然_Rhetoric_ I 和 II 讨论了思想（dianoia），即演说家应该说什么，但仍然需要探讨说同一件事的各种方式。在_Rhetoric_ III.1–12 的过程中，亚里士多德使用了一些非常不同的方法来解决这个任务。在对交流和风格领域进行初步探索之后（III.1），亚里士多德试图确定良好散文风格的要素；为此，他必须深入研究各种名词的区分和选择，其中之一被定义为隐喻（III.2）。接下来的第 III.3–6 章涉及的主题与良好散文风格的主题最多只有松散的联系；其中包括良好风格的相反，即冷淡或令人畏缩的风格（_psuchron_）（III.3），比喻与隐喻有关（III.4），正确的希腊语问题（III.5），适当性（III.7）以及使风格冗长和庄重的手段（III.6）。第 III.8–9 章介绍了两种与风格问题无关的新方法：散文风格的韵律塑造和言语的周期性和非周期性流动。第 III.10–11 章讨论了演说家如何“使事物显而易见”，这相当于使风格更生动。再次，隐喻被证明在这一目的中起着至关重要的作用，因此隐喻的主题再次被提及并通过大量的例子进行了深入探讨。第 III.12 章似乎重新开始，区分口头和书面风格，并评估它们在三种演讲类型中的适用性（参见上文[§2](https://plato.stanford.edu/entries/aristotle-rhetoric/#StruRhet)）。亚里士多德在_Rhetoric_ III.1–12 中关于风格的论文的哲学核心似乎包含在对良好散文风格的讨论中（参见下文[§8.1](https://plato.stanford.edu/entries/aristotle-rhetoric/#VirtStyl)），然而，隐喻的主题（参见下文[§8.2](https://plato.stanford.edu/entries/aristotle-rhetoric/#ArisMeta)）在后来的接受中引起了最多的关注，直到今天。

### 8.1 风格的美德

起初，风格的讨论属于诗歌艺术而不是修辞学；正如亚里士多德所观察到的，诗人们是第一个对风格研究产生冲击的人。然而，他承认风格问题或者更准确地说，不同的表达方式对于清晰度的程度可能会产生影响：“然而，关于“lexis”的问题在所有教学中都有一些必要的地位；因为以一种方式而不是另一种方式说话在清晰度方面会有一些差异；尽管不是很大的差异…”（_Rhet._ III.1, 1404a8–10）。清晰度再次对于理解很重要，而可理解性有助于说服力。事实上，亚里士多德甚至声称散文风格的美德或卓越（_aretê_）最终取决于清晰度，因为演讲的真正目的是使某事清晰明了。在散文演讲中，对事物状况的良好表达因此必须是清晰的。然而，仅仅说这些还不足以解释最佳或卓越的散文风格，因为清晰的语言表达往往是平庸或平淡的，而好的风格应该避免这种平庸。如果语言变得太平庸，它将无法吸引观众的注意力。演说家可以通过使用庄重或高尚的表达方式以及一般情况下偏离常规用法的所有表达方式来避免这种平庸倾向。一方面，不常见的词汇有引起观众好奇心的优势。另一方面，使用这种高尚词汇存在着严重的风险：每当演说家过度使用它时，演讲可能变得不清晰，从而无法满足散文演讲的默认要求，即清晰度。此外，如果词汇在与散文的主题（亚里士多德认为主要是日常事务）相关的情况下变得过于崇高或庄重，观众将会注意到演说家使用词语时的某种意图，并对演说家及其意图产生怀疑。因此，找到恰当的措辞既是清晰的问题，又不能太平庸；在努力避免太平庸的同时，必须使用不常见的、庄重的词汇和短语，但必须小心不要过度或不适当地使用它们与散文风格和散文演讲的典型主题相关。

将所有这些考虑综合起来，亚里士多德将良好的散文风格，即散文风格的美德，定义如下：“让语言形式的美德被定义为清晰，因为由于逻辑是一个（语言的，注）符号，只要它不清楚（它是符号的任何东西，注），它就无法发挥其适当的功能——既不平庸/低俗/平淡（_tapeinên_），也不过于应得的尊严，而是适当的（_prepon_）”（_修辞学_ III.2，1404b1–4；类似于 III.12，1414a22–26）。根据这个定义，散文风格的美德必须避免两种相反的倾向，两者都过度并且因此是谬误的：良好的风格以一种既不平庸也不过于庄重的方式清晰，而是适当的（与散文演讲的主题相称）。在这方面，风格美德的定义与亚里士多德伦理著作中伦理美德的定义遵循相同的模式，因为风格美德和品格美德都是以介于两种相反过度之间的中庸来定义的。如果将风格的美德定义为在平庸的清晰形式和过于庄重（因此不适当）的言辞之间的中庸，那么亚里士多德之所以只谈到散文风格的一个美德，而不是清晰度、装饰（通过庄重的表达）和适当性作为三种不同的风格美德，是有充分理由的。然而，从西塞罗和昆蒂利安斯开始，这三种美德连同希腊语或拉丁语的正确性成为演讲的四种规范美德（_virtutes dicendi_）。阅读亚里士多德时，学者们经常试图通过罗马修辞艺术的眼镜来确定他的风格的两种、三种或四种美德。

最后，如果风格的美德是关于在平庸的清晰度（乏味）和引人注目的庄重（在公众演讲中不恰当）之间找到平衡，演说家如何能够控制不同程度的清晰度和庄重呢？为此，亚里士多德给演说家提供了一个词语分类（几乎与《诗学》第 21 章中的分类相同）：首先，亚里士多德区分了标准表达（_kuria onamata_）和借用词（_glôtta_），即习语或方言表达。亚里士多德给出的这个后一类的大多数例子都来自不同的希腊方言，而这类例子中的大多数又来自荷马史诗的语言。其他类别由隐喻和一些在某种程度上被改变或修改的表达方式定义，例如新创词语（_pepoiêmena_），复合词语（尤其是新的或不寻常的组合词语（_ta dipla_）），以及延长、缩短或以其他方式改变的表达方式。有时，亚里士多德还使用术语“_kosmos_”，其中他收集了所有的修饰语和装饰性表达。这些不同类型的词语根据它们的熟悉程度而有所不同。最熟悉的是常用词，最不熟悉的词是借用词或新创词。隐喻也是不常见和不寻常的，因为它使用了一个通常的、众所周知的词来指代与其通常指代不同的东西（见下文[§8.2](https://plato.stanford.edu/entries/aristotle-rhetoric/#ArisMeta)）。最稳定的词语，即“_kuria_”，使其主题清晰，但不引起听众的好奇心，而其他类型的词语都没有被确立，因此具有异国情调或外来事物曾经具有的吸引力。由于遥远的事物是令人赞叹的（_thaumaston_），而令人赞叹的是愉快的，亚里士多德说，演说家应该通过使用这些不熟悉的词语使演讲令人赞叹和愉快。然而，演说家必须小心不要在散文演讲中使用过于庄重或诗意的词语。因此，通过选择和平衡使用这些不同类型的词语来实现风格的美德：对于散文演讲来说，使用常用和因此清晰的词语是基础。为了使演讲愉快和庄重，并避免平庸，演说家必须适度使用非熟悉的元素。隐喻在散文风格中起着重要的作用，因为隐喻既有助于清晰度，又具有避免平庸和乏味的不寻常效果，正如亚里士多德所说。
...
* 说服手段：_pistis_（在亚里士多德之前的用法中，这个词也指代演讲的某个部分）
* 隐喻：_metaphora_
* 有说服力的：_pithanon_
* 地点：_topos_（一个论证方案）
* 实践智慧：_phronêsis_
* 前提：_protasis_（也可以指“句子”，陈述）
* 可能的：_eikos_
* 证明：_apodeixis_（指“证明性论证，演绎”）
* 证明：_tekmêrion_（即必要的迹象或迹象论证）
* 符号：_sêmeion_（也可以表示“符号论证”）
* 风格：_lexis_
* 特定的_主题_：_idioi_ _topoi_（亚里士多德也称之为“_idiai protaseis_”或“_eidê_”）
