...
这些主题占据了《政治学》的剩余部分。第四至第六卷涉及现有的宪法：即三种异常的宪法，以及政体或“混合”宪法，这些在大多数情况下是最好的（IV.2.1289a26–38）。混合宪法一直是学者们特别关注的对象，因为它看起来像是现代共和制政权的先驱。第五卷全书探讨了革命或政治变革（_metabolê_）以及内战或派系斗争（_stasis_）的原因和预防措施。第七至第八卷则致力于理想宪法。正如预料的那样，亚里士多德试图实施这一计划面临许多困难，学者们对第四至第六卷和第七至第八卷之间的关系存在争议：例如，哪些是先写的，哪些是先阅读的，它们是否彼此一致。最重要的是，在第四至第六卷中，当亚里士多德提出实际的政治建议时，他是以最好的宪法作为规范理想，还是简单地放弃了政治理想主义，实行了一种现实政治？有关这个主题的进一步讨论，请参阅以下补充文件：
...
* 幸福：_eudaimonia_
* happy: _幸福_（eudaimôn）
* justice: _正义_（dikaiosunê）
* law: _法律_（nomos）
* 法律制定者：_nomothetês_
* 主人：_despotês_
* 自然：_phusis_
* noble: _kalon_ (也可以翻译为“美丽”或“优秀”)
* 人 (_dêmos_)
* political: _politikos_ (与城邦有关的，或与城邦相关的)
* 政治学：政治学（_politikê epistêmê_）
* 政治家：政治家（_politikos_）（也可称为“政治家”）
* 实践的：实践的（_praktikos_）
* 实践智慧：_phronêsis_
* 革命：_metabolê_（也可译为“变革”）
* 正确：_exousia_（也可译为“自由”）
* ruler: _archôn_（统治者：_archôn_）
* self-sufficient: _autarkês_（自给自足：_autarkês_）
* sovereign: _kurios_（主权者：_kurios_）
* 美德：_aretê_（也称为“卓越”）
* 无条件：_haplôs_（也称为“绝对”）
* 无权威：\*akuron
*
