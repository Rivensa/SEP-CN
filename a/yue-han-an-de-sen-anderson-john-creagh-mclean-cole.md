...
![一个有 3 列的表格，标题为“类别表”，第一列标为“逻辑或质量的类别”，列出了同一性、差异、存在、关系、普遍性；第二列标为“数学或数量的类别”，列出了从前一列链接过来的普遍性、特殊性、数目、顺序、数量；第三列标为“物理的类别”，列出了从前一列链接过来的数量、强度、物质、因果、个体](https://plato.stanford.edu/entries/anderson-john/ja_categories.jpg)
