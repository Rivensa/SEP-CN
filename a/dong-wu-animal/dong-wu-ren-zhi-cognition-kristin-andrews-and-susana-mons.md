...
动物展示出令人惊讶的行为的视频，比如一只猩猩洗衣服和锯木头，或者一只狗使用按钮“说话”（见[其他互联网资源](https://plato.stanford.edu/entries/cognition-animal/#Oth)），可能会让人认为这些动物很聪明或智能。一些动物比其他动物更聪明的想法也可能让你期望动物认知研究关注的是大猩猩、大象、海豚、狗或乌鸦等常常因其惊人能力而登上新闻的物种。但是动物认知研究对于蠕虫、蜜蜂、蛇、刺腹鱼、山雀和蜘蛛等物种的研究同样感兴趣，尽管对于行为主义的信鸽和大鼠仍然有相当多的认知研究。
...
这个关于科学术语使用的讨论是理解科学的理论负荷和价值负荷的起点。科学哲学的考虑可以帮助揭示科学家的选择如何影响研究。接下来，我们将考虑价值负荷、理论负荷、对客观性的关注以及对简单性美德的呼吁如何影响比较认知研究。

### 2.1 理论负荷

观察和术语的定义可能是理论负荷的，因为它们依赖于一组理论假设来进行解释。理论在动物认知的背景假设中起着作用，涉及跨物种心理的连续性或不连续性，或者涉及某些行为和某些能力之间的关系，或者涉及如何从研究对象中获得良好结果的最佳方法。

例如，达尔文对物种之间心理连续性的感知是一个理论负荷的承诺的例子，它塑造了数据的感知方式。在今天的科学家中，对连续性和不连续性存在多样的观点。有些科学家可能被描述为“浪漫主义者”，因为他们认为动物和人类在许多心理属性上是共享的，就像达尔文描述的那样。其他科学家可能被描述为“扫兴者”，因为他们否认动物具有许多人类的能力。这个术语首先由丹尼尔·丹尼特（1983 年）使用，并受到萨拉·谢特尔沃思（2010b 年）的批评，突显了一种理论负荷的科学方法的例子。试图避免从这两种观点中工作的尝试是为了寻找客观性，正如我们将看到的，这本身也面临着挑战。

动物认知研究在特定的研究范式中也可能受到理论的影响。我们可以看两个当前的例子。几十年来，将虚假信念任务作为测量儿童和动物心智理论的一种方法，可以追溯到三篇关于心智理论的科学研究的评论（Premack＆Woodruff 1978），这三篇评论是由哲学家丹尼特（1978），乔纳森·贝内特（1978）和吉尔伯特·哈曼（1978）提出的，他们首次提出了这种方法。这个建议反映了与心灵哲学中的功能主义相关的当前哲学理论，并且根据这个理论，行为是由命题态度（信念和欲望）引起的。

另一个例子可以在对非人类大型类人猿的社会学习和模仿研究中看到，这种研究基于这样一个理论，即人类与其他动物之间的重要差异在于人类文化的累积性质（例如，丹尼特 2017 年；亨里奇 2016 年；海耶斯 2018 年；斯特尔尼 2012 年；托马塞洛 2016 年）。根据这个理论，人类通过高保真度的模仿过程学习文化行为，即使是行为的因果无关方面也会被复制，即过度模仿，并且后续的几代人会创新改进，从而导致一个不断增长的技术社会。在这里，过度模仿被理解为一种人类强烈追求的能力，被认为是由社会因素驱动的，比如“融入”的愿望。大型类人猿已经多次接受过度模仿的测试，科学家们未能找到他们过度模仿的有力证据（尽管，使这个故事复杂化的是，有证据表明黑猩猩有时会过度模仿与其有长期关系的个体（Myowa-Yamakoshi＆Matsuzawa 2000），而家养狗有时会过度模仿它们的人类伴侣（Huber 等人 2018 年；Huber 等人 2020 年））。相比之下，年幼的儿童会毫不犹豫地过度模仿选择性实验者的行为（Clay＆Tennie 2018）。科学家们将这种结果模式描述为类人猿的“失败”和儿童的“成功”，并认为这支持了类人猿缺乏累积文化的理论。

### 2.2 价值负载性

科学哲学家们强调科学研究也是具有价值负载性的，因为科学家的价值观塑造了他们进行科学研究以及最终呈现的数据的方式。这在动物认知研究中也是显而易见的。价值观塑造了研究中选择研究的能力。例如，在 20 世纪期间，人们花费了大量精力试图教授大猩猩各种形式的语言交流，这是源于人类对语言的重视。价值观也塑造了科学家使用的方法。实验室中得出的实验证据通常被认为比野外研究中得出的观察性证据更有价值，因为实验设置的高度人为性会带来生态效度的丧失，但可以通过增加对影响动物表现的不同变量的控制能力来弥补。价值观还塑造了科学家对研究结果的解释。经验研究所提供的数据如果没有解释是无用的，而这种解释无法完全与科学家所坚持的价值观分离。这是因为科学家必须选择应用哪种统计方法，接受哪些理论，以及在撰写科学论文中遵循哪种叙事方式。

动物文化研究是价值导向性的另一个例子，因为其背后的驱动力是对人类文化的着迷，并试图描绘我们自己与其他类人猿物种之间的认知差异，以解释我们独特性的起源。这就是为什么在测试类人猿过度模仿的实验中得出的负面结果被描述为他们的“失败”。然而，根据过度模仿的定义，它是模仿与实现预期目标无关的行为，因此我们可以轻易地将这些结果颠倒过来，将其描述为证据，表明类人猿会选择更高效的解决问题的方法，而儿童则无法做到。这些结果没有以这种方式描述，表明了一种价值导向的观点，其中过度模仿被视为一种“可取”的能力，因为它与其他人类特征，如仪式、规范性和累积技术有关。

比较认知研究中研究设计的另一个很好的例子是镜像自我识别（MSR）测试，最初由戈登·加拉普（Gordon Gallup）（1970）设想用于探测动物的自我意识。在这个测试中，首先让动物熟悉镜子。然后，在第二步中，动物被麻醉，额头上涂上无味的标记。然后观察动物在镜子前的行为，看他们是否与标记互动，这将是他们理解镜子中的个体是自己的迹象。通过 MSR 测试被视为自我意识的标志，尽管是否显示对自己的思维或仅仅是自己的身体的意识存在争议（Heyes 1994, 2008; Povinelli 1998）。撇开 MSR 测试是否实际涉及这种能力的问题，这是一个理论导向性的问题，我们想要引起对方法论本身的注意。长期以来一直有人争论，动物可能因为与缺乏自我意识无关的原因而未能通过这个测试。例如，大猩猩未能通过这个测试与该物种倾向于避免与同类进行眼神接触有关，因为这被认为是一种威胁（Shillito, Gallup, & Beck 1999）。其他物种可能因为视觉不是它们主要的感觉模式而未能通过这个测试。例如，狗未能通过 MSR 测试，但通过类似的嗅觉测试（Horowitz 2017）通过。在这个替代测试中，狗被呈现出自己和其他狗的尿样。结果显示，它们花费较少的时间嗅闻自己的尿迹，这表明它们具有某种嗅觉自我识别能力。然而，对于人类来说，视觉是主要且最珍贵的感觉模式，这经常导致研究设计像 MSR 测试一样以视觉为中心。例如，共同注意力是通过注视跟随来测量的（Carpenter & Call 2013），Maria Botero（2016）批评了这一方法，认为对于非人类灵长类动物来说，触觉也可能是共同注意力产生的一种媒介。

尽管存在这些问题，MSR 测试仍然被视为自我意识研究中的黄金标准，这说明了人类对视觉自我认知的重视，以及我们未能意识到其他动物可能通过其他感官模式来认识自己。此外，MSR 测试假设被测试的动物在某种程度上关心自己的外貌。这是它们与标记互动的动力所必需的。在关于 MSR 测试的讨论中，这一点被认为是理所当然的，说明了我们对镜子传递我们期望的自我反映的重要性。然而，并不是所有动物都会立即关心这个问题。相反，它们是否关心很可能受到它们特定的生态和进化历史的影响。例如，最近发现一种小鱼——清道夫鱼通过了 MSR 测试，在镜子面前试图擦掉标记，并且如果标记是无色的或者没有镜子可用时则忽略它（Kohda 等人，2019）。当考虑到这种鱼类以视觉上检测到其他鱼类皮肤上的寄生虫为食，并且在它们头上种植的标记是故意制作成模仿这些寄生虫的颜色、大小和形状时，这个最初令人惊讶的结果变得不那么令人惊讶了。在清道夫鱼的生态环境中，这个标记显然是值得关注的，但对于所有物种来说可能并非如此。其他动物可能更关心它们的皮毛是否有意外的气味，而不是头上有一些杂物。

进一步说明了价值的负载性，比较心理学中的实验结果通常以一种描绘人类物种“优越”的方式进行传达，这可以通过一些将黑猩猩的表现与我们自己进行比较的实验来说明。例如，丹尼尔·波维内利和他的同事（1999 年）发现黑猩猩在追随凝视任务中表现优于儿童，但将儿童较差的表现解释为他们拥有更高认知能力的证据（参见 Leavens，Bard 和 Hopkins 2017）。在这个实验中，被试需要追随实验者的凝视来找到奖励，儿童和黑猩猩都能做到。然而，在一个条件下，实验者朝向奖励但凝视在奖励上方。虽然黑猩猩仍然可以利用这个凝视找到奖励，但儿童在这些试验中选择随机。波维内利等人将此解释为儿童而非黑猩猩具有心智理论，使得儿童能够将上方凝视解释为分心的凝视，不值得追随。然而，从黑猩猩的角度来看，也可以认为它们在这个任务中更为优越，因为它们比儿童更成功地找到了奖励。在另一个实验中（Jensen，Call 和 Tomasello 2007），黑猩猩在一项最后通牒游戏中进行了测试，其中一只黑猩猩（提议者）可以选择如何分配奖励给自己和另一只黑猩猩（回应者）。回应者可以选择接受提议（这样他们两个都保留奖励）或拒绝（这意味着他们两个都失去奖励）。实验者发现，只要回应者的份额高于零，他们总是会接受提议，无论分配是否不公平。黑猩猩的行为符合经济理论对完全理性行为者的预测，与人类相反，人类通常宁愿一文不值也不接受不公平的分配。尽管研究人员承认了这一点，他们还特别强调了这些结果如何说明黑猩猩缺乏特征（优越）人类社会所具有的公平敏感性，尽管他们未考虑到黑猩猩在食物分享以外的领域可能有公平规范。人类优越性叙事中进一步解释结果的另一个例子来自于井上早奈和松泽哲郎（2007 年）的一项研究，其中一只名为 Ayumu 的黑猩猩在工作记忆任务的速度和准确性方面明显优于人类。尽管在这篇论文中承认了黑猩猩的优越性，但其中一位作者（松泽 2010 年）后来利用这些结果强调了人类的认知能力优越性，主张在我们物种的谱系和个体发展中，记忆和抽象之间存在一种权衡，通过放弃我们的祖先可能与黑猩猩共享的摄影记忆，我们可以发展出我们特有的复杂表征和语言技能。

尽管人们可能希望客观性的呼吁能够帮助抵消科学的理论负荷和价值负荷，但科学哲学家倾向于将客观性描述为一种理想，而不是良好科学的可实现结果。鉴于客观性可以被理解为对事实的忠实，避免任何个人偏见或观点的价值和理论自由承诺——一种无处不在的观点——它最多只能作为平衡偏见的指南，而不是避免它们。

动物认知研究对客观性有着特殊的兴趣，原因在前两节中已经讨论过。此外，正如我们在[第 1 节](https://plato.stanford.edu/entries/cognition-animal/#WhatAnimCogn)中所看到的，达尔文可能强调物种之间的相似性而非差异性，暗示了一种将其他动物视为与我们相似的偏见。如果人类倾向于过分将动物视为类似于人类，那么可能需要一些原则来防止这种偏见。我们在比较心理学中看到了两个经典原则：摩根准则和反对拟人化。

英国生物学家和心理学家 C.劳埃德·摩根担心达尔文的方法强调我们倾向于将他人视为与我们相似的倾向，并且他感到有必要提供一种纠正我们以自我为中心的偏见的方法，现在被称为摩根准则：

> 如果我们可以将一个行为解释为较低心理层次的行为结果，那么在任何情况下，我们都不能将其解释为较高心理能力的行为结果。（摩根 1894 年：53）

摩根通过讲述托尼的故事来描述他的佳能相机。托尼是一只狐狸梗小狗，能够通过将头伸入门闩下方，抬起门闩并等待门打开来打开花园的大门并逃到马路上。虽然托尼看起来很聪明，他有一个目标，并且知道通过抬起门闩来实现目标，但摩根邀请我们考虑其他解释。也许托尼看到门闩是可抬起的，于是抬起了它，但并不知道门会打开或者想要出去。也许托尼将门闩与出去到街上联系在一起，并且想要去街上，所以他在不知道门闩如何工作的情况下推开了它。令人担忧的是，如果认为托尼是一只聪明的小狗，观察者就会产生拟人化的观点。

尽管从严格的字面意义上讲，“拟人化”只是指将人类特征归因于动物，但在比较认知中的常见用法中，它具有非常负面的含义，用于指代对动物错误地归因人类特征的行为。因此，拟人化与人类过度归因心理状态的倾向有关。这在 1940 年代已经得到证明，在弗里茨·海德尔和玛丽安娜·西梅尔（1944）的一项著名研究中已经得到证明。在这项研究中，人类参与者观看了一个视频，描述了动画几何形状在屏幕上移动的情景。尽管这些形状没有发出声音，也没有面部表情，但参与者不禁将它们的运动解释为有意识的行为，并构建了关于它们“互动”的叙事。这是我们拟人化偏见的一个特别严重的例子，它使我们倾向于用人类的术语解释各种实体（人类、非人类等）的行为。研究动物认知的科学家们对这种问题倾向非常清楚，并努力强调避免拟人化的重要性。

然而，关于需要避免拟人化的格言也是嵌入在比较认知中的哲学假设，因此它是可以质疑的。例如，有人认为，对动物归因人类特质的全面禁止会带来问题，因为这样假设了这些特质确实是独特的人类特质（Fitzpatrick 2017a）。Frans de Waal（1999）使用“人类否认”一词来指称事先拒绝人类和动物可能共享特征的可能性，并认为这与拟人化一样令人担忧。他指出，比较认知存在不平衡，即对动物心智能力的过度归因被视为比过度否认更为严重的问题。其原因在于，比较心理学家对违反摩根准则持谨慎态度。然而，de Waal 认为，通过竭尽全力保持“认知”简约性，比较心理学家可能忽视了“进化”简约性，后者规定我们应该提供在系统发生树中做出最少可能变化的解释。因此，我们应该避免人类否认和拟人化。Kristin Andrews 和 Brian Huss（2014）也提出了类似的观点，他们创造了“人类切除术”一词，指的是当动物实际上具有某种典型的人类能力时，否认它们具有这种能力的错误。他们认为，拟人化和人类切除术都是错误，它们都导致了对世界实际情况的错误描述，因此没有理由害怕其中之一。

虽然反拟人化试图避免在不存在心智时产生偏见，但它可能强调了人类特殊性的另一种偏见。人类切除术出现在人们将自己的认知能力视为复杂而将其他物种仅视为其稀释版本的情况下。例如，观察人类的文化实践并推断其他物种没有歌剧院，因此它们没有文化，这是人类切除术的表现。当我们犯自我服务偏见错误，并过快地假设我们比其他人更优越时，我们会误解自己和其他人。人类切除术的思维将这种偏见扩展到其他动物身上。

摩根还警告科学家不要进行人类解剖学。在我们可以称之为摩根的挑战中，他警告我们不要过快地将复杂的能力归因为解释人类行为的原因：

> 要解释动物行为，我们必须学会在比我们最高层次的反思自我意识更低的发展水平上看待自己的心智。这并不容易，并且有些带有悖论的味道。（摩根 1932 年：250）

摩根的观点是我们必须避免夸大人类的能力，并错误地否认我们与其他动物共享能力，这一观点已经在哲学家和心理学家的当前讨论中得到了采纳。例如，正如 Shettleworth（2010b）指出的那样，很多人类行为受到简单且常常无意识的认知机制的控制，这种机制通常只与动物有关。我们倾向于忽视这一点，结果有时会对人类产生拟人化的看法！不仅有一种忽视人类行为常常由简单机制引起的倾向，还可以看到一种夸大人类在各种任务上的能力的倾向。如果我们对人类的能力有误解，然后因为我们在其他动物中找不到这些虚构的能力而否认连续性的主张，那么我们就犯了一个双重错误——虚构人类的认知机制以及人类中心主义，这是卡梅伦·巴克纳称之为“人类中心主义”（Buckner 2013）的错误。例如，尽管我们知道人类的记忆在很大程度上是建构性和虚构性的，但许多比较心理学家通过期望动物能够在心理上重播过去的事件以获得情景记忆的能力来进行人类中心主义的推测（Suddendorf＆Corballis 2007; Tulving 1985; 引自 Buckner 2013: 830）。

理解摩根的一般观点的一种方式是，为了解释动物行为，我们需要有各种竞争的假设，并从中选择最合适的假设。摩根的准则暗示心理学上较低的解释是最好的，这与奥卡姆剃刀原则有关的一种简单性原则。但是，什么是最好的是科学哲学中的一个经典问题。我们接下来将讨论这个问题。

### 2.4 简洁性

在动物认知科学中，哲学假设显现出来的另一个方面是对动物行为的简单解释的偏好。简洁性长期以来被视为科学解释的一种优点，但决定哪种解释比另一种更简单是非常困难的。

在比较心理学中，尤其是在遵循摩根准则时，简单的解释被默认为零假设。这意味着除非有证据证明否定，否则它们被认为是真实的，并且证明的责任落在更复杂解释的一方。例如，对动物因果推理的研究将动物学习不同事件之间关联的能力作为零假设。然后，实验探究的是动物不仅能够进行这种简单形式的学习，还能否具备更复杂的理解某些事件*导致*其他事件的能力。当实验数据同时支持简单假设和更复杂假设时，科学家通常倾向于选择更简单的解释。例如，有人认为用于测试动物是否具备元认知能力（或思考自己的思维）的实验实际上可以通过仅使用一阶术语的推理（或思考世界）来通过。由于一阶思维被认为是对数据的更简单解释，因此有人认为应该优先选择这种解释（例如，Carruthers 2003; Hampton 2009）。

许多人认为，更简单的解释应该被优先考虑，这是将奥卡姆剃刀应用于动物认知研究的结果，而将一个解释称为“更简单”或“更简洁”通常被视为“讨论结束！”的等同。然而，在过去的几十年里，哲学家们认为，在比较认知中偏好简单性的做法比起初看起来更加棘手。首先，许多人认为在这种情况下，更简单的解释更有可能是真实的没有理由。更简单的解释可能具有其他优点，例如更容易理解或描述，但由于动物行为是自然选择的结果，而不是一个能够无误地提供最佳解决方案的智能设计过程的结果，因此没有理由认为它更有可能是由更简单的过程引起的（Mikhalevich，Powell 和 Logan 2017）。事实上，有人认为当科学家声称偏好更简单的解释时，实际上是其他考虑在起作用，比如我们应该避免对动物行为进行拟人化描述的想法（Fitzpatrick 2017a; Sober 1998）。我们可以在 Shettleworth（2010a）将更简单的解释与联想解释等同起来的地方看到这一点。她认为联想解释更值得推崇，但这不是简单性本身的结果，而是源于联想在动物界中的系统发生学广泛存在的观点，因此在她看来，联想解释更有可能是真实的。

实际上，简单本身并不存在。相反，我们所拥有的是根据我们如何以及我们专注于“简化”什么而有不同类型的简单。Irina Mikhalevich（2017）认为，简化可以通过同质化来实现，即通过减少实体类型的数量；通过减少实体数量来实现；或者通过理想化，即去除不被视为关键的实体。Simon Fitzpatrick（2009）在比较认知的文献中区分了五种不同的简单理想概念：

1. 简单作为心理统一（倾向于通过假设单一认知机制来统一不同行为的解释）；
...
1. 物种*x*的个体从事行为*y*。
2. 个体从事行为*y*的最佳科学解释是他们拥有思维。
3. 因此，物种*x*的个体很可能有思维。

当我们寻找一个现象的最佳解释时，我们首先必须产生一些假设，然后在它们之间做出决策。最佳解释将是那个能够产生准确预测并与我们其他科学承诺相一致的解释。
...
关于信念、概念、感知、心理表征、非概念内容、理性和推理的哲学探讨既涉及动物是否具有与思维相关的能力的问题，也涉及这些能力的本质问题。尽管当代关于这些主题的讨论很多，但这与哲学心灵学的历史发展相比，可以说是最近才出现的转变。在很大程度上，哲学心灵学一直只涉及人类的思维形式，这并不是因为缺乏兴趣，而是因为人们坚信只有人类才能思考。例如，笛卡尔曾经著名地论证过，动物缺乏语言能力使我们有充分理由认为它们没有任何形式的思维或理性。
...
交流是另一个利用动物研究数据来帮助塑造哲学理论的领域。许多人从 H.P.格赖斯（H.P. Grice）的观点出发，他提出，如果演讲者以意图发出*x*的话语，那么演讲者只有在这种情况下才意味着某种东西。
...
* –––, 1871 \[1874], *The Descent of Man*, London: J Murray. Second edition 1874. \[[Darwin 1871 and other editions available online](http://darwin-online.org.uk/EditorialIntroductions/Freeman\*TheDescentofMan.html)]
...
* Sneddon, L. U.,, 2006, “Ethics and Welfare: Pain Perception in Fish”, *Bulletin of the European Association of Fish Pathologists*, 26(1): 6–10. \[[Sneddon 2006 available online](https://www.wellbeingintlstudiesrepository.org/acwp\*aff/5/)]
