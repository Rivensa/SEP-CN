...
Searle（1969）也为另一个混合账户进行了辩护（参见 Searle 1975b：322 和 Searle＆Vanderveken 1985）。Searle 对断言的描述在他的著作中略有不同，但核心思想是，可以通过其独特的规则来确定断言的身份 - 发出断言的“成功”和“非缺陷”（即顺利）的规则。它们被呈现为使用力指示装置的规则（Searle 1969：62-4）。这些规则可以总结如下。这里_S_是说话者，_H_是听话者：
...
* Davidson, Donald, 1979, “Moods and Performances”, in _Meaning and Use_, Avishai Margalit (ed.), Dordrecht: Springer Netherlands, 9–22. doi:10.1007/978-1-4020-4104-4\_2
...
* –––, 2010, “Literal Force: A Defence of Conventional Assertion”, in _New Waves in Philosophy of Language_, Sarah Sawyer (ed.), London: Palgrave Macmillan UK, 108–137. doi:10.1057/9780230248588\_7
...
* –––, 2013b, “The Single Norm of Assertion”, in _Perspectives on Pragmatics and Philosophy_, Alessandro Capone, Franco Lo Piparo, and Marco Carapezza (eds.), Cham: Springer International Publishing, 35–52. doi:10.1007/978-3-319-01011-3\_2
