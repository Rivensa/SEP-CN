...
Floridi (2012)将强语义信息理论扩展到传统认识论的问题上。他的账户网络理论涉及到这样一个论点：如果强语义信息被嵌入到一个能正确解释它的问题和答案网络中，那么这对于强语义信息来说是必要且充分的，以便被视为知识。Floridi (2008)发展了一个相关语义信息理论，以阐述一个认识论相关性理论。在这里，他认为相关语义信息的性质是对真实性论题的进一步证明。在 Floridi (2011)中，他进一步探讨了语义信息成为真实的含义。他不接受对应、一致性或实用主义的真理理论，而是发展了他所称的真实性论题的正确性理论，该理论与上述的账户网络理论直接相关。
