...
Carnap认为哲学的作用是分析和澄清科学语言，并制定和推荐替代语言。1932年后，他认为存在不仅仅是符号变体的表达能力不同的语言。直观逻辑和经典逻辑的差异在这里是一个重要的例子，牛顿力学语言和相对论力学语言的差异也是如此。（他说，早些时候，他“忽视了可能存在多种语言的事实”，Carnap 1934, 245; 同一作品的322页也有类似的内容。）在给定的语言中，对于某个特定主题可能只有一个正确的理论。但选择语言在这方面与选择理论不同。在确定哪个理论是正确的时候，我们会依靠观察，但也会依靠语言的规则；而在选择语言时，我们无法进行这样的依靠，因为在这种情况下，我们选择的是规则本身。因此，Carnap认为没有一个正确的语言。这个想法被称为宽容原则；从20世纪30年代开始，它成为Carnap对哲学的看法以及它与科学的区别的基本观点。（Carnap从不质疑这种区别的存在。）因为没有一个正确的语言，所以哲学家的工作不是规定这种或那种语言，而仅仅是分析、澄清和提出替代方案。
...
奎因对意义概念的怀疑受到了很多批评。我们将提到两个批评。首先，当他说分析性的概念不够清晰时，他使用了什么标准的明确性？答案在奎因（1951）中没有明确提到，但可以通过我们在前一节中讨论的标准来推断出来；奎因要求一个符合他的自然主义标准的解释（参见Lugg 2012）。这样的解释不会预设一个意义的概念，并且只会在定义或约定的方式上使用这些概念，这些方式是通过这些术语的字面意义来证明的。其次，对奎因在这里的立场的一些回应认为它显然会导致荒谬的后果，比如意义的交流将变得不可能，或者我们无法理解我们的语言（例如，参见Grice和Strawson，1956年）。但是，奎因对意义的怀疑并不会导致对意义性的怀疑。如果我们将意义性看作是具有意义的一种情况，那么我们可能会认为，除非有意义，否则我们的话语就无法具有意义。但是，奎因声称，这种思考方式是非常误导人的。在奎因1953年的著作中，他提供了一个粗略而简单的行为解释来解释意义性；从解释的过程中可以清楚地看出，这种方式的成功对于定义同义词或分析性没有任何帮助。

我们上面说过，奎因试图“对意义的概念提出质疑”，对使用这个概念来解释教义变化中涉及意义变化和不涉及意义变化的区别，并进而解释分析性的观点提出质疑。读奎因1951年的著作，人们可能会得出这样的印象，即他不仅仅是对这些观点提出质疑，而是完全拒绝了这些观点。然而，在后来的作品中，他自己提出了分析性的定义。对于一个特定的母语使用者来说，如果他通过学习使用一个或多个词来学习了一个句子的真理，那么这个句子就是分析性的（奎因1991年，270页；参见奎因1974年，78-80页）。如果一个句子对所有的母语使用者都是分析性的，那么它就是无条件的分析性的。按照这个标准，一些显而易见的真理，比如“未婚男子是单身汉”，很可能会被视为分析性的。如果我们将分析性句子集合看作是在逻辑推论下封闭的，正如奎因所建议的，那么，他说，所有的一阶逻辑真理“也许就可以被视为分析性的”（奎因1991年，270页）。与此同时，他开始接受某些信念的修正确实涉及意义的变化，可能是在足够明确的意义上（奎因1991年，270页）。
