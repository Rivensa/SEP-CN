...
*首次发表于 1997 年 8 月 20 日，实质性修订于 2021 年 8 月 12 日。*
...
在本条目的其余部分，我们以我在条目开头所做的非常广泛的方式使用“感质”一词。因此，我们认为存在感质是理所当然的。在第 8 节中，我们将具体讨论感质作为内在的、非表征性属性的观点。
...
看起来，当玛丽被释放时，她不仅已经了解所有相关的真实世界物理事实，而且还会了解一些新事物，尽管她经历的新体验及其内省的感质完全是物理的。从日常的普通意义上讲，玛丽的知识增加了。可以争论的是，这就是物理主义者回答知识论证所需的一切。（值得一提的是，“事实”这个术语本身是含糊的。有时它用来指代仅仅是真实世界的事态；有时它用来指代在某些概念化下的这些事态。当我们上面提到物理事实时，我们应该理解为指的是仅仅是物理事态或者是在纯粹物理概念化下的这些事态。有关“事实”的更多信息，请参见 Tye 1995。）

一些哲学家坚持认为，在这种情况下，旧概念和新概念之间的差异是如此之大，以至于这些概念所代表或指示的属性之间必须存在差异（Jackson 1993，Chalmers 1996）。玛丽在牢房里就已经了解了其中一些属性，而其他属性只有在她被释放后才意识到。这对于玛丽来说是必要的，以进行真正的发现：她必须将红色的体验与她在房间里没有联系到的新的感质联系起来。物理主义者致力于否认这一主张；因为这些新的感质必须是非物理的。

这里的问题很复杂。物理主义者真正需要解决的问题是一个感质概念的理论（也就是所谓的特殊概念的理论，这些概念是从第一人称的角度出发，当我们认识到我们的经验是某种主观类型时所使用的），而这个理论本身又与物理主义相容。有一些提议（例如 Hill 1991，Loar 1990，Levine 2000，Sturgeon 2000，Perry 2001，Papineau 2002，Tye 2003），但至今还没有就这样一个理论应该采取何种形式达成一致，一些哲学家认为，一个恰当的感质概念的理论表明，物理主义者对于玛丽的房间的例子无法给出令人满意的答案（Chalmers 1999）。另一种可能性是，将感质概念理解为与其他概念在功能上非常不同的概念本身就是混淆的。从这个观点来看，那些曾经诉诸于感质概念来处理玛丽的房间的物理主义者是在错误的方向上努力（Tye 2009）。

另一个关于感质的著名反约简主义思想实验涉及到僵尸的可能性。哲学上的僵尸是一个分子级别上与有感知能力的生物完全相同的复制品，例如一个正常的人类，但与那个生物不同的是，它缺乏任何感知意识。当我躺在海滩上，愉快地喝着葡萄酒，看着海浪时，我经历了各种视觉、嗅觉和味觉的体验。但我的僵尸孪生体却完全没有任何体验。他没有任何感知意识。由于我的孪生体与我完全相同，他的内心心理状态在功能上与我的状态同构（假设他处于相同的环境中）。无论施加什么物理刺激，他都会以与我相同的方式处理刺激，并产生完全相同的行为反应。事实上，根据非感知心理状态是功能状态的假设（即以它们在介导刺激和行为之间的角色或功能来定义的状态），我的僵尸孪生体与我拥有完全相同的信念、思想和欲望。他与我唯一的区别在于体验。对他来说，凝视海浪或品味葡萄酒都没有任何感受。

假设存在哲学上的僵尸通常不是指这些僵尸在法则上是可能的，即它们的存在与实际自然法则是一致的假设。相反，这个建议是这种类型的僵尸复制品至少是可以想象的，因此在形而上学上是可能的。

哲学僵尸对感质的唯物主义观点构成了严重威胁。首先，如果僵尸复制品在形而上学上是可能的，那么似乎有一个简单的论证可以表明感知状态与内在客观物理状态并不相同。假设在某个适当的僵尸复制品中，客观物理状态 P 可以发生而没有感知状态 S（根据上述“可以”的形而上学意义）。直观上，S 不能没有 S 而发生。例如，疼痛不能没有疼痛而被感受到。因此，P 具有 S 所缺乏的一种模态属性，即可能在没有 S 的情况下发生。因此，根据莱布尼茨定律（对于任何 x 和任何 y，如果 x 与 y 相同，则 x 和 y 共享所有相同的属性），S 与 P 不相同。

其次，如果与我完全相同的人，在相同的环境中（包括现在和过去），可以没有任何感知经验，那么与经验和感觉有关的事实，即关于感质的事实，不一定由客观微观物理事实固定或决定。即使唯物主义者承认感知意识状态与内在客观物理状态并不严格相同，但她也不能接受这一点。对于唯物主义者来说，无论她是什么样的，她至少必须相信微观物理事实决定了所有事实，即在所有微观物理方面与我们完全相同的任何世界（包括最微小的细节，例如每个玻色子的位置）都必须在所有方面与我们的世界相似（包括相同的山脉、湖泊、冰川、树木、岩石、有感知能力的生物、城市等）。

一个众所周知的物理主义者对僵尸案例（Loar 1990）的回应是承认它们在概念上是可能的，或者至少在僵尸的概念中没有明显的矛盾，同时否认僵尸在形而上学上是可能的。由于反物理主义的论证需要形而上学的可能性，仅仅概念上的可能性是不够的，现在它崩溃了。事实表明，概念上的可能性对于反物理主义者的目的来说太弱（至少在没有进一步的限定和论证的情况下），因为即使在实际事实的基础上，概念上的可能性也是我不是迈克尔·泰（我是一个冒名顶替者或者是一个对他的过去情况不了解的人）。

## 4. 功能主义和感质

功能主义是这样一种观点，即个体的感质具有功能性质，例如，痛苦的现象特征与在介导物理输入（例如身体损伤）和物理输出（例如撤退行为）之间发挥某种因果或目标功能角色的属性是一致的。根据这个观点（Lycan 1987），感质是多重物理实现的。在物理上非常不同的内部状态可能感觉相同。对于它的感觉如何来说，关键是功能角色，而不是底层硬件。

对感质的功能主义理论有两个著名的反对意见：倒置光谱和缺失感质假设。前一种反对意见的第一步是声称当我看到绿色时，你可能看到红色，反之亦然；其他颜色也是如此，以至于我们的颜色体验在现象上是倒置的。然而，这对功能主义者来说还不足以引起麻烦。因为在这里，你和我在表征上肯定是不同的：例如，当我有一个代表绿色的视觉体验时，你有一个代表红色的视觉体验。而这种表征上的差异带来了我们与外部事物之间因果互动模式的差异（从而产生了功能上的差异）。

倒置感质的拥护者可以通过转向一种情况来回应这个问题，在这种情况下，我们在相同的场合上都有具有相同表征内容的视觉体验，但在现象上仍然存在差异。然而，这样的情况是否真正在形而上学上可能存在还有待争论。当然，那些对感质持表征主义立场的哲学家（见第 7 节）会否认它们的可能性。事实上，这样的情况是否在概念上可能存在甚至都不清楚（Harrison 1973，Hardin 1993，Tye 1995）。但是，撇开这个问题不谈，显然我们之间不可能没有一些显著的细粒度的功能差异，尽管我们在整体功能上是相同的。

考虑一个计算机的例子。对于任意两个数字输入 M 和 N，给定的计算机总是输出 M 和 N 的乘积。有第二台计算机也做同样的事情。这样，它们在功能上是完全相同的。这意味着它们运行的程序完全相同吗？当然不是！有各种各样的程序可以将两个数字相乘。这些程序可能有很大的差异。在一个粗略的层面上，这些机器在功能上是相同的，但在更低的层面上，这些机器在功能上可能是不同的。

对于你和我来说，倒置感质的反对者可以声称，即使我们在粗略的层面上在功能上是相同的 - 我们都称红色的东西为“红色”，我们都相信这些东西是红色的，基于我们的经验，我们都通过观察红色的东西而经历这样的经验等等 - 在我们的内部功能组织中必然存在细微的差异。这就是为什么我们的体验在现象上是不同的原因。

一些哲学家无疑会回应说，我们仍然可以想象你和我在所有相关方面都是功能上相同但感质上不同。但是，这个说法对于那些反对功能主义但接受物理主义的哲学家来说至少存在一个问题。因为想象分子级重复体中存在感质颠倒的情况（在相同的外部物理环境中）和想象功能重复体中存在感质颠倒的情况一样容易。如果前者的重复体真的是形而上学上不可能的，正如物理主义者所主张的，那为什么后者不是呢？需要提供进一步令人信服的论证来证明这两种情况是不相似的。在我看来，目前还没有提出这样的论证。（当然，这个回应不适用于那些认为感质是不可约的非物质实体的哲学家。然而，这些哲学家也面临着自己的严重问题。特别是，他们面临着感知因果性的问题。鉴于物理的因果封闭性，感质如何产生任何差异？更多信息请参见 Tye 1995 年，Chalmers 1996 年。）

缺席感质假设是一种假设，即有可能存在功能上与有感知能力的生物完全相同但缺乏感质的复制品。例如，有一位作家（Block 1980）要求我们假设十亿中国人每人都被配备了一台双向无线电，用于彼此之间和与一个人工（无脑）身体进行通信。身体的动作由无线电信号控制，信号本身根据中国人从天空中的一个巨大显示屏上接收到的指令制作而成，这个显示屏对所有人都可见。这些指令使得参与的中国人像个体神经元一样运作，而无线电链接则像突触一样，使得中国人共同复制了人脑的因果组织。无论这个系统是否会在实际中产生任何感受和体验，我们似乎可以合理地假设它可能不会。但如果这是一个真实的形而上学可能性，那么感质就没有功能本质。

对于像中国-身体系统这样的情况，标准功能主义的一个回应是勇敢面对并争辩说，无论看起来多么奇怪，中国-身体系统不可能不经历感质。根据一些功能主义者（Lycan 1987）的观点，这种观点的奇怪之处源于我们的相对大小。我们每个人都比中国-身体系统小得多，以至于我们看不到树木而只看到了森林。就像一个被困在人类头部内的神经元大小的生物可能会错误地相信那里不可能有意识一样，当我们思考中国-身体系统时，我们也会得出错误的结论。也有人争论说（例如，Shoemaker 1975），任何一个与我们之一完全功能重复的系统都必须受到所有相同信念的约束，包括关于其自身内部状态的信念。因此，中国-身体系统必须相信自己会经历疼痛；如果它有这种信念，那么它就不可能不成为某些经历（因此某些具有感知特征的状态）的主体。如果这个回应成功（关于这个回应的更新版本和一个新的相关思想实验，请参见 Tye 2006），它所展示的是具有某种感知特征的属性具有功能本质。但它并不表明个体的感质是功能性的。因此，一个人可以接受不存在感质是不可能的，同时也认为颠倒的光谱是可能的（参见，例如，Shoemaker 1975）。
...
我们在这里共享的表征具有与大卫·马尔在他著名的视觉理论（1982 年）中提出的 2 1/2 维草图的内容非常相似（有关详细信息，请参见 Tye 1995）。这个内容可以被合理地视为非概念性的。它形成了早期、主要是模块化的感官处理的输出，以及一个或多个更高层次认知处理系统的输入。表征主义者有时声称，正是在这个内容层面上可以找到感质（参见 Dretske 1995、Tye 1995、2000；关于相反的表征观点，请参见 McDowell 1994）。
...
对感质的再现观的反对往往采取假设的反例形式。其中一类是指声称经历具有相同再现内容但不同感知特征的情况。克里斯托弗·皮科克在他 1983 年的著作中举出了这类例子。根据一些人的观点（例如，布洛克 1990 年，舒马赫即将发表的著作），倒置光谱也提供了一个属于这一类别的例子。另一类是由所谓的问题案例组成，其中据称经历具有不同的再现内容（相关类型）但相同的感知特征。内德·布洛克的倒置地球例子（1990 年）属于这种类型。后者只威胁到强再现主义，前者旨在反驳强再现主义和较弱形式的再现主义。有时还会提供反例，其中声称存在某种类型的经历，但没有具有再现内容的状态。沼泽人（戴维森 1986 年）——我们中的一个人的分子级复制品，是在沼泽中部分浸没的原木被闪电击中时发生的化学反应意外形成的——根据一些哲学家的观点，就是这样一个反例。但还有更平凡的情况。考虑一下内源性的沮丧感。看起来，它没有再现内容。同样，内源性的兴奋感也是如此。然而，这些经历在感知上肯定是不同的。
...
在倒置地球问题上，有一些可供选择的回答（参见 Lycan 1996，Tye 2000）。这些回答要么是否认感质在转换到倒置地球时保持不变，要么认为可以制定一种非目的论的感官内容解释，其中感质保持不变。
...
罗素式一元论者可以说他们同意二元论者关于僵尸的可想象性（实际上是形而上学上的可能性）。他们可以声称，僵尸是可想象的，因为可以想象存在与我们相同但在现象上相关的感质方面不同的存在。这些存在在结构上、功能上和行为上与我们完全相同，但缺乏任何意识状态。
...
* –––, 2015, “Neuro-Cosmology,” in *Phenomenal Qualities: Sense, Perception and Consciousness*, P. Coates & S. Coleman (eds.), Oxford: Oxford University Press.
