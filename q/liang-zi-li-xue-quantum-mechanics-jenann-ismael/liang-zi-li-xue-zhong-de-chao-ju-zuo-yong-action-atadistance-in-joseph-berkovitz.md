...
> \*\* 经验充分性\*\* _P_ψ *lr*(*x\*\*l* & *yr*) = ∫λ _P_λ *lr*(*xl* & *yr*) · ρψ *lr*(λ) _P_ψ *l*(*x\*\*l*) = ∫λ _P_λ *l*(*x\*\*l* ) · ρψ *l*(λ) _P_ψ *r*(*y\*\*r*) = ∫λ _P_λ *r*(*y\*\*r*) · ρψ *r*(λ).\[[4](https://plato.stanford.edu/entries/qm-action-distance/notes.html#4)]
...
| *P_λ_l r*(*xl*) =*P_λ_l*(*xl*) | and | *P_λ_l r*(*yr*) =*P_λ_r*(*yr*). |
| ------------------------------ | --- | ------------------------------- |

> 结果独立性。EPR/B 实验中远距离测量结果的概率与附近测量结果无关。或者正式地说，对于任意一对的状态λ，L 设置 l，R 设置 r，L 结果 xl 和 R 结果 yr：

| *P_λ_l r*(*xl*/*yr*) =*P_λ_l r*(*xl*) | and | *P_λ_l r*(*yr*/*xl*) =*P_λ_l r*(*yr*) |
| ------------------------------------- | --- | ------------------------------------- |
|                                       |     |                                       |
| *P_λ_l r*(*yr*) > 0                   |     | *P_λ_l r*(*xl*) > 0,                  |
...
> |ψ_8_ >_S_1+*S_2 = ∑*i ci* |α_i*>*S_1 |β_i*>_S_2.
...
> (PI) _P_λ *lr*(*xl* & *yr*) + _P_λ *lr*(*xl* & ¬*yr*) = _P_λ *lr*′ (*xl* & *y\*\*r*′ ) + _P_λ *lr*′ (*xl* & ¬*y\*\*r*′ ).
