...
> ![figure2  commoncause model of the EPR/B experiment](https://plato.stanford.edu/entries/qm-action-distance/figure2.jpg)
>
...
> ![figure4  EPR/B experiment with SternGerlach measurement devices](https://plato.stanford.edu/entries/qm-action-distance/figure4.jpg)
> 图4. 带有Stern-Gerlach测量装置的EPR/B实验。Stern-Gerlach 1打开，用于测量L粒子的z自旋，而Stern-Gerlach 2关闭。左侧的水平线表示在L粒子上进行（冲击性的）z自旋测量后处于自旋纠缠态的六个L粒子的轨迹，右侧的水平线表示相应的R粒子的轨迹。中心平面与z轴正交对齐，因此从该平面上方出现的粒子对应于z自旋“上”结果，而从该平面下方出现的粒子对应于z自旋“下”结果。小箭头表示“非最小”Bohm理论（其中自旋是粒子的固有属性）中粒子的z自旋分量，对于“最小”Bohm理论（其中自旋不是粒子的固有属性）来说是无关紧要的。
...
> (PI)
> *P*λ *lr*(*xl* & *yr*) + *P*λ *lr*(*xl* & ¬*yr*) = *P*λ *lr*′ (*xl* & *y**r*′ ) + *P*λ *lr*′ (*xl* & ¬*y**r*′ ).
...
* ––– (2002b), “On peaceful coexistence: is the collapse postulate incompatible with relativity?’ *Studies in History and Philosophy of Modern Physics* 33, 435-466. [[Preprint available from the author](http://publish.uwo.ca/%7Ewmyrvold/PeacefulCoexistence.pdf).]
