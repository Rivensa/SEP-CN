...
*首次发表于 2002 年 5 月 3 日；实质性修订于 2019 年 12 月 6 日*
...
1900 年，马克斯·普朗克发现黑体辐射谱仅以离散能量出现，这些能量之间相隔 hν，其中 ν 为频率，h 为一个新的常数，即所谓的普朗克常数。根据经典物理学，这种连续辐射的强度会随着频率的增加而无限增长，导致所谓的紫外灾变。但普朗克的建议是，如果黑体只与辐射场以 hν 的比例交换能量，那么这个问题就会消失。能量的吸收和发射的不连续性与经典物理学的原理相冲突。几年后，阿尔伯特·爱因斯坦在解释光电效应时使用了这一发现。他提出光波是量子化的，并且每个光量子能够传递给阴极上的电子的能量恰好是 hν。下一步是在 1911 年，欧内斯特·卢瑟福德进行了一些实验，将 α 粒子射入金箔中。根据这些结果，他可以建立一个原子模型，其中原子由一个带有正电荷的重核和被负电子包围的电子组成，就像一个小型太阳系。这个模型也与经典物理学的定律相冲突。根据经典力学和电动力学，人们可能会预期，绕着带有正电荷的核心运动的电子会不断地发射辐射，以至于核心会迅速吞噬电子。
...
3. 卢瑟福指出，如果像玻尔那样假设光的频率 ν，即电子在跃迁中发射的光的频率，取决于初始能级和最终能级之间的差异，那么电子似乎必须“知道”它要朝哪个最终能级前进，以便以正确的频率发射光。
...
原子结构的玻尔-索默菲尔德核心模型在 20 世纪 20 年代初遇到了麻烦，因为它无法处理越来越多的光谱现象。1924 年，沃尔夫冈·泡利引入了一个新的自由度，根据这个自由度，具有相同已知量子数的两个电子不能处于相同的状态。一年后，即 1925 年，拉尔夫·克罗尼格、乔治·乌伦贝克和塞缪尔·古茨密特通过引入非经典的电子自旋概念解释了这个新的自由度。然而，有人认为，泡利的提议不仅对玻尔-索默菲尔德模型构成了致命打击，也对对应原理构成了挑战，因为“如何将对应原理所假设的经典周期运动与电子角动量的经典不可描述性相调和？”(Massimi 2005, p. 73)
...
12. 量子力学形式主义并没有为物理学家提供“图像化”表示：ψ 函数并不像薛定谔希望的那样代表一种新的现实。正如伯恩所建议的那样，ψ 函数的绝对值的平方表示测量结果的概率幅度。由于波动方程涉及虚数，所以这个方程只能具有象征性的特征，但形式主义可以用来预测在建立了位置、动量、时间和能量等概念适用于现象的测量条件下的测量结果。
...
这是因为量子力学中的虚数（其中共轭变量 p 和 q 的交换规则通过 qp−pq=ih/2π 将普朗克常数引入到形式主义中）使得量子力学无法给我们提供对世界的“图像”表示。波尔争辩说，相对论理论也没有给我们提供字面上的表示，因为光速在四维流形中的第四个坐标的定义中引入了一个 i 因子。因此，这些理论只能在明确定义的条件下以符号的方式用于预测观测结果。因此，许多哲学家将波尔解释为反实在论者或工具主义者。然而，波尔对量子力学中虚数的使用作为他拒绝图像表示的论据可能看起来有些不合适。虚数的使用更多地涉及到关于常规选择的问题，即测量是否应该用虚数或实数表示，而不是表明用这些数表示的某个数量不是真实的。Dieks（2017）对波尔的论点进行了细致的讨论，并得出结论，在量子力学的背景下，波尔认为虚数与不相容的物理量相关联。
...
互补性首先是量子力学的语义和认识论解读，具有某些本体论含义。玻尔的观点是，以现代哲学术语来表述，将某种运动学或动力学值归因于原子物体的句子的真值条件取决于所涉及的仪器，以这样的方式，这些真值条件必须包括对实验设置以及实际实验结果的参考。这一观点被称为玻尔的不可定义性论题（Murdoch 1987; Faye 1991）。因此，那些指责这种解释在测量过程中涉及波函数的神秘坍缩的物理学家是错误的。玻尔接受了波恩的统计解释，因为他认为 ψ 函数只具有象征意义，不代表任何真实的东西。只有当 ψ 函数可以给出图像表示时，才有意义谈论波函数的坍缩，而这一点他坚决否认。
...
康德主义。许多哲学家和物理学家认识到康德和玻尔思想之间的紧密联系，或者康德对玻尔的直接影响。在 30 年代，冯·魏茨塞克和格蕾特·赫尔曼试图以新康德主义思想来理解互补性。正如魏茨塞克多年后所说，“康德主义者和物理学家之间的联盟在康德时代是过早的，现在仍然是；在玻尔身上，我们开始看到它的可能性”。一系列现代学者（Folse 1985；Honner 1982, 1987；Faye 1991；Kaiser 1992；Chevalley 1994；Pringe 2009；Cuffaro 2010；Bitbol 2013, 2017；和 Kauark-Leite 2017）也强调了康德主义的相似之处。尽管这些学者发现了共同的主题，但他们对康德主义或新康德主义思想在视野玻尔对量子力学的理解中能够起到多大程度的作用存在分歧。另一方面，Cuffaro（2010）认为，“对玻尔的任何适当的解释都应该从康德开始”，并且“互补性自然地遵循广义康德主义认识论框架。”康德的假设是我们的直观形式和思维范畴构成了任何客观经验的先验条件。因此，空间和时间被称为直观形式，而因果关系、统一性、多样性和整体性等理解范畴是心智对出现在我们直观中的感觉印象施加的先验概念。类似地，有人认为玻尔将空间、时间、因果关系、统一性和整体性等概念视为先验范畴，这些范畴对于对量子现象的任何客观描述都是必要的，而经典物理学则是对这些先验概念的阐释和操作化。

实用主义。一些学者主张对于玻尔关于经典概念不可或缺性的论点提出更加实用主义的解释。在这种解释中，重点在于我们如何通过实验来了解原子。我们通过与原子系统的相互作用来了解原子，而不是通过描绘它们，这种相互作用可以用经验类别来解释。实用主义者通常拒绝将心智类别视为先验的状态，因为他们认为这些类别是偶然的。从物理学的角度来看，我们需要经典语言来理解我们的科学实践，这只是一个事实问题，不需要任何哲学上的证明（Dieks 2017）。同样，Dorato（2017）将玻尔的不可或缺论点与彼得·斯特劳森（Peter Strawson）的描述性形而上学进行了比较，后者认为我们都共享一个关于经验世界的共同概念框架，这个框架无法得到进一步的证明。Folse 也指出，在玻尔和 I.C. Lewis 之间的比较中，经典概念反映了我们的经验需求和共同利益，如果这些需求和利益发生变化，经典概念也可能发生变化（Folse 2017）。共同语言以及对一些基本经验概念的物理澄清的发展使我们得到了经典物理学，因为这种改进的语言使我们能够以明确和客观的方式进行观察的交流。正如玻尔所说：“即使现象超出了经典物理理论的范围，实验安排的解释和观察结果的记录也必须用简单的语言来表达，适当地补充技术物理术语。这是一个明确的逻辑要求，因为“实验”一词指的是我们可以告诉他人我们做了什么和学到了什么的情况。”（APHK，第 71 页）。使用经典概念来把握世界有助于相互理解。 这些经验概念为我们提供了物理实验的功能和结果的客观描述。
...
> Bohr 本人告诉我们，他关于配置空间维度的第二个论点是最重要的：“首先，与我们的普通概念之间不能有直接联系，因为……波动方程与所谓的坐标空间相关。”换句话说，在多粒子系统的情况下，薛定谔波不能是三维空间中的物理波（这将是一个“普通概念”），因为它“存在于”一个高维数学空间中（Dieks 2017，p.308）。
...
最近，玛拉·贝勒（1999）认为，只有在我们假设玻尔是一个激进的操作主义者或者一个简单的实证主义者的情况下，他的陈述才是可理解的。事实上，互补性在上世纪 30 年代被确立为量子力学的正统解释，当时实证主义在科学哲学中盛行，一些评论家认为这两者密切相关。在上世纪 30 年代，玻尔还与一些主要的新实证主义者或逻辑经验主义者保持联系，如奥托·诺伊拉特、菲利普·弗兰克和丹麦哲学家约尔根·约尔根森。尽管他们对科学的反形而上学方法可能对玻尔产生了一些影响（尤其是在 1935 年关于量子力学完备性的最后讨论中），但必须记住，玻尔始终将互补性视为对量子力学不确定性描述的必要回应，这是由于行动量子的结果。行动量子是一项经验性发现，而不是某种认识论理论的结果，玻尔认为不确定性是为了避免悖论而付出的代价。玻尔从未诉诸于验证主义的意义理论，也没有声称经典概念是操作定义的。但不可否认的是，一些逻辑经验主义者在玻尔的解释中找到了他们自己哲学的支持，无论对错，而玻尔有时也在某种程度上证实了他们的印象（Faye 2008）。
...
哥本哈根诠释并非一种统一的观点。这一认识在过去十到十五年间逐渐在科学历史学家和哲学家中兴起。詹姆斯·库辛（1994 年）和玛拉·贝勒（1999 年）都默认存在一个统一的哥本哈根诠释，并在他们对哥本哈根正统主导地位的社会和制度解释中，认为这一观点令人难以信服和过时，部分原因是他们通过海森堡的阐述来阅读玻尔对量子力学的观点。但科学历史学家和哲学家逐渐意识到，玻尔和海森堡关于互补性的观点在表面上可能相似，但在深层次上存在显著差异。唐纳德·霍华德（2004 年，第 680 页）甚至得出结论：“直到海森堡在 1955 年提出这个术语之前，没有一个统一的哥本哈根量子力学诠释。”这个术语显然首次出现在海森堡（1955 年）的著作中。此外，霍华德还认为，正是海森堡对互补性的阐述，而不是玻尔的观点，强调观察者的特权地位和观察者引起的波包坍缩，成为与该诠释相一致的观点。他说：“无论海森堡的动机如何，他对诠释的哥本哈根观点的发明，其中心是他自己独特的主观主义观察者角色观点，很快就找到了听众”（第 677 页）。这些听众包括像大卫·波姆、保罗·费耶阿本德、诺伍德·拉塞尔·汉森和卡尔·波普尔这样的人，他们以海森堡对互补性的阐述为批评正统观点的目标。然而，值得一提的是，在后来的工作中，费耶阿本德（1968 年，1969 年）是最早对互补性进行了详尽分析以消除其难以理解的神话的哲学家之一。费耶阿本德敦促哲学家和物理学家回到玻尔身上，仔细阅读他的观点。
...
但是，正如 Maximilian Schlosshauer 和 Kristian Camilleri（2008 年（其他互联网资源），2011 年）指出的那样，这并没有解决测量问题。Howard 没有解释在什么情况下可以从一个处于非可分离状态的量子系统兼测量装置转变为分离状态的混合物。因此，人们无法确定测量装置处于一个确定的状态，其指针处于一个确定的位置。一些哲学家似乎认为，玻尔是一个本体论的量子基础主义者，而不是一个认识论的量子基础主义者。例如，“玻尔相信量子力学的基本和普遍性质，并将仪器的经典描述视为纯粹的认识论行为，表达了一个给定的量子系统被用作测量装置的事实”（Landsman 2007）；以及类似的观点：“从玻尔的著作中可以得出这样的印象，量子-经典的分界是量子力学认识论结构的必要部分”（Schlosshauer 和 Camilleri 2008 年（其他互联网资源），2015 年）。因此，Klaas Landsman（2006 年，2007 年）接受了 Howard 的建议，认为玻尔是一个本体论的量子基础主义者，但他拒绝认为玻尔应该被视为一个认识论的量子基础主义者。Landsman 认为，玻尔认为测量仪器应该用经典术语来描述，因为任何测量的结果，就像在经典物理学中一样，总是具有确定的值。然而，Landsman 同意玻尔将所有物体都视为本质上是量子力学对象的观点。

然而，霍华德和兰斯曼似乎忽略了玻尔对本体论问题的实用性观点。玻尔曾多次提到，物理学不是关于寻找自然的本质，而是关于以明确的方式描述现象。玻尔思考的重点是：（1）对于测量结果的描述需要经典概念；（2）由于系统和测量仪器的纠缠，存在不可分割性；（3）互补性属性的测量具有语境性质；以及（4）量子形式主义的象征性特征。如果想要理解玻尔对经典-量子问题的解决方案，必须考虑这四个组成部分。根据玻尔的观点，在量子力学中，我们面临的是“无法将原子物体的行为与定义现象出现条件的测量仪器的相互作用明确分开”的困境（APHK，第 210 页）。这绝对是一个非经典特征，只能由量子力学来描述。在回应 EPR 论文时，玻尔坚决反对将这种形式的相互作用视为机械影响。这种影响是对描述条件的影响，即适用经典概念的实验条件。但在测量过程中，出于实用性的原因，我们需要将系统与测量仪器以及环境分开。实用性原因似乎是相当清楚的。无论进行何种实验，结果总是产生一个确定的值，因此由量子形式主义描述的物体和测量仪器的纠缠只持续到物体和仪器之间的相互作用停止为止。量子形式主义可以预测这些相互作用的统计结果，但无法对物体的轨迹做出任何说明。

Bohr 对于使用经典概念描述测量的坚持可以看作是他对测量问题的回应。这个问题源于量子力学本身无法解释为什么处于叠加态的物体实验总是产生确定的结果。因此，如果不主张波函数的自发坍缩、隐藏变量或多世界理论，就需要用钟表和测杆等经典描述来补充量子力学对测量仪器的描述。Henrik Zinkernagel（2015 年，2016 年）认为，波尔的观点似乎接近于他的观点，他认为波尔解决了测量问题，而是将其消解了。根据他的解释，波尔相信存在一个量子世界，但只相对于特定的经典描述和特定的经典世界。经典和量子（本体论和认识论）之间的区别是有上下文的。他认为，测量问题最终是本体论量子原子主义（即一切都是量子的）的结果。因为如果一切都是量子的，并且用量子形式主义正确描述（否则怎么称之为量子？），那么无论我们是否将仪器描述为经典的，测量结果最终都会处于叠加态。可以说，根据 Zinkernagel 的观点，波尔认为所有物体都可以被视为量子物体，但不能同时将它们都视为量子物体。借用两位俄罗斯物理学家 Landau 和 Lifshitz 的概念，Zinkernagel 声称，只有测量装置的某些部分与所讨论的物体纠缠在一起，而那些没有纠缠的部分存在为经典物体。根据上下文，物体在充当测量装置时不能被视为量子物体。 在这些情况下，测量设备的经典处理为我们提供了一个空间和时间的参考框架，相对于该框架，原子物体具有位置，并且相应地具有能量和动量。这样的参考框架对于我们定义和测量特定属性是必要的。用玻尔自己的话说：“在每种情况 [测量] 中，一些最终的测量仪器，如刻度和时钟，它们决定了空间-时间协调框架，最终甚至动量和能量数量的定义都依赖于此，必须始终完全按照经典方式进行描述，并因此保持在量子力学处理的系统之外”（CC，第 104 页）。参考框架的特征是它建立了归因于明确定义的位置或明确定义的动量的条件，并且经典处理的测量仪器正好充当参考框架。这意味着玻尔并没有排除量子理论对任何系统的应用。原则上，每个系统都可以量子力学处理，但由于我们总是需要一个参考框架来描述实验结果，因此并非所有系统都可以同时进行量子力学处理。
...
Rob Clifton 和 Hans Halvorson（1999 年，2002 年）认为，如果假设所有测量最终都归结为位置测量，那么玻姆对量子力学的解释可以看作是玻尔的互补性解释的一个特例。最初，Jeffrey Bub 和 Clifton（1996 年）能够证明（在一些理想化条件下），玻尔的互补性和玻姆的力学都属于他们的唯一性定理的无坍缩解释。Clifton 和 Halvorson 通过展示玻尔关于位置和动量互补性的想法可以用量子力学的 C*-代数形式主义中的不等价表示来表达，改进了这一结果。结果表明，位置或动量中的任何一个都具有动力学意义，但在任何单一的情境中，假设位置和动量都具有动力学意义是不允许的。基于这些假设，他们得出结论，玻姆的隐藏变量实际上就是互补性解释假设的“值状态”，如果位置测量始终具有动力学意义，但根据他们的结果，这种形而上学的限制并不是物理学所要求的。相反，Clifton 和 Halvorson（1999 年）以及 Halvorson（2004 年）认为，互补性可能为我们提供了量子场论的现实主义解释。
