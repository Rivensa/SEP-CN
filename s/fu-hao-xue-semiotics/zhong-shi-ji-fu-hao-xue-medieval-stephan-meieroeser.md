# 中世纪符号学 medieval (Stephan Meier-Oeser)
...
人类交流中使用的符号根据它们所涉及的感官进一步细分：“有些与视觉有关，有些与听觉有关，很少有些与其他感官有关”。奥古斯丁声称，所有“给定的符号”中，词语在其中起着卓越的作用，并不是因为它们数量上的优势，而是因为，正如他指出的那样，非语言符号所指示的一切都可以用言语表达，但反之则不行（奥古斯丁，《基督教教义》第二卷第七章，1963 年，35 页）。‘Word’（verbum）在其适当的意义上至少对于早期的奥古斯丁来说，意味着‘口头的话语’。写作（litterae）是人类引入的一种为了使口语具有持久性的辅助符号系统，它只是由“词语的符号”（signa verborum）而不是词语本身组成（奥古斯丁，《基督教教义》第二卷第八章，1975 年，86f.）。
...
在 12 世纪和 13 世纪初的逻辑教科书中，符号的概念并不起重要作用。在技术意义上，"符号"被视为所谓的同谓词术语的名称（例如，omnis [every]、nullus [no] 被视为普遍符号，quidam [a certain]、aliquis [some] 被视为特殊符号）（L. M. de Rijk, 1965–67, II/2.383）。根据亚里士多德的《论解释学》及其由博伊修斯翻译的文本，只有书面和口头的词语被认为具有意义。心理概念（passiones animae、intellectus、conceptus）被视为类似物（similitudines），而不是事物的符号。再次，正是在 13 世纪中叶，一个概念上的变化正在发生，尽管起初可能只是细微之处，但却是符号学历史上最重要的转折点之一：心理概念——虽然起初并没有失去作为事物类似物的地位——开始被描述为事物的符号（signa rerum）。确实，在博伊修斯、安瑟姆和阿贝拉尔的一些篇章中已经指向了这个方向（博伊修斯，《论解释学》第二版，1880 年，24 页；参见 Magee, 1989, 71 页；坎特伯雷的安瑟姆，《独白篇》，1968 年，25 页；阿贝拉尔，《逻辑学‘Ingredientibus’》，1927 年，315f 页）。但直到 13 世纪下半叶，这个观念才得到普遍接受，并与符号理论相关联。

这种观点的后果很多：例如，拒绝或至少修改奥古斯丁关于符号的崇高定义，以及在不涉及相似性概念的情况下描述概念与其对象之间关系的新可能性。此外，在语义三角中，博伊修斯的祷告秩序现在可以完全用符号和所指来描述。只要概念在其作为符号的功能上与语音表达一致，将思维过程构想为一种心理言语（oratio mentalis）并显示与口头话语密切类似是有意义的。这再次为心理逻辑的发展铺平了道路，其主要对象不再是语音术语和命题，而是相应的心理行为。将心理概念定义为 signa rerum 也为逻辑和认识论的紧密相互关系提供了基础，这在后期中世纪尤其显著。与此同时，对 significare（表示）概念的重新定义正在进行。因为如果将心理概念，即理解的行为（intellectus），视为符号本身，那么亚里士多德关于 significare（表示）的定义，即构成理解（constituere intellectum），就不再被认为是充分的。因此，“再现”（repraesentatio，repraesentare，facere praesens）这一术语，最初主要用于认识论背景下，通过与“表示”的术语融合，逐渐在逻辑语义学中变得越来越重要。最后，将心理概念描述为符号也可以看作是晚期中世纪逻辑中符号一般解释的主要动机之一。因为只有在这种条件下，逻辑不再仅仅关注任意符号，而是更多地关注自然符号。

## 7. 符号作为 14 世纪逻辑学中的核心概念

尽管在 13 世纪的术语逻辑学中，“significatio”被视为所有“术语属性”（proprietates terminorum）的基础，但威廉·谢伍德（William of Sherwood）和彼得·西班牙（Peter of Spain）的一代人对表示概念并不特别感兴趣。Significatio 被简要描述为“向智力呈现某种形式”（praesentatio alicuius formae ad intellectus）[44]或者“通过传统的语音表达来表示事物”（rei per vocem secundum placitum repraesentatio）（彼得·西班牙，Summule logicales，1972，79）。但详细的逻辑讨论从“suppositio”（指称）的概念开始，即从实词在命题语境中代表某物的能力。

然而，威廉·奥卡姆（约 1285-1347/49）开始将符号和意义的概念置于逻辑的中心地位（Biard 1981, 452; Biard 1989, Lenz 2003, Panaccio 2004）。逻辑被视为仅与符号有关，主要是心理符号，次要是口头或书面符号。奥卡姆将概念的指称集成到他对符号的定义中。他认识到，符号的一般概念作为使其他事物进入认知的东西太宽泛，对逻辑和语义理论来说没有用处；因此，他在定义中添加了一个标准，即符号在逻辑上的使用必须能够代表它使人们认知的事物，否则它必须是可以添加到代表某物的符号中的符号（natum est pro illo supponere vel tali addi in propositione）（威廉·奥卡姆，《逻辑总论》，1974 年，第 9 章）。因此，奥卡姆的逻辑符号概念被限制为后来被称为“命题符号”（signum propositionale）（约翰·劳林，《亚里士多德逻辑注释》，1500 年，fol. a5rb）。由于符号概念在他的逻辑中的核心地位，我们有权将奥卡姆的逻辑描述为“由符号概念统治”（“régie par le concept de signe”）（Biard 1989, 102）。奥卡姆经常提到符号的概念，他在许多情况下尝试对基本逻辑概念进行符号学重新定义（Biard 1989, 102-25），这反过来使他能够重新阐述传统的本体论问题，例如普遍性的问题、范畴的数量问题或关系的本体论地位问题，作为语义问题。

奥卡姆的逻辑标志着一个重要的，尽管不是唯一重要的，步骤，可以描述为符号的渐进“心智化”过程中的一部分。这个过程背后的想法是，如果没有某种形式的“意向性”，符号、意义和符号学现象将无法想象。将符号和意义的概念从口头语言的领域转移到心智的领域的倾向，是 14 世纪早期出现的心智主义逻辑的特征，并在后来的中世纪占主导地位。传统上认为，就理性论述而言，词语或符号是逻辑的基本主题。然而，根据心智主义逻辑的观点，“词语”或“符号”在逻辑上主要相关的不是口头语言，而是跨语言的心智词语（verba mentis）或心智概念。因此，在后来的中世纪逻辑中，正如在伯利和奥卡姆中一样，心智符号将成为逻辑语义学的焦点。根据彼得·奥费利（1330-1421）在 14 世纪下半叶引入的一个区别，

> …一件事物可以以两种意义上被称为符号。在第一种意义上，因为它导致了对其作为符号的事物的认识行为。在第二种意义上，因为它本身就是对事物的认识行为。在第二种意义上，我们可以说，一个概念是一个事物的符号，这个概念是这个事物的自然类似物，不是因为它导致了对那个事物的认识行为，而是因为它本身就是对那个事物的认识行为，[一种行为]自然而适当地代表了那个事物（彼得·奥费利，《概念》，1980 年，17 页）。

即使奥卡姆的语义学以及他的心理语言理论受到了严重的批评和修改，他的思维过程理论仍然是受到跨语言心理语法支配的术语逻辑定理的转化为思维过程理论的重要基础（奥卡姆的威廉，《逻辑总纲》，1974 年，11ff）[46]。尽管当然也有例外，但从 14 世纪开始，逻辑作者们普遍意识到符号概念的重要性。一些现实主义的神学家，如约翰·威克里夫（1330-1384）或斯坦尼斯拉斯·兹诺伊莫（约 1400 年），严厉批评了“符号教师”（doctores signorum）对符号的过高评价。根据斯坦尼斯拉斯的观点，逻辑的“虚无和无用的符号”只不过是人类堕落的必然结果（in penam peccati sumus necessitati in his vacuis et inanis signis erranter ambulare）（斯坦尼斯拉斯·兹诺伊莫，《论真与假》，1971 年，207）[47]。

## 8. 15 世纪和 16 世纪初的经院逻辑中的符号概念

随着奥卡姆，符号的概念成为逻辑理论的核心概念。然而，由于奥卡姆将命题符号作为逻辑中唯一相关的符号进行关注，最初只有一小部分符号学主题在逻辑中得到处理。与奥卡姆相反，晚期的术语逻辑以一种最普遍的理解为基础，讨论逻辑-语义主题（例如，terminus、significare、repraesentare、signum 等）。由于这种做法，虽然不直接涉及逻辑问题，但与符号学相关的主题开始在逻辑讨论的边缘积累。这一发展的顶点是约翰·梅杰（John Major，1469-1547）的巴黎学派，这是晚期术语逻辑研究最重要、最有影响力的中心。[48]

这个学派的成员将“signification”或“to signify”理解为“使（某人）知道（某事）”（facere cognoscere）的一般意义（Petrus Margallus, Log. utriusque scholia, 1520, 148）[49]，并按照旧的“repraesentare”的广义描述来构思它，根据这个描述，所有“以某种方式有助于认识一件事”的事物都可以被归为代表的功能（quod aliquo modo facit ad hoc quod res cognoscatur）[50]。因此，“to signify”经常被描述为“将某事物呈现给智力”（aliquid intellectui respraesentare）（Albert of Saxony, Quaest. in artem vet, 1988, 472；John Raulin, In log. Arist. Comment, 1500, fol. g4vb）。为了使这个定义适用于非智力的符号解释者（动物）[51]以及那些不恰当地表示“某事物”（aliquid）的所谓同谓词术语，还提出了一个更一般的版本，将表示行为定义为“以某种方式将某事物或某些事物或某种方式呈现给认知能力”（aliquid vel aliqua vel aliqualiter potentiae cognitivae repraesentare）（Gaspar Lax, Parve divis. term., ca. 1502, fol a4vb）。这个定义大致表达了从 14 世纪末到 16 世纪初的逻辑学家对“signification”概念的基本共识。尽管对于“signification”概念有许多定义变体，经常引发争议，但所有这些变体的共同点是它们主要是以认识论为导向的。与奥卡姆的符号概念相反，它不是指向一个“significatum”的逻辑功能处于前景，而是符号与认知能力的关系。 换句话说，符号的特征不是主要由其在命题背景下履行语义功能的适当性所决定，而是由其在认知能力上以认识论有效的方式发挥作用的能力所决定：“符号是使人思考的东西”（signum est res faciens cogitare）（彼得鲁斯·马加卢斯，逻辑学注释，1520 年，146 页）。与奥卡姆的符号语义概念不同，后来的作者更倾向于实用主义。

当彼得·奥艾利将表示行为定义为“通过生命力的改变来代表某物、某些事物或以某种方式影响认知能力”（aliquid vel aliqua vel aliqualiter potentiae cognitivae ipsam vitaliter immutando repraesentare）（彼得·奥艾利，概念，1980 年，16 页）时，这种倾向已经显而易见。通过“生命力的改变”（vitaliter immutare）进入“significare”的定义，与认知或认知能力的相关性成为意义的一个重要因素。正如约翰·格布维勒后来强调的：“没有这样的生命力改变，无论对谁都没有任何意义”（absque vitali immutatione nihil cuipiam significatur）（约翰·格布维勒，小逻辑艺术大师编纂，1511 年，h4r-h4v 页）。
...
* Fredborg, Karen Margarete: 1981, “Roger Bacon on ‘Impositio vocis ad significandum’“, in: *English Logic and Semantics: From the End of the Twelfth Century to the Time of Ockham and Burleigh*, ed. H. A. G. Braakhuis, C. H. Kneepkens, and L. M. de Rijk, Nijmegen: Ingenium, 167–191.
