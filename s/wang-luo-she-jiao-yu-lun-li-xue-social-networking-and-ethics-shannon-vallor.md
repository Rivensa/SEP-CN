...
学者们还注意到 SNS 架构通常对人类社交的细粒度缺乏敏感性（Hull，Lipford＆Latulipe 2011）。也就是说，这样的架构往往将人际关系视为一种，忽视了不同类型的社交关系之间的深刻差异（家庭，职业，同事，商业，公民等）。因此，这样的架构的隐私控制往往会削弱不同但重叠的社交领域内隐私规范的可变性。在隐私的哲学解释中，尼森鲍姆（2010）对情境完整性的看法似乎特别适合解释新社交媒体产生的隐私期望的多样性和复杂性（例如，参见 Grodzinsky 和 Tavani 2010; Capurro 2011）。情境完整性要求我们的信息实践尊重与上下文相关的隐私规范，其中“上下文”不是指“私人”和“公共”之间过于粗糙的区别，而是指一系列具有独特角色，规范和价值观的社交环境。例如，在 Facebook 上向家人和朋友发布状态更新的上下文中，相同的信息可能仍然被同一位披露者视为“私人”在其他情境中; 也就是说，她可能不希望同样的信息被搜索她姓名的陌生人提供，或者被银行员工检查她的信用历史。
...
对于 SNS 对用户自主权的伦理关注也被巴卡尔吉耶娃和加登（2012）所提出，他们指出，无论他们是否希望自己的身份以这种方式形成和使用，SNS 用户的在线自我都是由 SNS 开发者建立的类别构成的，并根据主要推动 SNS 社区狭窄的“道德经济”的货币进行排名和评估（2012 年，410 页）。然而，他们指出，用户并不完全无力对抗这种模式；用户保留并且许多人行使“自由做出知情选择并与他人协商自我构建和互动的条件”（2012 年，411 页），无论是通过采取措施抵制 SNS 网站的“商业要求”（同上）还是有意限制个人 SNS 实践的范围和程度。
...
### 3.4 民主、自由和公共领域中的网络社交服务

与隐私、身份、社区和网络社交上的友谊一样，关于网络社交对公共领域的公民辩论、自由和民主影响的伦理辩论必须被视为对互联网政治影响更广泛讨论的延伸，而这一讨论早在 Web 2.0 标准之前就已存在。关于这个问题的大部分文献集中在互联网是否鼓励或阻碍了公共理性辩论的自由行使上，这种行使方式受到了于尔根·哈贝马斯（1992/1998）关于公共领域中伦理辩论和决策民主的解释的影响（Ess 1996 和 2005b；Dahlberg 2001；Bohman 2008）。一个相关的关注点是网络社交通过鼓励形成“回音室”和“过滤泡泡”来分裂公共领域：这些是为了与自己观点相似的人而设立的信息孤岛，他们有意地避免接触其他观点。早期的担忧是这种封闭性会促进极端主义和错误观点的强化，同时也阻止了民主国家的公民认识到他们的共同利益和经验（Sunstein 2008），不幸的是，这些担忧已被证明是有根据的（如第 2.3.2 节所述）。早期的乐观主义认为网络社交将促进大众革命，导致威权政权的推翻（Marturano 2011；Frick and Oberprantacher 2011），但现实更为阴暗，网络社交更容易被用作宣传威权主义和极权主义运动，或者培养种族灭绝的冲动，比如 Facebook 被用来煽动对缅甸罗兴亚少数民族的暴力行为（BBC 2018）。

当特别考虑到这些问题时，网络社交（SNS）会引发一些独特的考虑。首先，与 LinkedIn 等较窄的 SNS 工具不同，Facebook 和 Twitter 等网站促进了各种类型的话语的分享和曝光。在 Facebook 上的任何一天，用户可能会在她的新闻动态中看到一篇受人尊敬的政治杂志文章的链接，然后是一只穿着可笑服装的猫的视频，接着是一篇新的科学研究的链接，然后是某人发布的关于午餐的冗长状态更新，接着是一张流行政治人物的照片，上面配有巧妙而颠覆性的字幕。度假照片与政治抱怨、文化活动邀请、生日提醒和旨在破坏常见政治、道德或经济信念的数据驱动图表混合在一起。因此，虽然用户有很大的自由选择关注哪种形式的话语，并且有工具可以隐藏或优先显示她网络中某些成员的帖子，但她的同伴们的私人和公共关注的多样性似乎至少提供了一定程度的保护，以防止与公共领域不兼容的极端封闭和碎片化的话语。

然而，在实践中，隐藏平台算法的功能可以打败这种多样性。这些算法通过对用户行为进行训练，以优化参与度和其他广告商和平台公司与其利润相关的指标，可以确保我只体验到我网络社交真正多样性的苍白阴影，只看到那些我最有可能主观上感到有价值并参与的帖子出现在我的动态顶部。例如，如果我支持黑人的命也是命运动，并且每当我看到我认为是朋友的人贬低 BLM 时，我都会感到沮丧和失望，那么平台算法可以轻松学习到这种关联，并优化我的体验，使之更有利于保留我的存在。然而，需要注意的是，在这种情况下，效果是算法和我的行为之间的相互作用。对于回音室和由此产生的极化或封闭性，用户承担多少责任，设计追踪和放大我们表达的偏好的算法的设计者承担多少责任？

技术哲学家经常谈论特定技术在特定环境中的可用性或梯度（Vallor 2010），因为它们使某些使用模式对用户更具吸引力或便利性（同时并不排除其他模式的可能性）。因此，虽然我可以寻找会让我感到不适或焦虑的帖子，但平台的梯度不会被设计成促进这种体验。然而，是否以及何时应该设计成这样并不明显。正如 Alexis Elder 所指出的（2020），社交媒体上的公民讨论可以通过谨慎使用断开连接的工具来推进，而不是受到阻碍。此外，使一个暴力的白人至上主义者在他们的社交环境中感到被接受、被重视、安全和受尊重（正是因为他们对白人至上主义暴力的态度和信仰）的平台可用性会对他人造成伤害，而使一个自闭症患者或一个跨性别女性感到被接受、被重视、安全和受尊重（因为他们的真实身份）的平台可用性则不会。公平和平等在 SNS 平台设计中并不意味着中立。伦理学明确要求在伤害和非伤害、正义和不正义之间不中立。但伦理学也要求在现实中进行认识论锚定。因此，即使我的态度和信仰不会伤害任何人，我仍然可能有一种规范认识论的责任来避免舒适的过滤泡泡。SNS 平台有责任阻止它们的算法帮助我进入其中吗？事实上，那些历史上被边缘化的身份很少有过滤泡泡选项的奢侈；在线和离线世界始终不断提醒他们被边缘化的事实。那么，SNS 设计师、用户和监管者如何在不使平台对弱势群体更加不友好的情况下，减轻过滤泡泡现象带来的有害政治和认识论影响呢？

人们还必须问一下，网络社交能否避免民主话语的全民公决模式所带来的危险，其中少数声音被众多声音分散和淹没。当然，与传统媒体偏爱的“一对多”沟通渠道相比，网络社交便于实现“多对多”的沟通模式，似乎降低了每个人参与公民话语的门槛，包括被边缘化的人。然而，网络社交缺乏确保少数化声音不仅享有自由，而且享有实质平等进入公共领域的制度结构。

我们还必须考虑网络社交上信息交流的质量，以及它们在多大程度上促进了真正对话和审议的公共领域，以及批判理性的行使。网络社交的规范往往偏向简洁和即时冲击，而不是沟通的实质和深度；Vallor（2012）认为，这对于培养对一个繁荣的公共领域至关重要的沟通美德是不利的。这种担忧只会被实证数据所加强，这些数据表明，网络社交延续了“沉默螺旋”现象，导致在重要的政治或公民问题上对不同观点的被动压制（Hampton 等，2014）。在相关批评中，Frick 和 Oberprantacher（2011）声称，网络社交促进公共“分享”的能力可能会掩盖分享作为“一种有前途的、积极的参与过程”和“被动的、不连贯的琐事分享”的深层模糊性。（2011，22）

在网络上，民主言论和辩论的普及程度与民主决策的相对缺失之间存在明显的差距。民主决策需要集体意愿的共同行使、合作和妥协，以及对行动基础上的共享现实的共识。我们时代最重大的道德挑战——应对气候变化危机、发展可持续的经济和社会生活模式、管理全球公共卫生威胁——不会通过意识形态战争来解决，而是通过审议性、协调性的公共智慧的行使。如今的社交媒体平台非常适合培养前者，但对于后者来说则不太适用。

网络民主的另一个重要问题与社交媒体平台上关于私人行为者应该容忍或惩罚有争议或不受欢迎言论的激烈辩论有关，尤其是当其后果在传统的线下环境和场所（如大学）中显现时。例如，美国的学术自由规范在“萨莱塔事件”中受到了严重动摇（该事件指的是伊利诺伊大学厄巴纳-香槟分校取消了对史蒂文·萨莱塔的终身聘用，原因是他在推特上批评以色列），还有其他几起学者因其有争议的社交媒体帖子而受到学校惩戒或其他处罚的案例（Protevi 2018）。然而，我们应该如何对待一位教授发表的帖子，其中表达了与学生发生性关系的愿望，或者对女性的智力或某个国籍的学生的诚信表示怀疑？在越来越多地通过网络社交服务进行中介的社区中，道德问责和言论自由之间能够找到什么平衡，这仍有待观察。相关的辩论涉及到那种经常被嘲笑为虚伪或表演性“虚伪信号”的社交媒体道德监督行为的伦理和社会价值。社交媒体平台在道德表演方面到底有多大的可行性，这些表演是否仅仅是表面文章？它们是否本质上是道德话语的“卖弄”滥用（Tosi and Warmke 2020），还是实际上可以成为社会进步和改革的积极力量（Levy 2020，Westra 2021）？

网络社交仍然需要观察市民话语和行动在网络社交服务(SNS)上在多大程度上会受到当前拥有和管理技术基础设施的商业利益的操纵或损害。这种担忧源于科技行业中公司的日益增长的经济和政治影响力，即卢西亚诺·弗洛里迪(2015b)所称的“灰色权力”，以及经济模式可能带来的剥夺和削弱效应，其中大多数用户扮演被动角色(弗洛里迪 2015a)。事实上，社交媒体用户与服务提供商之间的关系日益紧张，用户在经济背景下努力要求更多的隐私、更好的数据安全和更有效的在线骚扰保护，而他们在这种背景下几乎没有直接的议价权力(祖博夫 2019)。

2014 年，Facebook 的研究人员在没有用户知情的情况下，静悄悄地对用户进行了心理实验，通过改变其新闻动态中正面或负面内容的平衡来操纵他们的情绪(Goel 2014)。这项研究为现有关于依赖 SNS 生成的数据的社会科学研究的伦理和有效性的担忧增添了另一个维度(布坎南和齐默尔 2012)，这些担忧推动了一个日益重要和有争议的研究伦理领域(伍德菲尔德 2018，弗朗茨克等 2020)。

具有讽刺意味的是，在用户和网络社交服务提供商之间的权力斗争中，网络社交平台本身已成为主要战场，用户在这里发泄集体愤怒，试图迫使服务提供商回应他们的要求。结果有时是积极的，比如 Twitter 用户经过多年的抱怨，终于在 2015 年让该公司感到羞愧，提供了更好的在线骚扰举报工具。然而，由于其本质的混乱和争议，这个过程常常引发争议，比如在同一年，Reddit 用户成功要求 CEO Ellen Pao 下台，而在她的领导下，Reddit 禁止了一些令人厌恶的“子论坛”（比如“讨厌胖子”）。

从这里概述的考虑中，唯一明确的共识是，如果网络社交服务要促进哈贝马斯式公共领域的任何增强，或者任何正常运作的公共领域所必需的公民美德和实践，那么用户将必须积极动员自己来利用这样的机会（Frick 和 Oberprantacher，2011）。这种动员可能取决于抵制“虚假的活动和成就感”（Bar-Tura，2010，239），这种感觉可能仅仅通过点击“喜欢”来回应有意义的政治言论、转发签署请愿书的呼吁，或者仅仅在 Twitter 上“关注”一个直言不讳的社会批评家，而这些社会批评家的“推文”呼吁被公司公告、名人产品认可和个人评论的浪潮所淹没。有人认为，这还需要培养在线公民意识的新规范和美德，否则在线“民主”将继续受到自我毁灭和非理性暴民行为的统治（Ess，2010）。
