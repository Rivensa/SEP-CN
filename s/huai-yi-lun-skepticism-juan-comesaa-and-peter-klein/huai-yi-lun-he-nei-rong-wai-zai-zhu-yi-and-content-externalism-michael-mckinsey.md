...
希拉里·普特南（1981 年）提出了一种有趣且广为讨论的试图反驳基于脑中液体场景的怀疑论论证的方法。普特南试图反驳的方法基于内容外在主义（也称为语义外在主义）。根据这种观点，各种特指和泛指术语的指称和意义，以及包含这些术语的句子所表达的命题，都是由说话者外部环境的方面决定的。在本条目中，我们将考虑普特南原始论证的基本特点和问题，并介绍和讨论几种重要的重建或改进该论证的尝试。

---

## 1. 怀疑论假设和怀疑论论证

笛卡尔怀疑论描述了一种被认为在逻辑上可能发生的情景，即我们的心智生活及其历史与实际情况完全相同，但我们心智生活的事实的原因并不是我们通常认为的外部世界中的事件类型。根据笛卡尔的邪恶天才假设，不存在物质世界。相反，你是一个无身体的心灵，你的整个心智生活及其所有经历都是由一个全能的、纯精神的邪恶天才引起的。因此，你对外部世界的信念，比如你有一个身体，或者太阳系中有行星，都是错误的。根据脑中的大脑假设，一个人是一个无身体的大脑，生活在一个营养液罐中。大脑的神经末梢连接到一个超级计算机，其程序发送电脉冲，以与感知外部物体时实际大脑受到的刺激方式刺激大脑。如果你是一个大脑在罐子里，假设你的意识体验在整个心智生活过程中在质上无法区分与你所经历的体验相同。但是，如果由于计算机引起的经历的结果，你相信你有一个身体，那么你是错误的。

鉴于大脑在罐子里的假设，怀疑论者可以进一步论证我们认为自己知道的许多常识信念实际上并不为我们所知。一个常见的论证是基于广泛认可的封闭原则，即知识在已知蕴涵下是封闭的：

* （CL）对于所有人 S 和命题 p 和 q，如果 S 知道 p，并且 S 知道 p 蕴涵 q，则 S 知道 q。

现在选择任何关于外部世界的命题，你认为它是真实的，但与你是一个罐中的大脑不一致，比如说，你有一个身体的命题。然后怀疑论者可以如下论证：

* （SA）（1）你知道你有一个身体的命题蕴含着你不是一个罐中的大脑。【前提】
* ∴（2）如果你知道你有一个身体，那么你知道你不是一个罐中的大脑。【根据（1）和（CL）】
* (3)但你不知道你不是一个罐中的大脑。[前提]
* ∴ (4)你不知道你有一个身体。[根据(2)和(3)]

前提(3)似乎是合理的，因为无论你是一个正常的人类生活在正常的物理世界中，还是一个罐中的大脑，你都有相同的意识体验。因为你对每个选择的证据完全相同。所以你不知道你不是一个罐中的大脑。

## 2. Putnam 反对 BIV 怀疑论的论证

在 Putnam 关于脑在罐中假设的版本中，宇宙的内容现在和始终相对较少。只存在着营养罐中的大脑和与每个大脑相互发送和接收信息的超级计算机。Putnam 的假设假定每个存在或曾经存在的人类（以及每个有感知能力的生物）都是罐中的大脑之一。超级计算机非常聪明，它们与大脑的电子交互会导致每个大脑所属个体的心智生活和历史的精确复制。因此，我、你，事实上我们（所有人类）都是根据这个假设而成为罐中的大脑。让我们称这种罐中的大脑为“BIV”。

Putnam 的目标是反驳基于 BIV 假设的怀疑论论证，通过提供一个反论来得出结论，即我们不是 BIV。因此，每个人都有一种方式来知道自己不是 BIV，与怀疑论论证（SA）中的前提（3）相反。Putnam 论证中的关键一步是一个子论证，即如果一个人是 BIV，那么他将无法理解各种普遍术语的含义，比如“树”、“大脑”和“罐”。因为为了使“树”的话语能够代表或指称树木，Putnam 认为，使用“树”的行为和真实树木之间必须存在某种因果关系（Putnam 1981 [1999: 37]）。我将按照 Wright（1992: 71）的说法称之为“因果约束”。Putnam 假设类似的观点也适用于“大脑”和“罐”这些词，以及对这些词进行的心理话语和所表达的概念。由此可见，如果我们是 BIV，那么由于我们对“大脑”和“罐”的使用与实际大脑和罐之间没有正确的因果关系，我们甚至无法思考或说出自己是罐中的大脑（Putnam 1981 [1999: 31]）。
...
除了“图像中的大脑在罐中”，普特南还提出（1981 [1999: 36]）“大脑在罐中”可能指的另外两种可能性。它还可能指的是（ii）导致作为一个大脑在罐中的经历的电子脉冲，或者可能指的是（iii）导致这些电子脉冲的计算机程序的特征。我将使用“大脑*在罐中*”和“大脑在罐中 *”这两个表达来提供“大脑在罐中”在罐中英语中的这三种可能含义的概要表示，或者如果没有正确的含义，“大脑*在罐中 *”和“大脑在罐中*”则代表“大脑在罐中”在罐中英语中的含义，无论是什么。
...
但正如布鲁克纳自己早先指出的那样（1986: 165; 1995: 100），虽然我们可以以这种方式知道像(B *)这样的解引用句子是真的，但在我们知道使用的是哪种语言之前，我们无法知道表达的是哪个真理。在这种情况下，如果说话者是一个 BIV 说话的容器英语，那么(B*)将意味着“我的‘树是绿色的’的话是真的，当且仅当树*是绿色的”（其中‘树*’表示 Putnam 在容器英语中建议的‘树’的三种可能类型之一的意义）。因此，在假设说话者是一个 BIV 说话的容器英语的前提下，前提(B *)将是真的。然而，论证的结论(C)将意味着‘我不是一个 BIV*’，虽然这个结论也是真的，但对于 Putnam 所期望的结论（用英语表达）‘我不是一个 BIV’来说是无关紧要的。此外，请注意，如果理解为容器英语，前提(A*)将是假的。
...
“树”是一个自然种类术语。因此，可以合理地假设该术语的主要语义功能是在所有树所属的种类 T 中断言成员资格。但是假设不存在这样的种类 T。在这种情况下，普通术语“树”将没有语义值，因为根本就没有属于 T 的属性。因此，Brueckner 的前提 B*将不表达任何命题，也没有真值，因为术语“树”对 B*所说的内容没有语义贡献。因此，为了使前提 B*表达一个真理，必须存在一个自然种类 T，所有的树都属于该种类，因此 Brueckner 声称即使没有树，B*也可以是真的似乎是值得怀疑的。
...
沃菲尔德所说的“先验知识”是指在没有感知观察或经验调查的情况下获得的知识（1998 年：80；参见麦金西 1991 年）。沃菲尔德的观点是，一个人总是可以对自己思想的命题内容具有特权的先验知识（特权访问的传统原则），即使这些内容是外部的或广泛的，即具有该内容的思想在逻辑上意味着与行为体外部的特定对象或物质的存在（参见格特勒 2017 年关于自我知识的有用条目）。
...
我们已经研究了一些试图重建普特南的反怀疑论论证的尝试，这些尝试使用普特南的因果约束来驳斥基于脑中有罐头的情景和封闭原则（CP）的怀疑论论证。我们研究的大多数反怀疑论论证都以各种方式使用了解释原理，结果这些论证与布鲁克纳对普特南论证的原始重建方式类似地存在着问题。其中一些论证以一种不同的方式存在问题，这一点被哈尔（Hale）（2000 年）指出。
...
* Gertler, Brie, 2017, “Self-Knowledge”, *The Stanford Encyclopedia of Philosophy* (Fall 2017 Edition), Edward N. Zalta (ed.), URL = <https://plato.stanford.edu/archives/fall2017/entries/self-knowledge/>
...
* Kripke, Saul A., 1972, “Naming and Necessity”, in Donald Davidson and Gilbret Harman (eds.), *Semantics of Natural Language*, Dordrecht: D. Reidel:253–355. doi:10.1007/978-94-010-2557-7_9
...
* [Epistemology Research Guide](http://www.ucs.louisiana.edu/%7Ekak7409/EpistPapersBySubject.html#Skepticism), maintained by Keith Korcz, University of Louisiana.
