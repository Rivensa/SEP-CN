...
一些作者认为，奇迹论证实际上是一种谬误推理的例子，称为基本率谬误（Howson 2000：第 3 章；Lipton [1991] 2004：196-198；Magnus＆Callender 2004）。考虑以下例证。有一种疾病的测试，其假阴性率（疾病存在时的阴性结果）为零，假阳性率（疾病不存在时的阳性结果）为十分之一（即无病人群中 10％的人测试结果为阳性）。如果测试结果为阳性，那么患病的可能性是多少？基于假阳性率得出概率为 90％的结论是错误的，因为实际概率取决于一些进一步的关键信息：人群中患病的基本率（即患病人群的比例）。在整个人群中患病率越低，阳性结果表示患病的概率就越低。
...
逻辑实证主义计划的崩溃在一定程度上得益于 20 世纪 60 年代科学哲学的历史转向，与库恩、费耶阿本德和汉森等作者有关。库恩的影响深远的著作《科学革命的结构》在确立对科学知识历史主义形式的持久兴趣方面起到了重要作用，特别是在对科学实践本质感兴趣的人中间。历史转向的一个基本原则是认真对待科学的历史和实践，通过提供科学知识的现场描述来阐明。库恩认为这样的历史成果揭示了一个重复出现的模式：所谓的正常科学时期，通常持续相当长的时间（例如，受经典物理学或相对论物理学主导的时期），被革命所打断，将科学界从一个正常科学时期引向另一个。这种观点对实在论的影响源于库恩对革命分界线两侧知识的描述。他说，两个不同的正常科学时期在某种程度上是“不可比较的”，从而使得革命之后的世界变得重要不同（“世界变化”现象）。（关于这些主题的许多详细研究，请参见 Horwich 1993；Hoyningen-Huene 1993；Sankey 1994；Bird 2000 等。）

不可比性的概念适用于（包括但不限于）在正常科学不同时期运行的理论的比较。库恩认为，如果两个理论是不可比的，它们无法以一种允许判断一个理论在认识上优于另一个的方式进行比较，因为不同的正常科学时期具有不同的“范式”（对现象的符号表示、形而上学信仰、价值观和问题解决技术的承诺）。因此，处于不同正常科学时期的科学家通常采用不同的方法和标准，通过“理论负荷”的感知方式对世界有不同的体验，并且最重要的是对于库恩来说（1983 年），他们的术语的含义也不同。这是一种意义整体主义或语境主义的版本，根据这种观点，一个术语或概念的意义通过其在范式内与其他术语的联系来耗尽。网络中的任何部分的变化都会导致整体意义的变化——例如，“质量”一词在经典物理学和相对论物理学的背景下具有不同的含义。因此，任何关于后者对质量的描述更接近真相，甚至相关理论描述了相同属性的判断都是重要混淆的：它在两个不同的概念之间含混不清，这些概念只能以适当历史化的方式从它们所出现的范式的角度来理解。

Kuhn 所关联的范式变革中的感知、概念化和语言变化，也加强了他对世界变化的概念，进一步将历史主义方法与实在论对比。Kuhn 坚持认为，在科学革命之后，科学家们生活在一个不同的世界中，这在《结构》（[1962] 1970: 111, 121, 150）中是一个著名的神秘言论，但他（2000: 264）后来给出了一个新康德主义的解释：范式的功能是创造科学现象的现实，从而使科学家能够与这个现实互动。从这个观点来看，似乎术语的意义和指称都受到范式界限的约束。因此，反映出与新康德主义逻辑经验主义有趣的相似之处，范式超越的世界被科学家所研究，关于这个世界可能有知识，但没有明显的认知内容。在这种观点下，经验现实是由科学范式所构建的，这与实在论对认识一个独立于心灵的世界的承诺相冲突。

### 4.3 社会建构主义

科学哲学中历史转向及其对科学实践的强调的一个结果是对不可避免地围绕和渗透科学知识生成的复杂社会互动的关注。专家、学生和公众之间的关系，个人和机构之间的合作与竞争，以及社会、经济和政治背景成为一种被称为科学知识社会学（SSK）的研究科学方法的主题。虽然从理论上讲，从社会学角度研究科学的承诺可以被解释为在现实主义方面是中立的（Lewens 2005; cf. Kochan 2010），但在实践中，大多数受 SSK 启发的科学解释在暗示或明确上是反现实主义的。这种实践中的反现实主义源于一种常见的建议，即一旦人们意识到社会因素（将其作为上述互动和背景的一般术语）在科学知识的产生中所起的作用，对某种形式的“社会建构主义”的哲学承诺是不可避免的，而这种后者的承诺与现实主义的各个方面是不一致的。

“社会建构”一词指的是任何知识生成过程，其中事实的实质确定由社会因素决定，并且不同的社会因素可能会产生与实际产生的事实不一致的事实。这里的重要含义是关于事实依赖社会因素的反事实主张。社会决定事实性的方式有很多种，可能与实在论一致。例如，社会因素可能决定允许、鼓励和资助的研究方向和方法，但这本身并不会动摇对科学工作成果的实在主义态度。然而，社会建构主义的工作通常采用案例研究的形式，旨在展示特定决策如何影响科学工作，这些决策受到社会因素的影响，如果这些因素不同，将会产生与最终被接受为科学事实的结果不一致的结果。一些人，包括社会建构主义中所谓的强势派的支持者，认为出于更一般、更有原则的原因，这种事实的依赖性是不可避免的。（有关社会建构主义的一些有影响力的方法，请参见拉图尔和伍尔加尔[1979]1986 年；诺尔-塞蒂纳 1981 年；皮克林 1984 年；沙平和谢弗 1985 年；柯林斯和平奇 1993 年；关于强势派的研究，请参见巴恩斯、布洛尔和亨利 1996 年；关于从库恩到社会建构主义的转变的历史研究，请参见扎米托 2004 年第 5-7 章。）

通过将社会因素作为科学领域（以及其他领域）中真实与虚假的不可分割、实质性决定因素，社会建构主义与实在论的观点相对立，后者认为理论可以被理解为提供对独立于人类思维的世界的知识。与历史主义方法类似，真实、指称和本体论等概念在这里是相对于特定背景的；它们没有超越背景的意义。库恩和维特根斯坦的后期工作对“意义有限主义”的强势纲领的发展产生了重要影响，根据这一纲领，术语的意义被构想为社会制度：它们在语言社群内成功地进行交流的各种方式。这种意义理论构成了一个论证的基础，即科学（和其他）术语的意义是社会协商的产物，不需要固定或确定，这进一步与一些实在论观念相冲突，包括朝着真理理论的趋同、本体论或近似真理的改进以及对独立于人类思维的实体的确定指称的观念。因此，新康德主义的主题再次在这里出现，尽管其在建构主义学说中的力量有很大的差异。（对于一个坚定的有限主义观点，请参见库施 2002 年；对于一个更温和的建构主义，请参见普特南的（1981 年：第 3 章）“内在实在论”和参见埃利斯 1988 年）。

### 4.4 女性主义方法

女性主义与科学的互动在主题上与 SSK 和社会建构主义形式相关，因为它们承认社会因素作为科学事实的决定因素的作用。尽管如此，它们以一种更具体的方式扩展了分析，反映了对基于性别、种族、社会经济地位和政治地位的观点边缘化的特定关注。并非所有女性主义方法都是反现实主义的，但几乎所有方法都是规范性的，提供了修改科学实践和直接影响现实主义的客观性和知识等概念的建议。在这方面，区分三种广义方法是有用的（正如 Harding 1986 最初提出的）：女性主义经验主义关注科学社群内凭借透明度和考虑不同观点所带来的偏见而形成的合理信念的可能性。立场理论研究了科学知识与不同观点所产生的视角之间的密不可分的联系。女性主义后现代主义拒绝传统的普遍或绝对客观性和真理的概念。（正如人们可能预料到的，这些观点并不总是清晰可辨的；对于一些早期有影响力的方法，请参见 Keller 1985；Harding 1986；Haraway 1988；Longino 1990, 2002；Alcoff & Potter 1993；以及 Nelson & Nelson 1996）。

客观性的概念具有许多传统的内涵，包括无私（超然、无偏见）和普遍性（独立于任何特定观点或视角），这些内涵通常与对一个与心灵无关的世界的知识相关联。女性主义批评几乎一致地拒绝了客观性的科学意义上的无私，提供了旨在证明在科学界存在雄性中心偏见的案例研究，这些案例研究旨在说明如何以牺牲其他理论为代价来接受某一理论（Kourany 2010: chs. 1–3；有关详细案例，请参见 Longino 1990: ch. 6 和 Lloyd 2006）。可以说，在某些条件下，这种意义上的客观性的失败与实在论是一致的。例如，如果相关的偏见在认识论上是中立的（也就是说，一个人对科学证据的评估不受其影响），那么实在论可能仍然是科学工作产出的至少一种可行解释。在偏见在认识论上具有重要影响的更有趣的情况下，实在论的前景会减弱，但通过科学基础设施的运作，可以增强实在论的前景，该基础设施能够对其进行审查（例如，通过有效的同行评审、真正考虑少数意见等），从而在适当的情况下促进纠正措施。科学并不普遍具备这种基础设施的主张是女性主义经验主义的许多规范性的动机之一。

对于普遍性或透视独立性的客观性挑战，在某些情况下，可能更难与实在论的可能性相一致。在马克思主义的脉络中，一些立场理论家认为，在科学领域中，某些观点具有认识上的特权：即，相对于主导观点而言，被压制的观点由于能够提供更深入的洞察力而具有认识上的特权（正如无产阶级对人类潜力具有比权力者表面知识更深入的了解）。其他人以更分裂或泄气的方式描绘认识上的特权，暗示没有一个观点可以通过任何普遍的认识论评估标准来确立为优于另一个的。这种观点在女性主义后现代主义中最为明确，后者对真理（以及可能近似真理、科学本体论和其他与实在论各种描述相关的概念）持有彻底的相对主义态度。与强纲领社会建构主义的情况类似，真理和认识标准在这里仅在一个观点的背景下定义，因此不能以任何超越背景或超越心灵的方式进行解释。
...
> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=scientific-realism). |
> | --- | --- |
> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/scientific-realism/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
> | ![inpho icon](https://plato.stanford.edu/symbols/inpho.png) | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=scientific-realism&redirect=True) at the Internet Philosophy Ontology Project (InPhO). |
> | ![phil papers icon](https://plato.stanford.edu/symbols/pp.gif) | [Enhanced bibliography for this entry](http://philpapers.org/sep/scientific-realism/) at [PhilPapers](http://philpapers.org/), with links to its database. |

## Other Internet Resources

* Boyd, Richard, “Scientific Realism”, *The Stanford Encyclopedia of Philosophy* (Summer 2010 Edition), Edward N. Zalta (ed.), URL = <[Scientific Realism (Stanford Encyclopedia of Philosophy/Summer 2010 Edition)](https://plato.stanford.edu/archives/sum2010/entries/scientific-realism/)>. [This was the previous entry on scientific realism in the *Stanford Encyclopedia of Philosophy* — see the [version history](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=scientific-realism).]
* Worrall, John, “[Miracles, Pessimism, and Scientific Realism](http://philpapers.org/rec/WORMPA), unpublished manuscript.

## Related Entries

[abduction](https://plato.stanford.edu/entries/abduction/) | [constructive empiricism](https://plato.stanford.edu/entries/constructive-empiricism/) | [empiricism: logical](https://plato.stanford.edu/entries/logical-empiricism/) | [feminist philosophy, interventions: epistemology and philosophy of science](https://plato.stanford.edu/entries/feminism-epistemology/) | [feminist philosophy, topics: perspectives on science](https://plato.stanford.edu/entries/feminist-science/) | [incommensurability: of scientific theories](https://plato.stanford.edu/entries/incommensurability/) | [Kuhn, Thomas](https://plato.stanford.edu/entries/thomas-kuhn/) | [models in science](https://plato.stanford.edu/entries/models-science/) | [rationality: historicist theories of](https://plato.stanford.edu/entries/rationality-historicist/) | [science: theory and observation in](https://plato.stanford.edu/entries/science-theory-observation/) | [scientific explanation](https://plato.stanford.edu/entries/scientific-explanation/) | [scientific knowledge: social dimensions of](https://plato.stanford.edu/entries/scientific-knowledge-social/) | [scientific objectivity](https://plato.stanford.edu/entries/scientific-objectivity/) | [scientific progress](https://plato.stanford.edu/entries/scientific-progress/) | [scientific revolutions](https://plato.stanford.edu/entries/scientific-revolutions/) | [structural realism](https://plato.stanford.edu/entries/structural-realism/) | [theoretical terms in science](https://plato.stanford.edu/entries/theoretical-terms-science/) | [truthlikeness](https://plato.stanford.edu/entries/truthlikeness/) | [underdetermination, of scientific theories](https://plato.stanford.edu/entries/scientific-underdetermination/) | [Vienna Circle](https://plato.stanford.edu/entries/vienna-circle/)
