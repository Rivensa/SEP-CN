...
不同的观点关于已知的内容、如何获得已知以及可以获得什么之间存在联系。柏拉图将事物的领域区分为可见和可理解的（《理想国》，510a，柯珀 1997）。只有后者，即形式，才能成为知识的对象。可理解的真理可以像几何和演绎推理一样确定地知道。然而，对于物质世界的观察，从定义上来说是不完美和具有欺骗性的，而不是理想的。因此，柏拉图的知识方式强调推理作为一种方法，减少了观察的重要性。亚里士多德持不同意见，将形式定位在自然界中，作为通过对自然界的探究而发现的基本原理（《形而上学 Z》，巴恩斯 1984）。

亚里士多德被认为是西方传统中对科学探究性质进行最早系统论述的人，他的论述包括对自然界进行观察和推理。在《前分析》和《后分析》中，亚里士多德首先反思了对自然界进行探究的目标，然后是方法。大多数人认为，这些论述仍然被认为是科学的基本要素。对于亚里士多德来说，经验主义，即仔细观察（但是被动观察，而不是控制实验），是起点。然而，目标不仅仅是记录事实。对于亚里士多德来说，科学（epistêmê）是一种正确排列的知识或学习体系——经验事实，以及它们的排序和展示至关重要。发现、排序和展示事实的目标在一定程度上决定了成功的科学探究所需的方法。还有决定性的是所寻求的知识的性质，以及适用于该类知识的解释性原因（参见亚里士多德因果论条目中对四个原因的讨论）。

除了仔细观察之外，科学方法还需要逻辑作为一种推理系统，以正确地安排已知观察到的内容，并进行推断。推理方法可能包括归纳、预测或类比等。亚里士多德的系统（以及他列举的谬误推理目录）被收集在《逻辑学》这个标题下。这个标题在后来关于科学推理的著作中得到了呼应，比如弗朗西斯·培根的《新工具》和威廉·休厄尔的《修复的新工具》（见下文）。在亚里士多德的《逻辑学》中，推理主要分为两种形式，这种粗略的划分一直延续到现代。这种划分，今天最常见的是演绎法与归纳法，也出现在其他时代和方法论中，比如分析/综合、非扩大/扩大、甚至确认/验证。基本思想是我们的研究方法有两个“方向”：一个是远离观察到的内容，朝向更基本、更普遍、更全面的原则；另一个是从基本和普遍的原则出发，研究实例或原则的含义。

这里确定的研究的基本目标和方法可以看作是在接下来的两千年中对正确寻求知识的方法进行反思的主题：仔细观察自然，然后寻找解释或预测其运作的规律或原则。亚里士多德的著作为科学方法提供了一个独立于科学本身的评论传统（宇宙与物理学的对比）。在中世纪时期，阿尔伯图斯·马格努斯（1206-1280）、托马斯·阿奎那（1225-1274）、罗伯特·格罗塞特斯特（1175-1253）、罗杰·培根（1214/1220-1292）、奥卡姆的威廉（1287-1347）、安德烈亚斯·维萨里乌斯（1514-1546）、贾科莫·扎巴雷拉（1533-1589）等人都致力于澄清通过观察和归纳获得的知识类型、归纳的证明来源以及其应用的最佳规则。他们的许多贡献现在被认为是科学的基本要素（参见劳丹 1968 年）。正如亚里士多德和柏拉图曾经运用过“朝着形式”或“远离形式”的推理框架一样，中世纪的思想家们采用了远离现象或回归现象的方法。在分析中，对现象进行了研究以发现其基本的解释原则；在综合中，从第一原则构建了对现象的解释。

在科学革命期间，这些不同的论证、实验和理性的纽带被锻造成为一种主导的认识权威。16 世纪至 18 世纪是自然界运作知识的显著进展时期，包括机械、医学、生物学、政治、经济解释的进步，同时也是对革命性变革的自我意识和对取得这些进步的方法的源头和合法性的深思熟虑的时期。建立新权威的斗争包括方法论上的举措。根据伽利略·伽利雷（1564-1642）或弗朗西斯·培根（1561-1626）的隐喻，自然之书是用数学、几何和数字的语言书写的。这激发了对数学描述和机械解释作为科学方法重要方面的强调。通过亨利·莫尔和拉尔夫·卡德沃思等人，新柏拉图主义对于在表象背后对自然进行形而上学反思的重要性，特别是关于精神作为纯粹机械的补充的重要方法论线索，在科学革命中仍然是重要的（参见剑桥柏拉图主义者；博伊尔；亨利·莫尔；伽利略的条目）。

在《新工具》（1620）中，培根批评了亚里士多德的方法，认为从个别到普遍性的跳跃过快。推理的三段论形式容易混淆这两种类型的命题。培根的目标是发明新的艺术、原则和方向。他的方法将以方法性的观察收集为基础，结合我们感官的修正（尤其是对于避免他所称之为“偶像”的东西，即天真观察者容易犯的系统性错误类型的指导）。科学家社区随后可以通过谨慎、渐进和连续的攀升，得出可靠的普遍性主张。

培根的方法被批评为对实践科学家来说不切实际和过于死板。惠尔在他的《逻辑体系》中批评培根对科学家的实践关注不够。在科学史上很难找到培根的方法被实践的令人信服的例子，但有一些人被认为是 16 世纪科学归纳法的真实例子，即使不是严格的培根模式，如罗伯特·波义尔（1627-1691）和威廉·哈维（1578-1657）（参见培根的条目）。

然而，历史学家和方法论学家对艾萨克·牛顿（1642-1727）给予了最大的关注。考虑到他的《数学原理》和《光学》的巨大成功，这是可以理解的。对牛顿方法的研究主要有两个方向：《光学》中呈现的实验和推理的隐含方法，以及《数学原理》第三卷中作为哲学规则（Regulae）给出的明确方法论规则。牛顿的万有引力定律是他新宇宙学的关键，它打破了自然哲学的解释惯例，首先是因为它似乎提出了远距离作用，但更普遍地是因为它没有提供“真正的”物理原因。他的《世界体系》（《数学原理》第三卷）的论证是基于现象而不是推理的第一原则。这在大陆上被视为不足以进行适当的自然哲学。《哲学规则》对此反驳，通过重新定义自然哲学家应该遵循的方法来重新定义自然哲学的目标。（参见牛顿哲学的条目。）

在他的方法论建议清单中，应该加上牛顿著名的短语“hypotheses non fingo”（通常翻译为“我不构建假设”）。科学家不应该发明系统，而是从观察中推断解释，就像培根所主张的那样。这被称为归纳主义。在牛顿之后的一个世纪里，对牛顿方法的重要澄清被提出。例如，科林·麦克劳林（1698-1746）重建了该方法的基本结构，将其分为互补的分析和综合阶段，一个从现象中推广，另一个从一般命题中推导出新现象的解释。丹尼斯·狄德罗（1713-1784）和《百科全书》的编辑们在巩固和普及牛顿主义方面做了很多工作，弗朗切斯科·阿尔加罗蒂（1721-1764）也是如此。强调通常是相同的，不仅关注科学家的过程，也关注科学家的品质，这种品质仍然被普遍认为是正确的。科学家在面对自然时是谦卑的，不受教条束缚，只听从自己的眼睛，追随真理的方向。无疑，伏尔泰（1694-1778）和杜·沙特莱（1706-1749）在传播后一种科学家和他们的工艺的愿景方面最有影响力，以牛顿为英雄。科学方法成为启蒙运动的一股革命力量。（另请参阅有关牛顿、莱布尼茨、笛卡尔、波义尔、休谟、启蒙运动的条目，以及 Shank 2008 的历史概述。）

并非所有 18 世纪关于科学方法的反思都是如此赞美的。著名的还有乔治·伯克利（1685-1753）对新科学的数学的攻击，以及牛顿派对观察的过分强调；以及大卫·休谟（1711-1776）对归纳证明提供的科学主张的保证的削弱（参见：乔治·伯克利；大卫·休谟；休谟的牛顿主义和反牛顿主义）。休谟的归纳问题激发了伊曼纽尔·康德（1724-1804）寻求经验方法的新基础，尽管作为认识论重建，而不是科学家的任何实际指导。休谟和康德都影响了下一个世纪的方法论思考，比如密尔和惠威尔之间关于科学归纳推理的确定性的辩论。

约翰·斯图尔特·密尔（1806-1873）和威廉·休厄尔（1794-1866）之间的辩论已成为 19 世纪方法论辩论的经典之作。尽管常被描述为归纳主义和假设演绎主义之间的辩论，但双方方法的角色实际上更为复杂。在假设演绎的解释中，科学家努力提出假设，从中可以推导出真实的观察结果，因此称为假设演绎。由于休厄尔在方法论中强调了假设和演绎的双重作用，他可以被视为密尔归纳主义的便利对比。然而，对于休厄尔对科学方法的描绘来说，同样重要甚至更重要的是他所称的“基本对立”。知识是客观（我们在周围世界中看到的）和主观（我们的思维对我们所经历的感知和理解的贡献，他称之为基本思想）的产物。根据休厄尔的观点，这两个要素都是必不可少的，因此他批评康德过于关注主观，批评约翰·洛克（1632-1704）和密尔过于关注感官。休厄尔的基本思想可以是相对于学科的。即使在特定的科学学科中，一个思想只对知识有必要性（例如，化学亲和力对于化学而言），它仍然可以是基本的。这将基本思想与康德的直观形式和范畴区分开来。（参见休厄尔的条目。）

澄清基本概念因此成为科学方法和科学进步的重要组成部分。休厄尔称这个过程为“发现者归纳法”。这是归纳，遵循培根或牛顿的方法，但休厄尔试图通过强调思想在归纳假设的明确和谨慎制定中的作用来复兴培根的解释。休厄尔的归纳不仅仅是收集客观事实。主观因素通过休厄尔所称的事实归纳发挥作用，这是科学家的创造性行为，即理论的创造。然后通过测试来确认理论，将更多的事实纳入理论，这被称为归纳的一致性。休厄尔认为这是发现自然真实规律的方法：澄清基本概念，巧妙创造解释，谨慎测试。米尔在批评休厄尔时，以及其他将休厄尔视为假设演绎主义观点先驱的人，似乎低估了休厄尔对方法的这个发现阶段的重要性（Snyder 1997a,b, 1999）。在 20 世纪初的方法论中，淡化发现阶段成为一种特征（见第 3 节）。

在他的《逻辑体系》中，密尔提出了归纳法作为科学方法本质的更狭义观点。对于密尔来说，归纳是首先寻找事件之间的规律性。在这些规律性中，有些将继续适用于进一步的观察，最终获得法律的地位。人们还可以寻找在某一领域中发现的法律之间的规律性，即法律的法律。哪个“法律法则”将适用取决于时间和学科，并且可以进行修订。一个例子是普遍因果律，密尔提出了特定的方法来确定原因，现在通常被称为密尔的方法。这五种方法寻找感兴趣现象之间的共同情况，当现象不存在时缺少的情况，或者两者同时变化的情况。密尔的方法仍然被视为捕捉有关寻找相关解释因素的实验方法的基本直觉（《逻辑体系》（1843 年），参见密尔条目）。最终，惠尔和密尔提倡的方法看起来相似。两者都涉及归纳概括到涵盖法律。然而，它们在所获得的知识的必要性方面存在明显差异；也就是说，在元方法论层面上存在差异（参见惠尔和密尔条目）。
...
假设的潜在证伪者越多，它就越可证伪，假设声称的内容也就越多。相反，没有证伪者的假设几乎没有声称任何东西。最初，波普尔认为这意味着只有为了拯救理论而引入特别修正的假设不应被视为良好的科学方法。这些假设会削弱理论的可证伪性。然而，波普尔后来意识到，引入修正（他称之为免疫）通常是科学发展的重要组成部分。对令人惊讶或明显证伪的观察的回应往往会产生重要的新科学见解。波普尔自己的例子是天王星的观察运动，最初与牛顿的预测不一致。外行星的特别修正假设解释了这种不一致，并导致了进一步的可证伪预测。波普尔试图通过模糊可证伪和不可证伪之间的区别，并代之以可测试性的程度来调和这种观点（波普尔 1985 年：41f）。
...
类似的讨论在哲学文献中也有。一方面，柴奇曼（1948 年）和鲁德纳（1953 年）认为，由于科学假设永远无法完全验证，对科学推理方法的完整分析包括伦理判断，科学家必须决定证据是否足够强大或概率是否足够高，以决定是否接受假设，这又取决于接受或拒绝假设时犯错的重要性。其他人，如杰弗里（1956 年）和莱维（1960 年），持不同意见，他们支持科学的价值中立观点，即科学家在评估推理的正确性时应将态度、偏好、气质和价值观放在一边。有关科学哲学中这种无价值理想及其历史发展的更多细节，请参阅道格拉斯（2009 年）和霍华德（2003 年）。有关研究价值在科学中的作用的广泛案例研究，请参阅埃利奥特和理查兹（2017 年）等。
...
在计算机模拟的情况下，验证和验证之间的区别最容易描述。在典型的计算机模拟场景中，计算机用于数值积分无法获得解析解的微分方程。这些方程是科学家用来表示正在研究的现象或系统的模型的一部分。验证计算机模拟意味着检查模型的方程是否被正确近似。验证模拟意味着检查模型的方程是否适用于基于该模型进行推断的目的。
...
在科学的某些领域，学术出版物的结构可能给人一种整洁和线性的研究过程的印象，从提出问题，设计回答问题的方法，收集数据，到从数据分析中得出结论。例如，大多数生物医学期刊中所知的 IMRAD 格式（引言，方法，结果，分析，讨论）的编码格式被期刊编辑明确描述为“不是任意的出版格式，而是科学发现过程的直接反映”（参见所谓的“温哥华建议”，ICMJE 2013: 11）。然而，科学出版物通常不反映报告的科学结果是如何产生的过程。例如，在引人注目的标题“科学论文是一种欺诈吗？”下，梅达瓦尔认为科学论文通常误导了结果是如何产生的（梅达瓦尔 1963/1996）。哲学家、历史学家和科学社会学家也提出了类似的观点（吉尔伯特 1976；霍姆斯 1987；诺尔-塞蒂纳 1981；席科尔 2008；苏佩 1998），他们认为科学家的实验实践是混乱的，通常没有遵循任何可识别的模式。他们认为，研究结果的出版物是对这些活动的回顾性重建，通常不保留这些活动的时间顺序或逻辑，而是经常构建起来以避免潜在的批评（有关这项工作的综述，请参见席科尔 2008）。

### 6.3 法庭上的科学方法

对科学方法的哲学立场也进入了法庭，特别是在美国，法官们在决定何时给予科学专家证词特殊地位时，借鉴了科学哲学。一个关键案例是道伯特诉默沙东制药公司（92-102，509 U.S. 579, 1993）。在这个案例中，最高法院在其 1993 年的裁决中认为，审判法官必须确保专家证词的可靠性，并在此过程中审查专家的方法论，以确定所提供的证据是否真正是科学知识。此外，法院还提到了波普尔和亨普尔的著作，指出

> 通常，在确定一个理论或技术是否是科学知识时，一个关键问题要回答的是它是否可以（并且已经）经过测试。（布莱克曼法官，道伯特诉默沙东制药公司；请参阅其他互联网资源以获取裁决意见的链接）

但正如 Haack（2005a,b, 2010）和 Foster＆Hubner（1999）所主张的，法院将一个证词的可靠性问题与是否具有特殊方法论所指示的科学性问题等同起来，这导致了波普尔和亨普尔哲学的不一致混合，这在后续引用道伯特案的案例裁决中产生了相当大的混淆（详见 Haack 2010 的详细阐述）。

### 6.4 偏离的实践

鉴定科学方法的困难也反映在鉴定科学不端行为的困难上，这种不端行为包括对科学方法的不当应用。最早也是最有影响力的一次对科学不端行为的定义是 1989 年美国的定义，将不端行为定义为“伪造、篡改、抄袭或其他严重偏离科学界普遍接受的行为”（《联邦法规》第 50 部分，A 小节，1989 年 8 月 8 日，斜体添加）。

> 伪科学、伪造、抄袭或其他严重偏离科学界普遍接受的行为。

然而，“严重偏离的其他做法”条款受到了严厉批评，因为它可能被用来压制创造性或新颖的科学。例如，美国国家科学院在其《负责任科学》（1992 年）报告中指出，

> 希望阻止仅仅基于科学家使用新颖或非正统研究方法而提出不端行为投诉的可能性。（NAS：27）

因此，这个条款后来被从定义中删除。有关科学行为的重要哲学文献，请参阅 Shamoo＆Resnick（2009）。

## 7. 结论

科学成功的来源问题自现代科学开始以来一直是哲学的核心问题。如果从更一般的认识论角度来看，科学方法是整个哲学史的一部分。在这段时间里，科学及其从业者可能采用的方法发生了巨大变化。如今，许多哲学家已经开始关注多元主义或实践的问题，以对科学方法进行细致而有限的研究。其他人希望改变视角，提供一个更新的总体解释，以描述我们所称之为科学的活动的特征。

最近，Hoyningen-Huene（2008 年，2013 年）提出了一种观点，他从科学哲学的历史角度认为，在经历了三个漫长的阶段来描述科学的方法之后，我们现在正处于一种阶段，即对存在一种积极的科学方法的信念已经削弱，而用来描述科学的只剩下其可变性。首先是从柏拉图和亚里士多德一直到 17 世纪的阶段，在这个阶段中，科学知识的特殊性在于其通过明显的公理证明所建立的绝对确定性；接下来是直到 19 世纪中叶的阶段，在这个阶段中，确立科学知识确定性的手段已经普遍化，包括归纳程序。在第三个阶段，一直持续到 20 世纪最后几十年，人们认识到经验知识是有缺陷的，但由于其独特的生产方式，仍然被赋予了特殊地位。但是现在在第四个阶段，根据 Hoyningen-Huene 的观点，历史和哲学研究已经表明，“在第二和第三个阶段中所假设的具有特征的科学方法并不存在”（2008 年：168），而且哲学家和科学史学家对科学的本质已经没有共识。对于 Hoyningen-Huene 来说，这种立场过于消极，因此他再次提出了关于科学本质的问题。他自己对这个问题的回答是，“科学知识与其他类型的知识，尤其是日常知识，主要区别在于更加系统化”（Hoyningen-Huene 2013 年：14）。系统性可以有几个不同的维度：其中包括更系统的描述、解释、预测、知识主张的辩护、认识的联系、完整性理想、知识生成、知识的表达和批判性讨论。 因此，科学的特点在于更加谨慎地排除可能的替代解释，更加详细地阐述基于数据的预测，更加谨慎地检测和消除错误源，更加明确地与其他知识相连接等。在这个观点上，科学的特点不在于所采用的方法是科学独有的，而在于这些方法被更加谨慎地应用。
