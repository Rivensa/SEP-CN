# 经典理论中的空间与运动的绝对性与相对性 absolute and relational space and motion, classical theories (Carl Hoefer, Nick Huggett, and James Read)
...
因此，民间阅读简单地忽略了莱布尼兹关于运动的形而上学，它使莱布尼兹在他的定律方面犯了一个数学错误，并且可以争论是否这是对他关于相对论的表述的最佳诠释；它肯定不能毫无疑问地被接受。然而，理解民间阅读的诱惑并不难。在与克拉克的通信中，莱布尼兹说他相信空间是“仅仅是相对的东西，就像时间一样，...是一种共存的秩序，就像时间是一种连续的秩序”（LIII.4），这自然被理解为意味着空间本质上只是物体之间的距离和时间关系。（尽管即使这段话也有其微妙之处，因为上面讨论过的空间的理想性，以及在莱布尼兹的构想中，空间决定了哪些关系集是可能的。）如果相对距离和时间以这种方式完全涵盖了时空，那么难道所有的运动量都不应该用这些关系来定义吗？

我们已经看到了两种这种结论是错误的方式。力似乎涉及到一个与任何相对速度都不相同的速度概念。而且（除非假设的等价性最终是广义相对论的原则），定律选择了一个恒定运动的标准，这个标准不一定是任何恒定的相对运动。当然，很难将这些量与莱布尼兹提出的空间和时间观点调和起来 - 如果不是相对于某个物体或绝对空间的速度，那么大小乘以速度的速度是什么，或者恒定速度是什么？鉴于莱布尼兹认为空间在字面上是理想的（实际上，即使相对运动也不是“完全真实的”），也许最好的答案是，他认为力量，因此运动在其真实意义上根本不是由相对意义上的运动决定的，而是原始的单子量。也就是说，他认为 x 移动是一个一元谓词，但他相信它可以完全用严格的一元谓词来分析：x 移动当且仅当 x 具有非零导数主动力。当我们在构建空间的概念时，“假设某些物体不变”时，这种解释说明了莱布尼兹认为我们在假设什么：它们没有力量，没有任何引起或使运动变得真实的东西。

### 6.5 莱布尼兹对牛顿的注释的回应

再次比较莱布尼兹与笛卡尔和牛顿在运动方面的观点是有帮助的。评论者经常对莱布尼兹对牛顿关于绝对空间的论证的回应表示沮丧：“在注释中，我找不到任何证明或能够证明空间本身的实际性的东西。然而，我承认绝对真实的物体运动与仅仅相对变化之间存在差异…”（LV.53）。莱布尼兹不仅似乎没有认真对待这个论证，而且还承认了这个论证中似乎需要绝对空间的一步！但是通过我们对牛顿和莱布尼兹的理解，我们可以看出他所说的是完全有道理的（或者至少不像人们常常认为的那样不真诚）。

牛顿在注释中认为真实运动不能与笛卡尔考虑的那种运动等同；但这两种运动都是纯粹的相对运动，而莱布尼兹完全同意仅仅相对运动不是真实的（即“完全真实的”）。莱布尼兹的“让步”只是表示他同意牛顿对笛卡尔在真实运动和相对运动之间的区别上的观点；他肯定理解牛顿反驳的是谁和什么，而且这是一个他自己以不同的术语公开反驳过的立场。但正如我们所见，莱布尼兹对这种区别的分析与牛顿的分析非常不同；对他来说，真实运动不是相对于绝对空间的运动，而是具有力量数量的本体论，先于任何时空数量。在注释中确实没有明确反对这种观点的内容，而且由于它确实提供了一种理解真实运动的替代方式，莱布尼兹声称从真实运动到绝对空间没有演绎推理是合理的。

## 7. “非牛顿”与“莱布尼兹”

### 7.1 非因果关系错误地归因于牛顿

民间对莱布尼茨的误解是他寻求一种仅以物体之间的关系为基础的力学理论。正如我们在伴随文章中所看到的，在 19 世纪，恩斯特·马赫确实提出了这样的方法，但莱布尼茨显然没有；尽管莱布尼茨和马赫之间存在某些相似之处，尤其是对绝对空间的拒绝，这无疑有助于解释两者之间的混淆。但莱布尼茨经常被误解，对牛顿在《注释》中的论证也存在有影响力的误读，这些误读受到了他在某种程度上在回应莱布尼茨的观点的影响。当然，《自然哲学的数学原理》是在《通信》之前 30 年写的，《注释》中的论证并不是针对莱布尼茨而写的，但克拉克本人暗示（CIV.13）这些论证，特别是关于水桶的论证，对莱布尼茨是有说服力的。这个论证确实对所有相对运动的平等性产生了毁灭性的打击，但我们已经看到，莱布尼茨对假设的等同性是否等同于这样的观点是非常值得怀疑的。话虽如此，在《通信》的前四封信中，莱布尼茨的陈述可能会让克拉克在这一点上产生误导-正是在回应克拉克的挑战时，莱布尼茨明确否认了相对运动的平等性。但有趣的是，克拉克没有提出牛顿论证的真实版本-尽管牛顿在回复中有一定参与。他提出的不是基于旋转速率的唯一性的论证，而是认为具有不同速度的系统必须是不同的，因为如果将它们静止，观察到的效果将是不同的。当然，这个论证对于一个认为没有特权的静止标准的观点来说是完全无意义的（克拉克错误地将这个观点归因于莱布尼茨）！

正如我们在附带文章中进一步讨论的那样，马赫将牛顿错误地归因于一个谬误的论证，即因为水面即使在相对于桶静止时也呈现弯曲，所以它必须相对于绝对空间旋转。我们对牛顿的讨论表明了这样的阅读是多么误导人。首先，他还争辩说必须存在某种特权的旋转感，因此并非所有的相对运动都是相等的。其次，这个论证是针对笛卡尔的人身攻击，在这个背景下，一个分离的三段论——运动要么是适当的，要么是普通的，要么是相对于绝对空间的——在论证上是合理的。另一方面，马赫是正确的，牛顿在《学术注释》中的论证留下了逻辑上的可能性，即特权的真正旋转感（以及更一般的加速度）是某种相对运动的形式；如果不是运动本身，那么可能是相对于固定的恒星。 （事实上，牛顿在《引力论》（1962 年）中拒绝了这种可能性，理由是它将涉及一种可憎的超距作用；这是一种讽刺的立场，考虑到他的普遍引力理论。）

### 7.2 错误地归因于牛顿的最佳解释论证

大部分当代文献中对牛顿的民间解读取代了马赫的诠释，采用了更加宽容的解读方式：例如，Dasgupta 2015 年的文章是对以下辩证法及其与对称性论证的关系的最新有影响力的呈现。根据这种解读，牛顿的观点是，他的力学理论——与笛卡尔的理论不同——可以解释为什么旋转水面是弯曲的，他的解释涉及到一种特殊的旋转感，而在没有关于其相对性质的替代假设的情况下，我们应该接受绝对空间。但是我们对牛顿论证的讨论表明，它并不具有“演绎推理”或“最佳解释”的形式，而是从笛卡尔的前提出发，演绎出旋转既不是适当的运动，也不是普通的运动。

这并不意味着牛顿不理解他的力学理论如何解释这些效应。例如，在《原理定义》的推论 V 和 VI 中，他以一般性的术语陈述了根据他的力学定律，不同运动状态何时是不可辨的，从而间接地表明了何时是可辨的。这也不意味着牛顿的同时代人对解释惯性效应不认真。例如，莱布尼兹分析了一个旋转的物体（在《样本》中）。简而言之，旋转系统的部分与周围物质碰撞，并不断偏转，形成一系列线性运动，从而形成一条弯曲的路径。（尽管莱布尼兹构想的系统——由弹性物质粒子的充满物质组成——对他来说过于复杂，无法基于这种定性图像提供任何定量模型。因此，他没有对惯性效应提供任何严肃的替代解释。）

### 7.3 实体论和最佳解释论证

#### 7.3.1 旋转的球体

虽然这个论证不是牛顿提出的，但它仍然是对民间莱布尼兹提出的关系主义的重要回应，特别是当它通过引入牛顿的《注释》中的另一个例子来扩展时。牛顿考虑了一对相同的球体，通过一根绳子连接在一起，离任何物体都太远，无法观察到任何相对运动；他指出，通过测量绳子的张力，并在两个球体的相对面上施加压力，可以实验性地确定它们的旋转速率和方向，以查看张力是增加还是减少。他打算通过这个简单的例子证明，他在《自然哲学的数学原理》中打算进行的项目，即通过相对运动确定行星的绝对加速度和引力，是可行的。然而，如果我们进一步指定球体和绳子是刚性的，并且它们是宇宙中唯一的物体，那么这个例子可以用来指出，存在无限多种不同的旋转速率，它们在物体之间的关系上都是一致的。由于在不同的情况下，物体之间的关系没有差异，所以可以得出结论，旋转状态的可观察差异不能用物体之间的关系来解释。因此，民间莱布尼兹所归因的这种理论不能解释牛顿力学的所有现象，我们可以通过演绎推理来主张绝对空间的存在。[13]

这个论点既不是牛顿的，无论是前提还是结论，也不能被视为历史上准确的阅读。然而，这并不意味着这个论点是谬误的，事实上许多人发现它很有吸引力，特别是作为对牛顿的绝对空间的辩护，而不是对伽利略时空的辩护。也就是说，牛顿力学与伽利略时空可以解释与旋转相关的现象，而马赫提出的理论无法解释牛顿力学允许的不同情况之间的差异；但这些解释依赖于伽利略时空的几何结构-特别是它的仿射连接，来解释加速度。因此-论点是-这些解释使我们承认时空的实际存在：一个由点组成的流形，其属性包括适当的几何属性。这个最终的学说，即时空的实际存在，以及其组成的点或区域，与物质不同，具有几何属性，是我们之前所称的“实体主义”。
