...
夏普拒绝了现实主义标准对术语的普遍性（或普遍性，根据他的术语）的评判，并且在很大程度上接受了唯名论批评的意义。在他看来，与世界上真实存在的共同本质相匹配不再是成为普通术语的必要和充分条件。相反，普遍意义（即指示一个单一概念，进而指向至少具有类似存在方式的多样事物的条件）是语义普遍性的同等重要条件。他认为那些普遍意义的术语必须被视为共同的，以及那些指示存在于智力之外的共同本质的术语（同上，第 69 页）。因此，根据夏普的观点，有六种不同类型的普通表达方式，包括口头和书面表达：
...
夏普形而上学的核心在于他的通用性理论。他是一个现实主义者，因为他捍卫通用性的超心理存在（同上，第 68 页），但他对唯名论持开放态度，因为他认为语言的要素和结构与世界的要素和结构之间没有密切的对应关系。他对整个问题的处理可以被定义为“分析性的”，因为他似乎相信（i）任何本体论都必须建立在解决语义问题的基础上，（ii）任何关于现实的哲学解释都必须在我们的语言功能的语义解释之前。
