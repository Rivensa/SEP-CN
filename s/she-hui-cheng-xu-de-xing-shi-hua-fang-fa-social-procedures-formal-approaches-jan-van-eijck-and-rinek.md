...
Gale-Shapley 程序的运行时间与男性和女性的数量成二次关系（参见 Cechlérová等人，2005 年）。Pini 等人（2011 年）展示了参与者如何通过歪曲自己真实的偏好来轻松操纵程序的结果。幸运的是，Pini 等人还提出了一种替代程序，操纵该程序是困难的，因为想出一个个体上有利的偏好的歪曲是一个计算复杂的任务。
