...
> 如果将整体的原理与动物和植物的原理进行比较，也是不能正确理解的，因为从不确定、不完整的事物中总是产生更完整的事物，这就是为什么他说这对于第一事物是成立的，所以“一”本身甚至不是一个存在。

坚持我们的链接方法，我们在斯彪西波的观点中加入了一个主张：一是不是存在的（1092a14-15）。这是异因性原理的一个实例：存在的第一原因不是存在本身。

亚里士多德接着谈到“那些认为存在是由元素派生而来，而其中数字是第一位的人们”（1092a21-22）。我们可以假设斯彪西波也是其中之一：他会说元素并非如此派生，因此不是存在，而数字则是由这些元素派生而来的第一位存在。在这里，我们可以回到我们的锚定文本中的第一个（《形而上学》第七卷第二章 1028b21）以得到一些证实。

在一个更遥远的来源中可能有额外的证实。在普罗克洛斯对柏拉图的《巴门尼德》评论的拉丁翻译中（该评论的原始希腊文部分未能保存下来），普罗克洛斯告诉我们：“一是存在的先驱和原因，因此根据其存在本身而言，它不是存在，而是支持存在；它也不参与存在”，斯彪西波也赞同这个观点，尽管斯彪西波将其陈述为“仿佛在报告古人的观点”。不幸的是，如果这确实可以追溯到斯彪西波，它可能已经被新柏拉图主义的元素所污染，因为普罗克洛斯说斯彪西波认为“一比存在更好，是存在的来源”，而这不应该是斯彪西波的观点（参见上文他对一是善的主张的拒绝）。但对于一个新柏拉图主义者来说，斯彪西波对这个主张的拒绝是如此奇怪，以至于普罗克洛斯可能只是忽略了它。也许普罗克洛斯（或他的来源）所读到的是一是“超越”存在和存在的来源，并且，鉴于他的新柏拉图主义思维方式，毫不犹豫地认为“更好”。

许多学者认为，斯彪西波否认“一”是一种存在的观点在柏拉图的《理想国》中得到了支持：VI 509b2-10 经常被解读为将善的形式（根据从亚里士多德传承下来的传统，柏拉图将其与“一”等同起来）“超越存在”，因此使得柏拉图的本体论阶梯的顶端也不是一种存在。但这与《理想国》中的其他段落不一致，在这些段落中，善的形式明确被说成是一种存在（例如，VII 518cd，526e），而 509b 中经常被翻译为“超越存在”的短语可以简单地理解为“在存在的边缘”。这并不意味着柏拉图的著作中没有相关内容；在后期的对话中，特别是《巴门尼德篇》中有相关内容（见下文）。但是，《理想国》VI 509b2-10 不能被引用来支持斯彪西波的观点。

如果我们接受这一点，那么通过进一步的推论，看起来我们在伊安布利科斯（公元 3 世纪）的《普通数学科学》（以下简称 DCMS）的一章中引用或至少是斯彪西波关于“一”、多元性、数字甚至几何对象的观点的释义。伊安布利科斯是波菲利的学生，而波菲利则是普罗提诺的学生：这是新柏拉图主义的开始，新柏拉图主义与斯彪西波的观点之间存在许多相似之处和差异。但是有人提出了一个观点（Merlan 1968），即 DCMS 的第四章包含了斯彪西波的释义，即使不是引用。

伊安布利科斯以一种我们应该称之为“剽窃”的行为而闻名：他经常引用而不加注释。对他来说，这似乎并没有任何错误：他的一句引文是柏拉图的《理想国》中的一段较长的引文，他当然不会声称这是他自己的。可以推测这是一种敬意的表达：伊安布利科斯认为他在想要表达的内容上肯定找不到比柏拉图更好的，所以他以敬意但不加注释地引用。希望他这样做是出于某种目的。在那里我们读到：

> 对于数学中的数字，我们必须假设两个事物，第一个和最高的原则，即“一”（实际上我们甚至不应该称之为存在，因为它是简单的，而且它是为那些存在的事物提供原则的，而这个原则还不是像它所提供的事物那样），还有另一个原则，即多样性的原则，它本身可以提供分割，因此我们可以通过与其容量相适应的比较来断言它类似于一些湿润且完全可塑的物质；从这两者中产生了第一种数字，当它们与某种可说服的必要性相结合时。

在章节的稍后部分，伊安布利科斯或他的来源说：

> 但是，由于它超越了美和善，因此称之为既不美丽也不善良是合适的；因为当自然进一步远离起初的事物时，首先出现美丽，其次是当元素有更长的距离时出现善良。

在 DCMS iv 中，我们也发现：

> 但是，产生数字的元素还不属于美丽或善良；但是从一和作为多样性原因的物质的组合中，数字存在，并且首先在其中出现了存在和美丽，而接下来从几何物质的线元素中出现了存在，以同样的方式，在其中存在着存在和美丽，但其中没有丑陋或坏的东西；但在由最后的元素组合而成的第四和第五层中，恶性产生，不是直接产生的，而是由于疏忽和未能掌握符合自然的某些事物。

这里的图片不是伊安布利库斯自己的，而是与我们迄今为止所了解的斯彪西波相吻合并扩展的。存在有四个层次，而在它们之上有一个独立的层次，即不是存在的“一”。

在第一个引用的段落中，我们得到了两个关于“一”不是存在的论证。

第一个论证是基于“一”的假定简单性。这与我们在柏拉图的作品中可以找到的内容相符。在柏拉图的《巴门尼德篇》（137c-142a）中经常被称为“第一个假设”的部分中，巴门尼德首先（137c）提出“一”不能是多个；然后他首先（137cd）论证，如果“一”存在，它必须是没有部分的，否则它将是多个。随后的论证使得这成为对所有试图对“一”进行任何肯定性断言的禁止：任何这样的断言都会使“一”成为复数，使其由部分组成。最终，甚至包括“存在”这个断言：据说这意味着“一”“根本不是”（141e9-10），即它不存在；也就是说，它不是存在的（e11）。很难相信柏拉图本人会接受这个论证及其结论。他确实接受了一些思路：参见《苏菲斯特篇》244b-245e。但是，无论是柏拉图（即使在《苏菲斯特篇》中）还是亚里士多德似乎都准备从“S 是 P”的断言中推断出“S 是”的结论，而在《巴门尼德篇》的第一个假设和《DCMS iv》中，我们有一个从“一是 F”的断言到“一不是”的结论的论证。这不是试图澄清柏拉图段落与斯彪西波之间关系的地方，但有人提出了有趣的建议（Graeser 1997, 1999；另见 Halfwassen 1993），即柏拉图在《巴门尼德篇》中对斯彪西波做出了回应。无论如何，关于“一”的不是存在的简单性论证可以追溯到学院派。

为了解释“一”的不存在，第二个论证依赖于异因果原理：“这个原理还不是它所作为原理的那些事物的样子”；因此，存在的原理本身不能是一个存在的事物。

在“一”之后是第二层，即第一类存在的事物，即数目，然后是大小或几何形状：在这里我们首次遇到美和善。最后第四和第五层将是灵魂和可感知的物体，而在这里丑陋和邪恶出现。

数目的层次是在第二个原理，即多样性，介入时产生的。关于这个层次的更令人困惑的事情之一是，斯彪西波斯似乎认为数目中包括数字 1：在这一点上，他显然领先于他的时代，因为普遍接受的观点是 1 不是一个数（关于这一点请参见亚里士多德的《形而上学》第十卷，欧几里得的《几何原本》第七卷定义 2，命题 1 的证明等）。斯彪西波斯接受数字 1 的事实可以从他的作品中唯一的一段广泛引用的数学中得出：保存在伪伊安布利科斯的《算术神学》中（见下文）。但是，如果是这样，必须记住我们正在处理亚里士多德的“数学”数字，其中每个数字都有多样性。因此，有多个数字 1（这样我们可以将 1 和 1 相加得到 2，等等）。那么“一”不是数字 1；只有当你得到一组单位的多样性时，后者才会出现，其中任何一个都被视为 1，任何一对都被视为 2，依此类推。根据异因果原理，我们只能期望“一”不是数字 1：数字的原理本身不是一个数字。

亚里士多德多次抱怨斯彪西波的“片段式”宇宙：显然，因果关系的列车并不是从“一”开始，然后逐级下降，而是在每个层次重新开始。这在上面引用的《形而上学》第七篇第二章中是明确的：斯彪西波为每个层次的存在有新的原则。我们不必假设在斯彪西波的宇宙中，每个层次的“一”都是不同的；DCMS 中的文本表明，“一”在整个过程中是相同的原则，但由于所指的“物质”（见上面的引文）的差异，每个层次上的“一”以不同的方式实现：在数字层次上，作为数字 1 或单位，以多样性的形式实现；在几何图形层次上，作为点，在 DCMS 中称为“位置”或者我们可以翻译为“位置”。总体效果是，在算术层次开始运作的是“一”的多样性实现，即单位，它在该层次上代表了“一”，而在几何层次开始运作的是“一”的位置实现，即点，同样代表了该层次上的“一”。

我们可能对斯彪西波对数字的看法有相当多的信息，这些信息保存在伪伊安布利科斯的《算术神学》中（已经提到过）。这本书是从各种作者那里编纂而成的：阿纳托利乌斯，格拉萨的尼科马库斯，可能是伊安布利科斯本人，可能是未知的作者。它讨论了前十个数字的各种属性。当它到达数字 10 时，也就是“十位数”时，在一个看起来像是来自尼科马库斯的部分之后，它开始谈论斯彪西波和他的一本书，据说书名是《论毕达哥拉斯数字》，并且是从各种毕达哥拉斯的著作中编纂而成的，尤其是菲洛劳斯的著作（82.10-15：这本书有这个标题，而菲洛劳斯或其他任何毕达哥拉斯人都是斯彪西波的来源，这两个说法都存在问题）。在所谓的对这本书的描述之后（82.15-83.5），它引用了斯彪西波本人关于数字 10 的一段长引述。
...
因为我们在塞克斯图斯·恩皮里库斯的《反对数学家》第七卷 145-146 章中发现了这一点（伯里 1935 年第 80、81 页）。
...
我们已经看到斯彪西波拒绝了柏拉图的形而上学理论，并且他拒绝将善放置在形而上学的第一原则之中。因此，他显然不容易受到亚里士多德对柏拉图伦理学的反对的影响，在 Nicomachean Ethics I 6 中，亚里士多德的一般观点是柏拉图的理论使得善超出了人类的能力范围。

斯彪西波似乎采取了一个相当务实的目标，在这一点上他是希腊化时期关注的先导。希腊化时期的伦理学主要以将人类幸福的理想视为“无动于衷”（ataraxia）为主导。根据克莱门特的说法，Stromata II 22, 133（Stählin 1939 p. 186.19–23）：
