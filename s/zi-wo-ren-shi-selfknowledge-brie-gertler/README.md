...
> 主体报告的准确性非常差，以至于暗示任何可能存在的内省访问都不足以产生普遍正确或可靠的报告。(1977: 33)
...
对熟人账户的一个担忧源于观察到我们有时会对自己的经验出错。然而，大多数熟人理论家会承认我们对自己的现象状态可能是错误的。该理论仅暗示，在特定条件下，经验的现象现实——Chalmers 所称的“品质”——构成了它在思考者眼中的外观——该品质的“概念”（另请参见 Horgan 和 Kriegel 2007; Gertler 2012）。当满足这些条件时，我们以一种在没有那种经验的情况下无法发生的方式意识到经验，因此我们对经验的自我归属将是真实的。
...
我们必须进行解释才能了解自己的态度和情绪的观点呼应了赖尔（1949 年）的观点，即我们实现自我认识的方式与了解他人状态的方式大致相似。特别是，自我解释理论家认为，就像我们通过推断他们说的话来了解他人的态度一样，自我认识经常涉及对内部言语的推断。（在这里，我要感谢伯恩 2012a。）赖尔认为内部言语的体验是一种最有效的“偷听”方式。

> 我们窃听自己的言语表达和自己的默默独白。...这种活动本质上并没有专有性。我可以关注我听到你说的话，也可以关注我听到自己说的话，尽管我无法窃听到你与自己的默默对话。（莱尔 1949: 184）

自我解释的解释/原理确实承认自我认识和他人认识之间的差异。最重要的是，在我们自己的情况下，我们可以获得内省证据（关于我们的经验），而我们对他人状态的唯一证据是他们的行为，尤其是他们的言语行为。

我们对内省证据的获取是否也是推理的方式，从而威胁到回归？自我解释理论家认为，即使理解自己当前的感受也需要自我解释。卡桑姆用劳勒的例子解释了这一点：“当你将你的感觉识别为对另一个孩子的渴望时，你所做的是解释它”（卡桑姆 2015: 163）。卡桑姆认为，这个过程是整体的，因为你依赖于对最近的心理生活的了解（例如，最近对他人怀孕感到嫉妒）和也许是你最近的行为（特意去拜访一个有新生儿的朋友）来解释你当前的感受。

自我解释观点与我们非推理地了解自己的某些状态的观念是相容的。卡鲁瑟斯认为，对于可以仅基于原始感官数据识别的任何状态的知识，不需要解释，因为感官数据是心理阅读系统的输入。卡桑对这种可能性更加谨慎，指出即使对于像疼痛这样的基本感觉的知识，有时也需要认知努力（2015 年：164）。

自我解释观点的批评者认为，它忽视了自我认识和他人认识之间的深刻不对称性：我们的理性保证了我们对自己的态度具有非推理性的访问权（Shoemaker 1994），或者需要进行自我解释意味着我们与自己的态度疏离（Moran 2001）。这些主张构成了一些理性主义和行为主义观点的基础（见 3.6 和 3.7）。

### 3.4 经验主义透明度观点

透明度解释是受到上述与加雷斯·埃文斯的著名言论相关的思想的启发：如果有人问你是否相信会有第三次世界大战，你会通过直接考虑第三次世界大战的可能性来回答。透明度的隐喻表达了这样一个概念，即人们“透过”（透明的）心理状态直接考虑它所代表的内容。

一些哲学家利用心理状态“透明”的观念来推进自我认识的理性主义或行为主义解释，这些解释是非经验主义的（见 3.6 和 3.7）。当前的小节涉及将埃文斯的方法视为为自我断言产生经验上的证明或保证的透明度解释（Dretske 1994；Fernández 2003, 2013；Byrne 2005, 2018）。

德雷茨克将自我认识描述为“一种通过意识到非心理对象而获得的——实际上，只能通过意识到非心理对象获得的——感知知识”（Dretske 1994: 264）。例如，我可以通过从我意识到的非心理对象（如下雪）推断出我正在思考下雪的事实。这种解释确保了第一人称特权，因为我对雪的意识不会同样支持对他人心理状态的推断。这种解释要求我们依赖背景信念来证明从看到雪到我正在思考下雪的推断。对于这种解释的一个担忧是，相关的背景信念是否可得到或是否合理（Aydede 2003）不太清楚。

费尔南德斯对透明解释的版本通过将自我认识视为非推理的方式避免了这种担忧。他认为，一个单一的状态可以作为相信 p 和相信自己相信 p 的基础。例如，看到雪花飘落通常会导致相信正在下雪；这种视觉体验也可以成为自我归属的基础，即我相信正在下雪。费尔南德斯（2013）将此称为“绕过模型”，以表明它将信念的自我归属直接基于一阶信念的基础，绕过了一阶信念本身。这种自我归属是以“部分内在主义”（同上：44）的方式得到证明的，因为我可以接触到我相信自己相信正在下雪的基础，即我（似乎）看到了飘落的雪花。这种解释在某种程度上也是“部分外在主义”（同上）的：我的自我归属是有保证的，因为作为其基础的感知状态往往与正在下雪的信念相关联。

绕过方法是纯粹以第一人称为基础的，因为只有我可以直接将信念建立在我的感知状态上。而且，它比他人对我的心理状态的了解更加安全。他人只能通过推理来了解我的状态——通过我的行为和/或他们对我可获得的证据的观察。但是，满足绕过模型的自我认识是非推理的，因为自我归属（例如，我相信我相信正在下雪）不是从其基础（例如，看到飘落的雪花）推断出来的。

相比之下，伯恩（2005 年，2018 年）的透明解释明确是推理主义的。他声称我们通过根据“信念模式”（Gallois 1996）进行推理来了解我们的信念。

 我相信

伯恩提出以下论点。根据信念模式进行推理是从前提 p 推导出我相信 p；除非相信前提，否则不会从前提中推导出结论；因此，这样的推理将产生真实的自我陈述。无论前提是否合理，甚至思考者是否将其视为合理，信念模式都是自我验证的。[5] 无论前提是否合理，甚至思考者是否将其视为合理，信念模式都是自我验证的。

伯恩的主要论点是，通过使用信念模式来实现自我认识，这一观点基于两个基本主张。第一个主张是，我们实际上使用信念模式是独立可信的（正如埃文斯的言论所暗示的）。第二个主张是，我们使用信念模式的假设最能解释自我认识的特殊安全性和不对称性。根据他的提议，自我认识的特殊认识安全性是外在保证的问题：信念模式不仅是自我验证的，而且还产生了“安全”的自我陈述，即它们不容易是错误的。[6] 自我认识的不对称性在于，按照这个模式进行推理不会产生关于他人状态的知识。从“下雪”推理到“你/他们相信正在下雪”不会可靠地产生关于他人信念的真实信念。

对透明解释的一个反对意见是，通过直接考虑 p 是否可能无法揭示在问题出现之前的信念（Shah 和 Velleman 2005）。例如，通过考虑地缘政治问题来回答“你是否相信会有第三次世界大战？”的问题可能会产生一个新的信念，而不是揭示一个已存在的信念。一般来说，对于是否 p 的可获得证据的反思可能实际上会改变对这个问题的已有信念（Wilson 和 Kraft 1993）。透明理论家无法通过规定在考虑 p 时不得得出新结论来避免这种担忧。避免新结论需要已经知道自己的信念，也就是说，已经得出了哪些结论。

透明理论家可以通过辩称反对意见误解了这些解释的目的来回应。反对意见指责这种解释可能无法解释第一人称访问：如果你相信 p，你如何知道自己确实相信。透明解释可能旨在回答一个不同的问题，即，什么样的纯粹第一人称方法可以提供构成知识的自我归属。即使考虑地缘政治问题产生了一个新的信念，即第三次世界大战很可能发生，Byrne 所描述的推理——从第三次世界大战很可能发生到我相信第三次世界大战很可能发生——可以被认为产生了自我认识。然而，这个反对意见揭示了透明解释的一个可能的局限性。因为它们无法区分新形成的判断和先前的倾向性信念，它们无法解释我们明显有能力知识性地回答“你是否相信 p？”这个问题，其中这个问题涉及到在问题提出时一个人的信念（Gertler 2011b）。

另一个反对意见涉及这些解释的假设，即自我认识不需要满足认识论内在主义条件。Boyle（2011）针对 Byrne 在这一点上的观点提出了批评，认为即使从 p 到我相信 p 的推理可靠地产生真实（和安全的）自我归属，这种推理也无法解释自我认识，因为对思考者来说这种推理似乎不合理：毕竟，一般来说 p 的事实并不意味着我相信 p。Fernández 在论证中解决了这个担忧，认为通过绕过方法形成的信念对主体来说似乎是合理的。其他批评者认为从 p 到我相信 p 的转变不是真正的推理。Valaris（2011）认为，与真正的推理不同，这种转变不能在假设情境中使用，例如，当一个人从一个他不相信的前提出发，看看它会导致什么。Barnett（2016）认为，这种转变违反了对推理的合理、广泛的证据主义限制。

Fernández 将他的解释限制在解释信念和欲望的自我认识上，而 Byrne 将他的解释扩展到包括我们所有心理状态的自我认识。批评者对将透明度解释扩展到除了信念之外的领域表示怀疑：对欲望（Ashwell 2013a, 2013b），对思想或意图（Samoilova 2016），或对信念的自信程度不到 100%（Tang 2017）。
...
理性主义的解释面临两个相关的挑战。首先，为了捍卫理性保证自我认识能力的观念，这些解释必须采用相当苛刻的理性概念。但是，如果理性概念过于苛刻，那么它是否适用于像我们这样认知有缺陷的生物就成了问题（Kornblith 2012; Cassam 2015）。其次，为了解释我们如何能够满足他们对理性的苛刻标准——如何遵循 Stoljar 的内省原则，或者如何了解我们所有的信念——理性主义者往往会引用非标准的“意识”或“信念”概念。这里的挑战是要表明实现自我认识的过程在心理上是现实的，并且适用于我们实际拥有的那种状态。
...
一些行为主义观点独立于我们的态度是理性行为体的观念。麦基尔（1996）的观点是经验主义行为主义的先驱，他认为自我归属是“承诺性的”：在自我归属一种态度时，我们承诺以适应该态度的方式行为。
...
在其中一种方法中，意识状态可以直接为自我归属提供认识上的保证，以前面提到的两种直接性的意义：也就是说，不需要通过判断来介入，也不作为承认的证据。
