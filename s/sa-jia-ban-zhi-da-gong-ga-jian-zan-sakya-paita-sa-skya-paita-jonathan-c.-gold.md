...
Sapaṇ 可能是唯一能够准确理解业力对于阿波罗学说的重要性的人，这是佛教在空性光明下进行概念形成的方法。即使是达尔玛基尔提，他的认识论也吸引了声闻乘佛教徒，也不愿意如此生动地成为实用主义者。不管怎样，Sapaṇ 经常提到达尔玛基尔提，并且可以合理地认为他对其观点进行了忠实的延伸。最重要的是，Sapaṇ 始终坚持佛教认识论中的关键本体论区分，即真实的、因果有效的瞬时个别事物是感知的潜在对象，而虚假的概念构建是认知的表象对象。当现实被划分为这些类别时，我们甚至可以从定义中看出概念和抽象对象必须是虚幻的。查巴和他的追随者谈到了各种中间类别——认知和感知对象，并不仅仅是瞬时的裸体个别事物——而 Sapaṇ 和他的追随者认为这些中间类别对于佛教观点来说是不足够的。

这些中间立场的动机并不难理解。在瞬间感知的具体事物和错误的语言概念之间有如此严格的区分，很难解释我们如何能够获得类似知识的东西。这就是 Dignāga 的 apoha 学说所应该帮助的地方。虽然没有真正的概念和语言普遍性，但有表面上的普遍性，我们错误地但实用地将其叠加在真实的事物上。我们创造概念不是通过识别跨越不同实体的某种真实品质或相似性，而是通过忽略它们大部分的差异，并将非成员从概念领域之外的实用有益的边界中“排除”出去。一个关键问题是，如何解释一个错误的边界如何在实用上有益？例如，如果所指的对象之间没有真正的相似之处，为什么一个概念或一个词会被各种人认可和共享？答案是，正如我所说的 Sapaṇ 比其他思想家更明确地给出的，是因果报应。将被错误地认为是真正的普遍概念叠加在实际上真实的特定事物上的错误，对于倾向于以相同方式看待事物的存在是有效的：
...
与以前一样，不可能逐一讨论萨迦·班智达的所有重要论点，因此我将限制自己在一个他最广泛辩论的议题上，并且这也是这部作品的一个重要主题。问题是所谓的“白色自给自足的疗法”，通常被翻译为“白色万灵药”——这个术语用来描述称为“大手印”或 Mahāmudrā 的冥想修行。萨迦·班智达认为，这个对 Mahāmudrā 的称呼代表了对这个修行的错误理解，将一个合法的密宗修行转化为一个误导性和有害的错误教义。[19]
...
Sapaṇ 的攻击目标是这样一种观念：仅仅通过直接领悟被称为大手印的心性，就能获得修行的所有成就。这一单一的获得就是一种万灵药，一种“自给自足的疗法”。我们可以立即看到，这种修行的主张挑战并削弱了佛教传统的许多教义细节、修行方法和背景的重要性，将其简化为一种单一的幻觉体验。此外，Sapaṇ 认为这种观点是藏传佛教的发明，而不是印度的传统，它类似于一种与僧人 Hvashang Mohoyen 有关的中国著名被拒绝的教义。他认为，“白色自给自足的疗法”是对佛法的无知扭曲，导致教义的虚无主义式衰落。此外，Sapaṇ 认为大手印的修行是密宗而不是一般的大乘佛法，因此他拒绝了当时流传的非密宗形式的教法。有理由相信，这种将一般的大乘佛法和特定的密宗修行相结合的做法实际上在印度是有先例的，但 Sapaṇ 似乎认为印度的修行者会将其视为错误（参见 Mathes 2008）。
