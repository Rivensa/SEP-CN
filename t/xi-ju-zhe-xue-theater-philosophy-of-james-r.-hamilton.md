...
针对这些提议所提出的挑战，并注意到既没有对表演进行任何定义，也没有关注相关实践的历史事实（见下文第 3.1 节），有人认为最合理的表达“表演”的方式是基于标准的人类学和动物行为学理论，并将“表演”定义为各种物种（包括我们自己）展示的一种“展示行为”（Hamilton 2013）。然而，在这种解释中，表演并不是演戏的替代品，而更像是演戏的“属”，演戏则对应为“种”。
...
但假设评估艺术作品的价值与评估我们对艺术作品可能采取的行为之间存在差异。这两者作为推理目标，可能都是合法的吗？那些基于所有推理都是手段/目的的理由而拒绝“实践与理论推理”区分的人，因此认为一个推理是否好坏不能在未确定推理者的目标之前确定，将会发现伊森伯格（或“伊森伯格式”）的观点和对其的反对都不那么有趣。应用于戏剧表演的评估中，作为表演，我们也没有理由在这些不同形式的推理之间进行选择。
...
这种解释“为舞台而写”的方式并不排除所谓的“文学剧场”。如果我们将剧本视为“行动的乐谱”（Saltz 1991b），我们也可以将其视为提供观众将遇到的信息的特定排序（Stoppard 1999）。一些剧本以出色的效果做到了这一点；在剧院术语中，它们“有生命力”。就像一些体操或爵士乐的表演一样，它们经常被重复和模仿，因为它们产生了标志性的成就。写作可能对剧院的这一成就起到了贡献，因为它允许对信息的流动和顺序进行更大的控制，而不像为即兴演出而设计的复杂情节或甚至是从一代演员传给另一代的情节和语言那样。然而，无论对于剧本演出相对于其他方式生成的演出的价值如何，一个以剧本为驱动的剧院很可能是一个文学剧场，因为它将产生一些可以被视为文学作品的书面剧本。

对于作为剧本使用的戏剧文学作品的文学分析可能对演员有用，也可能无用。戏剧表演的内容并不完全由书面文本所控制、传递或检索。相对“薄弱”的文本受到演出的不确定性（Ball 1983；Worthen 2007，但参见 Goodman 1968: 210–211 的相反观点）。如果这是正确的，那么对于衡量演出本身的成就，需要一套完全不同的标准。

截至目前，哲学界对于这些特定标准的研究进展甚微。也许这个辩论最好留给实践中的评论家、演员和表演或剧院理论家。但通过考虑评估演出成就所需的条件，可以在哲学上取得一些进展。

要问戏剧表演中可能取得什么成就，首先需要我们了解成就是什么。思考这个问题的一个来源无疑是对教育中成就的实证研究，将其与其他因素相关联，但并没有具体说明成就本身包含什么（例如，Burke 和 Sass 2013）。另一个来源无疑将来自于那些关注德性认识论、德性伦理学或价值完善主义的人。Gwen Bradford 在几篇文章中探讨了“成就”的基本概念（Bradford 2013, 2015, 2016）。Bradford 将成就描述为需要两个条件：

> 首先，成就具有过程-产物结构：所有成就都有一个过程，最终产生一个产物。其次，成就的过程是困难的。为了成为一个成就，某件事必须在某种程度上具有足够的困难；毕竟，如果跑马拉松和写一本小说很容易，我们就不会倾向于称之为成就。...[而且]暂且假设一个活动之所以困难，是因为它需要从参与其中的行为体付出努力。（Bradford 2013: 205）

她最终否认了产品是否具有独立价值可能会产生影响的观点，理由是至少在将我们对成就的日常评估编码化的问题上，我们确实会计算一些事情，比如跑马拉松，考试成绩好，尽管它们的独立价值比不上，比如从火灾中挽救三十条生命，或者找到治疗小儿麻痹症的方法（Bradford 2016: 797）。因此，如果要评价戏剧表演中的成就，必须清楚地说明准备表演的过程涉及什么，为什么在这个过程中承担的任务并不容易，以及如何察觉和评估这些成就。

在准备和表演一个例行公事时，演员们会选择要说什么和做什么。演员们还会选择如何说出所说的内容以及如何完成他们所做的事情。此外，演员们还会决定在表演的每一刻要做什么以及如何做。到目前为止，这些决策涉及每个演员独立于其他演员所说和所做的内容，但演员通常不会孤立地做出这些决策。这些决策的另一个方面需要集中的、也许是集体的努力。任何一个团队都需要决定他们在每个时刻希望将注意力集中在哪里以及他们将如何做到这一点。其中一些决策涉及思考演员在表演空间中相对于彼此和观众的位置。决定如何引导观众的注意力的许多决策涉及决定每个演员的话语方式和时间与其他演员的话语内容、方式和时间的关系。同样，为了调节观众的注意力，团队会思考每个演员所做的事情与其他演员所做的事情之间的关系。显然，这些任务中没有一个特别容易，尤其是那些要求演员之间协调的任务。

此外，观众必须能够确定表演的风格，以便能够正确地引导相关的期望。因此，演员们也必须做出风格选择。因为实际上是特征序列（由选择序列产生）随着时间的推移塑造了表演的形式并引导了观众的期望。如果这个序列是由演员们共同的目标所规定的惯例，那么情况就是如此。再次强调，这些任务中没有一个特别容易成功，尤其是因为风格选择要求演员之间的协调。

这导致了一系列关于观众如何衡量成功的观念，特别是当他们发现失败时，他们能够对表演者、布景和整体舞台布置发表什么样的言论。如果一个观众对某个约定规则——一系列由某个总体目标控制的选择序列——毫不知情，并且如果该约定规则的存在是导致作品中可欣赏的方面存在的原因，那么该观众就无法欣赏该作品，至少对于那些方面来说是如此。这部分是因为欣赏取决于对自己所经历的事物有一定程度的理解。理解要求观众对表演者在表演中的行为提出假设，并将这些假设与实际表演的细节进行测试，通常是在表演展开的过程中，并根据其目标和背景评估表演所体现的成就。只有理解表演及其特点的观众才能提出相关类型的假设。

这样的观众能够察觉并解释技巧上的失败。一个背景适当的观众，因此理解了所涉及的约定规则和风格，将知道要观察什么。如果表演者在声音、语言、情绪、动作或行为方面没有展现出相关特征，那么他就会失败。这样的失败可能是技巧不足导致的。理解表演及其特点的观众不仅会注意到这一点，还能够向其他观众解释这种由于技巧不足而导致的失败。

在风格层面上，表演中的失败可以以至少三种方式发生。如果一些被归为惯例的特征不能清晰而连贯地引发它们所看似瞄准的效果或目标，那么失败就会发生。或者，如果表演者不理解他们所采用的惯例实际上引发了什么效果，因此，他们所做的选择与他们自己的自我意识目标完全不符，失败也会发生。如果表演者的目标不明确，并且他们选择了一系列令观众困惑的惯例混合，失败也会发生。如果观众正在追踪关于表演者所做的假设的充分性，并且她理解表演和它们的特征，她将会注意到这些失败，并且能够向他人解释它们。
...
* –––, 1972, “The Origin and Form of the Yoruba Masque Theatre”, *Cahiers d’études africaines*, 12(46): 254–276. doi:10.3406/cea.1972.2763
* Aneja, Deepali, Alex Colburn, Gary Faigin, Linda Shapiro, and Barbara Mones, 2017, “Modeling Stylized Character Expressions via Deep Learning”, in *Asian Conference on Computer Vision – ACCV 2016: 13th Asian Conference on Computer VisionTaipei, Taiwan, November 20–24, 2016, Revised Selected Papers, Part II*, Shang-Hong Lai, Vincent Lepetit, Ko Nishino, and Yoichi Sato (eds.), (Lecture Notes in Computer Science 10112), Cham: Springer International Publishing, 136–153. doi:10.1007/978-3-319-54184-6_9
* Artaud, Antonin, 1938 [1958], *Théâtre et son double*, Paris: Gallimard. Translated as *The Theatre and Its Double*, Mary Caroline Richards (trans.), New York: Grove Press, 1958.
* Auslander, Philip, 1986 [2002], “‘Just Be Your Self’: Logocentricism and Difference in Performance Theory”, *Art & Cinema*, 1: 10–12. Reprinted in Zarrilli 2002a: 53–60.
* Austin, J.L., 1962, *How To Do Things With Words: The William James Lectures Delivered at Harvard University in 1955*, J.O. Urmson and Marina Sbisà (eds.), Oxford: Clarendon Press. doi:10.1093/acprof:oso/9780198245537.001.0001
* Austin, J. L. and G. E. M. Anscombe, 1958, “Pretending”, *Aristotelian Society Supplementary Volume*, 32(1): 261–294. Austin’s essay is 261–278, Anscombe’s essay is 279–294. doi:10.1093/aristoteliansupp/32.1.261
* Badiou, Alain, 1990 [2013], *Rhapsodie pour le théâtre*, Paris: Imprimerie nationale. Translated as *Rhapsody for the Theatre*, Bruno Bosteels (trans. and ed.), London: Verso, 2013.
* Ball, David A., 1983, *Backwards and Forwards: A Technical Manual for Reading Plays*, Carbondale, IL: Southern Illinois University Press.
* Barish, Jonas A., 1966, “The Antitheatrical Prejudice”, *Critical Quarterly*, 8(4): 329–348. doi:10.1111/j.1467-8705.1966.tb01315.x
...
* Deleuze, Gilles, 1968 [1994], *Différence et répétition*, Paris: Presses Universitaires de France. Translated as *Difference and Repetition*, Paul Patton (trans.), New York: Columbia University Press, 1994.
...
* Predelli, Stefano, 2001, “Musical Ontology and the Argument From Creation”, *The British Journal of Aesthetics*, 41(3): 279–292. doi:10.1093/bjaesthetics/41.3.279
...
* Spingarn, Joel Elias, 1911 [1931], “The New Criticism: A Lecture Delivered at Columbia University, March 9, 1910”, New York: Columbia University Press. Reprinted in his *Creative Criticism, and Other Essays*, New York: Harcourt, 1931, pp. 3–38. [[Spingarn 1911 available online](https://archive.org/details/newcriticismlect00spin/page/n6)]
