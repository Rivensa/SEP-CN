...
这个例子很好地说明了参与思想实验的行为的许多常见特征：我们在想象中构建了某种情境；我们让它运行或进行某种操作；我们看看会发生什么；最后，我们得出一个结论。这个例子还说明了思想实验的可疑性。自卢克莱修斯以来，我们已经学会了如何概念化空间，使其既有限又无边界。想象一个圆圈，它是一个一维空间。当我们在圆圈上移动时，没有边缘，但它仍然是有限的。宇宙可能是这种拓扑结构的三维版本。因此，当想象反事实的情景时，我们必须尝试注意“物理尺度效应”（Klee，2008 年）或其他类似因素可能带来的意外限制。

![A person is about to throw a spear at a wall of stones floating in the clouds Above the clouds are two winged figures holding a banner that reads 'Welcome to the edge of the Universe'](https://plato.stanford.edu/entries/thought-experiment/figure1.jpg)

图 1. “欢迎来到宇宙的边缘”

通常，一个旨在成为思想实验类似物的真实实验由于物理、技术、伦理或财务限制而无法进行（参见，例如，Sorensen 1992 年，第 200-202 页）；但物理上的不可实现性并不是思想实验的定义条件。相反，主要观点是我们似乎能够通过思考来掌握自然，这就是哲学的巨大兴趣所在。这是恩斯特·马赫的立场（参见马赫，1897 年和 1905 年；对他观点的最有启发性的评估见 Kühne 2006 年，第 165-202 页，以及 Sorensen 1992 年，第 51-75 页）。思想实验属于不同类型实验的一种。它们使我们能够利用从过去经验中获得的大量“本能知识”。我们将在后面进一步讨论马赫的理论。他对思想实验的解释仍然是思想实验如何工作的主要理论之一。马赫最喜欢的一个例子是西蒙·斯蒂文（见马赫，1883 年，第 48-58 页）的例子。当一条链条悬挂在一个双摩擦力为零的平面上时，如图 2a 所示，它会如何移动？在图 2b 中添加一些链接。现在很明显了。初始设置必须处于静态平衡状态。否则，我们将会有一个永动机；根据我们基于经验的“本能知识”，马赫说，这是不可能的。我们不必在现实世界中进行实验，我们也无法这样做，因为这将需要一个完全无摩擦的平面。然而，结果似乎是令人信服的。

![A black dashed chain rests on top of the two top sides of a triangle](https://plato.stanford.edu/entries/thought-experiment/figure2a.gif)

(a)

![A black dashed chain rests on top of the two top sides of a triangle; the dashed chain is extended into a loop so that it rests, dangling below the bottom of the triangle](https://plato.stanford.edu/entries/thought-experiment/figure2b.gif)

(b)

图 2. "它会如何移动？"

Judith Thomson 在道德领域提供了一个最引人注目和有效的思想实验之一（参见 Thomson 1971）。她的例子针对的是一个常见的反堕胎论证，大致如下：胎儿是无辜的人。所有无辜的人都有生存权。堕胎导致胎儿死亡。因此，堕胎在道德上是错误的。在她的思想实验中，Thomson 要求你想象一个著名的小提琴家陷入昏迷。音乐爱好者社团通过医疗记录确定只有你一个人可以通过与他连接九个月来拯救小提琴家的生命。音乐爱好者在你熟睡时闯入你的家，将无意识（因此无辜）的小提琴家与你连接起来。你可能想要解开连接，但是你面临着音乐爱好者提出的以下论证：小提琴家是无辜的人。所有无辜的人都有生存权。解开连接将导致他死亡。因此，解开连接在道德上是错误的。然而，尽管这个论证与反堕胎论证具有相同的结构，但在这种情况下似乎并不令人信服。你愿意继续连接九个月是非常慷慨的，但你没有道义上的义务这样做。与堕胎案例的类比是明显的。Thomson 的思想实验在区分之前被混为一谈的两个概念上非常有效：“生存权”和“维持生命所需的权利”。胎儿和小提琴家可能都有前者，但不明显他们是否有后者。总之，即使胎儿有生存权（Thomson 并不相信，但为了论证的目的允许这种可能性），堕胎仍然可能在道德上是可容许的。那些反对 Thomson 观点的人有两个选择。他们可以将她的思想实验视为无用的虚构。实际上，作为伦理学方法的思想实验也有批评者（参见，例如，Dancy 1985）。 或者，他们可以提供同一情景的不同版本来挑战结论。思想实验的一个非常有趣的特点是它们可以被“重新思考”（参见 Bokulich 2001）。真实实验也经常可以被重新解释。在这方面，这两类实验之间似乎没有原则性的区别。

像论证一样，思想实验也可以以不同的方式受到批评。也许设定有问题；也许从思想实验中得出的结论是不合理的。类似的批评也可能出现在真实实验中。反思想实验可能是另一种批评形式。它们不针对特定思想实验中的前提或结论，而是质疑现象，即想象情景的非命题核心（参见布朗 2007 年）。例如，丹尼尔·丹尼特（Daniel Dennett）坚信弗兰克·杰克逊（Frank Jackson）的玛丽思想实验不足以反对心灵哲学中的物理主义。在杰克逊的版本中，玛丽对颜色了解物理学和神经科学所能知道的一切，但在一个无色环境中长大（只看到黑色、白色和灰色的东西），当她第一次看到一个红色的番茄时，她似乎学到了新东西。现在她知道了体验红色的感觉。这是一个支持感觉质的论证，认为它超越了物理层面。丹尼特在他的思想实验版本中，没有给玛丽一个红色的番茄，而是给了她一个鲜艳的蓝色香蕉。在他的故事版本中（与杰克逊的版本一样合理），玛丽犹豫不决地说她被欺骗了，因为她知道香蕉是黄色的，而这，玛丽说，是对颜色感知的一切物理知识的结果。当她第一次看到有颜色的物体时，玛丽并没有学到任何新东西，所以根本没有反对物理主义的理由。杰克逊最初的思想实验非常有说服力，但丹尼特的版本似乎同样有说服力，从而削弱了杰克逊的论证，尽管对后者的结论比前者更有抵抗力！丹尼特对持续存在的“玛丽学说”抱怨很多，他称之为对杰克逊的思想实验持续接受作为反对物理主义的有力案例。

思想实验显然具有引人入胜的可塑性，这引发了一个有趣的问题，即是什么保留了思想实验的身份。用蓝香蕉替换红番茄可能仍然让我们得到相同的思想实验，只是稍作修改。但是，在什么时候我们会得到一个新的思想实验呢？这不仅仅是一个关于概念模糊的问题。这有助于促进对思想实验认知效力的直观最合理观点的讨论，根据这个观点，这种效力取决于它们作为论证的程度。约翰·D·诺顿持有这样的观点，下面将对此进行讨论。鉴于在解决争议中，同一个思想实验的讨论起到重要作用的情况，以下问题出现了：如果与争议各方所考虑的不同版本的思想实验相对应的论证显著不同，那么同一个思想实验如何支持关于特定问题的相反观点呢？困境是：我们可以说，如果有多个论证，那么在争议中涉及的思想实验就不止一个。但如果这是真的，那么争议各方只是互相忽视对方的论证而提出自己的论证。或者，我们可以说一个思想实验可以对应多个不同的论证。但是，如果这是真的，那么思想实验以何种非平凡的方式与论证相同就变得不清楚了（参见 Bishop 1999，以及 Norton 2004 年的回应，63-64 页）。

思想实验的可塑性与思想实验的另一个特点相一致，即它们似乎只在历史和地方上具有“证据意义，即当和哪里的前提将其归因为具有证据意义时[...]被认可”（麦卡利斯特 1996 年，第 248 页）。

## 2. 思想实验的分类法

文献中可以找到许多分类法。它们并不是互相排斥的。我们将介绍其中的三种。第一种是根据思想实验的目的进行分类。在马赫（1897 年和 1905 年）的著作中可以找到一个非常基本的版本。这样的分类是有意义的，因为“一个“想象实验应该根据其特定目的来评判”（克里姆斯基，1973 年，第 331 页）。思想实验出于各种原因而进行（参见 DeMay 2006; Sorensen 1992, pp. 7–15），而且在各个领域都有，包括经济学（参见 Herfeld 2019; Thoma 2016），教育学（Helm and Gilbert 1985; Helm et al. 1985, Klassen 2006; Sriraman 2006; Stonier 1990），历史学（参见 Maar 2014; Reiss 2009），文学（参见 Davies 2007; Elgin 2004），数学（参见 Brown 1991 [2011], pp. 90–97; Glas 1999），道德学（参见 Hauerwas 1996; Wilson 2016），以及自然科学（参见 Krimsky 1973），社会政治领域（参见 Roberts 1993: Thaler 2016），和神学（参见 Gregersen 2014; Fehige 2024）。思想实验可以用来娱乐。这对于一些人认为符合某些条件的短篇小说或小说也是思想实验（参见 Davenport 1983）可能是正确的。一些思想实验在理论中具有特定的功能（参见 Borsboom et al. 2002）。其他一些是因为在现实世界中无法进行实验场景而进行的（参见 Sorensen 1992, pp. 200–202）。有时候思想实验有助于说明和澄清非常抽象的事态，从而加快理解的过程（参见 Behmel 2001）。还有一些在概念分析中作为例子（参见 Cohnitz 2006）。然后，在理论发现的过程中也有一些重要的思想实验（Praem and Steglich–Peterson 2015）。 最受关注的思想实验被认为是为了支持或反驳一个理论而进行的，使它们与现实世界的实验处于同等地位（参见，例如，Gendler 2004）。当然，使用思想实验的方式并不互相排斥。最明显的是，例如，一个思想实验既可以娱乐又可以反驳一个理论。

第二个分类法根据思想实验的逻辑结构对其进行分类（参见 Sorensen 1992，第 132-166 页）。其思想是将所有思想实验分为两种“真理否定者”：“虽然有很多方法可以对思想实验进行分类，但通过熟悉度、具体性和简单性来评判，否定格式得分最高。根据这个方案，思想实验旨在通过证明其模态后果之一的错误来推翻陈述。模态是应用于命题以产生新命题的运算符。有权利模态（允许，禁止），认知模态（知道，相信）和真理模态（可能，必然）。真理模态是最为人所知且更基本的模态。因此，我们集中研究它们不会错过任何东西”（Sorensen 1992，第 135 页）。一种思想实验的类型“旨在通过展示某个被该陈述排除为不可能的事实实际上是可能的”（Sorensen 1992，第 135 页）。在关于思想实验的形而上学讨论中，最常讨论的例子就是这种类型，即 Gettier 场景（参见 Grundmann＆Horvarth 2014; Saint-Germier 2019）。它们旨在推翻所有知识都是合理的、真实的信念的主张。它们作为“必然否定者”。另一种类型收集了“可能否定者”的例子。它们不肯定“思想实验内容的可能性”。相反，它们建立“共同可能性”。一个很好的例子是一个全能的上帝面临创造一个对其自身来说太重而无法举起的石头的任务。上帝似乎无法成功。神的全能概念在这里引起了一些困扰。

第三个分类法（参见 Brown 1991 年第 2 章）并不是没有受到质疑（参见 Norton 1993b），与前两个分类法相比，它更为有限，因为它主要关注那些被认为在理论选择中起作用的思想实验，而这种使用思想实验的方式已经引起了最多的关注。根据这个分类法，主要的区分是建设性和破坏性，类似于卡尔·波普尔（Karl Popper）对辩护性和批判性思想实验的区分。波普尔实际上区分了三种类型的思想实验：启发性（用于说明一个理论），批判性（反对一个理论）和辩护性（支持一个理论）（参见波普尔 1959 年）。他对批判性思想实验的成功所带来的主要认识论挑战并没有提出很多观点，他的论述非常有限，他只专注于量子物理学，并没有真正解决批判性思想实验的主要认识论挑战。

在破坏性的思想实验中，可以确定以下子类型：其中最简单的是通过揭示理论中的矛盾来驳斥它。伽利略著名的自由落体实验的第一部分就是这样做的。它表明在亚里士多德的解释中，一个复合体（连接的炮弹和子弹）将比单独的炮弹下落得更快和更慢。第二个子类型是由那些旨在显示所讨论的理论与我们持有的其他信念相冲突的思想实验构成的。例如，薛定谔的著名猫悖论并没有显示量子理论（至少在某些解释上）在内部是不一致的（参见薛定谔 1935 年，第 812 页；翻译：特里默 1980 年，第 328 页）：“一只猫被关在一个钢制房间里，与以下恶魔般的装置一起（必须防止猫直接干预）：在一个盖革计数器中有一小块放射性物质，可能在一个小时内有一个原子衰变，但也可能没有；如果发生衰变，计数器管就会放电，并通过继电器释放一个锤子，砸碎一小瓶氰化氢。如果一个小时内将整个系统留给自己，如果期间没有原子衰变，我们会说猫仍然活着。第一个原子衰变将会毒死它。整个系统的 q 函数将通过在其中混合或涂抹等量的活猫和死猫（请原谅这个说法）来表达这一点。”这个思想实验表明量子理论（由玻尔解释）与我们对于猫这样的宏观物体的一些非常强大的常识信念相冲突——它们不能以任何方式同时既死亡又活着。薛定谔说，原子世界中的叠加态的奇异性已经令人担忧，但当它意味着在日常层面上也存在同样的奇异性时，这是无法容忍的。 有一种负面思想实验的第三个子类型，即当思想实验本身的一个核心假设或前提被削弱时。例如，正如我们在上面看到的，汤姆森通过她的思想实验表明，“生命权”和“维持生命所需的权利”已经混为一谈。当这两者被区分开来时，反对堕胎的论点会受到负面影响。

负面思想实验的第四个子类型是“反思想实验”（参见布朗 2007 年）。诺顿非常有用地引入了一个相关的概念：“思想实验/反思想实验对”（参见诺顿 2004 年，第 45-49 页）。在上面，我们已经在讨论卢克莱修斯的矛头思想实验和丹尼特对杰克逊的备受关注的玛丽色彩科学家思想实验时遇到了这个子类型。在这里，我们想再举一个例子，即马赫对绝对空间的反思想实验。在他的《数学原理》中，牛顿提供了一对思想实验作为绝对空间的证据。一个是桶思想实验，水爬上墙壁（见图 3），另一个是一对由绳子连接的球，在其他空间中保持张力（见图 4）。牛顿认为，这些现象的解释是绝对空间：桶和连接的球体相对于空间本身旋转。作为回应，马赫修改了情景并主张，与牛顿相反，两个球体会因绳子的张力而相互靠近，如果我们在一个静止的桶周围旋转一个非常厚重的大环，我们会看到水爬上桶壁（有关马赫对牛顿的反思想实验的进一步讨论，请参见库内 2006 年，第 191-202 页）。简而言之，马赫的反思想实验的目的是以不同的方式描述思想实验的情景现象，即宣称会发生不同的事情。马赫的反思想实验削弱了我们对牛顿思想实验的信心。绝对空间可能是牛顿思想实验中现象的一个合理解释，但现在，在马赫的反思想实验的光下，我们对现象本身以及绝对空间的概念不再那么确定。

![Three successive figures I a pail halffull of water is suspended by a rope tied to its handle; II arrows show the pail halffull of water is in motion counterclockwise and the water in the pail is in motion clockwise; III the surface of the water in the rotating pail is shown higher at the edge of the pail and lower at the center](https://plato.stanford.edu/entries/thought-experiment/figure3.jpg)

图 3. 桶实验的阶段

![Two grey spheres joined by a black line The line is labeled 'tension in cord'](https://plato.stanford.edu/entries/thought-experiment/figure4.jpg)

图 4. 两个球由绳子连接在空旷的空间中

要有效果，反思想实验并不需要非常可信。在法庭上，只要罪行被“超出合理怀疑”的程度确定下来，陪审团就会判定有罪。常见的辩护策略是提供一种对证据的替代解释，这种解释足够可信，足以对控方的案件产生一定程度的怀疑。这已足以削弱控方的案件。反思想实验只需要做到这一点就足够有效，从这个意义上说，它的作用类似于 Sorensen 所说的“必要性反驳者”。

除了破坏性的思想实验，还有第二种类型，即建设性的思想实验。毫不奇怪，它们可以以许多方式为理论提供积极的支持。其中一种方式是提供一种使理论的主张清晰明了的插图。在这种情况下，思想实验充当一种启发式辅助工具。结果可能已经得到充分证实，但思想实验可以带来一种非常令人满意的理解感。在他的《数学原理》中，牛顿提供了一个很好的例子，展示了月球是如何保持在轨道上的，就像物体落向地球一样（参见 Ducheyne 2006，第 435-437 页）。他通过一门炮越来越远地射击炮弹的方式来说明这一点（见图 5）。在极限情况下，地球弯曲的速度与球体下落的速度一样快，最终结果是炮弹将返回到它被发射的地方，并且如果没有阻碍，将一次又一次地绕行。这就是月球正在做的事情。我们可以通过计算得出相同的结论。但牛顿的思想实验提供了那种难以捉摸的理解感。这是许多有力思想实验的典型“啊哈效应”的精彩例子。

![A globe with a hill at the top and a cannon Lines show a sequence of cannonball tracks; each track is longer until a track goes all the way around the globe There are two larger concentric circles around the globe and the cannonball tracks](https://plato.stanford.edu/entries/thought-experiment/figure5.jpg)

图 5. "世界震惊的一枪"

汤姆森的小提琴手表明，即使胎儿有生存权，堕胎在道德上也是可以接受的。同样，爱因斯坦的电梯实验表明，在引力场中光线会弯曲，因为根据等效原理，这样的参考系与在自由空间中加速的参考系没有区别；物理定律在所有参考系中都是相同的。假设一个观察者在一个与外界隔离的电梯内，观察者无法判断自己是在引力场中还是在加速。如果它是在加速，如果一束光线从一侧进入，那么由于电梯的运动，光线在穿过电梯时会出现下降或弯曲的现象。因此，如果电梯在引力场中，它也必须做同样的事情。因此，重力会“弯曲”光线。

麦克斯韦的恶魔实验表明熵可以减少：热力学第二定律暗示热量不会从冷物体传递到热物体。在经典热力学中，这个定律非常严格；但在麦克斯韦的热动力学理论中，这种事件发生的概率虽然极小，但是存在。有人认为这是对麦克斯韦理论的归谬论证。为了展示如何违反第二定律，麦克斯韦想象了一个控制两个房间之间门的微小生物。来自冷箱的快速分子被放入热箱，来自热箱的慢速分子被放入冷箱。因此，热箱中的平均速度增加，冷箱中的分子平均速度减少。由于在麦克斯韦的理论中，热量就是分子的平均速度，所以热量从冷物体流向热物体。

Parfit 的分裂人表明，在考虑人格时，生存比身份更重要（有关批判性讨论，请参见 Gendler 2002a）。我们说他们“展示”这样那样的东西，但是，“意图展示”可能更好，因为其中一些思想实验是相当有争议的。它们的共同之处在于它们旨在建立某种积极的东西。与破坏性思想实验不同，它们并不试图摧毁现有的理论，尽管它们可能在经过中做到这一点。重申一个重要观点：原则上，鉴于思想实验可以重新思考（请参见 Bokulich 2001），而证据的重要性取决于历史和地方的成就（请参见 McAllister 1996），确定思想实验者的意图对于确定思想实验的类型是不相关的是不相关的：“一个想象的实验应该根据其具体目的来判断”（Krimsky 1973，第 331 页）。
...
经常讨论的是凯瑟琳·威尔克斯提出的怀疑挑战。她对德里克·帕菲特的人们像阿米巴一样分裂的情景表达了深深的怀疑（参见帕菲特 1987 年；根德勒 2002a 年）。威尔克斯希望哲学“使用科学事实而不是科幻或幻想”（威尔克斯 1988 年，第 1 页），因此要避免使用思想实验，因为它们“既有问题又具有误导性”（威尔克斯 1988 年，第 2 页）。她声称，特别是关于个人身份的思想实验通常未能提供实验背景条件（参见威尔克斯 1988 年，第 7 页）。她认为，如果我们遇到像阿米巴一样分裂的人，我们将不知道该说什么。她坚持认为，合法的思想实验不能违反已知的自然法则。我们确实同意威尔克斯的观点，即不确定性可能是一个问题。但是，我们不应该将哲学中的思想实验一概而论地否定，而应该将其视为评估思想实验质量的关键因素（参见雷斯切尔 2005 年，第 9-14 页）。也就是说，虚构情景在相关方面越详细，思想实验就越好（参见布伦德尔 2004 年，第 97-99 页；哈格奎斯特 1996 年，第 28 页）。
...
对于第二个反对意见，当奥卡姆剃刀原则被用来排除一种理论时，通常会出现问题。无论我们通过简约原则排除了什么，我们都可以通过最佳解释的推理轻易地重新引入它（参见 Meixner 2000）。这正是一个柏拉图主义者所主张的思想实验的柏拉图主义，同时承认柏拉图直觉似乎是神奇的。但它们真的比感知更神奇吗？感知在许多方面似乎与柏拉图直觉相似。也许有人会说是的，因为我们似乎完全不知道柏拉图直觉是如何工作的，但我们对感知的性质有一些想法。我们知道，如果一个物体离得很远，它在视觉上会显得更小，在某些光线条件下，同一个物体看起来可能完全不同。然而，难道真的不可能提出类似的规则来捕捉柏拉图直觉的性质吗？如果你喝醉了或者注意力不集中，你很可能无法直觉到任何哲学价值的东西。
...
* –––, 2004a, “On Thought Experiments: Is There More to the Argument?” *Proceedings of the 2002 Biennial Meeting of the Philosophy of Science Association, Philosophy of Science*, 71: 1139–1151. [[Preprint available online](http://philsci-archive.pitt.edu/719/)].
* –––, 2004b, “Why Thought Experiments Do Not Transcend Empiricism”, in C. Hitchcock (ed.), *Contemporary Debates in the Philosophy of Science*, Oxford: Blackwell, 44–66. [[Preprint available online](http://philsci-archive.pitt.edu/960/)].
...
> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [How to cite this entry](https://plato.stanford.edu/cgi-bin/encyclopedia/archinfo.cgi?entry=thought-experiment). |
> | --- | --- |
> | ![sep man icon](https://plato.stanford.edu/symbols/sepman-icon.jpg) | [Preview the PDF version of this entry](https://leibniz.stanford.edu/friends/preview/thought-experiment/) at the [Friends of the SEP Society](https://leibniz.stanford.edu/friends/). |
> | ![inpho icon](https://plato.stanford.edu/symbols/inpho.png) | [Look up topics and thinkers related to this entry](https://www.inphoproject.org/entity?sep=thought-experiment&redirect=True) at the Internet Philosophy Ontology Project (InPhO). |
> | ![phil papers icon](https://plato.stanford.edu/symbols/pp.gif) | [Enhanced bibliography for this entry](https://philpapers.org/sep/thought-experiment/) at [PhilPapers](https://philpapers.org/), with links to its database. |

## Other Internet Resources

* [Thought Experiments](https://www.oxfordbibliographies.com/abstract/document/obo-9780195396577/obo-9780195396577-0143.xml?rskey=wuYhXP&result=1&q=Thought+Experiments#firstMatch/), entry in the *Oxford Bibliographies*, by James R. Brown and Michael T. Stuart.
* [Thought Experiments and Religion](https://oxfordre.com/religion/display/10.1093/acrefore/9780199340378.001.0001/acrefore-9780199340378-e-24?mediaType=Article), entry in the *Oxford Encyclopedia of Religion*, by Yiftach Fehige.
* [Goodies](http://www.pitt.edu/~jdnorton/Goodies/), a collection of intriguing questions in the philosophy of science, some about thought experiments, by John Norton.
* [An Interactive Version of Thomson’s violin thought experiment](http://www.philosophyexperiments.com/whosebody/Default.aspx).
* [Six famous thought Experiments Explained Quickly](http://www.wimp.com/thoughtexperiments/), a video tutorial.
* [Ethical Thought Experiments Like the Trolley Dilemma](https://www.youtube.com/watch?v=5PpOehMLtT4/), a video tutorial.

## Related Entries

[Descartes, René](https://plato.stanford.edu/entries/descartes/) | [Galileo Galilei](https://plato.stanford.edu/entries/galileo/) | [intuition](https://plato.stanford.edu/entries/intuition/) | [Leibniz, Gottfried Wilhelm](https://plato.stanford.edu/entries/leibniz/) | [Mach, Ernst](https://plato.stanford.edu/entries/ernst-mach/) | [moral psychology: empirical approaches](https://plato.stanford.edu/entries/moral-psych-emp/) | [Platonism: in metaphysics](https://plato.stanford.edu/entries/platonism/) | [rationalism vs. empiricism](https://plato.stanford.edu/entries/rationalism-empiricism/)
