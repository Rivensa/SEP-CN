...
第三个论点基于被呈现和存在之间的差异（§5, 24）。特瓦尔多夫斯基说，那些声称存在无对象的呈现的人混淆了“被呈现”和“存在”。为了加强他的观点，特瓦尔多夫斯基提出了几个观察，其中之一是基于这样的主张：矛盾属性的承载者是对象本身，而不是内容。这个主张后来被迈农和马利称为存在与具有属性的存在之间独立性原则。当我们呈现一个因为矛盾而不存在的对象时，我们不需要立即注意到该对象具有矛盾的特性：我们可能通过进一步的推理逐渐发现这一点。现在假设只接受具有可能对象的呈现。然后，特瓦尔多夫斯基继续说，具有矛盾的东西的呈现将在我们没有注意到矛盾之前一直有一个对象；一旦我们发现了矛盾，呈现就不再有对象。那么，是什么承载了这些矛盾的特性呢？既然内容不能承载矛盾的特性，那么承载它们的就是对象本身；但是，这个对象必须是被呈现的对象。[7]
...
内容和对象应被视为特瓦尔多夫斯基为自己设定的更大研究目标的一部分。这包括发展概念理论和判断理论。
...
根据特瓦尔多夫斯基的观点，这两个句子之间的区别仅在于它们的简洁性和实际应用。现在来看这个句子
...
在第一步中，产生了一个口头句子，它表达了一个判断，这样判断就是句子的意义，而句子则是判断的标志。过程如下：一个非持久的心理产物，即一个判断（连同判断的行为），它是不可感知的，通过成为它（部分）原因，产生了一个非持久的心理物理产物，即一个口头句子，它是可感知的。在这种情况下，口头句子是判断的表达（§30）。现在，如果口头句子本身成为另一个判断的部分原因，这个判断（我们可以说）是与初始判断相同类型的标记（通过部分引起判断的行为，在另一个人身上或在同一个人身上的不同时间产生了另一个判断），那么口头句子也可以被视为判断的标志，而判断则是表达的意义（§32，§34）。刚才在前提中勾勒出的条件是基本的：如果没有这个条件，一个句子 p 很可能曾经是一个判断的表达（是 p 的部分原因），但没有意义与 p 相关联：因为如果 p 是不可理解的，即它不是另一个判断′的部分原因，那么就不能说有任何东西是它的意义（§31）。

第二步是将口头句子（一个非持久的心理物理产物）保存在一个持久的心理物理产物 s 中，即一个书面句子[12]。当一个判断以这种方式被保存时，它在标记中具有一种称为潜在的存在。这是因为标记可能在任何时刻引起一个相同或相似的判断的形成（特瓦尔多夫斯基 1912 年，§34），并且只要它存在，它就能够（部分地）引起判断。因此，“意义”也可以意味着

> 具有在心理物理产品作为心理产品的标志对个体产生心理产品的能力，或者更简洁地说，将相应的心理产品带入意识的能力。（特瓦尔多夫斯基 1912 年，n. 51，125。）

一旦以这种两步方式保存，非持久性产品不仅具有持久性产品的虚假外观，而且还具有某种独立于产生它们的行为的产品的外观。独立性的外观更加强化了这样一个事实，即我们假装一个判断产品存在于所有个体中，尽管许多判断产品是由书面句子产品引发的。所有这些许多判断彼此不同，但只要我们将判断视为句子的意义，即其标志

> 这些个体心理产品中必须存在一组共同属性。而且，正是这些共同属性（这些个体产品一致的属性）通常被我们视为心理物理产品的意义，作为其中固有的内容，前提是这些共同属性与使用该心理物理产品作为标志的意图相对应。[...]因此，我们只谈论一个标志的意义——除非存在歧义的情况——而不是在它作用的人身上被唤起或能够被唤起的心理产品的数量。现在，以这种方式构思的意义不再是具体的心理产品，而是通过对具体产品进行的抽象得出的结果。（特瓦尔多夫斯基 1912 年，§39，128）

对于这段文字，特瓦尔多夫斯基附注了一条注释，提到了胡塞尔的理想意义概念。胡塞尔和特瓦尔多夫斯基关于意义的概念以及特瓦尔多夫斯基独特意义的地位一直是讨论的对象，而且仍然是未解决的问题（参见 Paczkowska-Łagowska 1979，Buczyńska-Garewicz 1980，Placek 1996，Brandl 1998，Schaar 2015，108）。这些问题应该被视为尚未解决的。

引入句子唯一意义的概念使特瓦尔多夫斯基进一步区分了替代性（artefacta）和非替代性判断。替代性判断并非真正的判断，而是虚构的判断。后者实际上是内容和对象的呈现判断；区别在于，在行为和产品中，特瓦尔多夫斯基将替代性判断的概念明确应用于逻辑：逻辑学家所说或写的句子并不是真正通过他们传递的判断的表达或意义，而只是呈现判断，由呈现行为产生——这与实际判断行为不同。例如，当逻辑学家构建一个由实质上错误的句子组成的有效三段论以示范形式有效推理时（§44，130），她并不实际判断所有三角形都是正方形，所有正方形都是圆的，以及所有三角形都是圆的，而只是呈现相应的判断。句子“所有三角形都是正方形”、“所有正方形都是圆的”和“所有三角形都是圆的”并非真实的句子，而是人为的句子，因为它们是“代替实际判断的人为产品的表达，即仅仅是呈现的判断”（同上）。这些人为句子的意义是人为判断，因为它们仅仅是呈现的，而不是通过的。这些人为判断是逻辑的主题（在这一点上，特瓦尔多夫斯基再次受到波尔查诺的影响）。使用诸如“所有三角形都是正方形”之类的替代句子构成了“使心理产品独立于仅仅能够真正（实际）存在的行为”的最极端例子（§44，131）。
...
| (1894/5) | *Logik* (Logic). Manuscript lecture notes, Winter Semester 1894/5, Vienna University, pp. 274. Twardowski Archives, Biblioteka IFiS PAN, Warsaw. Available online [here](http://www.elv-akt.net/) Critical edition by Arianna Betti and Venanzio Raspa as *Logik - Wiener Logikkolleg 1894/5*, Berlin: de Gruyter, 2016. |
| (1895) | *Die Unsterblichkeitsfrage* (The Problem of Immortality). Manuscript lecture notes, Spring Semester 1894/5, Vienna University, pp. 227, [available online](http://www.elv-akt.net/) (registration required). Now edited by Michał Sepioło as *Die Unsterblichkeitsfrage*, Wydawnictwo WFiS UW, Warszawa Twardowski Archives, Biblioteka IFiS PAN, Warsaw, 2009. |
| (1895/6) | *Logika* (Logic). Manuscript lecture notes, Winter Semester 1895/6, Lvov University, pp. 244. Twardowski Archives, Biblioteka IFiS PAN, Warsaw. [available online](http://www.elv-akt.net/) (registration required). Working Eng. Transl. (Arianna Betti) on the Polish Philosophy Page at http://www.fmag.unict.it/PolPhil/Tward/TwardLog.html |
...
| (1905-24) | *O sceptycyzmie etycznym* (On ethical skepticism) 1905/06 to 1923/1924, several sets of manuscript lecture notes, Lvov University, Twardowski Archives, Biblioteka IFiS PAN, Warsaw. Available online [here](http://www.elv-akt.net/) (registration required). Collated fragments published in a single edition by Izydora Dąmbska as “Wykłady z etyki. O sceptycyzmie etycznym”, *Etyka* 9 (1971), pp. 171–222. Eng. transl. (Alicja Chybińska) in (2014), pp. 237–286. |
| (1907/08) | *Psychologia myślenia* (Psychology of Thinking). Manuscript lecture notes, Lvov University, pp. 31. Twardowski Archives, Biblioteka IFiS PAN, Warsaw. [available online](http://www.elv-akt.net/). |
